...
void PrepareWeightingIterations_pp2760(TString suffix = "pdf", TString nameFilepp2760GeV = "data_PCMResults_pp.root",  Bool_t runDrawReweighted = kTRUE, TString stringIterationNumber = "",TString nameSDD="WSDD"){
	...
	TString cutNumber = "00003113_00200009366300003800000000_0163103100900000";
	TString cutNumbAdd= "00003123_00200009366300003800000000_0163103100900000";
...
// 	Color_t 	colorMCPythiaPP900GeV 								= color900GeV-4;
	...
	Color_t         colorMCPythiaJetJetPP2760GeV							= color2760GeV+6;
...
// 	TString 	collisionSystemPP900GeV 							= "pp #sqrt{#it{s}} = 0.9 TeV";     
	...
	// Pythia 8
	TFile* 		filePi0PCM2760GeV_LHC12f1a_PYT8 					= new TFile(Form("%s-LHC12f1a-%s/2.76TeV/Pi0_data_GammaConvV1Correction_%s.root",cutNumber.Data(),nameSDD.Data(),cutNumber.Data()));
	cout<< "Filename::" <<Form("%s-LHC12f1a-%s/2.76TeV/Pi0_data_GammaConvV1Correction_%s.root",cutNumber.Data(),nameSDD.Data(),cutNumber.Data())<<endl;
	...
	TFile* 		fileEtaPCM2760GeV_LHC12f1a_PYT8 					= new TFile(Form("%s-LHC12f1a-%s/2.76TeV/Eta_data_GammaConvV1Correction_%s.root",cutNumber.Data(),nameSDD.Data(),cutNumber.Data()));
	...
	cout<< "Pythia::"<<histoPi0InputMCWOWeights_LHC12f1a_PYT8_2760GeV->GetBinContent(1)<< " "<< histoPi0InputMCWOWeights_LHC12f1a_PYT8_2760GeV->GetBinContent(2)<< " " <<histoPi0InputMCWOWeights_LHC12f1a_PYT8_2760GeV->GetBinContent(3)<< endl;
	// Phojet
	TFile* 		filePi0PCM2760GeV_LHC12f1b_PHO 						= new TFile(Form("%s-LHC12f1b-%s/2.76TeV/Pi0_data_GammaConvV1Correction_%s.root",cutNumber.Data(),nameSDD.Data(),cutNumber.Data()));

	cout<< "Filename::" <<Form("%s-LHC12f1b-%s/2.76TeV/Pi0_data_GammaConvV1Correction_%s.root",cutNumber.Data(),nameSDD.Data(),cutNumber.Data())<<endl;
	...
	TFile*		fileEtaPCM2760GeV_LHC12f1b_PHO 						= new TFile(Form("%s-LHC12f1b-%s/2.76TeV/Eta_data_GammaConvV1Correction_%s.root",cutNumber.Data(),nameSDD.Data(),cutNumber.Data()));
	...
	cout<< "Phojet::"<<histoPi0InputMCWOWeights_LHC12f1b_PHO_2760GeV->GetBinContent(1)<< " "<< histoPi0InputMCWOWeights_LHC12f1b_PHO_2760GeV->GetBinContent(2)<< " " <<histoPi0InputMCWOWeights_LHC12f1b_PHO_2760GeV->GetBinContent(3)<< endl;
	// Pythia 8, LHC12i3
	TFile*		filePi0PCM2760GeV_LHC12i3_PYT8 						= new TFile(Form("%s-LHC12i3-%s/2.76TeV/Pi0_data_GammaConvV1Correction_%s.root",cutNumber.Data(),nameSDD.Data(),cutNumber.Data()));
	...
	TFile*		fileEtaPCM2760GeV_LHC12i3_PYT8 						= new TFile(Form("%s-LHC12i3-%s/2.76TeV/Eta_data_GammaConvV1Correction_%s.root",cutNumber.Data(),nameSDD.Data(),cutNumber.Data()));
	...
	// Pythia Jet-Jet, LHC15g1a
	TFile*		filePi0PCM2760GeV_LHC15g1a_PYT8 = new TFile(Form("%s-LHC15g1a-%s/2.76TeV/Pi0_data_GammaConvV1Correction_%s.root",cutNumber.Data(),nameSDD.Data(),cutNumber.Data()));
	TH1D*           histoPi0InputMCWOWeights_LHC15g1a_PYT8_2760GeV = NULL;
	TH1D*		histoPi0Efficiency_LHC15g1a_PYT8_2760GeV       = NULL;
	if( !filePi0PCM2760GeV_LHC15g1a_PYT8->IsZombie() ){
	histoPi0InputMCWOWeights_LHC15g1a_PYT8_2760GeV = (TH1D*)filePi0PCM2760GeV_LHC15g1a_PYT8->Get("MCYield_Meson_oldBinWOWeights");
	histoPi0Efficiency_LHC15g1a_PYT8_2760GeV       = (TH1D*)filePi0PCM2760GeV_LHC15g1a_PYT8->Get("TrueMesonEffiPt");
	}
	
	
	TFile*		fileEtaPCM2760GeV_LHC15g1a_PYT8 			= new TFile(Form("%s-LHC15g1a-%s/2.76TeV/Eta_data_GammaConvV1Correction_%s.root",cutNumber.Data(),nameSDD.Data(),cutNumber.Data()));
	TH1D*		histoEtaInputMCWOWeights_LHC15g1a_PYT8_2760GeV = NULL;
	TH1D*		histoEtaEfficiency_LHC15g1a_PYT8_2760GeV       = NULL;

	if( !fileEtaPCM2760GeV_LHC15g1a_PYT8->IsZombie() ){
	histoEtaInputMCWOWeights_LHC15g1a_PYT8_2760GeV 		= (TH1D*)fileEtaPCM2760GeV_LHC15g1a_PYT8->Get("MCYield_Meson_oldBinWOWeights");
	histoEtaEfficiency_LHC15g1a_PYT8_2760GeV 		= (TH1D*)fileEtaPCM2760GeV_LHC15g1a_PYT8->Get("TrueMesonEffiPt");
	}
	...
	TString nameFilePi0Fullmergedpp2760GeV = Form("%s_FullMerged-%s/2.76TeV/Pi0_MC_GammaConvV1Correction_%s.root",cutNumber.Data(),nameSDD.Data(),cutNumber.Data());
	TString nameFileEtaFullmergedpp2760GeV = Form("%s_FullMerged-%s/2.76TeV/Eta_MC_GammaConvV1Correction_%s.root",cutNumber.Data(),nameSDD.Data(),cutNumber.Data());
	
	
	if( Iteration0  ){
	  
	  nameFilePi0Fullmergedpp2760GeV = Form("%s_FullAdded-%s/2.76TeV/Pi0_MC_GammaConvV1Correction_%s.root",cutNumber.Data(),nameSDD.Data(),cutNumber.Data());
	  nameFileEtaFullmergedpp2760GeV = Form("%s_FullAdded-%s/2.76TeV/Eta_MC_GammaConvV1Correction_%s.root",cutNumber.Data(),nameSDD.Data(),cutNumber.Data());
	  
	}
	
	// Pythia 8, LHC12i3 added signals
	TFile*		filePi0PCM2760GeV_LHC12i3_PYT8Addsig 				= new TFile(nameFilePi0Fullmergedpp2760GeV.Data());
	TH1D*		histoPi0InputMCWOWeights_LHC12i3_PYT8addSig_2760GeV = (TH1D*)filePi0PCM2760GeV_LHC12i3_PYT8Addsig->Get("MCYield_Meson_oldBinWOWeights_AddedSig");
	TH1D*		histoPi0Efficiency_LHC12i3_PYT8addSig_2760GeV 		= (TH1D*)filePi0PCM2760GeV_LHC12i3_PYT8Addsig->Get("TrueMesonEffiPt");
	TFile*		fileEtaPCM2760GeV_LHC12i3_PYT8Addsig 				= new TFile(nameFileEtaFullmergedpp2760GeV.Data());
	TH1D* 		histoEtaInputMCWOWeights_LHC12i3_PYT8addSig_2760GeV = (TH1D*)fileEtaPCM2760GeV_LHC12i3_PYT8Addsig->Get("MCYield_Meson_oldBinWOWeights_AddedSig");
	TH1D* 		histoEtaEfficiency_LHC12i3_PYT8addSig_2760GeV 		= (TH1D*)fileEtaPCM2760GeV_LHC12i3_PYT8Addsig->Get("TrueMesonEffiPt");
	
	cout<< "done with getting histos"<< endl;
	/*
	// Pythia 8
...
*/
	...
	cout<<"before pi0 drawing"<<endl;
	DrawGammaSetMarker(histoPCMYieldPi02760GeV, markerStyleSpectrum2760GeV, markerSizePP2760GeV, color2760GeV , color2760GeV);
	cout<<"before pi0 drawing2"<<endl;
	histoPCMYieldPi02760GeV->Draw("p,same,e1");
	cout<<"before pi0 drawing3"<<endl;
	SetStyleHisto(histoPi0InputFullReweighted2760GeV, 1., lineStyleMCA, kBlue+1);  
	cout<<"after pi0 drawing"<<endl;
	histoPi0InputFullReweighted2760GeV->Draw("same,hist,c");    
	cout<<"after pi0 drawing2"<<endl;
	if(!Iteration0)SetStyleHisto(histoPi0InputFullAddSigReweighted2760GeV, 1., lineStyleMCAddSig, kBlue+2); 
	cout<<"after pi0 drawing3"<<endl;
	if(!Iteration0)histoPi0InputFullAddSigReweighted2760GeV->Draw("same,hist,c");    
	cout<<"after pi0 drawing-style"<<endl;
	...
	cout<<"after pi0 drawing-2"<<endl;
	if(histoPi0InputMCWOWeights_LHC15g1a_PYT8_2760GeV){
	 SetStyleHisto(histoPi0InputMCWOWeights_LHC15g1a_PYT8_2760GeV,1.,lineStyleMCJetJet, colorMCPythiaJetJetPP2760GeV);
	 histoPi0InputMCWOWeights_LHC15g1a_PYT8_2760GeV->Draw("same,hist,c");    
	}
...
// 	legendSpectraPi02760GeV->SetNColumns(2);
	...
	if( histoPi0InputMCWOWeights_LHC15g1a_PYT8_2760GeV ){
	legendSpectraPi02760GeV->AddEntry(histoPi0InputMCWOWeights_LHC15g1a_PYT8_2760GeV,"Pythia 8, LHC15g1a, Jet-Jet","l");
	}
	...
	legendSpectraPi02760GeV->AddEntry(histoPi0InputMCWOWeights_LHC12i3_PYT8addSig_2760GeV,"Pythia 8, LHC12i3, added Signals","l");
      	if(!Iteration0)legendSpectraPi02760GeV->AddEntry(histoPi0InputFullAddSigReweighted2760GeV,"added Signals, reweighted","l"); 
	...
	TLegend* legendSpectraPi0WithJetJet2760GeV 										= new TLegend(0.16,0.09,0.73,0.3);
	legendSpectraPi0WithJetJet2760GeV->SetFillColor(0);
	legendSpectraPi0WithJetJet2760GeV->SetLineColor(0);
	legendSpectraPi0WithJetJet2760GeV->SetTextSize(0.025);
	legendSpectraPi0WithJetJet2760GeV->SetMargin(0.2);
	legendSpectraPi0WithJetJet2760GeV->AddEntry(histoPCMYieldPi02760GeV,collisionSystemPP2760GeV.Data(),"pf");
	if( histoPi0InputMCWOWeights_LHC15g1a_PYT8_2760GeV ){
	legendSpectraPi0WithJetJet2760GeV->AddEntry(histoPi0InputMCWOWeights_LHC15g1a_PYT8_2760GeV,"Pythia 8, LHC15g1a, Jet-Jet","l");
	}
	legendSpectraPi0WithJetJet2760GeV->AddEntry(histoPi0InputFullReweighted2760GeV,"full MC reweighted","l");
	legendSpectraPi0WithJetJet2760GeV->Draw();
	
	labelSpectraPi0Label->Draw();
	
	canvasPi0Spectra2760GeV->Update();
	canvasPi0Spectra2760GeV->Print(Form("%s/Pi0_Spectra_With_Jet_Jet_2760GeV.%s",outputDir.Data(),suffix.Data()));
	...
	cout<<"Test1- fit to pi0 spectra"<<endl;
	...
	cout<<"Test2 - after fit to pi0 spectra"<<endl;
	// **********************************************************************************************************************
	...
	TH1D* histoRatioPi0MCAddSigtoDataFit2760GeV  = NULL;
	if( !Iteration0 ) histoRatioPi0MCAddSigtoDataFit2760GeV = CalculateHistoRatioToFit (histoPi0InputFullAddSigReweighted2760GeV, fitInvYieldDataPi0Comb2760GeV,kTRUE);
	...
	if(!Iteration0 ) SetStyleHisto(histoRatioPi0MCAddSigtoDataFit2760GeV, 2, lineStyleMCAddSig, kBlue+2 );
	...
	if (runDrawReweighted && !Iteration0 ) histoRatioPi0MCAddSigtoDataFit2760GeV->Draw("same,hist,l");  
	...
	if (runDrawReweighted && !Iteration0) legendRatioPi02760GeV->AddEntry(histoRatioPi0MCAddSigtoDataFit2760GeV,Form("MC add Sig weighted %s/Tsallis  fit to Data (0.4 <#it{p}_{T}<10)",stringIterationNumber.Data()), "l"); 
	...
	cout<<"Test1- going to compare pi0 efficiencies"<<endl;
...
// 	canvasPi0Efficiencies2760GeVDiffMC->SetLogx();
	...
	if( histoPi0Efficiency_LHC15g1a_PYT8_2760GeV ){
	DrawGammaSetMarker(histoPi0Efficiency_LHC15g1a_PYT8_2760GeV, markerStyleMCJetJe, markerSizePP2760GeV, colorMCPythiaJetJetPP2760GeV , colorMCPythiaJetJetPP2760GeV);
	histoPi0Efficiency_LHC15g1a_PYT8_2760GeV->Draw("p,same,e1");
	}
	...
	legendEfficiencyPi02760GeV->AddEntry(histoPi0Efficiency_LHC15g1a_PYT8_2760GeV,"Pythia 8, LHC15g1a, Jet-Jet","p");
	legendEfficiencyPi02760GeV->Draw();
	
	canvasPi0Efficiencies2760GeVDiffMC->Update();
	canvasPi0Efficiencies2760GeVDiffMC->Print(Form("%s/Pi0_Efficiency_%s_2760GeV.%s",outputDir.Data(),nameSDD.Data(),suffix.Data()));
	...
	canvasPi0Efficiencies2760GeVDiffMC->Update();
	canvasPi0Efficiencies2760GeVDiffMC->Print(Form("%s/Pi0_Efficiency_%s_2760GeV_LinY.%s",outputDir.Data(),nameSDD.Data(),suffix.Data()));
	...
	cout<<"Test1- going to start with eta "<<endl;
	//	**********************************************************************************************************************
	...
	cout<<"Test2- going to start with eta "<<endl;
	...
	if(!Iteration0) SetStyleHisto(histoEtaInputFullAddSigReweighted2760GeV, 1., lineStyleMCAddSig, kBlue+2);  
	if(!Iteration0) histoEtaInputFullAddSigReweighted2760GeV->Draw("same,hist,c");    

	cout<<"Test2-1- going to start with eta "<<endl;
	...
	cout<<"Test22- going to start with eta "<<endl;
	...
	cout<<"Test3- going to start with eta "<<endl;
	if( histoEtaInputMCWOWeights_LHC15g1a_PYT8_2760GeV ) {
	SetStyleHisto(histoEtaInputMCWOWeights_LHC15g1a_PYT8_2760GeV, 1., lineStyleMCJetJet, colorMCPythiaJetJetPP2760GeV);  
	histoEtaInputMCWOWeights_LHC15g1a_PYT8_2760GeV->Draw("same,hist,c");    
	...
	if( histoEtaInputMCWOWeights_LHC15g1a_PYT8_2760GeV)
	legendSpectraEta2760GeV->AddEntry(histoEtaInputMCWOWeights_LHC15g1a_PYT8_2760GeV,"Pythia 8, LHC15g1a","l"); 
	...
	if(!Iteration0) legendSpectraEta2760GeV->AddEntry(histoEtaInputFullAddSigReweighted2760GeV,"added Signals, reweighted","l"); 
	legendSpectraEta2760GeV->Draw();
	cout<<"Test4- going to start with eta "<<endl;	
	canvasEtaSpectra2760GeV->Update();
	canvasEtaSpectra2760GeV->Print(Form("%s/Eta_Spectra_2670GeV.%s",outputDir.Data(),suffix.Data()));
	...
	TLegend* legendSpectraEtaWithJetJet2760GeV 										= new TLegend(0.16,0.09,0.73,0.3);
	legendSpectraEtaWithJetJet2760GeV->SetFillColor(0);
	legendSpectraEtaWithJetJet2760GeV->SetLineColor(0);
	legendSpectraEtaWithJetJet2760GeV->SetTextSize(0.025);
	legendSpectraEtaWithJetJet2760GeV->SetMargin(0.2);
	legendSpectraEtaWithJetJet2760GeV->AddEntry(histoPCMYieldEta2760GeV,collisionSystemPP2760GeV.Data(),"pf");
	if( histoEtaInputMCWOWeights_LHC15g1a_PYT8_2760GeV)
	legendSpectraEtaWithJetJet2760GeV->AddEntry(histoEtaInputMCWOWeights_LHC15g1a_PYT8_2760GeV,"Pythia 8, LHC15g1a, Jet-Jet","l"); 
	
	legendSpectraEtaWithJetJet2760GeV->AddEntry(histoEtaInputFullReweighted2760GeV,"full MC reweighted","l");
	legendSpectraEtaWithJetJet2760GeV->Draw();
	
	
	labelSpectraEtaLabel->Draw();
	
	canvasEtaSpectra2760GeV->Update();
	canvasEtaSpectra2760GeV->Print(Form("%s/Eta_Spectra_With_Jet_Jet_2670GeV.%s",outputDir.Data(),suffix.Data()));
...
// 	fitInvYieldDataEtaComb2760GeV->SetParLimits(1,fitInvYieldDataPi0Comb2760GeV->GetParameter(1)*0.9,fitInvYieldDataPi0Comb2760GeV->GetParameter(1)*1.1);
	...
	TH1D* histoRatioEtaMCAddSigtoDataFit2760GeV = NULL; 
	if(!Iteration0) histoRatioEtaMCAddSigtoDataFit2760GeV = CalculateHistoRatioToFit(histoEtaInputFullAddSigReweighted2760GeV, fitInvYieldDataEtaComb2760GeV,kTRUE); 
	...
	if(!Iteration0) SetStyleHisto(histoRatioEtaMCAddSigtoDataFit2760GeV, 2, lineStyleMCAddSig, kBlue+2 );
	...
	if (runDrawReweighted && !Iteration0) histoRatioEtaMCAddSigtoDataFit2760GeV->Draw("same,hist,l");  
	...
	if (runDrawReweighted && !Iteration0) legendRatioEta2760GeV->AddEntry(histoRatioEtaMCAddSigtoDataFit2760GeV,Form("MC add Sig weighted %s/Tsallis  fit to Data (0.6 <#it{p}_{T}<6)",stringIterationNumber.Data()), "l"); 
...
// 	canvasEtaEfficiencies2760GeVDiffMC->SetLogx();
	...
	if( histoEtaEfficiency_LHC15g1a_PYT8_2760GeV ){
	DrawGammaSetMarker(histoEtaEfficiency_LHC15g1a_PYT8_2760GeV, markerStyleMCJetJe, markerSizePP2760GeV, colorMCPythiaJetJetPP2760GeV , colorMCPythiaJetJetPP2760GeV);
	histoEtaEfficiency_LHC15g1a_PYT8_2760GeV->Draw("p,same,e1");
	...
	if(histoEtaEfficiency_LHC15g1a_PYT8_2760GeV)
	legendEfficiencyEta2760GeV->AddEntry(histoEtaEfficiency_LHC15g1a_PYT8_2760GeV,"Pythia 8, LHC15g1a, Jet-Jet","p");
	  
	legendEfficiencyEta2760GeV->Draw();
	
	canvasEtaEfficiencies2760GeVDiffMC->Update();
	canvasEtaEfficiencies2760GeVDiffMC->Print(Form("%s/Eta_Efficiency_%s_2760GeV.%s",outputDir.Data(),nameSDD.Data(),suffix.Data()));
	...
	canvasEtaEfficiencies2760GeVDiffMC->Update();
	canvasEtaEfficiencies2760GeVDiffMC->Print(Form("%s/Eta_Efficiency_%s_2760GeV_LinY.%s",outputDir.Data(),nameSDD.Data(),suffix.Data()));
	...
	*/
	...
	TFile fMCSpectraInput("MCSpectraInputpp.root","UPDATE");
		...
		if (histoPi0InputMCWOWeights_LHC12f1b_PHO_2760GeV){
			histoPi0InputMCWOWeights_LHC12f1b_PHO_2760GeV->SetTitle(Form("Pi0_Phojet_LHC12f1b_%s_2760GeV",nameSDD.Data()));
			histoPi0InputMCWOWeights_LHC12f1b_PHO_2760GeV->Write(Form("Pi0_Phojet_LHC12f1b_%s_2760GeV",nameSDD.Data()),TObject::kOverwrite);
		cout<< "Phojet::"<<histoPi0InputMCWOWeights_LHC12f1b_PHO_2760GeV->GetBinContent(1)<< " "<< histoPi0InputMCWOWeights_LHC12f1b_PHO_2760GeV->GetBinContent(2)<< " " <<histoPi0InputMCWOWeights_LHC12f1b_PHO_2760GeV->GetBinContent(3)<< endl;
		}
		if (histoPi0InputMCWOWeights_LHC12f1a_PYT8_2760GeV){
		cout<< "Pythia::"<<histoPi0InputMCWOWeights_LHC12f1a_PYT8_2760GeV->GetBinContent(1)<< " "<< histoPi0InputMCWOWeights_LHC12f1a_PYT8_2760GeV->GetBinContent(2)<< " " <<histoPi0InputMCWOWeights_LHC12f1a_PYT8_2760GeV->GetBinContent(3)<< endl;
			histoPi0InputMCWOWeights_LHC12f1a_PYT8_2760GeV->SetTitle(Form("Pi0_Pythia8_LHC12f1a_%s_2760GeV",nameSDD.Data()));
			histoPi0InputMCWOWeights_LHC12f1a_PYT8_2760GeV->Write(Form("Pi0_Pythia8_LHC12f1a_%s_2760GeV",nameSDD.Data()),TObject::kOverwrite);
		}	
		if (histoPi0InputMCWOWeights_LHC12i3_PYT8_2760GeV){
			histoPi0InputMCWOWeights_LHC12i3_PYT8_2760GeV->SetTitle(Form("Pi0_Pythia8_LHC12i3_%s_2760GeV",nameSDD.Data()));
			histoPi0InputMCWOWeights_LHC12i3_PYT8_2760GeV->Write(Form("Pi0_Pythia8_LHC12i3_%s_2760GeV",nameSDD.Data()),TObject::kOverwrite);
		}
		if (histoPi0InputFullAddSig2760GeV){
			histoPi0InputFullAddSig2760GeV->SetTitle(Form("Pi0_Pythia8_LHC12i3_%s_addSig_2760GeV",nameSDD.Data()));
			histoPi0InputFullAddSig2760GeV->Write(Form("Pi0_Pythia8_LHC12i3_%s_addSig_2760GeV",nameSDD.Data()),TObject::kOverwrite);
		}
		if (histoPi0InputMCWOWeights_LHC12i3_PYT8addSig_2760GeV){
		        histoPi0InputMCWOWeights_LHC12i3_PYT8addSig_2760GeV->SetTitle(Form("Pi0_Pythia8_LHC12i3_%s_addSig_2760GeV",nameSDD.Data()));
			histoPi0InputMCWOWeights_LHC12i3_PYT8addSig_2760GeV->Write(Form("Pi0_Pythia8_LHC12i3_%s_addSig_2760GeV",nameSDD.Data()),TObject::kOverwrite);
		}
		if (histoEtaInputMCWOWeights_LHC12f1b_PHO_2760GeV){
			histoEtaInputMCWOWeights_LHC12f1b_PHO_2760GeV->SetTitle(Form("Eta_Phojet_LHC12f1b_%s_2760GeV",nameSDD.Data()));
			histoEtaInputMCWOWeights_LHC12f1b_PHO_2760GeV->Write(Form("Eta_Phojet_LHC12f1b_%s_2760GeV",nameSDD.Data()),TObject::kOverwrite);
		}
		if (histoEtaInputMCWOWeights_LHC12f1a_PYT8_2760GeV){
			histoEtaInputMCWOWeights_LHC12f1a_PYT8_2760GeV->SetTitle(Form("Eta_Pythia8_LHC12f1a_%s_2760GeV",nameSDD.Data()));
			histoEtaInputMCWOWeights_LHC12f1a_PYT8_2760GeV->Write(Form("Eta_Pythia8_LHC12f1a_%s_2760GeV",nameSDD.Data()),TObject::kOverwrite);
		}	
		if (histoEtaInputMCWOWeights_LHC12i3_PYT8_2760GeV){
			histoEtaInputMCWOWeights_LHC12i3_PYT8_2760GeV->SetTitle(Form("Eta_Pythia8_LHC12i3_%s_2760GeV",nameSDD.Data()));
			histoEtaInputMCWOWeights_LHC12i3_PYT8_2760GeV->Write(Form("Eta_Pythia8_LHC12i3_%s_2760GeV",nameSDD.Data()),TObject::kOverwrite);
		}
		if (histoEtaInputFullAddSig2760GeV){
			histoEtaInputFullAddSig2760GeV->SetTitle(Form("Eta_Pythia8_LHC12i3_%s_addSig_2760GeV",nameSDD.Data()));
			histoEtaInputFullAddSig2760GeV->Write(Form("Eta_Pythia8_LHC12i3_%s_addSig_2760GeV",nameSDD.Data()),TObject::kOverwrite);
		}
		if (histoEtaInputMCWOWeights_LHC12i3_PYT8addSig_2760GeV){
		        histoEtaInputMCWOWeights_LHC12i3_PYT8addSig_2760GeV->SetTitle(Form("Eta_Pythia8_LHC12i3_%s_addSig_2760GeV",nameSDD.Data()));
			histoEtaInputMCWOWeights_LHC12i3_PYT8addSig_2760GeV->Write(Form("Eta_Pythia8_LHC12i3_%s_addSig_2760GeV",nameSDD.Data()),TObject::kOverwrite);
		}
