...
void Interpolation_yShift(TString resultsType ="PCMPileUpCorrection", TString suffix="eps", TString outputDir="OutputRpPb_yShift",TString FitFuncName="Bylinkin", TString thesisPlots="" )
{
	...
	graphAsymmChargedParticlesRpPbSystErr = GetChargeParticlesRpPb("Syst");
	graphAsymmChargedParticlesRpPbStatErr = GetChargeParticlesRpPb("Stat");
	...
	TGraphAsymmErrors* graphInvYieldPi0PCMpPb5023GeVYShiftedSystErr    = (TGraphAsymmErrors*)graphInvYieldPi0PCMpPb5023GeVSystErr->Clone();
 	TGraphAsymmErrors* graphInvYieldPi0PCMpPb5023GeVYShiftedStatErr    = (TGraphAsymmErrors*)graphInvYieldPi0PCMpPb5023GeVStatErr->Clone();
	TGraphAsymmErrors* graphInvYieldPi0PCMpPb5023GeVYShiftedComplErr   = (TGraphAsymmErrors*)graphInvYieldPi0PCMpPb5023GeVComplErr->Clone();
	...
	TGraphAsymmErrors* graphInvYieldPi0DalitzpPb5023GeVYShiftedStatErr  = (TGraphAsymmErrors*) graphInvYieldPi0DalitzpPb5023GeVStatErr->Clone();	
	TGraphAsymmErrors* graphInvYieldPi0DalitzpPb5023GeVYShiftedSystErr  = (TGraphAsymmErrors*) graphInvYieldPi0DalitzpPb5023GeVSystErr->Clone();
	TGraphAsymmErrors* graphInvYieldPi0DalitzpPb5023GeVYShiftedComplErr = (TGraphAsymmErrors*) graphInvYieldPi0DalitzpPb5023GeVComplErr->Clone();
	...
	cout<<"*******************************BinYShift Dalitz**************************************"<<endl;
	
	

	//Use Bylinkin fit from combined spectrum for YShift

	TF1 *fitBylinkinPi0pPb5023GeV = (TF1*)CommonFile->Get("FitCombinedpPbSpectrum");
	
	
	
	graphInvYieldPi0DalitzpPb5023GeVYShiftedComplErr  = ApplyYshiftIndividualSpectra(graphInvYieldPi0DalitzpPb5023GeVYShiftedComplErr ,fitBylinkinPi0pPb5023GeV);
	graphInvYieldPi0DalitzpPb5023GeVYShiftedSystErr   = ApplyYshiftIndividualSpectra(graphInvYieldPi0DalitzpPb5023GeVYShiftedSystErr,fitBylinkinPi0pPb5023GeV); 
	graphInvYieldPi0DalitzpPb5023GeVYShiftedStatErr   = ApplyYshiftIndividualSpectra(graphInvYieldPi0DalitzpPb5023GeVYShiftedStatErr, fitBylinkinPi0pPb5023GeV);

	
	cout<<"**********************************BinYShift PCM********************************************"<<endl;
	
	
	
	graphInvYieldPi0PCMpPb5023GeVYShiftedComplErr  = ApplyYshiftIndividualSpectra(graphInvYieldPi0PCMpPb5023GeVYShiftedComplErr ,fitBylinkinPi0pPb5023GeV);
	graphInvYieldPi0PCMpPb5023GeVYShiftedSystErr   = ApplyYshiftIndividualSpectra( graphInvYieldPi0PCMpPb5023GeVYShiftedSystErr,fitBylinkinPi0pPb5023GeV); 
	graphInvYieldPi0PCMpPb5023GeVYShiftedStatErr   = ApplyYshiftIndividualSpectra( graphInvYieldPi0PCMpPb5023GeVYShiftedStatErr, fitBylinkinPi0pPb5023GeV);
	...
	TF1* fitPi02760GeVBinDalitzStatSystErr = RebinWithFitToTGraph(graphInvYieldPi02760GeVStatSystErr,&graphAInvYieldPi02760GeVBinDalitzStatSystErr,graphInvYieldPi0DalitzpPb5023GeVYShiftedComplErr,fitType.Data(),minPt,maxPt,Parameters2760GeV);
	
	cout<<"Rebinning graphInvYieldPi02760GeVStatSystErr to PCM"<<endl;
	
	TF1* fitPi02760GeVBinPCMStatSystErr    = RebinWithFitToTGraph(graphInvYieldPi02760GeVStatSystErr,&graphAInvYieldPi02760GeVBinPCMStatSystErr,graphInvYieldPi0PCMpPb5023GeVYShiftedComplErr,fitType.Data(),minPt,maxPt,Parameters2760GeV);
		
	cout<<"Rebinning graphInvYieldPi02760GeVSystErr to Dalitz"<<endl;
	
	TF1* fitPi02760GeVBinDalitzSystErr     = RebinWithFitToTGraph(graphInvYieldPi02760GeVSystErr,&graphInvYieldPi02760GeVBinDalitzSystErr,graphInvYieldPi0DalitzpPb5023GeVYShiftedSystErr,fitType.Data(),minPt,maxPt,Parameters2760GeV);
	
	cout<<"Rebinning graphInvYieldPi02760GeVSystErr to PCM"<<endl;
		
	TF1* fitPi02760GeVBinPCMSystErr        = RebinWithFitToTGraph(graphInvYieldPi02760GeVSystErr,&graphInvYieldPi02760GeVBinPCMSystErr,graphInvYieldPi0PCMpPb5023GeVYShiftedSystErr,fitType.Data(),minPt,maxPt,Parameters2760GeV);
	...
	TF1* fitPi07TeVBinDalitzStatSystErr = RebinWithFitToTGraph(graphInvYieldPi07TeVStatSystErr,&graphAInvYieldPi07TeVBinDalitzStatSystErr,graphInvYieldPi0DalitzpPb5023GeVYShiftedComplErr, fitType.Data(),minPt,maxPt,Parameters7TeV);
	
	
	cout<<"Rebinning graphInvYieldPi07TeVStatSystErr to PCM"<<endl;
	
	
	TF1* fitPi07TeVBinPCMStatSystErr    = RebinWithFitToTGraph(graphInvYieldPi07TeVStatSystErr,&graphAInvYieldPi07TeVBinPCMStatSystErr,   graphInvYieldPi0PCMpPb5023GeVYShiftedComplErr,fitType.Data(),minPt,maxPt,Parameters7TeV);
	...
	TF1* fitPi07TeVBinDalitzSystErr     = RebinWithFitToTGraph(graphInvYieldPi07TeVSystErr,&graphInvYieldPi07TeVBinDalitzSystErr,graphInvYieldPi0DalitzpPb5023GeVYShiftedSystErr,fitType.Data(),minPt,maxPt,Parameters7TeV);
	
	cout<<"Rebinning graphInvYieldPi07TeVSystErr to PCM"<<endl;
	
	
	TF1* fitPi07TeVBinPCMSystErr        = RebinWithFitToTGraph(graphInvYieldPi07TeVSystErr,&graphInvYieldPi07TeVBinPCMSystErr,   graphInvYieldPi0PCMpPb5023GeVYShiftedSystErr,fitType.Data(),minPt,maxPt,Parameters7TeV);
	...
	TString namePtvsSqrtsPlotDalitz = 	Form("%s/Pt_vs_Sqrts_Dalitz.%s",outputDir.Data(),suffix.Data());	
	 ...
	 PlotInterpolationPtBins(graphPtvsSqrtsPCM,gPtvsEnergiesPCM,fPowerlawPCM,graphErrosInterPolation5023GeVBinPCM,7,5,namePtvsSqrtsPlotPCM);
	...
	graphInvYieldPi0DalitzpPb5023GeVYShiftedSystWOMatErr =  CancelOutMaterialError(graphInvYieldPi0DalitzpPb5023GeVYShiftedSystErr,"Dalitz");
	...
	graphInvYieldPi0PCMpPb5023GeVYShiftedSystWOMatErr    = CancelOutMaterialError(graphInvYieldPi0PCMpPb5023GeVYShiftedSystErr,"PCMPCM");
	
	
	CalcRpPb(graphErrosInterPolation5023GeVBinDalitzSystWOMatErr,graphErrosInterPolation5023GeVBinDalitzStatErr,graphInvYieldPi0DalitzpPb5023GeVYShiftedSystWOMatErr, graphInvYieldPi0DalitzpPb5023GeVYShiftedStatErr,&graphRpPbDalitzSystErr,&graphRpPbDalitzStatErr);
	CalcRpPb(graphErrosInterPolation5023GeVBinPCMSystWOMatErr,graphErrosInterPolation5023GeVBinPCMStatErr,graphInvYieldPi0PCMpPb5023GeVYShiftedSystWOMatErr, graphInvYieldPi0PCMpPb5023GeVYShiftedStatErr,&graphRpPbPCMSystErr,&graphRpPbPCMStatErr);
	
	} else {
		
	CalcRpPb(graphErrosInterPolation5023GeVBinDalitzSystErr,graphErrosInterPolation5023GeVBinDalitzStatErr,graphInvYieldPi0DalitzpPb5023GeVYShiftedSystErr, graphInvYieldPi0DalitzpPb5023GeVYShiftedStatErr,&graphRpPbDalitzSystErr,&graphRpPbDalitzStatErr);
	CalcRpPb(graphErrosInterPolation5023GeVBinPCMSystErr,graphErrosInterPolation5023GeVBinPCMStatErr,graphInvYieldPi0PCMpPb5023GeVYShiftedSystErr, graphInvYieldPi0PCMpPb5023GeVYShiftedStatErr,&graphRpPbPCMSystErr,&graphRpPbPCMStatErr);
	...
	//TGraphAsymmErrors* graphInvYieldPi0DalitzpPb5023GeVYShiftedComplErrC        = new TGraphAsymmErrors( *graphInvYieldPi0DalitzpPb5023GeVYShiftedComplErr );
	...
	//graphInvCrossSectionPi0DalitzpPb5023GeVYShiftedComplErr   = ScaleGraph(graphInvCrossSectionPi0DalitzpPb5023GeVYShiftedComplErr,recalcBarn*xSectionpPb5023GeVINEL);
	...
	DrawGammaSetMarkerTGraphAsym(graphInvYieldPi0DalitzpPb5023GeVYShiftedComplErr,20,1.5,  kBlack,   kBlack);
	
	
	graphInvYieldPi0DalitzpPb5023GeVYShiftedComplErr->Draw("p,e1");
	...
	graphInvYieldPi0DalitzpPb5023GeVYShiftedComplErr->SetFillColor(0);
	...
	legendppAndpPbComarisonDalitz->AddEntry(graphInvYieldPi0DalitzpPb5023GeVYShiftedComplErr,Form("%s, |#it{y}_{cms}| < 0.8",energyLabel.Data()));
	...
	DrawGammaSetMarkerTGraphAsym(graphInvYieldPi0PCMpPb5023GeVYShiftedComplErr,20,1,  kBlack,   kBlack);
	
	
	graphInvYieldPi0PCMpPb5023GeVYShiftedComplErr->Draw("p,e1");
	...
	graphInvYieldPi0PCMpPb5023GeVYShiftedComplErr->SetFillColor(0);
	...
	legendppAndpPbComarisonPCM->AddEntry(graphInvYieldPi0PCMpPb5023GeVYShiftedComplErr,"p-Pb, MB, #sqrt{#it{s}_{NN}} = 5.02 TeV");
	...
	TCanvas* cInvYieldPi0DalitzpPb5023GeVYShifted = new TCanvas("cInvYieldPi0DalitzpPb5023GeVYShifted","Pi0 Dalitz pPb at 5.23 TeV X shifted",200,10,700,500);
		
	DrawGammaCanvasSettings( cInvYieldPi0DalitzpPb5023GeVYShifted,  0.15, 0.02, 0.03, 0.1);
	cInvYieldPi0DalitzpPb5023GeVYShifted->SetLogx();
	cInvYieldPi0DalitzpPb5023GeVYShifted->SetLogy();
	
	TPad* padInvYieldPi0DalitzpPb5023GeVYShifted = new TPad("padInvYieldPi0DalitzpPb5023GeVYShifted", "", 0., 0.42, 1., 0.5,-1, -1, -2);
	DrawGammaPadSettings( padInvYieldPi0DalitzpPb5023GeVYShifted, 0.15, 0.02, 0.03, 0.1);
	padInvYieldPi0DalitzpPb5023GeVYShifted->Draw();
	
	
	TH2F * histoInvYieldPi0DalitzpPb5023GeVYShifted;
	histoInvYieldPi0DalitzpPb5023GeVYShifted = new TH2F("histoInvYieldPi0DalitzpPb5023GeVYShifted","histoInvYieldPi0DalitzpPb5023GeVYShifted",1000,0.23,30.,1000,2e-8,5e1);
	SetStyleHistoTH2ForGraphs(histoInvYieldPi0DalitzpPb5023GeVYShifted, "#it{p}_{T} (GeV/#it{c})", "#frac{1}{2#pi #it{N}_{ev.}} #frac{d^{2}#it{N}}{#it{p}_{T}d#it{p}_{T}d#it{y}} (c/GeV)^{2}", 0.032,0.04, 0.04,0.04, 1,1.55);
	histoInvYieldPi0DalitzpPb5023GeVYShifted->DrawCopy(); 
	
	DrawGammaSetMarkerTGraphAsym(graphInvYieldPi0DalitzpPb5023GeVYShiftedComplErr, 	20, 1, kRed,   kRed);
	...
	graphInvYieldPi0DalitzpPb5023GeVYShiftedComplErr->Draw("p,same,e1");
	
	TLegend* legendInvYieldPi0DalitzpPb5023GeVYShifted = new TLegend(0.20,0.25,0.70,0.40);
	legendInvYieldPi0DalitzpPb5023GeVYShifted->SetFillColor(0);
	legendInvYieldPi0DalitzpPb5023GeVYShifted->SetLineColor(0);
	legendInvYieldPi0DalitzpPb5023GeVYShifted->SetTextSize(0.03);
	legendInvYieldPi0DalitzpPb5023GeVYShifted->AddEntry(graphInvYieldPi0DalitzpPb5023GeVComplErr,"#pi^{0} p-Pb at #sqrt{#it{s}_{NN}} = 5.02 TeV (Dalitz)");
	legendInvYieldPi0DalitzpPb5023GeVYShifted->AddEntry(graphInvYieldPi0DalitzpPb5023GeVYShiftedComplErr,"#pi^{0} p-Pb at #sqrt{#it{s}_{NN}} = 5.02  YBin shifted (Dalitz)");
	legendInvYieldPi0DalitzpPb5023GeVYShifted->Draw("same");
	
		
	
	cInvYieldPi0DalitzpPb5023GeVYShifted->Update();
	cInvYieldPi0DalitzpPb5023GeVYShifted->SaveAs(Form("%s/InvYield_YShifted_Dalitz_pPb_5023GeV.%s",outputDir.Data(),suffix.Data()));
	
	
	
	
	TCanvas* cInvYieldPi0PCMpPb5023GeVYShifted = new TCanvas("cInvYieldPi0PCMpPb5023GeVYShifted","Pi0 PCM pPb at 5.23 TeV X shifted",200,10,700,500);
		
	DrawGammaCanvasSettings( cInvYieldPi0PCMpPb5023GeVYShifted,  0.15, 0.02, 0.03, 0.1);
	cInvYieldPi0PCMpPb5023GeVYShifted->SetLogx();
	cInvYieldPi0PCMpPb5023GeVYShifted->SetLogy();
	
	TPad* padInvYieldPi0PCMpPb5023GeVYShifted = new TPad("padInvYieldPi0PCMpPb5023GeVYShifted", "", 0., 0.42, 1., 0.5,-1, -1, -2);
	DrawGammaPadSettings( padInvYieldPi0PCMpPb5023GeVYShifted, 0.15, 0.02, 0.03, 0.1);
	padInvYieldPi0PCMpPb5023GeVYShifted->Draw();
	
	
	TH2F * histoInvYieldPi0PCMpPb5023GeVYShifted;
	histoInvYieldPi0PCMpPb5023GeVYShifted = new TH2F("histoInvYieldPi0PCMpPb5023GeVYShifted","histoInvYieldPi0PCMpPb5023GeVYShifted",1000,0.23,30.,1000,2e-8,5e1);
	SetStyleHistoTH2ForGraphs(histoInvYieldPi0PCMpPb5023GeVYShifted, "#it{p}_{T} (GeV/#it{c})", "#frac{1}{2#pi #it{N}_{ev.}} #frac{d^{2}#it{N}}{#it{p}_{T}d#it{p}_{T}d#it{y}} (c/GeV)^{2}", 0.032,0.04, 0.04,0.04, 1,1.55);
	histoInvYieldPi0PCMpPb5023GeVYShifted->DrawCopy(); 
	
	DrawGammaSetMarkerTGraphAsym(graphInvYieldPi0PCMpPb5023GeVYShiftedComplErr, 	20, 1, kRed,   kRed);
	...
	graphInvYieldPi0PCMpPb5023GeVYShiftedComplErr->Draw("p,same,e1");
	
	TLegend* legendInvYieldPi0PCMpPb5023GeVYShifted = new TLegend(0.20,0.25,0.70,0.40);
	legendInvYieldPi0PCMpPb5023GeVYShifted->SetFillColor(0);
	legendInvYieldPi0PCMpPb5023GeVYShifted->SetLineColor(0);
	legendInvYieldPi0PCMpPb5023GeVYShifted->SetTextSize(0.03);
	legendInvYieldPi0PCMpPb5023GeVYShifted->AddEntry(graphInvYieldPi0PCMpPb5023GeVComplErr,"#pi^{0} p-Pb at #sqrt{#it{s}_{NN}} = 5.02 TeV (PCM)");
	legendInvYieldPi0PCMpPb5023GeVYShifted->AddEntry(graphInvYieldPi0PCMpPb5023GeVYShiftedComplErr,"#pi^{0} p-Pb at #sqrt{#it{s}_{NN}} = 5.02  YBin shifted (PCM)");
	legendInvYieldPi0PCMpPb5023GeVYShifted->Draw("same");
	
		
	
	cInvYieldPi0PCMpPb5023GeVYShifted->Update();
	cInvYieldPi0PCMpPb5023GeVYShifted->SaveAs(Form("%s/InvYield_YShifted_PCM_pPb_5023GeV.%s",outputDir.Data(),suffix.Data()));
	...
	//	canvasRpPbCombineAllGA->SetLogx();
	DrawGammaCanvasSettings( canvasRpPbCombineAllGA,  0.1, 0.02, 0.02, 0.13);
	
	TH2F * histo2DRpPbCombineAllGA = new TH2F("histo2DRpPbCombineAllGA","histo2DRpPbCombineAllGA",1000,0.3,20.,1000,0.3,1.5);
...
void SavingFiles(TString outputDir){
      ...
      graphRpPbPHOSStatErr->Print();graphRpPbPHOSSystErr->Print();
      ...
      graphRpPbPHOSStatErr->Write("Pi0_RpPb_PHOS_StatErr");
      graphRpPbPHOSSystErr->Write("Pi0_RpPb_PHOS_SystErr");
