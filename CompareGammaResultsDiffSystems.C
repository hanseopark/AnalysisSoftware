...
Color_t GetDefaultDifferentSystemsAndCents( TString centrality,
    ...
    if (!collisionsEnergy.CompareTo("PbPb_2.76TeV") && !experiment.CompareTo("ALICE")){
    ...
    } else if (!collisionsEnergy.CompareTo("PbPb_2.76TeV") && !experiment.CompareTo("ATLAS")){
        if (!centrality.CompareTo("0-10%")){
            return kOrange+10;
        ...
        if (!centrality.CompareTo("0-20%") || !centrality.CompareTo("0-5%")){
            return kGreen+2;
        } else if (!centrality.CompareTo("20-40%")){
            return kGreen-2;
        } else if (!centrality.CompareTo("40-60%")){
...
void CompareGammaResultsDiffSystems(    TString inputFileNamePP2760GeV      = "",
    ...
    TString nameCentspPb5TeVALICE                       = "0-100%";
    TString nameCentspPb5TeVALICEOut                    = "00100";
    TString labelXTpPb5TeVALICE                         = "ALICE wip. (0-100% p-Pb 5.02TeV)";
    TString labelpPb5TeVALICE                           = "ALICE wip. (0-100%)";
    Double_t xLegpPb5TeVALICEXT                         = 0.625;
    Double_t yLegpPb5TeVALICEXT                         = 0.61;
    Color_t colorCombpPb5ALICE                          = GetDefaultDifferentSystemsAndCents(nameCentspPb5TeVALICE.Data(),"pPb_5.023TeV", "ALICE")+1;
    Color_t colorCombpPb5ALICEBox                       = GetDefaultDifferentSystemsAndCents(nameCentspPb5TeVALICE.Data(),"pPb_5.023TeV", "ALICE")+1;
    Style_t markerStyleCombpPb5ALICE                    = 47;
    Style_t markerStyleCombpPb5ALICEMC                  = 46;
    Size_t markerSizeCombpPb5ALICE                      = 2;
    ...
    Double_t xLegCMSXT[3]                           = {0.23, 0.245, 0.26};
    Double_t yLegCMSXT[3]                           = {0.58, 0.56, 0.54};
    ...
    TString nameCentspAu200Out[2]                   = {"0005", "00100"};
    TString nameCentspAu200[2]                      = {"0-5%", "0-100%"};
    TString labelXTPHENIXpAu200[2]                  = {"PHENIX prel. (0-5% p-Au 0.2TeV)", "PHENIX prel. (0-100% p-Au 0.2TeV)"};
    TString labelPHENIXpAu200[2]                    = {"PHENIX prel. (0-5%)", "PHENIX prel. (0-100%)"};
    ...
    TString nameCentsdAu200Out                      = "00100";
    ...
    TString namePbPbCentATLAS[4]                    = {"0-10%", "10-20%", "20-40%", "40-80%"};
    TString namePbPbCentATLASOut[4]                 = {"0010", "1020", "2040", "4080"};
    TString labelXTATLAS[4]                         = {"ATLAS (0-10% Pb-Pb 2.76TeV)", "ATLAS (10-20% Pb-Pb 2.76TeV)", "ATLAS (20-40% Pb-Pb 2.76TeV)", "ATLAS (40-80% Pb-Pb 2.76TeV)"};
    TString labelATLAS[4]                           = {"ATLAS (0-10%)", "ATLAS (10-20%)", "ATLAS (20-40%)", "ATLAS (40-80%)"};
    Double_t xLegATLASXT[4]                         = {0.23, 0.245, 0.26, 0.275};
    Double_t yLegATLASXT[4]                         = {0.51, 0.49, 0.47, 0.45};

    Color_t colorCombATLAS[4];
    Style_t markerStyleCombATLAS[4];
    Style_t markerStyleCombMCATLAS[4];
    Size_t markerSizeCombATLAS[4];
    Double_t nCollATLAS[4];
    for (Int_t centPb = 0; centPb < 4; centPb++){
        colorCombATLAS[centPb]                      = GetDefaultDifferentSystemsAndCents(namePbPbCentATLAS[centPb].Data(), "PbPb_2.76TeV", "ATLAS");
        markerStyleCombATLAS[centPb]                = GetDefaultMarkerStyle("PbPb_2.76TeV", "", namePbPbCentATLAS[centPb].Data());
        markerStyleCombMCATLAS[centPb]              = GetDefaultMarkerStyle("PbPb_2.76TeV", "MC", namePbPbCentATLAS[centPb].Data());
        markerSizeCombATLAS[centPb]                 = GetDefaultMarkerSize("PbPb_2.76TeV", "", namePbPbCentATLAS[centPb].Data());
        nCollATLAS[centPb]                          = GetNCollFromName(namePbPbCentATLASOut[centPb].Data());
    }
    ...
    Double_t xLegSTAR200XT[5]                           = {0.30, 0.315, 0.33, 0.345, 0.36};
    Double_t yLegSTAR200XT[5]                           = {0.42, 0.40, 0.38, 0.36, 0.34};
    for (Int_t centAu = 0; centAu < 5; centAu++){
...
//         ProduceGraphAsymmWithoutXErrors(xTOtherExperiments[i]);
    ...
    for (Int_t ncent = 0; ncent < 2; ncent++){
        ...
        if (graphYieldDirGammapAu200GeVStat[ncent])
            graphYieldDirGammapAu200GeVStatNCollScaled[ncent]   = ScaleGraph(graphYieldDirGammapAu200GeVStat[ncent], 1./(nCollpAu200[ncent]));
        if (graphYieldDirGammapAu200GeVSys[ncent])
            graphYieldDirGammapAu200GeVSysNCollScaled[ncent]    = ScaleGraph(graphYieldDirGammapAu200GeVSys[ncent], 1./(nCollpAu200[ncent]));
        if (graphYieldDirGammapAu200GeVTot[ncent])
            graphYieldDirGammapAu200GeVTotNCollScaled[ncent]    = ScaleGraph(graphYieldDirGammapAu200GeVTot[ncent], 1./(nCollpAu200[ncent]));
    ...
    for (Int_t ncent = 0; ncent < 2; ncent++){
        ...
        if (graphYieldDirGammadAu200GeVStat)
            graphYieldDirGammadAu200GeVStatNCollScaled   = ScaleGraph(graphYieldDirGammadAu200GeVStat, 1./(nColldAu200));
        if (graphYieldDirGammadAu200GeVSys)
            graphYieldDirGammadAu200GeVSysNCollScaled    = ScaleGraph(graphYieldDirGammadAu200GeVSys, 1./(nColldAu200));
        if (graphYieldDirGammadAu200GeVTot)
            graphYieldDirGammadAu200GeVTotNCollScaled    = ScaleGraph(graphYieldDirGammadAu200GeVTot, 1./(nColldAu200));
    ...
    // ATLAS graphs at 8 TeV
    TGraphErrors* graphYieldDirGammapPb8TeVATLASTot                      = (TGraphErrors*)fileOtherExperimentsPA->Get("Gamma/graph_InvYieldIsoGamma_ATLAS_pPb_8TeV_Tot_00100");
    TGraphErrors* graphYieldDirGammapPb8TeVATLASTotNCollScaled           = NULL;
    TGraphErrors* graphYieldDirGammapPb8TeVATLASTotNCollScaledXT         = NULL;
    TGraphAsymmErrors* graphYieldDirGammapPb8TeVATLASTotArNCollScaled    = NULL;
    TGraphAsymmErrors* graphYieldDirGammapPb8TeVATLASTotArNCollScaledXT  = NULL;
    if (graphYieldDirGammapPb8TeVATLASTot)
        graphYieldDirGammapPb8TeVATLASTotNCollScaled                 = ScaleGraph(graphYieldDirGammapPb8TeVATLASTot, 1./(nCollpPb8ATLAS));

    if (graphYieldDirGammapPb8TeVATLASTotNCollScaled){
        Int_t nUpperLimits = 0;
        for (Int_t i=0; i< graphYieldDirGammapPb8TeVATLASTotNCollScaled->GetN(); i++){
            if (graphYieldDirGammapPb8TeVATLASTotNCollScaled->GetEY()[i]/graphYieldDirGammapPb8TeVATLASTotNCollScaled->GetY()[i] > 0.8)
                nUpperLimits++;
        }
        if (nUpperLimits>0){
            graphYieldDirGammapPb8TeVATLASTotArNCollScaled = new TGraphAsymmErrors(nUpperLimits);
            Int_t currPtBinNew = 0;
            for (Int_t i=0; i< graphYieldDirGammapPb8TeVATLASTotNCollScaled->GetN(); i++){
                if (graphYieldDirGammapPb8TeVATLASTotNCollScaled->GetEY()[i]/graphYieldDirGammapPb8TeVATLASTotNCollScaled->GetY()[i] > 0.8){
                    graphYieldDirGammapPb8TeVATLASTotArNCollScaled->SetPoint(currPtBinNew, graphYieldDirGammapPb8TeVATLASTotNCollScaled->GetX()[i], graphYieldDirGammapPb8TeVATLASTotNCollScaled->GetY()[i]+graphYieldDirGammapPb8TeVATLASTotNCollScaled->GetEY()[i]);
                    graphYieldDirGammapPb8TeVATLASTotArNCollScaled->SetPointError(currPtBinNew, graphYieldDirGammapPb8TeVATLASTotNCollScaled->GetEX()[i], graphYieldDirGammapPb8TeVATLASTotNCollScaled->GetEX()[i], graphYieldDirGammapPb8TeVATLASTotNCollScaled->GetY()[i]*3.6, 0);
                    graphYieldDirGammapPb8TeVATLASTotNCollScaled->RemovePoint(i);
                    i--;
                    currPtBinNew++;
                }
            }
            graphYieldDirGammapPb8TeVATLASTotArNCollScaledXT = xTScalePhoton(graphYieldDirGammapPb8TeVATLASTotArNCollScaled, 8000.);
        }
        graphYieldDirGammapPb8TeVATLASTotNCollScaledXT  = xTScalePhoton(graphYieldDirGammapPb8TeVATLASTotNCollScaled, 8000.);
    }

    // ALICE graphs at 5 TeV
    TGraphErrors* graphYieldDirGammapPb5TeVALICETot                      = (TGraphErrors*)fileOtherExperimentsPA->Get("Gamma/graph_InvYieldIsoGamma_ALICE_pPb_5TeV_Stat_00100");
    TGraphErrors* graphYieldDirGammapPb5TeVALICETotNCollScaled           = NULL;
    TGraphErrors* graphYieldDirGammapPb5TeVALICETotNCollScaledXT         = NULL;
    TGraphAsymmErrors* graphYieldDirGammapPb5TeVALICETotArNCollScaled    = NULL;
    TGraphAsymmErrors* graphYieldDirGammapPb5TeVALICETotArNCollScaledXT  = NULL;
    if (graphYieldDirGammapPb5TeVALICETot)
        graphYieldDirGammapPb5TeVALICETotNCollScaled                 = ScaleGraph(graphYieldDirGammapPb5TeVALICETot, 1./nCollpPb5[4]);

    if (graphYieldDirGammapPb5TeVALICETotNCollScaled){
        Int_t nUpperLimits = 0;
        for (Int_t i=0; i< graphYieldDirGammapPb5TeVALICETotNCollScaled->GetN(); i++){
            if (graphYieldDirGammapPb5TeVALICETotNCollScaled->GetEY()[i]/graphYieldDirGammapPb5TeVALICETotNCollScaled->GetY()[i] > 0.8)
                nUpperLimits++;
        }
        if (nUpperLimits>0){
            graphYieldDirGammapPb5TeVALICETotArNCollScaled = new TGraphAsymmErrors(nUpperLimits);
            Int_t currPtBinNew = 0;
            for (Int_t i=0; i< graphYieldDirGammapPb5TeVALICETotNCollScaled->GetN(); i++){
                if (graphYieldDirGammapPb5TeVALICETotNCollScaled->GetEY()[i]/graphYieldDirGammapPb5TeVALICETotNCollScaled->GetY()[i] > 0.8){
                    graphYieldDirGammapPb5TeVALICETotArNCollScaled->SetPoint(currPtBinNew, graphYieldDirGammapPb5TeVALICETotNCollScaled->GetX()[i], graphYieldDirGammapPb5TeVALICETotNCollScaled->GetY()[i]+graphYieldDirGammapPb5TeVALICETotNCollScaled->GetEY()[i]);
                    graphYieldDirGammapPb5TeVALICETotArNCollScaled->SetPointError(currPtBinNew, graphYieldDirGammapPb5TeVALICETotNCollScaled->GetEX()[i], graphYieldDirGammapPb5TeVALICETotNCollScaled->GetEX()[i], graphYieldDirGammapPb5TeVALICETotNCollScaled->GetY()[i]*3.6, 0);
                    graphYieldDirGammapPb5TeVALICETotNCollScaled->RemovePoint(i);
                    i--;
                    currPtBinNew++;
                }
            }
            graphYieldDirGammapPb5TeVALICETotArNCollScaledXT = xTScalePhoton(graphYieldDirGammapPb5TeVALICETotArNCollScaled, 5023.);
        }
        graphYieldDirGammapPb5TeVALICETotNCollScaledXT  = xTScalePhoton(graphYieldDirGammapPb5TeVALICETotNCollScaled, 5023.);
    }
                ...
                if (nUpperLimits>0){
                    ...
                    for (Int_t i=0; i< graphYieldDirGammaAuAu200GeVTotNCollScaled[centAu][meth]->GetN(); i++){
                        if (graphYieldDirGammaAuAu200GeVTotNCollScaled[centAu][meth]->GetEY()[i]/graphYieldDirGammaAuAu200GeVTotNCollScaled[centAu][meth]->GetY()[i] > 0.8){
                            ...
                            graphYieldDirGammaAuAu200GeVTotArNCollScaled[centAu][meth]->SetPointError(currPtBinNew, graphYieldDirGammaAuAu200GeVTotNCollScaled[centAu][meth]->GetEX()[i], graphYieldDirGammaAuAu200GeVTotNCollScaled[centAu][meth]->GetEX()[i], graphYieldDirGammaAuAu200GeVTotArNCollScaled[centAu][meth]->GetY()[currPtBinNew]*0.8, 0);
            ...
            if (nUpperLimits>0){
                ...
                for (Int_t i=0; i< graphYieldDirGammaAuAu200GeVSTARTotNCollScaled[centAu]->GetN(); i++){
                    if (graphYieldDirGammaAuAu200GeVSTARTotNCollScaled[centAu]->GetEYlow()[i]/graphYieldDirGammaAuAu200GeVSTARTotNCollScaled[centAu]->GetY()[i] > 0.8){
                        ...
                        graphYieldDirGammaAuAu200GeVSTARTotArNCollScaled[centAu]->SetPointError(currPtBinNew, graphYieldDirGammaAuAu200GeVSTARTotNCollScaled[centAu]->GetEXlow()[i], graphYieldDirGammaAuAu200GeVSTARTotNCollScaled[centAu]->GetEXhigh()[i], graphYieldDirGammaAuAu200GeVSTARTotArNCollScaled[centAu]->GetY()[currPtBinNew]*0.8, 0);
        ...
        if (nUpperLimits>0){
            ...
            for (Int_t i=0; i< graphYieldDirGammaAuAu39GeVTotNCollScaled->GetN(); i++){
                if (graphYieldDirGammaAuAu39GeVTotNCollScaled->GetEY()[i]/graphYieldDirGammaAuAu39GeVTotNCollScaled->GetY()[i] > 0.8){
                    ...
                    graphYieldDirGammaAuAu39GeVTotArNCollScaled->SetPointError(currPtBinNew, graphYieldDirGammaAuAu39GeVTotNCollScaled->GetEX()[i], graphYieldDirGammaAuAu39GeVTotNCollScaled->GetEX()[i], graphYieldDirGammaAuAu39GeVTotArNCollScaled->GetY()[currPtBinNew]*0.8, 0);
            ...
            if (nUpperLimits>0){
                ...
                for (Int_t i=0; i< graphYieldDirGammaAuAu62GeVTotNCollScaled[centAu]->GetN(); i++){
                    if (graphYieldDirGammaAuAu62GeVTotNCollScaled[centAu]->GetEY()[i]/graphYieldDirGammaAuAu62GeVTotNCollScaled[centAu]->GetY()[i] > 0.8){
                        ...
                        graphYieldDirGammaAuAu62GeVTotArNCollScaled[centAu]->SetPointError(currPtBinNew, graphYieldDirGammaAuAu62GeVTotNCollScaled[centAu]->GetEX()[i], graphYieldDirGammaAuAu62GeVTotNCollScaled[centAu]->GetEX()[i], graphYieldDirGammaAuAu62GeVTotArNCollScaled[centAu]->GetY()[currPtBinNew]*0.8, 0);
            ...
            if (nUpperLimits>0){
                ...
                for (Int_t i=0; i< graphYieldDirGammaCuCu200GeVTotNCollScaled[centCu]->GetN(); i++){
                    if (graphYieldDirGammaCuCu200GeVTotNCollScaled[centCu]->GetEY()[i]/graphYieldDirGammaCuCu200GeVTotNCollScaled[centCu]->GetY()[i] > 0.8){
                        ...
                        graphYieldDirGammaCuCu200GeVTotArNCollScaled[centCu]->SetPointError(currPtBinNew, graphYieldDirGammaCuCu200GeVTotNCollScaled[centCu]->GetEX()[i], graphYieldDirGammaCuCu200GeVTotNCollScaled[centCu]->GetEX()[i], graphYieldDirGammaCuCu200GeVTotArNCollScaled[centCu]->GetY()[currPtBinNew]*0.8, 0);
            ...
            if (nUpperLimits>0){
                ...
                for (Int_t i=0; i< graphYieldDirGammaCMSPbPb2760GeVTotNCollScaled[centPb]->GetN(); i++){
                    if (graphYieldDirGammaCMSPbPb2760GeVTotNCollScaled[centPb]->GetEYlow()[i]/graphYieldDirGammaCMSPbPb2760GeVTotNCollScaled[centPb]->GetY()[i] > 0.8){
                        ...
                        graphYieldDirGammaCMSPbPb2760GeVTotArNCollScaled[centPb]->SetPointError(currPtBinNew, graphYieldDirGammaCMSPbPb2760GeVTotNCollScaled[centPb]->GetEXlow()[i], graphYieldDirGammaCMSPbPb2760GeVTotNCollScaled[centPb]->GetEXhigh()[i], graphYieldDirGammaCMSPbPb2760GeVTotArNCollScaled[centPb]->GetY()[currPtBinNew]*0.8, 0);
    ...
    TGraphAsymmErrors* graphYieldDirGammaATLASPbPb2760GeVStat[4]                   = {NULL, NULL, NULL};
    TGraphAsymmErrors* graphYieldDirGammaATLASPbPb2760GeVSys[4]                    = {NULL, NULL, NULL};
    TGraphAsymmErrors* graphYieldDirGammaATLASPbPb2760GeVTot[4]                    = {NULL, NULL, NULL};
    TGraphAsymmErrors* graphYieldDirGammaATLASPbPb2760GeVStatNCollScaled[4]        = {NULL, NULL, NULL};
    TGraphAsymmErrors* graphYieldDirGammaATLASPbPb2760GeVSysNCollScaled[4]         = {NULL, NULL, NULL};
    TGraphAsymmErrors* graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[4]         = {NULL, NULL, NULL};
    TGraphAsymmErrors* graphYieldDirGammaATLASPbPb2760GeVTotArNCollScaled[4]       = {NULL, NULL, NULL};
    TGraphAsymmErrors* graphYieldDirGammaATLASPbPb2760GeVTotNCollScaledXT[4]         = {NULL, NULL, NULL};
    TGraphAsymmErrors* graphYieldDirGammaATLASPbPb2760GeVTotArNCollScaledXT[4]       = {NULL, NULL, NULL};
    for (Int_t centPb = 0; centPb < 4; centPb++){
        cout << Form("Gamma/graph_ATLAS_PbPb2760GeV_Stat_%s", namePbPbCentATLASOut[centPb].Data()) << "\t" << nCollATLAS[centPb] << endl;
        graphYieldDirGammaATLASPbPb2760GeVStat[centPb]      = (TGraphAsymmErrors*)fileOtherExperimentsAA->Get(Form("Gamma/graph_ATLAS_PbPb2760GeV_Stat_%s", namePbPbCentATLASOut[centPb].Data()));
        graphYieldDirGammaATLASPbPb2760GeVSys[centPb]       = (TGraphAsymmErrors*)fileOtherExperimentsAA->Get(Form("Gamma/graph_ATLAS_PbPb2760GeV_Sys_%s", namePbPbCentATLASOut[centPb].Data()));
        graphYieldDirGammaATLASPbPb2760GeVTot[centPb]       = (TGraphAsymmErrors*)fileOtherExperimentsAA->Get(Form("Gamma/graph_ATLAS_PbPb2760GeV_Tot_%s", namePbPbCentATLASOut[centPb].Data()));
        if (graphYieldDirGammaATLASPbPb2760GeVStat[centPb])
            graphYieldDirGammaATLASPbPb2760GeVStatNCollScaled[centPb]   = ScaleGraph(graphYieldDirGammaATLASPbPb2760GeVStat[centPb], 1./nCollATLAS[centPb]);
        if (graphYieldDirGammaATLASPbPb2760GeVSys[centPb])
            graphYieldDirGammaATLASPbPb2760GeVSysNCollScaled[centPb]    = ScaleGraph(graphYieldDirGammaATLASPbPb2760GeVSys[centPb], 1./nCollATLAS[centPb]);
        if (graphYieldDirGammaATLASPbPb2760GeVTot[centPb])
            graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]    = ScaleGraph(graphYieldDirGammaATLASPbPb2760GeVTot[centPb], 1./nCollATLAS[centPb]);

        if (graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]){
            Int_t nUpperLimits = 0;
            for (Int_t i=0; i< graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]->GetN(); i++){
                if (graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]->GetEYlow()[i]/graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]->GetY()[i] > 0.8)
                    nUpperLimits++;
            }
            if (nUpperLimits>0){
                graphYieldDirGammaATLASPbPb2760GeVTotArNCollScaled[centPb] = new TGraphAsymmErrors(nUpperLimits);
                Int_t currPtBinNew = 0;
                for (Int_t i=0; i< graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]->GetN(); i++){
                    if (graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]->GetEYlow()[i]/graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]->GetY()[i] > 0.8){
                        graphYieldDirGammaATLASPbPb2760GeVTotArNCollScaled[centPb]->SetPoint(currPtBinNew, graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]->GetX()[i], graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]->GetY()[i]+graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]->GetEYhigh()[i]);
                        graphYieldDirGammaATLASPbPb2760GeVTotArNCollScaled[centPb]->SetPointError(currPtBinNew, graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]->GetEXlow()[i], graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]->GetEXhigh()[i], graphYieldDirGammaATLASPbPb2760GeVTotArNCollScaled[centPb]->GetY()[currPtBinNew]*0.8, 0);
                        graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]->RemovePoint(i);
                        i--;
                        currPtBinNew++;
                    }
                }
                graphYieldDirGammaATLASPbPb2760GeVTotArNCollScaledXT[centPb]     = xTScalePhoton(graphYieldDirGammaATLASPbPb2760GeVTotArNCollScaled[centPb], 2760.);
            }
            graphYieldDirGammaATLASPbPb2760GeVTotNCollScaledXT[centPb]  = xTScalePhoton(graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb], 2760.);
        }
    }
    ...
    TGraphAsymmErrors* graphYieldDirGammaWA98Pb17GeVTotAr                   = (TGraphAsymmErrors*)fileOtherExperimentsAA->Get("Gamma/graph_WA98_PbPb17.2GeV_TotAr_0010");
    ...
    if (graphYieldDirGammaWA98Pb17GeVTotAr){
        graphYieldDirGammaWA98Pb17GeVTotArNCollScaled   = ScaleGraph(graphYieldDirGammaWA98Pb17GeVTotAr, 1./nCollPbPb17);
    ...
    dummyDirGamma->DrawCopy();
        ...
        for (Int_t centPb = 0; centPb < 3; centPb++){
            ...
            if (graphInvYieldDirGammaTotArPbPb[centPb]){
                DrawGammaSetMarkerTGraphAsym(graphInvYieldDirGammaTotArPbPb[centPb] , 1, 3, colorComb[centPb], colorComb[centPb], 1, kTRUE);
        ...
        if (graphInvYieldDirGammaTotArpp2760GeV){
            DrawGammaSetMarkerTGraphAsym(graphInvYieldDirGammaTotArpp2760GeV , 1, 3, colorCombpp2760GeV, colorCombpp2760GeV, 1, kTRUE);
        ...
        if (graphInvYieldDirGammaTotArpPb5TeV[4]){
            DrawGammaSetMarkerTGraphAsym(graphInvYieldDirGammaTotArpPb5TeV[4] , 1, 3, colorCombpPb[4], colorCombpPb[4], 1, kTRUE);
...
//     dummyDirGammapPb1->GetXaxis()->SetRangeUser(doubleRatioX[0],doubleRatioX[1]);
    dummyDirGammapPb1->DrawCopy();
        ...
        TLegend* legendInvYieldGammapPb8TeV     = GetAndSetLegend2( xMinLegpPb, yMinLegpPb, xMinLegpPb+widthColumnpPb*2, yMinLegpPb+(nRowsGammapPb*textsizeLabelsDirGamma*0.5) ,0.5*textsizeLabelsDirGamma,
                                                                    nColumnsGammapPb, Form("#scale[1.25]{%s}",collisionSystempPb8TeV.Data()), 42, 0.15);
        TLegend* legendInvYieldGammapPb5TeV     = GetAndSetLegend2( xMinLegpPb, yMinLegpPb+(nRowsGammapPb)*textsizeLabelsDirGamma*0.5+0.01, xMinLegpPb+widthColumnpPb*3,
        ...
        for (Int_t ncent = 0; ncent < 5; ncent++){
            if (graphInvYieldDirGammaTotpPb5TeVNCollScaled[ncent]){
                ...
                legendInvYieldGammapPb5TeV->AddEntry(graphInvYieldDirGammaTotpPb5TeVNCollScaled[ncent], labelALICEpPb[ncent].Data(), "p");
            }
            if (graphInvYieldDirGammaTotArpPb5TeV[ncent]){
                cout << "Pb:    " << ncent << endl;
                DrawGammaSetMarkerTGraphAsym(graphInvYieldDirGammaTotArpPb5TeVNCollScaled[ncent] , 1, 3, colorCombpPb[ncent], colorCombpPb[ncent], 1, kTRUE);
        ...
        for (Int_t centAu = 0; centAu < 2; centAu++){
            ...
            if (graphYieldDirGammapAu200GeVTotArNCollScaled[centAu]){
                DrawGammaSetMarkerTGraphAsym(graphYieldDirGammapAu200GeVTotArNCollScaled[centAu] , 1, 3, colorCombpAu200[centAu], colorCombpAu200[centAu], 1, kTRUE);
        ...
        if (graphYieldDirGammadAu200GeVTotArNCollScaled){
            DrawGammaSetMarkerTGraphAsym(graphYieldDirGammadAu200GeVTotArNCollScaled , 1, 3, colorCombdAu200, colorCombdAu200, 1, kTRUE);
        ...
        if (graphYieldDirGammapPb8TeVATLASTotNCollScaled){
            //                     ProduceGraphAsymmWithoutXErrors(graphYieldDirGammadAu200GeVStat);
            DrawGammaSetMarkerTGraphErr(graphYieldDirGammapPb8TeVATLASTotNCollScaled, markerStyleCombpPb8ATLASMC, markerSizeCombpPb8ATLAS, colorCombpPb8ATLAS, colorCombpPb8ATLAS );
            graphYieldDirGammapPb8TeVATLASTotNCollScaled->Draw("p,E1,same");
            legendInvYieldGammapPb8TeV->AddEntry(graphYieldDirGammapPb8TeVATLASTotNCollScaled, labelpPb8TeVATLAS.Data(), "p");
        }
        if (graphYieldDirGammapPb8TeVATLASTotArNCollScaled){
            DrawGammaSetMarkerTGraphAsym(graphYieldDirGammapPb8TeVATLASTotArNCollScaled , 1, 3, colorCombpPb8ATLAS, colorCombpPb8ATLAS, 1, kTRUE);
            graphYieldDirGammapPb8TeVATLASTotArNCollScaled->Draw(">,same");
            graphYieldDirGammapPb8TeVATLASTotArNCollScaled->Print();
            PlotErrorBarAtUpperEdgeOfTGraphAsymErr(graphYieldDirGammapPb8TeVATLASTotArNCollScaled, 0.1);
        }
        // plotting ATLAS pPb 8000
        if ( enablePrelim > 1 ){
            if (graphYieldDirGammapPb5TeVALICETotNCollScaled){
                //                     ProduceGraphAsymmWithoutXErrors(graphYieldDirGammadAu200GeVStat);
                DrawGammaSetMarkerTGraphErr(graphYieldDirGammapPb5TeVALICETotNCollScaled, markerStyleCombpPb5ALICEMC, markerSizeCombpPb5ALICE, colorCombpPb5ALICE, colorCombpPb5ALICE );
                graphYieldDirGammapPb5TeVALICETotNCollScaled->Draw("p,E1,same");
                legendInvYieldGammapPb5TeV->AddEntry(graphYieldDirGammapPb5TeVALICETotNCollScaled, labelpPb5TeVALICE.Data(), "p");
            }
            if (graphYieldDirGammapPb5TeVALICETotArNCollScaled){
                DrawGammaSetMarkerTGraphAsym(graphYieldDirGammapPb5TeVALICETotArNCollScaled , 1, 3, colorCombpPb5ALICE, colorCombpPb5ALICE, 1, kTRUE);
                graphYieldDirGammapPb5TeVALICETotArNCollScaled->Draw(">,same");
                graphYieldDirGammapPb5TeVALICETotArNCollScaled->Print();
                PlotErrorBarAtUpperEdgeOfTGraphAsymErr(graphYieldDirGammapPb5TeVALICETotArNCollScaled, 0.1);
            }
        }

        legendInvYieldGammapPb5TeV->Draw();
        legendInvYieldGammapAu200->Draw();
        legendInvYieldGammadAu200->Draw();
        legendInvYieldGammapPb8TeV->Draw();

    if ( enablePrelim > 1){
        canvasDirGammapPb->Print(Form("%s/DirGammaSpectra_pA_NCollScaled_wip.%s",outputDir.Data(),suffix.Data()));
        canvasDirGammapPb->Print(Form("%s/DirGammaSpectra_pA_NCollScaled_wip.pdf",outputDir.Data()));
    } else {
        canvasDirGammapPb->Print(Form("%s/DirGammaSpectra_pA_NCollScaled_prel.%s",outputDir.Data(),suffix.Data()));
        canvasDirGammapPb->Print(Form("%s/DirGammaSpectra_pA_NCollScaled_prel.pdf",outputDir.Data()));
    }
    ...
    dummyDirGammapPb2->DrawCopy();
        ...
        for (Int_t ncent = 0; ncent < 5; ncent++){
            ...
            if (graphInvYieldDirGammaTotArpPb5TeV[ncent]){
                cout << "Pb:    " << ncent << endl;
                DrawGammaSetMarkerTGraphAsym(graphInvYieldDirGammaTotArpPb5TeVNCollScaledXT[ncent] , 1, 3, colorCombpPb[ncent], colorCombpPb[ncent], 1, kTRUE);
        ...
        for (Int_t centAu = 0; centAu < 2; centAu++){
            ...
            if (graphYieldDirGammapAu200GeVTotArNCollScaledXT[centAu]){
                DrawGammaSetMarkerTGraphAsym(graphYieldDirGammapAu200GeVTotArNCollScaledXT[centAu] , 1, 3, colorCombpAu200[centAu], colorCombpAu200[centAu], 1, kTRUE);
        ...
        if (graphYieldDirGammadAu200GeVTotArNCollScaledXT){
            DrawGammaSetMarkerTGraphAsym(graphYieldDirGammadAu200GeVTotArNCollScaledXT , 1, 3, colorCombdAu200, colorCombdAu200, 1, kTRUE);
        ...
        if (graphYieldDirGammapPb8TeVATLASTotNCollScaledXT){
            DrawGammaSetMarkerTGraphErr(graphYieldDirGammapPb8TeVATLASTotNCollScaledXT, markerStyleCombpPb8ATLASMC, markerSizeCombpPb8ATLAS, colorCombpPb8ATLAS, colorCombpPb8ATLAS );
            graphYieldDirGammapPb8TeVATLASTotNCollScaledXT->Draw("p,E1,same");

            TMarker* markerCurrent             = CreateMarkerFromGraph(graphYieldDirGammapPb8TeVATLASTotNCollScaledXT, xLegpPb8TeVATLASXT-0.015 , yLegpPb8TeVATLASXT,1);
            markerCurrent->SetNDC(kTRUE);
            markerCurrent->Draw("same,p");
        ...
        if (graphYieldDirGammapPb8TeVATLASTotArNCollScaledXT){
            DrawGammaSetMarkerTGraphAsym(graphYieldDirGammapPb8TeVATLASTotArNCollScaledXT , 1, 3, colorCombpPb8ATLAS, colorCombpPb8ATLAS, 1, kTRUE);
            graphYieldDirGammapPb8TeVATLASTotArNCollScaledXT->Draw(">,same");
            graphYieldDirGammapPb8TeVATLASTotArNCollScaledXT->Print();
            PlotErrorBarAtUpperEdgeOfTGraphAsymErr(graphYieldDirGammapPb8TeVATLASTotArNCollScaledXT, 0.001);
        }

        if (enablePrelim > 1){
            if (graphYieldDirGammapPb5TeVALICETotNCollScaledXT){
                DrawGammaSetMarkerTGraphErr(graphYieldDirGammapPb5TeVALICETotNCollScaledXT, markerStyleCombpPb5ALICEMC, markerSizeCombpPb5ALICE, colorCombpPb5ALICE, colorCombpPb5ALICE );
                graphYieldDirGammapPb5TeVALICETotNCollScaledXT->Draw("p,E1,same");

                TMarker* markerCurrent             = CreateMarkerFromGraph(graphYieldDirGammapPb5TeVALICETotNCollScaledXT, xLegpPb5TeVALICEXT-0.015 , yLegpPb5TeVALICEXT,1);
                markerCurrent->SetNDC(kTRUE);
                markerCurrent->Draw("same,p");
                TLatex *labelCurrent               = new TLatex(xLegpPb5TeVALICEXT , yLegpPb5TeVALICEXT, labelXTpPb5TeVALICE);
                SetStyleTLatex( labelCurrent, textSizeLabelsPixelDirGam*0.5, 4, 1, 43, kTRUE, 12);
                labelCurrent->Draw();
            }
            if (graphYieldDirGammapPb5TeVALICETotArNCollScaledXT){
                DrawGammaSetMarkerTGraphAsym(graphYieldDirGammapPb5TeVALICETotArNCollScaledXT , 1, 3, colorCombpPb5ALICE, colorCombpPb5ALICE, 1, kTRUE);
                graphYieldDirGammapPb5TeVALICETotArNCollScaledXT->Draw(">,same");
                graphYieldDirGammapPb5TeVALICETotArNCollScaledXT->Print();
                PlotErrorBarAtUpperEdgeOfTGraphAsymErr(graphYieldDirGammapPb5TeVALICETotArNCollScaledXT, 0.001);
            }
        }
    if (enablePrelim > 1){
        canvasDirGammapPb->Print(Form("%s/DirGammaSpectra_pA_NCollScaled_xT_wip.%s",outputDir.Data(),suffix.Data()));
        canvasDirGammapPb->Print(Form("%s/DirGammaSpectra_pA_NCollScaled_xT_wip.pdf",outputDir.Data()));
    } else {
        canvasDirGammapPb->Print(Form("%s/DirGammaSpectra_pA_NCollScaled_xT_prel.%s",outputDir.Data(),suffix.Data()));
        canvasDirGammapPb->Print(Form("%s/DirGammaSpectra_pA_NCollScaled_xT_prel.pdf",outputDir.Data()));
    }
    
    ...
    TH1D* dummyDirGamma2 = new TH1D("dummyDirGamma", "dummyDirGamma", 1000, 0.07, 400.);
    SetStyleHistoTH1ForGraphs( dummyDirGamma2, "#it{p}_{T} (GeV/#it{c})", "#frac{1}{#it{N}_{coll}} #frac{1}{2#pi #it{N}_{inel}} #frac{d^{2}#it{N}_{#gamma_{dir}}}{#it{p}_{T}d#it{p}_{T}d#it{y}} (GeV^{-2}#it{c}^{2})",
                               0.85*textsizeLabelsDirGamma, textsizeLabelsDirGamma, 0.85*textsizeLabelsDirGamma, textsizeLabelsDirGamma, 0.78, 1.85);
    dummyDirGamma2->GetYaxis()->SetRangeUser( 1.2e-18,4e0);
...
//     dummyDirGamma2->GetXaxis()->SetRangeUser(doubleRatioX[0],doubleRatioX[1]);
    dummyDirGamma2->DrawCopy();
        ...
        TLegend* legendInvYieldGammaAu200   = GetAndSetLegend2( xMinLeg, yMinLeg+(nRowsGammaPb)*textsizeLabelsDirGamma*0.5+0.01, xMinLeg+widthColumn*nColumnsGammaAu200,
                                                                yMinLeg+((nRowsGammaPb+nRowsGammaAu200)*textsizeLabelsDirGamma*0.5)+0.01 ,0.5*textsizeLabelsDirGamma,
                                                                nColumnsGammaAu200, Form("#scale[1.25]{%s}",collisionSystemAuAu200GeV.Data()), 42, 0.15);
        ...
        for (Int_t centPb = 0; centPb < 3; centPb++){
            ...
            if (graphInvYieldDirGammaTotArPbPb[centPb]){
                cout << "Pb:    " << centPb << endl;
                DrawGammaSetMarkerTGraphAsym(graphInvYieldDirGammaTotArPbPbNCollScaled[centPb] , 1, 3, colorCombPbALICE[centPb], colorCombPbALICE[centPb], 1, kTRUE);
        ...
        legendInvYieldGammaPb->AddEntry((TObject*)0, "", "");
        // plotting CMS
        for (Int_t centPb = 0; centPb < 3; centPb++){
            if (graphYieldDirGammaCMSPbPb2760GeVTotNCollScaled[centPb]){
                ...
                legendInvYieldGammaPb->AddEntry(graphYieldDirGammaCMSPbPb2760GeVTotNCollScaled[centPb], labelCMS[centPb].Data(), "p");
            }
            if (graphYieldDirGammaCMSPbPb2760GeVTotArNCollScaled[centPb]){
                ...
                DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaCMSPbPb2760GeVTotArNCollScaled[centPb] , 1, 3, colorCombCMS[centPb], colorCombCMS[centPb], 1, kTRUE);
        ...
        for (Int_t centPb = 0; centPb < 4; centPb++){
            if (graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]){
                ProduceGraphAsymmWithoutXErrors(graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]);
                DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb], markerStyleCombMCATLAS[centPb], markerSizeCombATLAS[centPb], colorCombATLAS[centPb], colorCombATLAS[centPb] );
                graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb]->Draw("p,E1,same");
                legendInvYieldGammaPb->AddEntry(graphYieldDirGammaATLASPbPb2760GeVTotNCollScaled[centPb], labelATLAS[centPb].Data(), "p");
            }
...
//                 cout << "trying to plot: " << centAu << "\t" << meth << endl;
                ...
                if (graphYieldDirGammaAuAu200GeVTotArNCollScaled[centAu][meth]){
                    DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaAuAu200GeVTotArNCollScaled[centAu][meth] , 1, 3, colorCombAuAu200[centAu], colorCombAuAu200[centAu], 1, kTRUE);
        ...
        for (Int_t centAu = 0; centAu < 4; centAu++){
            ...
            if (graphYieldDirGammaAuAu200GeVSTARTotArNCollScaled[centAu]){
                ...
                DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaAuAu200GeVSTARTotArNCollScaled[centAu] , 1, 3, colorCombAuAu200STAR[centAu], colorCombAuAu200STAR[centAu], 1, kTRUE);
...
//             cout << "trying to plot: " << centCu  << endl;
            ...
            if (graphYieldDirGammaCuCu200GeVTotArNCollScaled[centCu]){
                DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaCuCu200GeVTotArNCollScaled[centCu] , 1, 3, colorCombCuCu200[centCu], colorCombCuCu200[centCu], 1, kTRUE);
...
//             cout << "trying to plot: " << centAu << "\t" << endl;
            ...
            if (graphYieldDirGammaAuAu62GeVTotArNCollScaled[centAu]){
                DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaAuAu62GeVTotArNCollScaled[centAu] , 1, 3, colorCombAuAu62[centAu], colorCombAuAu62[centAu], 1, kTRUE);
        ...
        if (graphYieldDirGammaAuAu39GeVTotArNCollScaled){
            ...
            DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaAuAu39GeVTotArNCollScaled , 1, 3, colorCombAuAu39, colorCombAuAu39, 1, kTRUE);
        ...
        if (graphYieldDirGammaWA98Pb17GeVTotNCollScaled){
            ...
            ProduceGraphAsymmWithoutXErrors(graphYieldDirGammaWA98Pb17GeVTotNCollScaled);
        ...
        if (graphYieldDirGammaWA98Pb17GeVTotArNCollScaled){
            ...
            DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaWA98Pb17GeVTotArNCollScaled , 1, 3, colorCombPbPb17, colorCombPbPb17, 1, kTRUE);
    ...
    canvasDirGammaPb->Print(Form("%s/DirGammaSpectra_AA_NCollScaled.%s",outputDir.Data(),suffix.Data()));
    canvasDirGammaPb->Print(Form("%s/DirGammaSpectra_AA_NCollScaled.pdf",outputDir.Data()));
    ...
    dummyDirGamma3->DrawCopy();
        ...
        for (Int_t centPb = 0; centPb < 3; centPb++){
            ...
            if (graphInvYieldDirGammaTotArPbPb[centPb]){
                cout << "Pb:    " << centPb << endl;
                DrawGammaSetMarkerTGraphAsym(graphInvYieldDirGammaTotArPbPbNCollScaledXT[centPb] , 1, 3, colorCombPbALICE[centPb], colorCombPbALICE[centPb], 1, kTRUE);
        ...
        for (Int_t centPb = 0; centPb < 3; centPb++){
            ...
            if (graphYieldDirGammaCMSPbPb2760GeVTotArNCollScaledXT[centPb]){
                ...
                DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaCMSPbPb2760GeVTotArNCollScaledXT[centPb] , 1, 3, colorCombCMS[centPb], colorCombCMS[centPb], 1, kTRUE);
        ...
        // Plotting ATLAS
        for (Int_t centPb = 0; centPb < 4; centPb++){
            if (graphYieldDirGammaATLASPbPb2760GeVTotNCollScaledXT[centPb]){
                ProduceGraphAsymmWithoutXErrors(graphYieldDirGammaATLASPbPb2760GeVTotNCollScaledXT[centPb]);
                DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaATLASPbPb2760GeVTotNCollScaledXT[centPb], markerStyleCombMCATLAS[centPb], markerSizeCombATLAS[centPb], colorCombATLAS[centPb], colorCombATLAS[centPb] );
                graphYieldDirGammaATLASPbPb2760GeVTotNCollScaledXT[centPb]->Draw("p,E1,same");
                TMarker* markerCurrent             = CreateMarkerFromGraph(graphYieldDirGammaATLASPbPb2760GeVTotNCollScaledXT[centPb], xLegATLASXT[centPb]-0.015 , yLegATLASXT[centPb],1);
                markerCurrent->SetNDC(kTRUE);
                markerCurrent->Draw("same,p");
                TLatex *labelCurrent               = new TLatex(xLegATLASXT[centPb] , yLegATLASXT[centPb], labelXTATLAS[centPb]);
                SetStyleTLatex( labelCurrent, textSizeLabelsPixelDirGam*0.5, 4, 1, 43, kTRUE, 12);
                labelCurrent->Draw();
            }
...
//                 cout << "trying to plot: " << centAu << "\t" << meth << endl;
                ...
                if (graphYieldDirGammaAuAu200GeVTotArNCollScaledXT[centAu][meth]){
                    DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaAuAu200GeVTotArNCollScaledXT[centAu][meth] , 1, 3, colorCombAuAu200[centAu], colorCombAuAu200[centAu], 1, kTRUE);
...
//                 graphYieldDirGammaAuAu200GeVSTARTotNCollScaledXT[centAu]->Print();
            ...
            if (graphYieldDirGammaAuAu200GeVSTARTotArNCollScaledXT[centAu]){
                ...
                DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaAuAu200GeVSTARTotArNCollScaledXT[centAu] , 1, 3, colorCombAuAu200STAR[centAu], colorCombAuAu200STAR[centAu], 1, kTRUE);
...
//             cout << "trying to plot: " << centCu  << endl;
            ...
            if (graphYieldDirGammaCuCu200GeVTotArNCollScaledXT[centCu]){
                DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaCuCu200GeVTotArNCollScaledXT[centCu] , 1, 3, colorCombCuCu200[centCu], colorCombCuCu200[centCu], 1, kTRUE);
...
//             cout << "trying to plot: " << centAu << "\t" << endl;
            ...
            if (graphYieldDirGammaAuAu62GeVTotArNCollScaledXT[centAu]){
                DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaAuAu62GeVTotArNCollScaledXT[centAu] , 1, 3, colorCombAuAu62[centAu], colorCombAuAu62[centAu], 1, kTRUE);
...
//                 graphYieldDirGammaAuAu62GeVTotArNCollScaledXT[centAu]->Print();
        ...
        if (graphYieldDirGammaAuAu39GeVTotArNCollScaledXT){
            DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaAuAu39GeVTotArNCollScaledXT , 1, 3, colorCombAuAu39, colorCombAuAu39, 1, kTRUE);
        ...
        if (graphYieldDirGammaWA98Pb17GeVTotArNCollScaledXT){
            ...
            DrawGammaSetMarkerTGraphAsym(graphYieldDirGammaWA98Pb17GeVTotArNCollScaledXT , 1, 3, colorCombPbPb17, colorCombPbPb17, 1, kTRUE);
    ...
    canvasDirGamma->Print(Form("%s/DirGammaSpectra_AA_NCollScaled_xT.%s",outputDir.Data(),suffix.Data()));
    canvasDirGamma->Print(Form("%s/DirGammaSpectra_AA_NCollScaled_xT.pdf",outputDir.Data()));
    ...
    dummyDirGamma->DrawCopy();
        ...
        if (graphInvYieldDirGammaTotArpp2760GeV){
            DrawGammaSetMarkerTGraphAsym(graphInvYieldDirGammaTotArpp2760GeV , 1, 3, colorEpp2760GeV, colorEpp2760GeV, 1, kTRUE);
            graphInvYieldDirGammaTotArpp2760GeV->Draw(">,same");
            PlotErrorBarAtUpperEdgeOfTGraphAsymErr(graphInvYieldDirGammaTotArpp2760GeV);
        }
        ...
        if (graphInvYieldDirGammaTotArpp8TeV){
            DrawGammaSetMarkerTGraphAsym(graphInvYieldDirGammaTotArpp8TeV , 1, 3, colorEpp8TeV, colorEpp8TeV, 1, kTRUE);
    ...
    canvasDirGamma->Print(Form("%s/DirGammaSpectra_PP.%s",outputDir.Data(),suffix.Data()));
    canvasDirGamma->Print(Form("%s/DirGammaSpectra_PP.pdf",outputDir.Data()));
...
//     dummyXSecGamma->GetXaxis()->SetRangeUser(doubleRatioX[0],doubleRatioX[1]);
    ...
    labelXTscaledGamma2->Draw();
        ...
        if ( enablePrelim ){
            ...
            if (graphXSecDirGammaTotArpp7TeV){
                DrawGammaSetMarkerTGraphAsym(graphXSecDirGammaTotArpp7TeV , 1, 3, colorEpp7TeV, colorEpp7TeV, 1, kTRUE);
        ...
        if (graphXSecDirGammaTotArpp2760GeV){
            DrawGammaSetMarkerTGraphAsym(graphXSecDirGammaTotArpp2760GeV , 1, 3, colorEpp2760GeV, colorEpp2760GeV, 1, kTRUE);
        ...
        if (graphXSecDirGammaTotArpp8TeV){
            DrawGammaSetMarkerTGraphAsym(graphXSecDirGammaTotArpp8TeV , 1, 3, colorEpp8TeV, colorEpp8TeV, 1, kTRUE);
    ...
    if (enablePrelim){
        canvasDirGamma2->Print(Form("%s/DirGammaInvXSecSpectra_PP_withPrelim.%s",outputDir.Data(),suffix.Data()));
        canvasDirGamma2->Print(Form("%s/DirGammaInvXSecSpectra_PP_withPrelim.pdf",outputDir.Data()));
    } else {
        canvasDirGamma2->Print(Form("%s/DirGammaInvXSecSpectra_PP.%s",outputDir.Data(),suffix.Data()));
        canvasDirGamma2->Print(Form("%s/DirGammaInvXSecSpectra_PP.pdf",outputDir.Data()));
    }
    ...
    dummyXSecGamma_xT->DrawCopy();
        ...
        if ( enablePrelim ){
            ...
            if (graphXSecDirGammaTotArpp7TeV_xT){
                DrawGammaSetMarkerTGraphAsym(graphXSecDirGammaTotArpp7TeV_xT , 1, 3, colorEpp7TeV, colorEpp7TeV, 1, kTRUE);
...
//             markerCurrent->Print();
        ...
        if (graphXSecDirGammaTotArpp2760GeV_xT){
            DrawGammaSetMarkerTGraphAsym(graphXSecDirGammaTotArpp2760GeV_xT , 1, 3, colorEpp2760GeV, colorEpp2760GeV, 1, kTRUE);
...
//         markerCurrent2760GeV->Print();
        ...
        if (graphXSecDirGammaTotArpp8TeV_xT){
            DrawGammaSetMarkerTGraphAsym(graphXSecDirGammaTotArpp8TeV_xT , 1, 3, colorEpp8TeV, colorEpp8TeV, 1, kTRUE);
...
//                 markerCurrent->Print();
    ...
    if (enablePrelim){
        canvasDirGamma2->Print(Form("%s/DirGammaInvXSecSpectra_PP_xT_withPrelim.%s",outputDir.Data(),suffix.Data()));
        canvasDirGamma2->Print(Form("%s/DirGammaInvXSecSpectra_PP_xT_withPrelim.pdf",outputDir.Data()));
    } else {
    ...
    canvasDirGamma->Print(Form("%s/IncGammaSpectra_PP_wFit.%s",outputDir.Data(),suffix.Data()));
    canvasDirGamma->Print(Form("%s/IncGammaSpectra_PP_wFit.pdf",outputDir.Data()));
        ...
        for (Int_t centPb = 0; centPb < 3; centPb++){
            ...
            if (graphInvYieldDirGammaTotArPbPbPlot[centPb]){
                if (graphInvYieldDirGammaTotArPbPbPlot[centPb]->GetN() > 0){
                    DrawGammaSetMarkerTGraphAsym(graphInvYieldDirGammaTotArPbPbPlot[centPb] , 1, 3, colorComb[centPb], colorComb[centPb], 1, kTRUE);
    ...
    canvasDirGamma->Print(Form("%s/DirGammaSpectra_AA_WithScaledPP.%s",outputDir.Data(),suffix.Data()));
    canvasDirGamma->Print(Form("%s/DirGammaSpectra_AA_WithScaledPP.pdf",outputDir.Data()));
    ...
    canvasDirGamma->Print(Form("%s/DirGammaSpectra_AA_WithScaledPP_Split.%s",outputDir.Data(),suffix.Data()));
    canvasDirGamma->Print(Form("%s/DirGammaSpectra_AA_WithScaledPP_Split.pdf",outputDir.Data()));
