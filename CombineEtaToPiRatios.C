...
// 0.40 0.50 1.119247202e-02 8.994972179e-04 1.101869365e-03
// 0.50 0.60 1.533208402e-02 6.295941749e-04 1.581905727e-03
// 0.60 0.70 1.864215424e-02 5.232385277e-04 1.868848646e-03
// 0.70 0.80 2.452232769e-02 5.496848650e-04 2.514044412e-03
// 0.80 0.90 2.890036189e-02 6.062008267e-04 2.956792689e-03
// 0.90 1.00 3.571668561e-02 7.334431535e-04 3.547199518e-03
// 1.00 1.10 4.189824060e-02 8.999940406e-04 4.026962770e-03
// 1.10 1.20 4.949514549e-02 1.106071036e-03 4.988083954e-03
// 1.20 1.30 5.651248406e-02 1.363279269e-03 6.658769101e-03
// 1.30 1.40 6.307407920e-02 1.625844248e-03 7.587164846e-03
// 1.40 1.50 6.801247840e-02 1.976728860e-03 7.668559573e-03
// 1.50 1.60 7.533635873e-02 2.274333731e-03 9.005238564e-03
// 1.60 1.70 8.174400361e-02 2.601051492e-03 9.625709494e-03
// 1.70 1.80 8.764237237e-02 2.908019836e-03 9.771773650e-03
// 1.80 1.90 8.917655620e-02 3.161382295e-03 9.568485948e-03
// 1.90 2.00 8.857730995e-02 3.300159174e-03 1.039718102e-02
// 2.00 2.20 9.587081473e-02 2.629077487e-03 1.005044416e-02
// 2.20 2.40 1.044300342e-01 3.151066585e-03 1.152118092e-02
// 2.40 2.60 1.050055171e-01 3.487316359e-03 1.372232580e-02
// 2.60 2.80 1.149071190e-01 4.192586576e-03 1.509959004e-02
// 2.80 3.00 1.182595988e-01 4.801603508e-03 1.545271193e-02
// 3.00 3.50 1.260789449e-01 3.941883188e-03 1.529558821e-02
// 3.50 4.00 1.409705043e-01 5.574422171e-03 1.769544912e-02
// 4.00 4.50 1.550439739e-01 7.619842933e-03 1.962113206e-02
// 4.50 5.00 1.637287914e-01 1.059080219e-02 2.166891568e-02
...
void CombineEtaToPiRatios(TString suffix = "pdf", TString nameFilepPb = "data_PCMResults_pPb.root", Bool_t runDrawReweighted = kTRUE){
	...
	TString outputDir = Form("%s/%s/CombineEtaToPiRatios",suffix.Data(),dateForOutput.Data());
	...
	TH1D* histoPCMEtaToPi0RatiopPb 							= (TH1D*)directoryPCMEtapPb->Get("EtatoPi0Ratio");
	TGraphAsymmErrors* graphPCMEtaToPi0RatioSysErrpPb		= (TGraphAsymmErrors*)directoryPCMEtapPb->Get("EtatoPi0RatioSys"); 

	TFile* filePCMPbPb 										= new TFile("data_PCMResults_PbPb_2.76TeV_LuciaEta24022015.root");
	...
	TDirectory*	directoryPCMEtaPbPb2040 					= (TDirectory*)filePCMPbPb->Get("Eta_PbPb_2.76TeV_20-40%"); 
	TH1D* histoPCMEtaToPi0RatioPbPb2040 					= (TH1D*)directoryPCMEtaPbPb2040->Get("EtatoPi0Ratio");
	TGraphAsymmErrors* graphPCMEtaToPi0RatioSysErrPbPb2040	= (TGraphAsymmErrors*)directoryPCMEtaPbPb2040->Get("EtatoPi0RatioSys"); 
...
// 	legendRatioALICE->Draw();
	...
	DrawGammaSetMarker(histoPCMEtaToPi0RatioPbPb2040, markerStylePbPb2040, markerSizepPb, colorCombPbPb2040, colorCombPbPb2040);
	...
	DrawGammaSetMarkerTGraphAsym(graphPCMEtaToPi0RatioSysErrPbPb2040, markerStylePbPb2040, markerSizepPb, colorCombPbPb2040, colorCombPbPb2040, widthLinesBoxes, kTRUE);
	...
	graphPCMEtaToPi0RatioSysErrPbPb0010->RemovePoint(0);
	graphPCMEtaToPi0RatioSysErrPbPb2040->RemovePoint(0);
	...
	histo2DRatioEtaToPi0ALICE->Draw();
// 	graphPCMEtaToPi0RatioSysErrPbPb2040->Draw("same,pE2");  
	graphPCMEtaToPi0RatioSysErrPbPb0010->Draw("same,pE2");  
	graphCombEtaToPi0RatioSysErrpp7TeV->Draw("same,pE2");
	
// 	histoPCMEtaToPi0RatioPbPb2040->Draw("same,peX0");
	...
	TLegend* legendRatioALICEdata2 = new TLegend(0.12,0.82,0.32,0.96);
...
// 	legendRatioALICEdata2->SetMargin(0.1);
	...
	legendRatioALICEdata2->AddEntry(graphPCMEtaToPi0RatioSysErrPbPb0010,Form("%s, Lucia Leardini",collisionSystemPbPb0010.Data()),"pe");
	...
	canvasRatioEtaToPi0ALICE->Update();
	canvasRatioEtaToPi0ALICE->SaveAs(Form("%s/EtaToPi0Ratio_DiffSystems_PbPb.%s",outputDir.Data(), suffix.Data()));
