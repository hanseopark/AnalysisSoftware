...
void ProduceTheoryGraphsDirectPhotons(  Bool_t runPP    = kTRUE,
    ...
    if (runPP){
        ...
        TString nameCocktailFilePP7TeVLMEE   = "CocktailInput/GammaCocktail_pp7TeV_MB_LMEE.root";
        TFile* fileCockailPP7TeVLMEE         = new TFile(nameCocktailFilePP7TeVLMEE.Data());
        TH1D* histoGammaDecayLMEEPP7TeV      = (TH1D*)fileCockailPP7TeVLMEE->Get("Gamma_Pt_OrBin");
        for (Int_t i = 1; i < histoGammaDecayLMEEPP7TeV->GetNbinsX()+1; i++){
            histoGammaDecayLMEEPP7TeV->SetBinContent(i, histoGammaDecayLMEEPP7TeV->GetBinContent(i)/(histoGammaDecayLMEEPP7TeV->GetBinCenter(i) *2* TMath::Pi()) );
            histoGammaDecayLMEEPP7TeV->SetBinError(i, histoGammaDecayLMEEPP7TeV->GetBinError(i)/(histoGammaDecayLMEEPP7TeV->GetBinCenter(i)*2* TMath::Pi()));
        }
        histoGammaDecayLMEEPP7TeV->GetXaxis()->SetRangeUser(0,30);
        ...
        // **********************************************************************************************************************
        // **********************************************************************************************************************
        // Load cocktail for pp 8TeV comb
        // **********************************************************************************************************************
        TString nameCocktailFilePP8TeVComb   = "CocktailInput/GammaCocktail_pp8TeV_MB_comb.root";
        TFile* fileCockailPP8TeVComb         = new TFile(nameCocktailFilePP8TeVComb.Data());
        TH1D* histoGammaDecayCombPP8TeV      = (TH1D*)fileCockailPP8TeVComb->Get("Gamma_Pt_OrBin");
        for (Int_t i = 1; i < histoGammaDecayCombPP8TeV->GetNbinsX()+1; i++){
            histoGammaDecayCombPP8TeV->SetBinContent(i, histoGammaDecayCombPP8TeV->GetBinContent(i)/(histoGammaDecayCombPP8TeV->GetBinCenter(i) *2* TMath::Pi()) );
            histoGammaDecayCombPP8TeV->SetBinError(i, histoGammaDecayCombPP8TeV->GetBinError(i)/(histoGammaDecayCombPP8TeV->GetBinCenter(i)*2* TMath::Pi()));
        }
        histoGammaDecayCombPP8TeV->GetXaxis()->SetRangeUser(0,30);
        ...
        TGraphAsymmErrors* graphpp8TeVPythia8_direct = 0x0;
        if(graphpp8TeVPythia8_prompt->GetN() == graphpp8TeVPythia8_frag_onlyJJ->GetN()){ // make sure both graphs are compatible for adding
            Int_t nPoints_temp = graphpp8TeVPythia8_prompt->GetN();
            ...
            for(Int_t i=0; i < nPoints_temp; i++){
                graphpp8TeVPythia8_prompt->GetPoint(i,xVal_prompt[i],yVal_prompt[i]);
                graphpp8TeVPythia8_frag_onlyJJ->GetPoint(i,xVal_frag[i],yVal_frag[i]);
                yVal_dir[i] = yVal_prompt[i] + yVal_frag[i];
            }
            graphpp8TeVPythia8_direct = new TGraphAsymmErrors(nPoints_temp, xVal_prompt, yVal_dir);
        } else {
            ...
            delete graphpp8TeVPythia8_direct;
        }
        ...
        graphpp8TeVPythia8_direct->RemovePoint(0);
        TGraphAsymmErrors* graphRatioPythia8FragGammaDivTot8TeV    = CalculateAsymGraphRatioToGraph(graphpp8TeVPythia8_frag_onlyJJ, graphpp8TeVPythia8_direct);
        TGraphAsymmErrors* graphRatioPythia8PromptGammaDivTot8TeV  = CalculateAsymGraphRatioToGraph(graphpp8TeVPythia8_prompt, graphpp8TeVPythia8_direct);
        ...
        TF1* fitGammaDirect8TeV_Pythia8                 = FitObject("powPure","fitPythiacalcDirectGamma8TeV","Gamma",graphpp8TeVPythia8_direct,15.,100.,NULL,"QNRMEX0+");
        TF1* fitFragDivGammaDir8TeV_Pythia8     = CalculateRatioOfTwoFunctions (fitGammaFrag8TeV_Pythia8, fitGammaDirect8TeV_Pythia8, "ratioFitPythia8FragDivDirGamma8TeV");
        TF1* fitPromptDivGammaDir8TeV_Pythia8   = CalculateRatioOfTwoFunctions (fitGammaPrompt8TeV_Pythia8, fitGammaDirect8TeV_Pythia8, "ratioFitPythia8PromptDivDirGamma8TeV");
        ...
        graphRatioPythia8FragGammaDivTot8TeV->Draw();

        graphRatioPythia8FragGammaDivTot8TeV->Fit(fitFragDivGammaDir8TeV_Pythia8,"QNRMEX0+");
        graphRatioPythia8PromptGammaDivTot8TeV->Fit(fitPromptDivGammaDir8TeV_Pythia8,"QNRMEX0+");
        graphRatioPythia8PromptGammaDivFrag8TeV->Fit(fitPromptDivFragGamma8TeV_Pythia8,"QNRMEX0+");
        fitFragDivGammaDir8TeV_Pythia8->SetRange(15.,200.);
        fitPromptDivGammaDir8TeV_Pythia8->SetRange(15.,200.);
        ...
        histo2DRatioGammaCalc_2->Draw("copy");
            ...
            DrawGammaSetMarkerTGraphAsym(graphRatioPythia8FragGammaDivTot8TeV, 0, 0, colorFrag, colorFrag, 1, kTRUE, colorFrag);
            graphRatioPythia8FragGammaDivTot8TeV->Draw("3,same");

            DrawGammaSetMarkerTGraphAsym(graphRatioPythia8PromptGammaDivTot8TeV, 0, 0, colorPrompt, colorPrompt, 1, kTRUE, colorPrompt);
            graphRatioPythia8PromptGammaDivTot8TeV->Draw("3,same");

            DrawGammaLines(10., 200. , 1., 1.,0.1, kGray+2);
            ...
            canvasRatioDirGammaCalc->SaveAs(Form("%s/GammaPythia8Calc_Separation_PP8TeV.%s",outputDir.Data(),suffix.Data()));

        // **********************************************************************************************************************
        // *********************************** direct photon calculations for 13TeV *********************************************
        // **********************************************************************************************************************
        TString nameCocktailFilePP13TeVLMEE   = "CocktailInput/GammaCocktail_pp13TeV_MB_LMEE.root";
        TFile* fileCockailPP13TeVLMEE         = new TFile(nameCocktailFilePP13TeVLMEE.Data());
        TH1D* histoGammaDecayLMEEPP13TeV      = (TH1D*)fileCockailPP13TeVLMEE->Get("Gamma_Pt_OrBin");
        for (Int_t i = 1; i < histoGammaDecayLMEEPP13TeV->GetNbinsX()+1; i++){
            histoGammaDecayLMEEPP13TeV->SetBinContent(i, histoGammaDecayLMEEPP13TeV->GetBinContent(i)/(histoGammaDecayLMEEPP13TeV->GetBinCenter(i) *2* TMath::Pi()) );
            histoGammaDecayLMEEPP13TeV->SetBinError(i, histoGammaDecayLMEEPP13TeV->GetBinError(i)/(histoGammaDecayLMEEPP13TeV->GetBinCenter(i)*2* TMath::Pi()));
        }
        histoGammaDecayLMEEPP13TeV->GetXaxis()->SetRangeUser(0,30);
        ...
        TString fileNameNLOPhotonHalf13TeV    = "ExternalInput/Theory/ALICENLOcalcDirectPhoton13TeVmuhalf_eta08_ct14.dat";
        TString fileNameNLOPhotonOne13TeV     = "ExternalInput/Theory/ALICENLOcalcDirectPhoton13TeVmuone_eta08_ct14.dat";
        TString fileNameNLOPhotonTwo13TeV     = "ExternalInput/Theory/ALICENLOcalcDirectPhoton13TeVmutwo_eta08_ct14.dat";

        Int_t nlinesNLOTwo13TeV              = 0;
        Int_t nlinesNLOOne13TeV              = 0;
        Int_t nlinesNLOHalf13TeV             = 0;
        Int_t nlinesNLOPaquett13TeV             = 0;
        Double_t ptNLOPhotonTwo13TeV[100];
        Double_t ptNLOPhotonTwo13TeVErr[100];
        Double_t ptNLOPhotonOne13TeV[100];
        Double_t ptNLOPhotonHalf13TeV[100];
        Double_t ptNLOPaquettPhoton13TeV[200];
        Double_t ptNLOPhotonPaquett13TeVErr[200];
        Double_t GammaNLOPhotonPaquett13TeVErr[200];

        Double_t muHalfDF13TeV[100];
        Double_t muHalfD13TeV[100];
        Double_t muHalfF13TeV[100];
        Double_t muOneDF13TeV[100];
        Double_t muOneD13TeV[100];
        Double_t muOneF13TeV[100];
        Double_t muTwoDF13TeV[100];
        Double_t muTwoD13TeV[100];
        Double_t muTwoF13TeV[100];
        Double_t paquettGamma13TeV[200];
        Double_t gammaValue13TeV[100];
        Double_t gammaErrUp13TeV[100];
        Double_t gammaErrDown13TeV[100];
        Double_t fragGammaValue13TeV[100];
        Double_t fragGammaErrUp13TeV[100];
        Double_t fragGammaErrDown13TeV[100];
        Double_t promptGammaValue13TeV[100];
        Double_t promptGammaErrUp13TeV[100];
        Double_t promptGammaErrDown13TeV[100];

        ifstream inHalf13TeV;
        inHalf13TeV.open(fileNameNLOPhotonHalf13TeV,ios_base::in);
        cout << fileNameNLOPhotonHalf13TeV << endl;

        while(!inHalf13TeV.eof()){
            nlinesNLOHalf13TeV++;
            //               Pt                              DirectPhoton           FragmentationPhoton         SumPhoton
            inHalf13TeV >> ptNLOPhotonHalf13TeV[nlinesNLOHalf13TeV] >> muHalfD13TeV[nlinesNLOHalf13TeV] >> muHalfF13TeV[nlinesNLOHalf13TeV] >> muHalfDF13TeV[nlinesNLOHalf13TeV];

        }
        inHalf13TeV.close();

        ifstream inOne13TeV;
        inOne13TeV.open(fileNameNLOPhotonOne13TeV,ios_base::in);
        cout << fileNameNLOPhotonOne13TeV << endl;

        while(!inOne13TeV.eof()){
            nlinesNLOOne13TeV++;
            inOne13TeV >> ptNLOPhotonOne13TeV[nlinesNLOOne13TeV] >> muOneD13TeV[nlinesNLOOne13TeV] >> muOneF13TeV[nlinesNLOOne13TeV] >> muOneDF13TeV[nlinesNLOOne13TeV];
        }
        inOne13TeV.close();

        ifstream inTwo13TeV;
        inTwo13TeV.open(fileNameNLOPhotonTwo13TeV,ios_base::in);
        cout << fileNameNLOPhotonTwo13TeV << endl;

        while(!inTwo13TeV.eof()){
            nlinesNLOTwo13TeV++;
            inTwo13TeV >> ptNLOPhotonTwo13TeV[nlinesNLOTwo13TeV] >> muTwoD13TeV[nlinesNLOTwo13TeV] >> muTwoF13TeV[nlinesNLOTwo13TeV] >> muTwoDF13TeV[nlinesNLOTwo13TeV];
            ptNLOPhotonTwo13TeVErr[nlinesNLOTwo13TeV] = 0.25;
        }
        inTwo13TeV.close();


        for (Int_t i = 0; i < nlinesNLOTwo13TeV; i++){
            cout << ptNLOPhotonHalf13TeV[i] << "\t" << muHalfDF13TeV[i] << "\t" << muOneDF13TeV[i] << "\t" << muTwoDF13TeV[i] << endl;
            gammaValue13TeV[i]               = muOneDF13TeV[i];
            if (muHalfDF13TeV[i] > muOneDF13TeV[i]){
                gammaErrUp13TeV[i]           = muHalfDF13TeV[i]-muOneDF13TeV[i];
                if (muOneDF13TeV[i]-muTwoDF13TeV[i] < 0){
                    gammaErrDown13TeV[i]     = 0;
                    if (gammaErrUp13TeV[i] < TMath::Abs(muOneDF13TeV[i]-muTwoDF13TeV[i]))
                        gammaErrUp13TeV[i]   = TMath::Abs(muOneDF13TeV[i]-muTwoDF13TeV[i]);
                } else {
                    gammaErrDown13TeV[i]     = muOneDF13TeV[i]-muTwoDF13TeV[i];
                }
            } else {
                gammaErrUp13TeV[i]           = muTwoDF13TeV[i]-muOneDF13TeV[i];
                if (muOneDF13TeV[i]-muHalfDF13TeV[i] < 0){
                    gammaErrDown13TeV[i]     = 0;
                    if (gammaErrUp13TeV[i] < TMath::Abs(muOneDF13TeV[i]-muHalfDF13TeV[i]))
                        gammaErrUp13TeV[i]   = TMath::Abs(muOneDF13TeV[i]-muHalfDF13TeV[i]);
                } else {
                    gammaErrDown13TeV[i]     = muOneDF13TeV[i]-muHalfDF13TeV[i];
                }
            }
            fragGammaValue13TeV[i]           = muOneF13TeV[i];
            if (muHalfF13TeV[i] > muOneF13TeV[i]){
                fragGammaErrUp13TeV[i]           = muHalfF13TeV[i]-muOneF13TeV[i];
                if (muOneF13TeV[i]-muTwoF13TeV[i] < 0){
                    fragGammaErrDown13TeV[i]     = 0;
                    if (fragGammaErrUp13TeV[i] < TMath::Abs(muOneF13TeV[i]-muTwoF13TeV[i]))
                        fragGammaErrUp13TeV[i]   = TMath::Abs(muOneF13TeV[i]-muTwoF13TeV[i]);
                } else {
                    fragGammaErrDown13TeV[i]     = muOneF13TeV[i]-muTwoF13TeV[i];
                }
            } else {
                fragGammaErrUp13TeV[i]           = muTwoF13TeV[i]-muOneF13TeV[i];
                if (muOneF13TeV[i]-muHalfF13TeV[i] < 0){
                    fragGammaErrDown13TeV[i]     = 0;
                    if (fragGammaErrUp13TeV[i] < TMath::Abs(muOneF13TeV[i]-muHalfF13TeV[i]))
                        fragGammaErrUp13TeV[i]   = TMath::Abs(muOneF13TeV[i]-muHalfF13TeV[i]);
                } else {
                    fragGammaErrDown13TeV[i]     = muOneF13TeV[i]-muHalfF13TeV[i];
                }
            }
            promptGammaValue13TeV[i]     = muOneD13TeV[i];
            if (muHalfD13TeV[i] > muOneD13TeV[i]){
                promptGammaErrUp13TeV[i]           = muHalfD13TeV[i]-muOneD13TeV[i];
                if (muOneD13TeV[i]-muTwoD13TeV[i] < 0){
                    promptGammaErrDown13TeV[i]     = 0;
                    if (promptGammaErrUp13TeV[i] < TMath::Abs(muOneD13TeV[i]-muTwoD13TeV[i]))
                        promptGammaErrUp13TeV[i]   = TMath::Abs(muOneD13TeV[i]-muTwoD13TeV[i]);
                } else {
                    promptGammaErrDown13TeV[i]     = muOneD13TeV[i]-muTwoD13TeV[i];
                }
            } else {
                promptGammaErrUp13TeV[i]           = muTwoD13TeV[i]-muOneD13TeV[i];
                if (muOneD13TeV[i]-muHalfD13TeV[i] < 0){
                    promptGammaErrDown13TeV[i]     = 0;
                    if (promptGammaErrUp13TeV[i] < TMath::Abs(muOneD13TeV[i]-muHalfD13TeV[i]))
                        promptGammaErrUp13TeV[i]   = TMath::Abs(muOneD13TeV[i]-muHalfD13TeV[i]);
                } else {
                    promptGammaErrDown13TeV[i]     = muOneD13TeV[i]-muHalfD13TeV[i];
                }
            }
        }

        TGraphAsymmErrors *graphNLOCalcDirGam13TeV       = new TGraphAsymmErrors(nlinesNLOTwo13TeV,ptNLOPhotonTwo13TeV,gammaValue13TeV,ptNLOPhotonTwo13TeVErr,ptNLOPhotonTwo13TeVErr,gammaErrDown13TeV,gammaErrUp13TeV);
        graphNLOCalcDirGam13TeV->RemovePoint(0);
        graphNLOCalcDirGam13TeV->RemovePoint(0);
        TGraphAsymmErrors *graphNLOCalcFragGam13TeV      = new TGraphAsymmErrors(nlinesNLOTwo13TeV,ptNLOPhotonTwo13TeV,fragGammaValue13TeV,ptNLOPhotonTwo13TeVErr,ptNLOPhotonTwo13TeVErr,fragGammaErrDown13TeV,fragGammaErrUp13TeV);
        graphNLOCalcFragGam13TeV->RemovePoint(0);
        graphNLOCalcFragGam13TeV->RemovePoint(0);
        TGraphAsymmErrors *graphNLOCalcPromGam13TeV      = new TGraphAsymmErrors(nlinesNLOTwo13TeV,ptNLOPhotonTwo13TeV,promptGammaValue13TeV,ptNLOPhotonTwo13TeVErr,ptNLOPhotonTwo13TeVErr,promptGammaErrDown13TeV,promptGammaErrUp13TeV);
        graphNLOCalcPromGam13TeV->RemovePoint(0);
        graphNLOCalcPromGam13TeV->RemovePoint(0);
        ...
        TF1* fitGammaPrompt13TeV                         = FitObject("powPure","fitNLOcalcPromptGamma13TeV","Gamma",graphNLOCalcPromGam13TeV,3,6.,NULL,"QNRMEX0+");
        TF1* fitFragDivGammaDir13TeV                     = CalculateRatioOfTwoFunctions (fitGammaFrag13TeV, fitGammaDir13TeV, "ratioFitNLOFragDivDirGamma13TeV");
        fitFragDivGammaDir13TeV->SetRange(2,50);
        TF1* fitPromptDivGammaDir13TeV                   = CalculateRatioOfTwoFunctions (fitGammaPrompt13TeV, fitGammaDir13TeV, "ratioFitNLOPromptDivDirGamma13TeV");
        fitPromptDivGammaDir13TeV->SetRange(2,50);
        TF1* fitPromptDivFragGamma13TeV                  = CalculateRatioOfTwoFunctions (fitGammaPrompt13TeV, fitGammaFrag13TeV, "ratioFitNLOPromptDivFragGamma13TeV");
        fitPromptDivFragGamma13TeV->SetRange(10,50);

        graphRatioNLOFragGammaDivTot13TeV->Fit(fitFragDivGammaDir13TeV,"QNRMEX0+");
        graphRatioNLOPromptGammaDivTot13TeV->Fit(fitPromptDivGammaDir13TeV,"QNRMEX0+");
        graphRatioNLOPromptGammaDivFrag13TeV->Fit(fitPromptDivFragGamma13TeV,"QNRMEX0+");
        fitPromptDivFragGamma13TeV->SetRange(2,100);
        ...
        DrawGammaSetMarkerTGraphAsym(graphRatioNLOFragGammaDivTot13TeV, 0, 0, colorFrag, colorFrag, 1, kTRUE, colorFrag);
        graphRatioNLOFragGammaDivTot13TeV->Draw("3,same");

        DrawGammaSetMarkerTGraphAsym(graphRatioNLOPromptGammaDivTot13TeV, 0, 0, colorPrompt, colorPrompt, 1, kTRUE, colorPrompt);
        graphRatioNLOPromptGammaDivTot13TeV->SetFillStyle(3245);
        graphRatioNLOPromptGammaDivTot13TeV->Draw("3,same");

        DrawGammaLines(0.23, 100. , 1., 1.,0.1, kGray+2);

        legendRatioGammaCalc->Draw();

        TLatex *labelRatioGammaCalc13TeV   = new TLatex(0.15,0.93,collisionSystem13TeV.Data());
        SetStyleTLatex( labelRatioGammaCalc13TeV, 0.85*32,4);
        labelRatioGammaCalc13TeV->SetTextFont(43);
        labelRatioGammaCalc13TeV->Draw();
        labelRatioGamma->Draw();

        canvasRatioDirGammaCalc->SaveAs(Form("%s/GammaNLOCalc_Separation_PP13TeV.%s",outputDir.Data(),suffix.Data()));
        ...
        TGraphAsymmErrors* graphNLOCalcInvYieldINT7DirGam8TeV       = (TGraphAsymmErrors*)graphNLOCalcDirGam8TeV->Clone("graphNLOCalcInvYieldINT7DirGam8TeV");
        graphNLOCalcInvYieldINT7DirGam8TeV                          = (TGraphAsymmErrors*)ScaleGraphAsym(graphNLOCalcInvYieldINT7DirGam8TeV, 1/recalcBarn/ReturnCorrectXSection("8TeV", 1));
        TGraphAsymmErrors* graphNLOCalcInvYieldINT7PromGam8TeV      = (TGraphAsymmErrors*)graphNLOCalcPromGam8TeV->Clone("graphNLOCalcInvYieldINT7PromGam8TeV");
        ...
        cout << "calculating 13TeV inv yields" << endl;
        TGraphAsymmErrors* graphNLOCalcInvYieldINT7DirGam13TeV      = (TGraphAsymmErrors*)graphNLOCalcDirGam13TeV->Clone("graphNLOCalcInvYieldINT7DirGam13TeV");
        graphNLOCalcInvYieldINT7DirGam13TeV                         = (TGraphAsymmErrors*)ScaleGraphAsym(graphNLOCalcInvYieldINT7DirGam13TeV, 1/recalcBarn/ReturnCorrectXSection("13TeV", 1));
        TGraphAsymmErrors* graphNLOCalcInvYieldINT7PromGam13TeV     = (TGraphAsymmErrors*)graphNLOCalcPromGam13TeV->Clone("graphNLOCalcInvYieldINT7PromGam13TeV");
        graphNLOCalcInvYieldINT7PromGam13TeV                        = (TGraphAsymmErrors*)ScaleGraphAsym(graphNLOCalcInvYieldINT7PromGam13TeV, 1/recalcBarn/ReturnCorrectXSection("13TeV", 1));
        TGraphAsymmErrors* graphNLOCalcInvYieldINT7FragGam13TeV     = (TGraphAsymmErrors*)graphNLOCalcFragGam13TeV->Clone("graphNLOCalcInvYieldINT7FragGam13TeV");
        graphNLOCalcInvYieldINT7FragGam13TeV                        = (TGraphAsymmErrors*)ScaleGraphAsym(graphNLOCalcInvYieldINT7FragGam13TeV, 1/recalcBarn/ReturnCorrectXSection("13TeV", 1));
        TGraphAsymmErrors* graphNLOCalcInvYieldINELDirGam13TeV      = (TGraphAsymmErrors*)graphNLOCalcDirGam13TeV->Clone("graphNLOCalcInvYieldINELDirGam13TeV");
        graphNLOCalcInvYieldINELDirGam13TeV                         = (TGraphAsymmErrors*)ScaleGraphAsym(graphNLOCalcInvYieldINELDirGam13TeV, 1/recalcBarn/ReturnCorrectXSection("13TeV", 3));
        TGraphAsymmErrors* graphNLOCalcInvYieldINELPromGam13TeV     = (TGraphAsymmErrors*)graphNLOCalcPromGam13TeV->Clone("graphNLOCalcInvYieldINELPromGam13TeV");
        graphNLOCalcInvYieldINELPromGam13TeV                        = (TGraphAsymmErrors*)ScaleGraphAsym(graphNLOCalcInvYieldINELPromGam13TeV, 1/recalcBarn/ReturnCorrectXSection("13TeV", 3));
        TGraphAsymmErrors* graphNLOCalcInvYieldINELFragGam13TeV     = (TGraphAsymmErrors*)graphNLOCalcFragGam13TeV->Clone("graphNLOCalcInvYieldINELFragGam13TeV");
        graphNLOCalcInvYieldINELFragGam13TeV                        = (TGraphAsymmErrors*)ScaleGraphAsym(graphNLOCalcInvYieldINELFragGam13TeV, 1/recalcBarn/ReturnCorrectXSection("13TeV", 3));
        TGraphAsymmErrors* graphNLOCalcInvYieldDirGam13TeV          = (TGraphAsymmErrors*)graphNLOCalcDirGam13TeV->Clone("graphNLOCalcInvYieldDirGam13TeV");
        graphNLOCalcInvYieldDirGam13TeV                             = (TGraphAsymmErrors*)ScaleGraphAsym(graphNLOCalcInvYieldDirGam13TeV, 1/recalcBarn/ReturnCorrectXSection("13TeV", 1));
        TGraphAsymmErrors* graphNLOCalcInvYieldPromGam13TeV         = (TGraphAsymmErrors*)graphNLOCalcPromGam13TeV->Clone("graphNLOCalcInvYieldPromGam13TeV");
        graphNLOCalcInvYieldPromGam13TeV                            = (TGraphAsymmErrors*)ScaleGraphAsym(graphNLOCalcInvYieldPromGam13TeV, 1/recalcBarn/ReturnCorrectXSection("13TeV", 1));
        TGraphAsymmErrors* graphNLOCalcInvYieldFragGam13TeV         = (TGraphAsymmErrors*)graphNLOCalcFragGam13TeV->Clone("graphNLOCalcInvYieldFragGam13TeV");
        graphNLOCalcInvYieldFragGam13TeV                            = (TGraphAsymmErrors*)ScaleGraphAsym(graphNLOCalcInvYieldFragGam13TeV, 1/recalcBarn/ReturnCorrectXSection("13TeV", 1));
        ...
        TGraphAsymmErrors* graphJETPHOXRGammaALICECocktailPP2760GeV = (TGraphAsymmErrors*)graphpp2760GeVJetPhox_invyield->Clone("graphJETPHOXRGammaALICECocktailPP2760GeV");
        TGraph* graphJETPHOXRGammaALICECocktailPP2760GeVCenter      = new TGraph(graphJETPHOXRGammaALICECocktailPP2760GeV->GetN());
        for (Int_t i = 0; i < graphJETPHOXRGammaALICECocktailPP2760GeV->GetN(); i++){
            Double_t decayGamma                                     = histoGammaDecayCombPP2760GeV->Interpolate(graphJETPHOXRGammaALICECocktailPP2760GeV->GetX()[i]);
            Double_t theoGamma                                      = graphJETPHOXRGammaALICECocktailPP2760GeV->GetY()[i];
            Double_t drtheoGamma                                    = (theoGamma+decayGamma)/decayGamma;
            Double_t errUpGamma                                     = (theoGamma+graphJETPHOXRGammaALICECocktailPP2760GeV->GetEYhigh()[i]+decayGamma)/decayGamma - drtheoGamma;
            Double_t errDownGamma                                   = TMath::Abs((theoGamma-graphJETPHOXRGammaALICECocktailPP2760GeV->GetEYlow()[i]+decayGamma)/decayGamma - drtheoGamma);
            graphJETPHOXRGammaALICECocktailPP2760GeV->SetPoint(i, graphJETPHOXRGammaALICECocktailPP2760GeV->GetX()[i], drtheoGamma);
            graphJETPHOXRGammaALICECocktailPP2760GeVCenter->SetPoint(i, graphJETPHOXRGammaALICECocktailPP2760GeV->GetX()[i], drtheoGamma);
        ...
        TGraph* graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeV = (TGraph*)graphThermalAndPromptInvYieldINT1DirGam7TeV->Clone("graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeV");
        TGraph* graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeVCenter      = new TGraph(graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeV->GetN());
        for (Int_t i = 0; i < graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeV->GetN(); i++){
            Double_t decayGamma                                     = histoGammaDecayLMEEPP7TeV->Interpolate(graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeV->GetX()[i]);
            Double_t theoGamma                                      = graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeV->GetY()[i];
            Double_t drtheoGamma                                    = (theoGamma+decayGamma)/decayGamma;
            Double_t errGamma                                     = (theoGamma+graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeV->GetEY()[i]+decayGamma)/decayGamma - drtheoGamma;
            graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeV->SetPoint(i, graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeV->GetX()[i], drtheoGamma);
            graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeVCenter->SetPoint(i, graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeV->GetX()[i], drtheoGamma);
        }
        TGraphAsymmErrors* graphNLOCalcRGammaALICECocktailPP7TeV = (TGraphAsymmErrors*)graphNLOCalcInvYieldINT1DirGam7TeV->Clone("graphNLOCalcRGammaALICECocktailPP7TeV");
        TGraph* graphNLOCalcRGammaALICECocktailPP7TeVCenter      = new TGraph(graphNLOCalcRGammaALICECocktailPP7TeV->GetN());
        for (Int_t i = 0; i < graphNLOCalcRGammaALICECocktailPP7TeV->GetN(); i++){
            Double_t decayGamma                                     = histoGammaDecayCombPP7TeV->Interpolate(graphNLOCalcRGammaALICECocktailPP7TeV->GetX()[i]);
            Double_t theoGamma                                      = graphNLOCalcRGammaALICECocktailPP7TeV->GetY()[i];
            Double_t drtheoGamma                                    = (theoGamma+decayGamma)/decayGamma;
            Double_t errUpGamma                                     = (theoGamma+graphNLOCalcRGammaALICECocktailPP7TeV->GetEYhigh()[i]+decayGamma)/decayGamma - drtheoGamma;
            Double_t errDownGamma                                   = TMath::Abs((theoGamma-graphNLOCalcRGammaALICECocktailPP7TeV->GetEYlow()[i]+decayGamma)/decayGamma - drtheoGamma);
            graphNLOCalcRGammaALICECocktailPP7TeV->SetPoint(i, graphNLOCalcRGammaALICECocktailPP7TeV->GetX()[i], drtheoGamma);
            graphNLOCalcRGammaALICECocktailPP7TeVCenter->SetPoint(i, graphNLOCalcRGammaALICECocktailPP7TeV->GetX()[i], drtheoGamma);
            graphNLOCalcRGammaALICECocktailPP7TeV->SetPointError(i, graphNLOCalcRGammaALICECocktailPP7TeV->GetEXlow()[i], graphNLOCalcRGammaALICECocktailPP7TeV->GetEXhigh()[i],
                                                                    errDownGamma, errUpGamma);
        }
        TGraphAsymmErrors* graphNLOCalcRGammaALICELMEECocktailPP7TeV = (TGraphAsymmErrors*)graphNLOCalcInvYieldINT1DirGam7TeV->Clone("graphNLOCalcRGammaALICELMEECocktailPP7TeV");
        TGraph* graphNLOCalcRGammaALICELMEECocktailPP7TeVCenter      = new TGraph(graphNLOCalcRGammaALICELMEECocktailPP7TeV->GetN());
        for (Int_t i = 0; i < graphNLOCalcRGammaALICELMEECocktailPP7TeV->GetN(); i++){
            Double_t decayGamma                                     = histoGammaDecayLMEEPP7TeV->Interpolate(graphNLOCalcRGammaALICELMEECocktailPP7TeV->GetX()[i]);
            Double_t theoGamma                                      = graphNLOCalcRGammaALICELMEECocktailPP7TeV->GetY()[i];
            Double_t drtheoGamma                                    = (theoGamma+decayGamma)/decayGamma;
            Double_t errUpGamma                                     = (theoGamma+graphNLOCalcRGammaALICELMEECocktailPP7TeV->GetEYhigh()[i]+decayGamma)/decayGamma - drtheoGamma;
            Double_t errDownGamma                                   = TMath::Abs((theoGamma-graphNLOCalcRGammaALICELMEECocktailPP7TeV->GetEYlow()[i]+decayGamma)/decayGamma - drtheoGamma);
            graphNLOCalcRGammaALICELMEECocktailPP7TeV->SetPoint(i, graphNLOCalcRGammaALICELMEECocktailPP7TeV->GetX()[i], drtheoGamma);
            graphNLOCalcRGammaALICELMEECocktailPP7TeVCenter->SetPoint(i, graphNLOCalcRGammaALICELMEECocktailPP7TeV->GetX()[i], drtheoGamma);
            graphNLOCalcRGammaALICELMEECocktailPP7TeV->SetPointError(i, graphNLOCalcRGammaALICELMEECocktailPP7TeV->GetEXlow()[i], graphNLOCalcRGammaALICELMEECocktailPP7TeV->GetEXhigh()[i],
                                                                 errDownGamma, errUpGamma);
        }
        ...
        TGraph* graphNLOCalcRGammaALICECocktailPP8TeVJETPHOXCenter      = new TGraph(graphNLOCalcRGammaALICECocktailPP8TeVJETPHOX->GetN());
        for (Int_t i = 0; i < graphNLOCalcRGammaALICECocktailPP8TeVJETPHOX->GetN(); i++){
            Double_t decayGamma                                     = histoGammaDecayCombPP8TeV->Interpolate(graphNLOCalcRGammaALICECocktailPP8TeVJETPHOX->GetX()[i]);
            Double_t theoGamma                                      = graphNLOCalcRGammaALICECocktailPP8TeVJETPHOX->GetY()[i];
            Double_t drtheoGamma                                    = (theoGamma+decayGamma)/decayGamma;
            Double_t errUpGamma                                     = (theoGamma+graphNLOCalcRGammaALICECocktailPP8TeVJETPHOX->GetEYhigh()[i]+decayGamma)/decayGamma - drtheoGamma;
            Double_t errDownGamma                                   = TMath::Abs((theoGamma-graphNLOCalcRGammaALICECocktailPP8TeVJETPHOX->GetEYlow()[i]+decayGamma)/decayGamma - drtheoGamma);
        ...
        TGraphAsymmErrors* graphNLOCalcRGammaALICELMEECocktailPP13TeV = (TGraphAsymmErrors*)graphNLOCalcInvYieldINT7DirGam13TeV->Clone("graphNLOCalcRGammaALICELMEECocktailPP13TeV");
        TGraph* graphNLOCalcRGammaALICELMEECocktailPP13TeVCenter      = new TGraph(graphNLOCalcRGammaALICELMEECocktailPP13TeV->GetN());
        for (Int_t i = 0; i < graphNLOCalcRGammaALICELMEECocktailPP13TeV->GetN(); i++){
            Double_t decayGamma                                     = histoGammaDecayLMEEPP13TeV->Interpolate(graphNLOCalcRGammaALICELMEECocktailPP13TeV->GetX()[i]);
            Double_t theoGamma                                      = graphNLOCalcRGammaALICELMEECocktailPP13TeV->GetY()[i];
            Double_t drtheoGamma                                    = (theoGamma+decayGamma)/decayGamma;
            Double_t errUpGamma                                     = (theoGamma+graphNLOCalcRGammaALICELMEECocktailPP13TeV->GetEYhigh()[i]+decayGamma)/decayGamma - drtheoGamma;
            Double_t errDownGamma                                   = TMath::Abs((theoGamma-graphNLOCalcRGammaALICELMEECocktailPP13TeV->GetEYlow()[i]+decayGamma)/decayGamma - drtheoGamma);
            graphNLOCalcRGammaALICELMEECocktailPP13TeV->SetPoint(i, graphNLOCalcRGammaALICELMEECocktailPP13TeV->GetX()[i], drtheoGamma);
            graphNLOCalcRGammaALICELMEECocktailPP13TeVCenter->SetPoint(i, graphNLOCalcRGammaALICELMEECocktailPP13TeV->GetX()[i], drtheoGamma);
            graphNLOCalcRGammaALICELMEECocktailPP13TeV->SetPointError(i, graphNLOCalcRGammaALICELMEECocktailPP13TeV->GetEXlow()[i], graphNLOCalcRGammaALICELMEECocktailPP13TeV->GetEXhigh()[i],
                                                                     errDownGamma, errUpGamma);
        }
        TGraphAsymmErrors* graphThermalAndPromptRGammaALICELMEECocktailPP13TeV = (TGraphAsymmErrors*)graphNLOCalcInvYieldThermalAndPromptDirGam13TeV->Clone("graphThermalAndPromptRGammaALICELMEECocktailPP13TeV");
        TGraph* graphThermalAndPromptRGammaALICELMEECocktailPP13TeVCenter      = new TGraph(graphThermalAndPromptRGammaALICELMEECocktailPP13TeV->GetN());
        for (Int_t i = 0; i < graphThermalAndPromptRGammaALICELMEECocktailPP13TeV->GetN(); i++){
            Double_t decayGamma                                     = histoGammaDecayLMEEPP13TeV->Interpolate(graphThermalAndPromptRGammaALICELMEECocktailPP13TeV->GetX()[i]);
            Double_t theoGamma                                      = graphThermalAndPromptRGammaALICELMEECocktailPP13TeV->GetY()[i];
            Double_t drtheoGamma                                    = (theoGamma+decayGamma)/decayGamma;
            Double_t errUpGamma                                     = (theoGamma+graphThermalAndPromptRGammaALICELMEECocktailPP13TeV->GetEYhigh()[i]+decayGamma)/decayGamma - drtheoGamma;
            Double_t errDownGamma                                   = TMath::Abs((theoGamma-graphThermalAndPromptRGammaALICELMEECocktailPP13TeV->GetEYlow()[i]+decayGamma)/decayGamma - drtheoGamma);
            graphThermalAndPromptRGammaALICELMEECocktailPP13TeV->SetPoint(i, graphThermalAndPromptRGammaALICELMEECocktailPP13TeV->GetX()[i], drtheoGamma);
            graphThermalAndPromptRGammaALICELMEECocktailPP13TeVCenter->SetPoint(i, graphThermalAndPromptRGammaALICELMEECocktailPP13TeV->GetX()[i], drtheoGamma);
            graphThermalAndPromptRGammaALICELMEECocktailPP13TeV->SetPointError(i, graphThermalAndPromptRGammaALICELMEECocktailPP13TeV->GetEXlow()[i], graphThermalAndPromptRGammaALICELMEECocktailPP13TeV->GetEXhigh()[i],
                                                                      errDownGamma, errUpGamma);
        }
        ...
        TFile *fileTheoryGraphsPP   = new TFile("ExternalInput/Theory/TheoryCompilationPP.root","UPDATE");
            ...
            graphJETPHOXRGammaALICECocktailPP2760GeV->GetYaxis()->SetTitle("R_{#gamma}");
            graphJETPHOXRGammaALICECocktailPP2760GeV->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphJETPHOXRGammaALICECocktailPP2760GeV->Write("graphRGammaDirectPhotonJETPHOXInvYieldINT1_pp2760GeV_ALICECocktail",TObject::kOverwrite);
            graphJETPHOXRGammaALICECocktailPP2760GeVCenter->GetYaxis()->SetTitle("R_{#gamma}");
            graphJETPHOXRGammaALICECocktailPP2760GeVCenter->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphJETPHOXRGammaALICECocktailPP2760GeVCenter->Write("graphRGammaDirectPhotonJETPHOXInvYieldINT1_pp2760GeV_ALICECocktail_Center",TObject::kOverwrite);
            ...
            graphNLOCalcRGammaALICECocktailPP7TeV->GetYaxis()->SetTitle("R_{#gamma}");
            graphNLOCalcRGammaALICECocktailPP7TeV->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphNLOCalcRGammaALICECocktailPP7TeV->Write("graphRGammaDirectPhotonNLOVogelsangInvYieldINT1_pp7TeV_CT10_ALICECocktail",TObject::kOverwrite);
            graphNLOCalcRGammaALICECocktailPP7TeVCenter->GetYaxis()->SetTitle("R_{#gamma}");
            graphNLOCalcRGammaALICECocktailPP7TeVCenter->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphNLOCalcRGammaALICECocktailPP7TeVCenter->Write("graphRGammaDirectPhotonNLOVogelsangInvYieldINT1_pp7TeV_CT10_ALICECocktail_Center",TObject::kOverwrite);
            graphNLOCalcRGammaALICELMEECocktailPP7TeV->GetYaxis()->SetTitle("R_{#gamma}");
            graphNLOCalcRGammaALICELMEECocktailPP7TeV->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphNLOCalcRGammaALICELMEECocktailPP7TeV->Write("graphRGammaDirectPhotonNLOVogelsangInvYieldINT1_pp7TeV_CT10_ALICELMEECocktail",TObject::kOverwrite);
            graphNLOCalcRGammaALICELMEECocktailPP7TeVCenter->GetYaxis()->SetTitle("R_{#gamma}");
            graphNLOCalcRGammaALICELMEECocktailPP7TeVCenter->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphNLOCalcRGammaALICELMEECocktailPP7TeVCenter->Write("graphRGammaDirectPhotonNLOVogelsangInvYieldINT1_pp7TeV_CT10_ALICELMEECocktail_Center",TObject::kOverwrite);
            ...
            graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeV->GetYaxis()->SetTitle("R_{#gamma}");
            graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeV->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeV->Write("graphRGammaThermalAndPromptDirectPhotonLiuWerner_pp7TeV_ALICELMEECocktail",TObject::kOverwrite);
            graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeVCenter->GetYaxis()->SetTitle("R_{#gamma}");
            graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeVCenter->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphNLOCalcRGammaALICELMEECocktailPromtThermalPP7TeVCenter->Write("graphRGammaThermalAndPromptDirectPhotonLiuWerner_pp7TeV_ALICELMEECocktail_Center",TObject::kOverwrite);
            ...
            histoGammaDecayLMEEPP7TeV->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            histoGammaDecayLMEEPP7TeV->GetYaxis()->SetTitle("#frac{1}{2#pi N_{ev.}} #frac{d^{2}N}{#it{p}_{T}d#it{p}_{T}dy} (GeV^{-2}#it{c})");
            histoGammaDecayLMEEPP7TeV->Write("histoALICELMEECocktailGammasPP7TeV",TObject::kOverwrite);
            // writing 8TeV Gammas
            ...
            graphNLOCalcRGammaALICECocktailPP8TeV->Write("graphRGammaDirectPhotonNLOVogelsangInvYieldINT7_pp8TeV_CT10_ALICECocktail",TObject::kOverwrite);
            graphNLOCalcRGammaALICECocktailPP8TeVCenter->GetYaxis()->SetTitle("R_{#gamma}");
            graphNLOCalcRGammaALICECocktailPP8TeVCenter->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphNLOCalcRGammaALICECocktailPP8TeVCenter->Write("graphRGammaDirectPhotonNLOVogelsangInvYieldINT7_pp8TeV_CT10_ALICECocktail_Center",TObject::kOverwrite);

            histoGammaDecayCombPP8TeV->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            histoGammaDecayCombPP8TeV->GetYaxis()->SetTitle("#frac{1}{2#pi N_{ev.}} #frac{d^{2}N}{#it{p}_{T}d#it{p}_{T}dy} (GeV^{-2}#it{c})");
            histoGammaDecayCombPP8TeV->Write("histoALICECombCocktailGammasPP8TeV",TObject::kOverwrite);

            // writing 13TeV Gammas
            ...
            graphNLOCalcDirGam13TeV->GetYaxis()->SetTitle("#it{E} #frac{d^{3}#sigma}{d#it{p}^{3}} (pb GeV^{-2} #it{c}^{3} )");
            graphNLOCalcDirGam13TeV->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphNLOCalcDirGam13TeV->Write("graphDirectPhotonNLOVogelsang_13TeV",TObject::kOverwrite);
            graphNLOCalcInvYieldDirGam13TeV->GetYaxis()->SetTitle("#frac{1}{2#pi N_{ev.}} #frac{d^{2}N}{#it{p}_{T}d#it{p}_{T}dy} (GeV^{-2}#it{c})");
            graphNLOCalcInvYieldDirGam13TeV->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphNLOCalcInvYieldDirGam13TeV->Write("graphDirectPhotonNLOVogelsangInvYield_13TeV",TObject::kOverwrite);
            graphNLOCalcPromGam13TeV->GetYaxis()->SetTitle("#it{E} #frac{d^{3}#sigma}{d#it{p}^{3}} (pb GeV^{-2} #it{c}^{3} )");
            graphNLOCalcPromGam13TeV->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphNLOCalcPromGam13TeV->Write("graphPromptPhotonNLOVogelsang_13TeV",TObject::kOverwrite);
            graphNLOCalcInvYieldPromGam13TeV->GetYaxis()->SetTitle("#frac{1}{2#pi N_{ev.}} #frac{d^{2}N}{#it{p}_{T}d#it{p}_{T}dy} (GeV^{-2}#it{c})");
            graphNLOCalcInvYieldPromGam13TeV->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphNLOCalcInvYieldPromGam13TeV->Write("graphPromptPhotonNLOVogelsangInvYield_13TeV",TObject::kOverwrite);
            graphNLOCalcFragGam13TeV->GetYaxis()->SetTitle("#it{E} #frac{d^{3}#sigma}{d#it{p}^{3}} (pb GeV^{-2} #it{c}^{3} )");
            graphNLOCalcFragGam13TeV->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphNLOCalcFragGam13TeV->Write("graphFragmentationPhotonNLOVogelsang_13TeV",TObject::kOverwrite);
            graphNLOCalcInvYieldFragGam13TeV->GetYaxis()->SetTitle("#frac{1}{2#pi N_{ev.}} #frac{d^{2}N}{#it{p}_{T}d#it{p}_{T}dy} (GeV^{-2}#it{c})");
            graphNLOCalcInvYieldFragGam13TeV->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphNLOCalcInvYieldFragGam13TeV->Write("graphFragmentationPhotonNLOVogelsangInvYield_13TeV",TObject::kOverwrite);
            graphRatioNLOFragGammaDivTot13TeV->Write("graphFragPhotonDivDirectNLOVogelsang_13TeV",TObject::kOverwrite);
            graphRatioNLOPromptGammaDivTot13TeV->Write("graphPromptPhotonDivDirectNLOVogelsang_13TeV",TObject::kOverwrite);
            graphRatioNLOPromptGammaDivFrag13TeV->Write("graphPromptPhotonDivFragementationNLOVogelsang_13TeV",TObject::kOverwrite);
            fitPromptDivFragGamma13TeV->Write("ratioFitNLOPromptDivFragGamma13TeV", TObject::kOverwrite);
            graphNLOCalcRGammaALICELMEECocktailPP13TeV->GetYaxis()->SetTitle("R_{#gamma}");
            graphNLOCalcRGammaALICELMEECocktailPP13TeV->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphNLOCalcRGammaALICELMEECocktailPP13TeV->Write("graphRGammaDirectPhotonNLOVogelsangInvYieldINT7_pp13TeV_CT14_ALICELMEECocktail",TObject::kOverwrite);
            graphNLOCalcRGammaALICELMEECocktailPP13TeVCenter->GetYaxis()->SetTitle("R_{#gamma}");
            graphNLOCalcRGammaALICELMEECocktailPP13TeVCenter->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphNLOCalcRGammaALICELMEECocktailPP13TeVCenter->Write("graphRGammaDirectPhotonNLOVogelsangInvYieldINT7_pp13TeV_CT14_ALICELMEECocktail_Center",TObject::kOverwrite);
            histoGammaDecayLMEEPP13TeV->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            histoGammaDecayLMEEPP13TeV->GetYaxis()->SetTitle("#frac{1}{2#pi N_{ev.}} #frac{d^{2}N}{#it{p}_{T}d#it{p}_{T}dy} (GeV^{-2}#it{c})");
            histoGammaDecayLMEEPP13TeV->Write("histoALICELMEECocktailGammasPP13TeV",TObject::kOverwrite);
            graphThermalAndPromptRGammaALICELMEECocktailPP13TeV->GetYaxis()->SetTitle("R_{#gamma}");
            graphThermalAndPromptRGammaALICELMEECocktailPP13TeV->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphThermalAndPromptRGammaALICELMEECocktailPP13TeV->Write("graphRGammaDirectPhotonThermalAndPromptShenInvYieldINT7_pp13TeV_CT10_ALICELMEECocktail",TObject::kOverwrite);
            graphThermalAndPromptRGammaALICELMEECocktailPP13TeVCenter->GetYaxis()->SetTitle("R_{#gamma}");
            graphThermalAndPromptRGammaALICELMEECocktailPP13TeVCenter->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
            graphThermalAndPromptRGammaALICELMEECocktailPP13TeVCenter->Write("graphRGammaDirectPhotonThermalAndPromptShenInvYieldINT7_pp13TeV_CT10_ALICELMEECocktail_Center",TObject::kOverwrite);
    ...
    //     graphTheoryMcGill2040Plot->RemovePoint(0);
        ...
        //#p_T[GeV] dN/(2*pi*p_T dp_T dy)[GeV^-2] statistical_error[same units] //the spectra "dN/(2*pi*p_T dp_T dy)" is at mid-rapidity (y=0)
        //direct photon calculations include thermal photons (computed with thermal rates and a hydrodynamic simulation of Pb-Pb collisions) and also prompt photons
        Double_t ptMCGill0005           [70];
        Double_t yieldMCGill0005        [70];
        Double_t errYieldMCGill0005     [70];
        Double_t errYieldXMCGill0005    [70];
        Int_t nlinesMCGill0005                      = 0;

        TString fileNameMCGill0005                  = "ExternalInputPbPb/Theory/McGill/direct_photons_LHC2760GeV_cent0005_McGill.dat";
        ifstream  fileMCGill0005;
        fileMCGill0005.open(fileNameMCGill0005,ios_base::in);
        cout << fileNameMCGill0005 << endl;

        while(!fileMCGill0005.eof() && nlinesMCGill0005< 70){
            fileMCGill0005 >> ptMCGill0005[nlinesMCGill0005] >> yieldMCGill0005[nlinesMCGill0005];
            cout << nlinesMCGill0005 << "\t"  << ptMCGill0005[nlinesMCGill0005] << "\t"  << yieldMCGill0005[nlinesMCGill0005] << endl;;
            errYieldMCGill0005[nlinesMCGill0005]    = 0;
            errYieldXMCGill0005[nlinesMCGill0005]   = 0;
            nlinesMCGill0005++;
        }
        fileMCGill0005.close();
        TGraphErrors* graphDirectPhotonMCGill0005   = new TGraphErrors(nlinesMCGill0005-1,ptMCGill0005,yieldMCGill0005, errYieldXMCGill0005, errYieldMCGill0005);

        Double_t ptMCGill0510           [70];
        Double_t yieldMCGill0510        [70];
        Double_t errYieldMCGill0510     [70];
        Double_t errYieldXMCGill0510    [70];
        Int_t nlinesMCGill0510                      = 0;

        Double_t yieldMCGill0010        [70];
        Double_t errYieldMCGill0010     [70];
        Double_t errYieldXMCGill0010    [70];

        TString fileNameMCGill0510                  = "ExternalInputPbPb/Theory/McGill/direct_photons_LHC2760GeV_cent0510_McGill.dat";
        ifstream  fileMCGill0510;
        fileMCGill0510.open(fileNameMCGill0510,ios_base::in);
        cout << fileNameMCGill0510 << endl;

        while(!fileMCGill0510.eof() && nlinesMCGill0510< 70){
            fileMCGill0510 >> ptMCGill0510[nlinesMCGill0510] >> yieldMCGill0510[nlinesMCGill0510];
            cout << nlinesMCGill0510 << "\t"  << ptMCGill0510[nlinesMCGill0510] << "\t"  << yieldMCGill0510[nlinesMCGill0510] << endl;;
            errYieldMCGill0510[nlinesMCGill0510]    = 0;
            errYieldXMCGill0510[nlinesMCGill0510]   = 0;

            yieldMCGill0010[nlinesMCGill0510]       = (yieldMCGill0510[nlinesMCGill0510] + yieldMCGill0005[nlinesMCGill0510])/2;
            errYieldMCGill0010[nlinesMCGill0510]    = 0;
            errYieldXMCGill0010[nlinesMCGill0510]   = 0;

            nlinesMCGill0510++;
        }
        fileMCGill0510.close();
        TGraphErrors* graphDirectPhotonMCGill0510   = new TGraphErrors(nlinesMCGill0510-1,ptMCGill0510,yieldMCGill0510, errYieldXMCGill0510, errYieldMCGill0510);
        TGraphErrors* graphDirectPhotonMCGill0010   = new TGraphErrors(nlinesMCGill0510-1,ptMCGill0510,yieldMCGill0010, errYieldXMCGill0010, errYieldMCGill0010);

        Double_t ptMCGill2050           [70];
        Double_t yieldMCGill2050        [70];
        Double_t errYieldMCGill2050     [70];
        Double_t errYieldXMCGill2050    [70];
        Int_t nlinesMCGill2050                      = 0;

        TString fileNameMCGill2050                  = "ExternalInputPbPb/Theory/McGill/direct_photons_LHC2760GeV_cent2050_McGill.dat";
        ifstream  fileMCGill2050;
        fileMCGill2050.open(fileNameMCGill2050,ios_base::in);
        cout << fileNameMCGill2050 << endl;

        while(!fileMCGill2050.eof() && nlinesMCGill2050< 70){
            fileMCGill2050 >> ptMCGill2050[nlinesMCGill2050] >> yieldMCGill2050[nlinesMCGill2050];
            cout << nlinesMCGill2050 << "\t"  << ptMCGill2050[nlinesMCGill2050] << "\t"  << yieldMCGill2050[nlinesMCGill2050] << endl;;
            errYieldMCGill2050[nlinesMCGill2050]    = 0;
            errYieldXMCGill2050[nlinesMCGill2050]   = 0;
            nlinesMCGill2050++;
        }
        ...
        // this calculation is missing the prompt photon contribution! needs to be added
        Double_t ptPHSDnew          [27];
        Double_t yieldPHSD0010      [27];
        Double_t yieldPHSD2050      [27];
        Double_t errPHSD0010        [27];
        Double_t errPHSD2050        [27];
        nlinesPHSD = 0;

        TString fileNamePHSDnew                        = "ExternalInputPbPb/Theory/PHSD/4ALICE_PbPb_276TeV-PHSD_forRead.dat";
        ifstream  filePHSDnew;
        filePHSDnew.open(fileNamePHSDnew,ios_base::in);
        cout << fileNamePHSDnew << endl;

        while(!filePHSDnew.eof() && nlinesPHSD< 27){
            filePHSDnew >> ptPHSDnew[nlinesPHSD] >> yieldPHSD0010[nlinesPHSD] >> yieldPHSD2050[nlinesPHSD];
            cout << nlinesPHSD << "\t"  << ptPHSDnew[nlinesPHSD] << "\t"  << yieldPHSD0010[nlinesPHSD]<< "\t"  << yieldPHSD2050[nlinesPHSD] << endl;;
            errPHSD0010[nlinesPHSD]                 = 0;
            errPHSD2050[nlinesPHSD]                 = 0;
            errXPHSD[nlinesPHSD]                    = 0;
            nlinesPHSD++;
        }
        filePHSDnew.close();
        TGraphErrors* graphDirectPhotonPHSD0010     = new TGraphErrors(nlinesPHSD-1,ptPHSDnew,yieldPHSD0010, errXPHSD, errPHSD0010);
        TGraphErrors* graphDirectPhotonPHSD2050     = new TGraphErrors(nlinesPHSD-1,ptPHSDnew,yieldPHSD2050, errXPHSD, errPHSD2050);
    ...
    //     TGraphErrors* graphDirectPhotonHe0040 = new TGraphErrors(nlinesHe-1,ptHe,yieldHe0040, errXHe, errHe0040);
        ...
        Double_t yieldSummedChatterjee0010      [20];
        Double_t errYieldChatterjee0010         [20];
        Double_t errYieldXChatterjee0010        [20];
        Int_t nlinesChatterjee0010                  = 0;

        TString fileNameChatterjee0010              = "ExternalInputPbPb/Theory/Chatterjee/0_10_directphoton_2.76PbPb_forReading.dat";
        ...
        while(!fileChatterjee0010.eof() && nlinesChatterjee0010< 20){
            ...
            yieldSummedChatterjee0010[nlinesChatterjee0010] = yieldThermalChatterjee0010[nlinesChatterjee0010] + yieldPromptChatterjee0010[nlinesChatterjee0010];
        ...
        TGraphErrors* graphDirectPhotonSummedChatterjee0010 = new TGraphErrors(nlinesChatterjee0010,ptChatterjee0010,yieldSummedChatterjee0010, errYieldXChatterjee0010, errYieldChatterjee0010);
            while (graphDirectPhotonSummedChatterjee0010->GetY()[0] == 0) graphDirectPhotonSummedChatterjee0010->RemovePoint(0);
            while (graphDirectPhotonSummedChatterjee0010->GetY()[graphDirectPhotonSummedChatterjee0010->GetN()-1] == 0) graphDirectPhotonSummedChatterjee0010->RemovePoint(graphDirectPhotonSummedChatterjee0010->GetN()-1);

        TGraphErrors* graphDirectPhotonChatterjee0010 = new TGraphErrors(nlinesChatterjee0010,ptChatterjee0010,yieldChatterjee0010, errYieldXChatterjee0010, errYieldChatterjee0010);
            while (graphDirectPhotonChatterjee0010->GetY()[0] == 0) graphDirectPhotonChatterjee0010->RemovePoint(0);
            while (graphDirectPhotonChatterjee0010->GetY()[graphDirectPhotonChatterjee0010->GetN()-1] == 0) graphDirectPhotonChatterjee0010->RemovePoint(graphDirectPhotonChatterjee0010->GetN()-1);

        TGraphErrors* graphDirectPhotonThermalChatterjee0010 = new TGraphErrors(nlinesChatterjee0010,ptChatterjee0010,yieldThermalChatterjee0010, errYieldXChatterjee0010, errYieldChatterjee0010);
        ...
        TGraphErrors* graphDirectPhotonPromptChatterjee0010 = new TGraphErrors(nlinesChatterjee0010,ptChatterjee0010,yieldPromptChatterjee0010, errYieldXChatterjee0010, errYieldChatterjee0010);
            while (graphDirectPhotonPromptChatterjee0010->GetY()[0] == 0) graphDirectPhotonPromptChatterjee0010->RemovePoint(0);
        ...
        Double_t yieldSummedChatterjee2050      [20];
        Double_t errYieldChatterjee2050         [20];
        Double_t errYieldXChatterjee2050        [20];
        Int_t nlinesChatterjee2050                  = 0;

        TString fileNameChatterjee2050              = "ExternalInputPbPb/Theory/Chatterjee/20_50_directphoton_2.76PbPb_forReading.dat";
        ...
        while(!fileChatterjee2050.eof() && nlinesChatterjee2050< 20){
            ...
            yieldSummedChatterjee2050[nlinesChatterjee2050] = yieldThermalChatterjee2050[nlinesChatterjee2050] + yieldPromptChatterjee2050[nlinesChatterjee2050];
        ...
        TGraphErrors* graphDirectPhotonSummedChatterjee2050 = new TGraphErrors(nlinesChatterjee2050,ptChatterjee2050,yieldSummedChatterjee2050, errYieldXChatterjee2050, errYieldChatterjee2050);
            while (graphDirectPhotonSummedChatterjee2050->GetY()[0] == 0) graphDirectPhotonSummedChatterjee2050->RemovePoint(0);
            while (graphDirectPhotonSummedChatterjee2050->GetY()[graphDirectPhotonSummedChatterjee2050->GetN()-1] == 0) graphDirectPhotonSummedChatterjee2050->RemovePoint(graphDirectPhotonSummedChatterjee2050->GetN()-1);

        TGraphErrors* graphDirectPhotonChatterjee2050           = new TGraphErrors(nlinesChatterjee2050,ptChatterjee2050,yieldChatterjee2050, errYieldXChatterjee2050, errYieldChatterjee2050);
        ...
        TGraphErrors* graphDirectPhotonThermalChatterjee2050    = new TGraphErrors(nlinesChatterjee2050,ptChatterjee2050,yieldThermalChatterjee2050, errYieldXChatterjee2050, errYieldChatterjee2050);
        ...
        TGraphErrors* graphDirectPhotonPromptChatterjee2050     = new TGraphErrors(nlinesChatterjee2050,ptChatterjee2050,yieldPromptChatterjee2050, errYieldXChatterjee2050, errYieldChatterjee2050);
	...
	//******************************************************************************************************************
       ...
       TGraphErrors* graphDirectPhotonMCGill_PbPb5020_0010   = new TGraphErrors(nlinesMCGill_PbPb5020-1,ptMCGill_PbPb5020,yieldMCGill_PbPb5020_0010, errYieldXMCGill_PbPb5020_0010, errYieldMCGill_PbPb5020_0010);
        ...
        TFile *fileTheoryGraphsPbPb = new TFile("ExternalInputPbPb/Theory/TheoryCompilationPbPb.root","UPDATE");
            ...
            // sligtly different underlying hydro compared to older one (preliminary reuslts)
            graphDirectPhotonMCGill0005->Write("graphDirectPhotonYield_McGill_0005", TObject::kOverwrite);
            graphDirectPhotonMCGill0510->Write("graphDirectPhotonYield_McGill_0510", TObject::kOverwrite);
            graphDirectPhotonMCGill0010->Write("graphDirectPhotonYield_McGill_0010", TObject::kOverwrite);
            graphDirectPhotonMCGill2050->Write("graphDirectPhotonYield_McGill_2050", TObject::kOverwrite);
            ...
            graphDirectPhotonPHSD0010->Write("graphDirectPhotonYield_PHSD_0010", TObject::kOverwrite);
            graphDirectPhotonPHSD2050->Write("graphDirectPhotonYield_PHSD_2050", TObject::kOverwrite);
    ...
    //         graphDirectPhotonHe0040->Write("graphDirectPhotonYield_He_0040", TObject::kOverwrite);
            ...
            graphDirectPhotonSummedChatterjee0010->Write("graphDirectPhotonSummedYield_Chatterjee_0010", TObject::kOverwrite);
            ...
            graphDirectPhotonSummedChatterjee2050->Write("graphDirectPhotonSummedYield_Chatterjee_2050", TObject::kOverwrite);
    ...
    if (runPPb){
        ...
        for (Int_t i = 0; i < graphNLOCalcRGammaALICECocktail->GetN(); i++){
            ...
            Double_t drtheoGamma                                    = (theoGamma+decayGamma)/decayGamma;
            Double_t errUpGamma                                     = (theoGamma+graphNLOCalcRGammaALICECocktail->GetEYhigh()[i]+decayGamma)/decayGamma - drtheoGamma;
            Double_t errDownGamma                                   = TMath::Abs((theoGamma-graphNLOCalcRGammaALICECocktail->GetEYlow()[i]+decayGamma)/decayGamma - drtheoGamma);
    ...
    //     }
        ...
        // read direct photon v2
        nlinesGammaMCGill           = 0;
        ifstream inMCGillGamma0020;
        Double_t y0020GammaMCGill[100], y0020ErrGammaMCGill[100];
        inMCGillGamma0020.open("ExternalInputpPb/Theory/McGill/direct_photon_sp_pPbC0-20.dat",ios_base::in);
        while(!inMCGillGamma0020.eof()){
            inMCGillGamma0020 >> xPtGammaMCGill[nlinesGammaMCGill]  >> y0020GammaMCGill[nlinesGammaMCGill] >> y0020ErrGammaMCGill[nlinesGammaMCGill];
            cout << nlinesGammaMCGill << "         "  << xPtGammaMCGill[nlinesGammaMCGill] << "         "  <<y0020GammaMCGill[nlinesGammaMCGill]<<endl;
            xPtErrGammaMCGill[nlinesGammaMCGill] = 0;
            nlinesGammaMCGill++;

        }
        inMCGillGamma0020.close();
        TGraphErrors* graphGammaSpecMcGill5023GeV0020 = new TGraphErrors(nlinesGammaMCGill-1,xPtGammaMCGill,y0020GammaMCGill, xPtErrGammaMCGill, y0020ErrGammaMCGill );
        ...
        TGraphErrors* graphMCGillRGammaALICECocktail0020                = (TGraphErrors*)graphGammaSpecMcGill5023GeV0020->Clone("graphMCGillRGammaALICECocktail0020");
        ...
        for (Int_t i = 0; i < graphMCGillRGammaALICECocktail0020->GetN(); i++){
            Double_t decayGamma                                     = histoGammaDecaypPb5TeV0020->Interpolate(graphMCGillRGammaALICECocktail0020->GetX()[i]);
...
//         }
      ...
      TGraphAsymmErrors* graphPowhegGammaALICECocktail_nCTEQ15    = (TGraphAsymmErrors*)graphPowhegInvYieldINT7DirGamma_pPb_nCTEQ15->Clone("graphPowhegGammaALICECocktail_nCTEQ15");
        ...
        for (Int_t i = 0; i < graphPowhegGammaALICECocktail_nCTEQ15->GetN(); i++){
            ...
            if (theoGamma != 0){
                errUpGamma                                          = (theoGamma+graphPowhegGammaALICECocktail_nCTEQ15->GetEYhigh()[i]+decayGamma)/decayGamma - drtheoGamma;
                errDownGamma                                        = TMath::Abs((theoGamma-graphPowhegGammaALICECocktail_nCTEQ15->GetEYlow()[i]+decayGamma)/decayGamma - drtheoGamma);
            }
            ...
            graphPowhegGammaALICECocktail_nCTEQ15->SetPointError(i, graphPowhegGammaALICECocktail_nCTEQ15->GetEXlow()[i], graphPowhegGammaALICECocktail_nCTEQ15->GetEXhigh()[i], errDownGamma, errUpGamma);
        }
      ...
      TGraphAsymmErrors* graphPowhegGammaALICECocktail_nCTEQ15_60100    = (TGraphAsymmErrors*)graphPowhegInvYieldINT7DirGamma_pPb_nCTEQ15->Clone("graphPowhegGammaALICECocktail_nCTEQ15_60100");
        ...
        for (Int_t i = 0; i < graphPowhegGammaALICECocktail_EPPS16->GetN(); i++){
            ...
            if (theoGamma != 0){
                errUpGamma                                          = (theoGamma+graphPowhegGammaALICECocktail_EPPS16->GetEYhigh()[i]+decayGamma)/decayGamma - drtheoGamma;
                errDownGamma                                        = TMath::Abs((theoGamma-graphPowhegGammaALICECocktail_EPPS16->GetEYlow()[i]+decayGamma)/decayGamma - drtheoGamma);
            }
            ...
            graphPowhegGammaALICECocktail_EPPS16->SetPointError(i, graphPowhegGammaALICECocktail_EPPS16->GetEXlow()[i], graphPowhegGammaALICECocktail_EPPS16->GetEXhigh()[i], errDownGamma, errUpGamma);
        }
    ...
    fitPromptDivFragGammapPb8TeV_Pythia8->Draw("same");
        ...
        TFile *fileTheoryGraphsPPb   = new TFile("ExternalInputpPb/Theory/TheoryCompilationPPb.root","UPDATE");
            ...
            fileTheoryGraphsPPb->cd("pPb_5.023TeV");
                ...
                delete graphGammaSpecMcGill5023GeV0020;
