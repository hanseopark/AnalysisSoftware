...
void MergeEffiWithProperWeighting(TString sourcePath, TString fCutSelection, TString mesonType, TString fSuffix, TString fEnergyFlag, TString nameFileCorrectionFileFull, TString nameFileCorrectionFileBC, TString nameFileCorrectionFileD){
   ...
   TString outputDirGamma = Form("%s/%s/%s/ExtractGammaSignal",fCutSelection.Data(),fEnergyFlag.Data(),fSuffix.Data());
   ...
   for (Int_t nFiles = 0; nFiles < 6; nFiles ++){
      ...
      TList *TopDir =(TList*)fileInput->Get("GammaConvV1");   
   ...
   cout<< "Ratios Data:  BC/Full =" << ratioData[0] << "  D/Full ="  << ratioData[1] << endl;
   cout<< "Ratios MC:  BC/Full =" << ratioMC[0] << "  D/Full ="  << ratioMC[1] << endl;
	
   Double_t weighting[2];
   weighting[0] = ratioData[0]/ratioMC[0];
   weighting[1] = ratioData[1]/ratioMC[1];
	
   cout << "Weighting MC : BC =" << weighting[0] << "  D"  << weighting[1] << endl;
   cout << "Corrected Ratio MC : BC/Full=" << ratioMC[0]*weighting[0] << "  D/Full ="  << ratioMC[1]*weighting[1] << endl;
   ...
   TH1D *histoGammaMCPrimaryRecoEffRSMCPtWeighted;
   ...
   TH1D *histoMCGammaPurity =				(TH1D*)file->Get("MCGammaPurity"); //not yet correct MesonEffiPt
   TH1D *histoMCGammaTruePurity = 			(TH1D*)file->Get("MCGammaTruePurity"); //not yet correct MesonEffiPt;
   TH1D *histoGammaRecoEff = 				(TH1D*)file->Get("MCGammaRecoEff");
   TH1D *histoGammaMCPrimaryRecoEff = 			(TH1D*)file->Get("MCGammaPrimaryRecoEff"); //not yet correct MesonEffiPt;
   TH1D *histoGammaMCPrimaryRecoEffMCPt = 			(TH1D*)file->Get("MCGammaPrimaryRecoEffMCPt"); //not yet correct MesonEffiPt;
   TH1D *histoGammaMCPrimaryRecoEffRSMCPt = 			(TH1D*)file->Get("MCGammaPrimaryRecoEffRSMCPt"); //not yet correct MesonEffiPt;
   ...
   TH1D *histoMCGammaConvProb = 			(TH1D*)file->Get("MCGammaConvProb");
   ...
   TH1D *fHistoFracAllGammaToSecOldBin = (TH1D*)file->Get("FracAllGammaToSecOriginalBinning");
   TH1D *fHistoFracAllGammaToSecFromXFromK0s = (TH1D*)file->Get("FracAllGammaToSecFromXFromK0s");
   TH1D *fHistoFracAllGammaToSecFromXFromK0sOldBin = (TH1D*)file->Get("FracAllGammaToSecFromXFromK0sOriginalBinning");
   ...
   TH1D *histoMCGammaPurityBC =				(TH1D*)fileBC->Get("MCGammaPurity"); //not yet correct MesonEffiPt
   TH1D *histoMCGammaTruePurityBC = 			(TH1D*)fileBC->Get("MCGammaTruePurity"); //not yet correct MesonEffiPt;
   TH1D *histoGammaRecoEffBC = 				(TH1D*)fileBC->Get("MCGammaRecoEff");
   TH1D *histoGammaMCPrimaryRecoEffBC = 			(TH1D*)fileBC->Get("MCGammaPrimaryRecoEff"); //not yet correct MesonEffiPt;
   TH1D *histoGammaMCPrimaryRecoEffMCPtBC = 			(TH1D*)fileBC->Get("MCGammaPrimaryRecoEffMCPt"); //not yet correct MesonEffiPt;
   TH1D *histoGammaMCPrimaryRecoEffRSMCPtBC = 			(TH1D*)fileBC->Get("MCGammaPrimaryRecoEffRSMCPt"); //not yet correct MesonEffiPt;
   // 	TH1D *histoMCGammaBackground =				(TH1D*)fileBC->Get("fMCGammaBackground"); //not yet correct MesonEffiPt
   // 	histoMCGammaBackground->Scale(1./numberEvents[4]);
   TH1D *histoMCGammaConvProbBC = 			(TH1D*)fileBC->Get("MCGammaConvProb");
   ...
   TH1D *fHistoFracAllGammaToSecOldBinBC = (TH1D*)fileBC->Get("FracAllGammaToSecOriginalBinning");
   TH1D *fHistoFracAllGammaToSecFromXFromK0sBC = (TH1D*)fileBC->Get("FracAllGammaToSecFromXFromK0s");
   TH1D *fHistoFracAllGammaToSecFromXFromK0sOldBinBC = (TH1D*)fileBC->Get("FracAllGammaToSecFromXFromK0sOriginalBinning");
   ...
   TH1D *histoMCGammaPurityD =				(TH1D*)fileD->Get("MCGammaPurity"); //not yet correct MesonEffiPt
   TH1D *histoMCGammaTruePurityD = 			(TH1D*)fileD->Get("MCGammaTruePurity"); //not yet correct MesonEffiPt;
   TH1D *histoGammaRecoEffD = 				(TH1D*)fileD->Get("MCGammaRecoEff");
   TH1D *histoGammaMCPrimaryRecoEffD = 			(TH1D*)fileD->Get("MCGammaPrimaryRecoEff"); //not yet correct MesonEffiPt;
   TH1D *histoGammaMCPrimaryRecoEffMCPtD = 			(TH1D*)fileD->Get("MCGammaPrimaryRecoEffMCPt"); //not yet correct MesonEffiPt;
   TH1D *histoGammaMCPrimaryRecoEffRSMCPtD = 			(TH1D*)fileD->Get("MCGammaPrimaryRecoEffRSMCPt"); //not yet correct MesonEffiPt;
   // 	TH1D *histoMCGammaBackground =				(TH1D*)fileD->Get("fMCGammaBackground"); //not yet correct MesonEffiPt
   // 	histoMCGammaBackground->Scale(1./numberEvents[4]);
   TH1D *histoMCGammaConvProbD = 			(TH1D*)fileD->Get("MCGammaConvProb");
   ...
   TH1D *fHistoFracAllGammaToSecOldBinD = (TH1D*)fileD->Get("FracAllGammaToSecOriginalBinning");
   TH1D *fHistoFracAllGammaToSecFromXFromK0sD = (TH1D*)fileD->Get("FracAllGammaToSecFromXFromK0s");
   TH1D *fHistoFracAllGammaToSecFromXFromK0sOldBinD = (TH1D*)fileD->Get("FracAllGammaToSecFromXFromK0sOriginalBinning");
   ...
   if (fEnergyFlag.CompareTo("2.76TeV")==0 || fEnergyFlag.CompareTo("HI")==0  ){
      ...
      histoGammaMCPrimaryRecoEffRSMCPtWeighted=(TH1D*) histoGammaMCPrimaryRecoEffRSMCPt->Clone();
      ...
      histoGammaMCPrimaryRecoEffRSMCPtWeighted=(TH1D*) histoGammaMCPrimaryRecoEffRSMCPtBC->Clone();
      histoGammaMCPrimaryRecoEffRSMCPtWeighted->Scale(ratioData[0]);
      histoGammaMCPrimaryRecoEffRSMCPtWeighted->Add(histoGammaMCPrimaryRecoEffRSMCPtD, ratioData[1]);
      ...
      canvasEffSimple->Update();
      canvasEffSimple->SaveAs(Form("%s/%s_ComparisonGammaEffiMerged_%s.%s",outputDirGamma.Data(),mesonType.Data(),fCutSelection.Data(),fSuffix.Data()));
      delete canvasEffSimple;
      ...
      canvasEffSimple->Update();
      canvasEffSimple->SaveAs(Form("%s/%s_ComparisonGammaPrimaryEffiMerged_%s.%s",outputDirGamma.Data(),mesonType.Data(),fCutSelection.Data(),fSuffix.Data()));
      delete canvasEffSimple;
      ...
      canvasEffSimple->Update();
      canvasEffSimple->SaveAs(Form("%s/%s_ComparisonGammaPrimaryEffiMCPtMerged_%s.%s",outputDirGamma.Data(),mesonType.Data(),fCutSelection.Data(),fSuffix.Data()));
      delete canvasEffSimple;
      ...
      DrawAutoGammaMesonHistos( histoGammaMCPrimaryRecoEffRSMCPtWeighted, 
                                "", "p_{t} (GeV/c)", "#gamma reco. Efficiency", 
                                kTRUE, 2., 3e-6, kFALSE,
                                kFALSE, 0., 0.7, 
                                kFALSE, 0., 10.);
				
      DrawGammaSetMarker(histoGammaMCPrimaryRecoEffRSMCPtWeighted, 22, 1., kBlack, kBlack);										 
      histoGammaMCPrimaryRecoEffRSMCPtWeighted->DrawCopy("e1"); 	
		
      DrawGammaSetMarker(histoGammaMCPrimaryRecoEffRSMCPtBC, 22, 1., kBlue, kBlue);										 
      histoGammaMCPrimaryRecoEffRSMCPtBC->DrawCopy("e1,same"); 	
		
      DrawGammaSetMarker(histoGammaMCPrimaryRecoEffRSMCPtD, 22, 1., kRed, kRed);										 
      histoGammaMCPrimaryRecoEffRSMCPtD->DrawCopy("e1,same"); 		
		
      TLegend* legendYield = new TLegend(0.6,0.15,0.95,0.3);
      legendYield->SetTextSize(0.02);			
      legendYield->SetFillColor(0);
      legendYield->AddEntry(histoGammaMCPrimaryRecoEffRSMCPtWeighted,"merged with weighting");
      legendYield->AddEntry(histoGammaMCPrimaryRecoEffRSMCPtBC,"Period B&C");
      legendYield->AddEntry(histoGammaMCPrimaryRecoEffRSMCPtD,"Period D&E");
      legendYield->Draw();
			
      canvasEffSimple->Update();
      canvasEffSimple->SaveAs(Form("%s/%s_ComparisonGammaPrimaryEffiRSMCPtMerged_%s.%s",outputDirGamma.Data(),mesonType.Data(),fCutSelection.Data(),fSuffix.Data()));
      delete canvasEffSimple;
      ...
      canvasEffSimple->Update();
      canvasEffSimple->SaveAs(Form("%s/%s_ComparisonGammaProbMerged_%s.%s",outputDirGamma.Data(),mesonType.Data(),fCutSelection.Data(),fSuffix.Data()));
      delete canvasEffSimple;
      ...
      canvasEffSimple->Update();
      canvasEffSimple->SaveAs(Form("%s/%s_ComparisonGammaPurityMerged_%s.%s",outputDirGamma.Data(),mesonType.Data(),fCutSelection.Data(),fSuffix.Data()));
      delete canvasEffSimple;
      ...
      canvasEffSimple->Update();
      canvasEffSimple->SaveAs(Form("%s/%s_ComparisonGammaTruePurityMerged_%s.%s",outputDirGamma.Data(),mesonType.Data(),fCutSelection.Data(),fSuffix.Data()));
      delete canvasEffSimple;
      ...
      DrawAutoGammaMesonHistos( fHistoFracAllGammaToSecWeighted, 
                                "", "p_{t} (GeV/c)", "#gamma Sec. Fraction", 
                                kFALSE, 2., 3e-6, kFALSE,
                                kTRUE, 0.0, 0.06, 
                                kFALSE, 0., 10.);
	
      DrawGammaSetMarker(fHistoFracAllGammaToSecWeighted, 22, 1., kBlack, kBlack);										 
      fHistoFracAllGammaToSecWeighted->DrawCopy("e1"); 	
		
      DrawGammaSetMarker(fHistoFracAllGammaToSecBC, 22, 1., kBlue, kBlue);										 
      fHistoFracAllGammaToSecBC->DrawCopy("e1,same"); 	
		
      DrawGammaSetMarker(fHistoFracAllGammaToSecD, 22, 1., kRed, kRed);										 
      fHistoFracAllGammaToSecD->DrawCopy("e1,same"); 		
		
      TLegend* legendYield = new TLegend(0.2,0.7,0.55,0.85);
      legendYield->SetTextSize(0.02);			
      legendYield->SetFillColor(0);
      legendYield->AddEntry(fHistoFracAllGammaToSecWeighted,"merged with weighting");
      legendYield->AddEntry(fHistoFracAllGammaToSecBC,"Period B&C");
      legendYield->AddEntry(fHistoFracAllGammaToSecD,"Period D&E");
      legendYield->Draw();
      
      canvasEffSimple->Update();
      canvasEffSimple->SaveAs(Form("%s/%s_ComparisonGammaSecondaryFractionMerged_%s.%s",outputDirGamma.Data(),mesonType.Data(),fCutSelection.Data(),fSuffix.Data()));
      delete canvasEffSimple;
      ...
      DrawAutoGammaMesonHistos( fHistoFracAllGammaToSecFromXFromK0sWeighted, 
                                "", "p_{t} (GeV/c)", "#gamma Sec. Fraction K0s", 
                                kFALSE, 2., 3e-6, kFALSE,
                                kTRUE, 0.0, 0.06, 
                                kFALSE, 0., 10.);
				
      DrawGammaSetMarker(fHistoFracAllGammaToSecFromXFromK0sBC, 22, 1., kBlack, kBlack);										 
      fHistoFracAllGammaToSecFromXFromK0sWeighted->DrawCopy("e1"); 	
		
      DrawGammaSetMarker(fHistoFracAllGammaToSecFromXFromK0sD, 22, 1., kBlue, kBlue);										 
      fHistoFracAllGammaToSecFromXFromK0sBC->DrawCopy("e1,same"); 	
      
      DrawGammaSetMarker(fHistoFracAllGammaToSecFromXFromK0sD, 22, 1., kRed, kRed);										 
      fHistoFracAllGammaToSecFromXFromK0sD->DrawCopy("e1,same"); 		
		
      TLegend* legendYield = new TLegend(0.2,0.7,0.55,0.85);
      legendYield->SetTextSize(0.02);			
      legendYield->SetFillColor(0);
      legendYield->AddEntry(fHistoFracAllGammaToSecFromXFromK0sWeighted,"merged with weighting");
      legendYield->AddEntry(fHistoFracAllGammaToSecFromXFromK0sBC,"Period B&C");
      legendYield->AddEntry(fHistoFracAllGammaToSecFromXFromK0sD,"Period D&E");
      legendYield->Draw();
      
      canvasEffSimple->Update();
      canvasEffSimple->SaveAs(Form("%s/%s_ComparisonGammaSecondaryFractionFromK0sMerged_%s.%s",outputDirGamma.Data(),mesonType.Data(),fCutSelection.Data(),fSuffix.Data()));
      delete canvasEffSimple;
   ...
   fHistoFracAllGammaToSecOldBin->Write("FracAllGammaToSecOldBin",TObject::kOverwrite);
   fHistoFracAllGammaToSecFromXFromK0s->Write("FracAllGammaToSecFromXFromK0s",TObject::kOverwrite);
   fHistoFracAllGammaToSecFromXFromK0sOldBin->Write("FracAllGammaToSecFromXFromK0sOldBin",TObject::kOverwrite);
