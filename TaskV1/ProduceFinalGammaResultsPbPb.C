...
void ProduceFinalGammaResultsPbPb(TString inputFileName = "", TString cutSel = "", TString option = ""){
    ...
    TString fileNameSysErrDoubleRatio                           = Form("SystematicErrorsNew/SystematicErrorAveraged_DoubleRatio_PbPb_2.76TeV_%s_2015_07_29.dat",cent.Data());
    TString fileNameSysErrDoubleRatioPi0Fit                     = Form("SystematicErrorsNew/SystematicErrorAveraged_DoubleRatioPi0Fit_PbPb_2.76TeV_%s_2015_07_29.dat",cent.Data());
    TString fileNameSysErrIncGamma                              = Form("SystematicErrorsNew/SystematicErrorAveraged_GammaInc_PbPb_2.76TeV_%s_2015_07_29.dat",cent.Data());
    TString fileNameSysErrIncRatio                              = Form("SystematicErrorsNew/SystematicErrorAveraged_IncRatio_PbPb_2.76TeV_%s_2015_07_29.dat",cent.Data());
    TString fileNameSysErrIncRatioPi0Fit                        = Form("SystematicErrorsNew/SystematicErrorAveraged_IncRatioPi0Fit_PbPb_2.76TeV_%s_2015_07_29.dat",cent.Data());
    TString fileNameSysErrPi0                                   = Form("SystematicErrorsNew/SystematicErrorAveraged_Pi0_PbPb_2.76TeV_%s_2015_07_29.dat",cent.Data());
    TString fileNameSysErrPi0Fit                                = Form("SystematicErrorsNew/SystematicErrorAveraged_Pi0Fit_PbPb_2.76TeV_%s_2015_07_29.dat",cent.Data());

    if (option.CompareTo("7TeV") == 0 || option.CompareTo("2.76TeV") == 0){
        fileNameSysErrDoubleRatio                               = Form("SystematicErrorsNew/SystematicErrorAveraged_DoubleRatio_%s_pp_19_Apr_2015.dat",option.Data());
        fileNameSysErrDoubleRatioPi0Fit                         = Form("SystematicErrorsNew/SystematicErrorAveraged_DoubleRatioPi0Fit_%s_pp_19_Apr_2015.dat",option.Data());
        fileNameSysErrIncGamma                                  = Form("SystematicErrorsNew/SystematicErrorAveraged_GammaInc_%s_pp_19_Apr_2015.dat",option.Data());
        fileNameSysErrIncRatio                                  = Form("SystematicErrorsNew/SystematicErrorAveraged_IncRatio_%s_pp_19_Apr_2015.dat",option.Data());
        fileNameSysErrIncRatioPi0Fit                            = Form("SystematicErrorsNew/SystematicErrorAveraged_IncRatioPi0Fit_%s_pp_19_Apr_2015.dat",option.Data());
        fileNameSysErrPi0                                       = Form("SystematicErrorsNew/SystematicErrorAveraged_Pi0_%s_pp_19_Apr_2015.dat",option.Data());
        fileNameSysErrPi0Fit                                    = Form("SystematicErrorsNew/SystematicErrorAveraged_Pi0Fit_%s_pp_19_Apr_2015.dat",option.Data());
    }    
    if (option.CompareTo("pPb_5.023TeV") == 0){
