...
TH1D*		histoFWHMMesonPi0MC;
TH1D*		histoMassMesonPi0;
TH1D*		histoMassMesonPi0MC;
TH1D*		histoAccPi0;
...
Int_t 		nPointsPi0 = 			0;
Double_t 		relSystErrorPi0Up[80];
Double_t 		relSystErrorPi0Down[80];
Double_t 		relSystErrorWOMaterialPi0Up[80];
Double_t 		relSystErrorWOMaterialPi0Down[80];
Double_t 		systErrorPi0Up[80];
Double_t 		systErrorPi0Down[80];
Double_t 		xValueCorrYieldPi0[80];
Double_t 		yValueCorrYieldPi0[80];
Double_t 		yErrorCorrYieldPi0[80];
Double_t 		xErrorCorrYieldPi0[80];
Double_t 		yErrorCombinedPi0Up[80];
Double_t 		yErrorCombinedPi0Down[80];
Double_t 		sysErrPi0RatioFitConvUp[80];
Double_t 		sysErrPi0RatioFitConvDown[80];
Double_t 		yValuePi0RatioFitConv[80];
ifstream 		fileSysErrEta;
Int_t 			nPointsEta = 0;
Double_t 		relSystErrorEtaUp[80];
Double_t 		relSystErrorEtaDown[80];
Double_t 		relSystErrorWOMaterialEtaUp[80];
Double_t 		relSystErrorWOMaterialEtaDown[80];
Double_t 		systErrorEtaUp[80];
Double_t 		systErrorEtaDown[80];
Double_t 		xValueCorrYieldEta[80];
Double_t 		yValueCorrYieldEta[80];
Double_t 		yErrorCorrYieldEta[80];
Double_t 		xErrorCorrYieldEta[80];
Double_t 		yErrorCombinedEtaUp[80];
Double_t 		yErrorCombinedEtaDown[80];
Double_t 		sysErrEtaRatioFitConvUp[80];
Double_t 		sysErrEtaRatioFitConvDown[80];
Double_t 		yValueEtaRatioFitConv[80];
