...
TH1F*   histoMappingRDataScaledToGas;
TH1F*   histoMappingRFullPtDataScaledToGas;
TH1F*   histoMappingRMCScaledToGas;
TH1F*   histoMappingRFullPtMCScaledToGas;
TH1F*   histoMappingRDataScaledToGasRebin;
TH1F*   histoMappingRMCScaledToGasRebin;
TH1F*   histoMappingDataMCRatioRScaledToGas;
TH1F*   histoMappingRFullPtDataScaledToGasRebin;
TH1F*   histoMappingRFullPtMCScaledToGasRebin;
TH1F*   histoMappingDataMCRatioRFullPtScaledToGas;

TH1F*	histoMappingDataMCRatioR;
TH1F*	histoMappingMidPtDataMCRatioR;
...
TH1D*	histoMappingDataMCRatioPhiInR[nBinsR];

TH1D*   histoMappingZInRData[nBinsR];
TH1D*   histoMappingZInRMC[nBinsR];
TH1D*	histoMappingDataMCRatioZInR[nBinsR];
