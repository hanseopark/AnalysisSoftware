...
void CalculateRAA(TString fileName = "myOutput", TString cutSel = "",TString fileNamepp = "CombinedResultsPaperX.root", TString suffix = "gif", TString textMeson = "Pi0" ,TString makeBinShiftWithFunction = "", TString option = "", TString multFlag= "",Bool_t optNoBinShift=kFALSE, TString fileName2 = "", Int_t mode = 9){
    ...
    if (centralityString.CompareTo("0-10%") == 0 ){
        fileNameSysErr = Form("SystematicErrorsCalculatedGammaPbPb_LHC11h_2017_07_28/SystematicErrorAveraged_%s_PbPb_2.76TeV0010_2017_07_28.dat", textMeson.Data());
    } else if (centralityString.CompareTo("0-5%") == 0){
        fileNameSysErr = Form("SystematicErrorsCalculatedGammaPbPb_LHC11h_2017_07_28/SystematicErrorAveraged_%s_PbPb_2.76TeV0005_2017_07_28.dat", textMeson.Data());
    } else if (centralityString.CompareTo("5-10%") == 0){
        fileNameSysErr = Form("SystematicErrorsCalculatedGammaPbPb_LHC11h_2017_07_28/SystematicErrorAveraged_%s_PbPb_2.76TeV0510_2017_07_28.dat", textMeson.Data());
    } else if (centralityString.CompareTo("20-40%") == 0){
        fileNameSysErr = Form("SystematicErrorsCalculatedGammaPbPb_LHC11h_2017_07_28/SystematicErrorAveraged_%s_PbPb_2.76TeV2040_2017_07_28.dat", textMeson.Data());
    }else if (centralityString.CompareTo("20-50%") == 0){
        fileNameSysErr = Form("SystematicErrorsCalculatedGammaPbPb_LHC11h_2017_07_28/SystematicErrorAveraged_%s_PbPb_2.76TeV2050_2017_07_28.dat", textMeson.Data());
    } else {
...
//     }
	...
	if (fileName2.CompareTo("")!=0 && textMeson.CompareTo("Eta")==0){
        ...
        if (centralityString.CompareTo("0-10%") == 0 ){
            fileNameSysErrPi0EtaBinning = "SystematicErrorsCalculatedGammaPbPb_LHC11h_2017_07_28/SystematicErrorAveraged_EtaToPi0_PbPb_2.76TeV0010_2017_07_28.dat";
        } else if (centralityString.CompareTo("0-5%") == 0){
            fileNameSysErrPi0EtaBinning = "SystematicErrorsCalculatedGammaPbPb_LHC11h_2017_07_28/SystematicErrorAveraged_EtaToPi0_PbPb_2.76TeV0005_2017_07_28.dat";
        } else if (centralityString.CompareTo("5-10%") == 0){
            fileNameSysErrPi0EtaBinning = "SystematicErrorsCalculatedGammaPbPb_LHC11h_2017_07_28/SystematicErrorAveraged_EtaToPi0_PbPb_2.76TeV0510_2017_07_28.dat";
        } else if (centralityString.CompareTo("20-40%") == 0){
            fileNameSysErrPi0EtaBinning = "SystematicErrorsCalculatedGammaPbPb_LHC11h_2017_07_28/SystematicErrorAveraged_EtaToPi0_PbPb_2.76TeV2040_2017_07_28.dat";
        }else if (centralityString.CompareTo("20-50%") == 0){
            fileNameSysErrPi0EtaBinning = "SystematicErrorsCalculatedGammaPbPb_LHC11h_2017_07_28/SystematicErrorAveraged_EtaToPi0_PbPb_2.76TeV2050_2017_07_28.dat";
        } else {
        ...
        if (centralityString.CompareTo("0-10%") == 0 ){
            fileNameSysErrPi0EtaBinningFromEta = Form("SystematicErrorsCalculatedGammaPbPb_LHC11h_2017_07_28/SystematicErrorAveraged_%s_PbPb_2.76TeV0010_2017_07_28.dat", textMeson.Data());
        } else if (centralityString.CompareTo("0-5%") == 0){
            fileNameSysErrPi0EtaBinningFromEta = Form("SystematicErrorsCalculatedGammaPbPb_LHC11h_2017_07_28/SystematicErrorAveraged_%s_PbPb_2.76TeV0005_2017_07_28.dat", textMeson.Data());
        } else if (centralityString.CompareTo("5-10%") == 0){
            fileNameSysErrPi0EtaBinningFromEta = Form("SystematicErrorsCalculatedGammaPbPb_LHC11h_2017_07_28/SystematicErrorAveraged_%s_PbPb_2.76TeV0510_2017_07_28.dat", textMeson.Data());
        } else if (centralityString.CompareTo("20-40%") == 0){
            fileNameSysErrPi0EtaBinningFromEta = Form("SystematicErrorsCalculatedGammaPbPb_LHC11h_2017_07_28/SystematicErrorAveraged_%s_PbPb_2.76TeV2040_2017_07_28.dat", textMeson.Data());
            }else if (centralityString.CompareTo("20-50%") == 0){
            fileNameSysErrPi0EtaBinningFromEta = Form("SystematicErrorsCalculatedGammaPbPb_LHC11h_2017_07_28/SystematicErrorAveraged_%s_PbPb_2.76TeV2050_2017_07_28.dat", textMeson.Data());
        } else {
