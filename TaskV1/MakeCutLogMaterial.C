...
void MakeCutLogMaterial(const char *inputRootFile = "AnalysisResults.root", const char *InputName= "CutSelection.log",Int_t mode = 1){
  ...
  TString nameOutputDir = "GammaConvMaterial";
  ...
  if( mode ==  6 || mode == 7 ){
    ...
    nameOutputDir = "GammaConvMaterial";
