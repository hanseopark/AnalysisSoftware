...
void GammaCutStudiesV3(TString cutFile = "CombineCuts.dat",TString energy="",TString cutVariationName ="",TString suffix = "eps", Int_t mode = 9){
    ...
    if(!cutVariationName.CompareTo("8TeVPeriods")){
        ...
        specialString[6]="LHC12h";
        specialString[7]="LHC12i";
    }
    if(!cutVariationName.CompareTo("PileupDCA")){
        specialString[0]="std";
        specialString[1]="DCAvar1";
        specialString[2]="DCAvar2";
    ...
    for(Int_t i = 0; i<number; i++){
        ...
        if (cutVariationName.Contains("SpecialTrigg")){
            ...
            cutStringsName[i] = AnalyseSpecialTriggerCut(CutNumberToInteger(fTrigger));
        ...
        if(!cutVariationName.CompareTo("Cocktail")||!cutVariationName.CompareTo("7TeVPeriods")||!cutVariationName.CompareTo("8TeVPeriods")||!cutVariationName.CompareTo("PileupDCA")){
        ...
        if (haveOutputGammaToPi0){
            ...
            SetHistogramm(histoPi0SpectrumRatio[i],"#it{p}_{T} (GeV/c)","Ratios of #pi^{0} Spectra",0.8,1.2);
//missing
            ...
            */
            ...
            SetHistogramm(histoIncGammaToPi0RatioFitRatio[i],"#it{p}_{T} (GeV/c)","Ratios of #gamma/#pi^{0}_{Fit} Ratios",0.8,1.2);

            histoDR[i] = (TH1D*) fileCurrentFinal[i]->Get("DoubleRatioTrueEffPurity");
            if(i > 0 && cutVariationName.Contains("IntRange")) histoDR[i] = (TH1D*) fileCurrentFinal[i]->Get(Form("DoubleRatioTrueEffPurity%s",nameIntRanges[i].Data()));
            if(i == 1 && cutVariationName.CompareTo("CocktailEta") == 0) histoDR[i] = (TH1D*) fileCurrentFinal[i]->Get("DoubleRatioTrueEffPurityHigh");
            if(i == 2 && cutVariationName.CompareTo("CocktailEta") == 0) histoDR[i] = (TH1D*) fileCurrentFinal[i]->Get("DoubleRatioTrueEffPurityLow");
            if(i == 1 && cutVariationName.CompareTo("CocktailEtaNorm") == 0) histoDR[i] = (TH1D*) fileCurrentFinal[i]->Get("DoubleRatioTrueEffPurityEtaHigh");
            if(i == 2 && cutVariationName.CompareTo("CocktailEtaNorm") == 0) histoDR[i] = (TH1D*) fileCurrentFinal[i]->Get("DoubleRatioTrueEffPurityEtaLow");
            if(i == 1 && cutVariationName.Contains("CocktailParam")) histoDR[i] = (TH1D*) fileCurrentFinal[i]->Get("DoubleRatioTrueEffPurityModA");
            ...
            if(i == 1 && cutVariationName.CompareTo("CocktailEta") == 0) histoDRFit[i] = (TH1D*) fileCurrentFinal[i]->Get("DoubleRatioFitPurityHigh");
            if(i == 2 && cutVariationName.CompareTo("CocktailEta") == 0) histoDRFit[i] = (TH1D*) fileCurrentFinal[i]->Get("DoubleRatioFitPurityLow");
            if(i == 1 && cutVariationName.CompareTo("CocktailEtaNorm") == 0) histoDRFit[i] = (TH1D*) fileCurrentFinal[i]->Get("DoubleRatioFitPurityEtaHigh");
            if(i == 2 && cutVariationName.CompareTo("CocktailEtaNorm") == 0) histoDRFit[i] = (TH1D*) fileCurrentFinal[i]->Get("DoubleRatioFitPurityEtaLow");
            if(i == 1 && cutVariationName.Contains("CocktailParam")) histoDRFit[i] = (TH1D*) fileCurrentFinal[i]->Get("DoubleRatioFitPurityModA");
            if(i == 2 && cutVariationName.Contains("CocktailParam")) histoDRFit[i] = (TH1D*) fileCurrentFinal[i]->Get("DoubleRatioFitPurityModB");
