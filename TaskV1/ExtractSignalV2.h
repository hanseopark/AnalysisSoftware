...
TString     ObjectNameMCHeavyMesonAcc                                   = "";
TString     ObjectNameMCHeavyMesonAccWOWeights                          = "";
TString     ObjectNameMCHeavyMesonAccWOEvtWeights                       = "";
...
TString     ObjectNameMCHeavyMeson                                      = "";
TString     ObjectNameMCHeavyMesonWOWeights                             = "";
TString     ObjectNameMCHeavyMesonWOEvtWeights                          = "";
...
Double_t*    fMesonLambdaTailRangeNominal                               = NULL;
Double_t*    fMesonLambdaTailRangeMC                                    = NULL;
...
Double_t*   fMesonTrueSigmapar                                          = NULL;
Double_t*   fMesonTrueSigmaparError                                     = NULL;
...
TH1D*       fHistoTrueLambdaTail                                        = NULL;
TH1D*       fHistoAmplitude                                             = NULL;
TH1D*       fHistoSigma                                                 = NULL;
TH1D*       fHistoTrueSigma                                             = NULL;
...
void InitializeWindows(TString setPi0, Int_t mode, TString trigger, Int_t triggerSet = -1){
    ...
    //****************************************************************************************************
        ...
        fPeakRange[0]                   = 0.86;
        fPeakRange[1]                   = 1.06;
        fIntFixedRange[0]               = 0.75;
        fIntFixedRange[1]               = 1.1;
        fFitRange[0]                    = 0.75;
        fFitRange[1]                    = 1.1;
        fBGFitRange[0]                  = 1.07;
        fBGFitRange[1]                  = 1.17;
        fBGFitRangeLeft[0]              = 0.75;
        fBGFitRangeLeft[1]              = 0.8;
        fMesonPlotRange[0]              = 0.71;
        fMesonPlotRange[1]              = 1.1;
        ...
        fMesonMassPlotRange[0]          = 0.71;
        fMesonMassPlotRange[1]          = 1.17;;
