...
TGraphErrors*      graphAlpha;
TGraphErrors**     graphPtvsSqrts; 
TGraphErrors**     gPtvsEnergiesSystem;
TF1**		   fPowerlawSystem;
...
enum{kDalitz,kPCM,kPHOS,kEMCal,kPion,kKaon,kProton,kNAna};
