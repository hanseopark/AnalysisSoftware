...
void CombineGammaResultsPP8TeV(     TString inputFileNamePCM           = "CombinationInputGammaPP/InputPCMGammapp8000GeV.root",
    ...
    TString outputDir                                           = Form("%s/%s/CombineGammaMeasurementspp8TeV",suffix.Data(),dateForOutput.Data());
...
//  incRatio[0]         = 0.0;      incRatio[1]         = 1.7;
    ...
    TDirectory* directoryPCMGammapp8TeV          = (TDirectory*)filePCMGammapp8TeV->Get("Gamma_pp8TeV");
        ...
        histoDRStatErr[0]                               = (TH1D*) directoryPCMGammapp8TeV->Get("DoubleRatioStatError");
        graphDRSysErr[0]                                = (TGraphAsymmErrors*) directoryPCMGammapp8TeV->Get("DoubleRatioSystError");
        histoIncGammaRatioStatErr[0]                    = (TH1D*) directoryPCMGammapp8TeV->Get("IncRatioStatError");
        graphIncGammaRatioSysErr[0]                     = (TGraphAsymmErrors*) directoryPCMGammapp8TeV->Get("IncRatioSystError");
        ...
        histoIncGammaStatErr[0]                         = (TH1D*) directoryPCMGammapp8TeV->Get("IncGammaStatError");
        graphIncGammaSysErr[0]                          = (TGraphAsymmErrors*) directoryPCMGammapp8TeV->Get("IncGammaSystError");
...
//             for (Int_t i = 0; i < graphDRPi0FitSysErr[4]->GetN(); i++){
//                 graphDRPi0FitSysErr[4]->SetPointError( i, graphDRPi0FitSysErr[4]->GetEXlow()[i], graphDRPi0FitSysErr[4]->GetEXhigh()[i],
//                                                        graphDRPi0FitSysErr[4]->GetEYlow()[i]*1.5, graphDRPi0FitSysErr[4]->GetEYlow()[i]*1.5 );
//             }
            histoDRStatErr[4]                         = (TH1D*) directoryPCMEMCGammapp8TeV->Get("DoubleRatioStatError");
            graphDRSysErr[4]                          = (TGraphAsymmErrors*) directoryPCMEMCGammapp8TeV->Get("DoubleRatioSystError");
//             for (Int_t i = 0; i < graphDRSysErr[4]->GetN(); i++){
//                 graphDRSysErr[4]->SetPointError( i, graphDRSysErr[4]->GetEXlow()[i], graphDRSysErr[4]->GetEXhigh()[i],
//                                                  graphDRSysErr[4]->GetEYlow()[i]*1.5, graphDRSysErr[4]->GetEYlow()[i]*1.5 );
//             }
            histoIncGammaRatioStatErr[4]                    = (TH1D*) directoryPCMEMCGammapp8TeV->Get("IncRatioStatError");
            graphIncGammaRatioSysErr[4]                     = (TGraphAsymmErrors*) directoryPCMEMCGammapp8TeV->Get("IncRatioSystError");
//             for (Int_t i = 0; i < graphIncGammaRatioSysErr[4]->GetN(); i++){
//                 graphIncGammaRatioSysErr[4]->SetPointError( i, graphIncGammaRatioSysErr[4]->GetEXlow()[i], graphIncGammaRatioSysErr[4]->GetEXhigh()[i],
//                                                             graphIncGammaRatioSysErr[4]->GetEYlow()[i]*1.5, graphIncGammaRatioSysErr[4]->GetEYlow()[i]*1.5 );
//             }
            ...
            histoIncGammaStatErr[4]                         = (TH1D*) directoryPCMEMCGammapp8TeV->Get("IncGammaStatError");
            graphIncGammaSysErr[4]                          = (TGraphAsymmErrors*) directoryPCMEMCGammapp8TeV->Get("IncGammaSystError");
//             for (Int_t i = 0; i < graphIncGammaSysErr[4]->GetN(); i++){
//                 graphIncGammaSysErr[4]->SetPointError( i, graphIncGammaSysErr[4]->GetEXlow()[i], graphIncGammaSysErr[4]->GetEXhigh()[i],
//                                                        graphIncGammaSysErr[4]->GetEYlow()[i]*1.5, graphIncGammaSysErr[4]->GetEYlow()[i]*1.5 );
//             }
        ...
        // TDirectory* directoryPCMEMCCocktailpp8TeV       = (TDirectory*)fileCocktailGamma8TeV->Get("8TeV_PCMEMCal");
        //     for(Int_t i=0;i<14;i++){
        //       histoGammaFractionsCocktail[i][4]                 = (TH1D*) directoryPCMEMCCocktailpp8TeV->Get(Form("Gamma_From_%s_Pt_OrBin_RatioToAll",fParticle[i].Data()));
        ...
        //     }
            // for(Int_t i=0;i<14;i++){
            //   if(i==5||i==8)
            //     histoGammaFractionsCocktailPartialSums[i][4]->Add(histoGammaFractionsCocktail[i+1][4]);
            //   if(i==6||i==9)
...
//             for (Int_t i = 0; i < graphDRPi0FitSysErr[2]->GetN(); i++){
//                 graphDRPi0FitSysErr[2]->SetPointError( i, graphDRPi0FitSysErr[2]->GetEXlow()[i], graphDRPi0FitSysErr[2]->GetEXhigh()[i],
//                                                        graphDRPi0FitSysErr[2]->GetEYlow()[i]*1.5, graphDRPi0FitSysErr[2]->GetEYlow()[i]*1.5 );
//             }
            histoDRStatErr[2]                         = (TH1D*) directoryEMCGammapp8TeV->Get("DoubleRatioStatError");
            graphDRSysErr[2]                          = (TGraphAsymmErrors*) directoryEMCGammapp8TeV->Get("DoubleRatioSystError");
//             for (Int_t i = 0; i < graphDRSysErr[2]->GetN(); i++){
//                 graphDRSysErr[2]->SetPointError( i, graphDRSysErr[2]->GetEXlow()[i], graphDRSysErr[2]->GetEXhigh()[i],
//                                                  graphDRSysErr[2]->GetEYlow()[i]*1.5, graphDRSysErr[2]->GetEYlow()[i]*1.5 );
//             }
            histoIncGammaRatioStatErr[2]                    = (TH1D*) directoryEMCGammapp8TeV->Get("IncRatioStatError");
            graphIncGammaRatioSysErr[2]                     = (TGraphAsymmErrors*) directoryEMCGammapp8TeV->Get("IncRatioSystError");
//             for (Int_t i = 0; i < graphIncGammaRatioSysErr[2]->GetN(); i++){
//                 graphIncGammaRatioSysErr[2]->SetPointError( i, graphIncGammaRatioSysErr[2]->GetEXlow()[i], graphIncGammaRatioSysErr[2]->GetEXhigh()[i],
//                                                             graphIncGammaRatioSysErr[2]->GetEYlow()[i]*1.5, graphIncGammaRatioSysErr[2]->GetEYlow()[i]*1.5 );
//             }
            ...
            histoIncGammaStatErr[2]                         = (TH1D*) directoryEMCGammapp8TeV->Get("IncGammaStatError");
            graphIncGammaSysErr[2]                          = (TGraphAsymmErrors*) directoryEMCGammapp8TeV->Get("IncGammaSystError");
//             for (Int_t i = 0; i < graphIncGammaSysErr[2]->GetN(); i++){
//                 graphIncGammaSysErr[2]->SetPointError( i, graphIncGammaSysErr[2]->GetEXlow()[i], graphIncGammaSysErr[2]->GetEXhigh()[i],
//                                                        graphIncGammaSysErr[2]->GetEYlow()[i]*1.5, graphIncGammaSysErr[2]->GetEYlow()[i]*1.5 );
//             }
    ...
    TFile* fileTheory                               = new TFile( fileNameTheorypp8TeV.Data());
        ...
        // TGraph* graphTheoryNLODRpp8TeVPaquettCenter  = (TGraph*) fileTheory->Get("DirectPhoton/graphDRNLOPaquett_2760GeV_ALICECocktail");
        // TGraph* graphTheoryNLOpp8TeVPaquettCenter    = (TGraph*) fileTheory->Get("DirectPhoton/graphNLOPaquett_2760GeV");
...
//     }
    ...
    TLatex *labelRatioToFitEnergy   = new TLatex(0.95, 0.92, collisionSystempp8TeV.Data());
    ...
    // purely calculating points based on all Systematic errors
    TGraphAsymmErrors *graphCombDirGammaNonFitSpectrumSystErr = CalculateDirectPhotonPointsAndUpperLimits(histoCombDirGammaNonFitSpectrumErrSys,histoCombDirGammaSpecNonFitStatErr,0,0.5);
    ...
    // purely calculating points based on Statistical errors
    TGraphAsymmErrors *graphCombDirGammaNonFitSpectrumStatErr = CalculateDirectPhotonPointsAndUpperLimits(histoCombDirGammaNonFitSpectrumErrStat,histoCombDirGammaSpecNonFitStatErr,0,0.5);
    ...
    // purely calculating points based on all Systematic + Statistical errors
    TGraphAsymmErrors *graphCombDirGammaNonFitSpectrumSumErr = CalculateDirectPhotonPointsAndUpperLimits(histoCombDirGammaNonFitSpectrumErrSum,histoCombDirGammaSpecNonFitStatErr,0,0.5);
    ...
    // calculate points above confidence level summed errors
    TGraphAsymmErrors *graphCombDirGammaNonFitSpectrumSumErrConfi = CalculateDirectPhotonPointsAndUpperLimits(histoCombDirGammaNonFitSpectrumErrSum,histoCombDirGammaSpecNonFitStatErr,2,0.5);
    ...
    // calculate arrows for points with 0, error summed
    TGraphAsymmErrors *graphCombDirGammaNonFitSpectrumSumErrAr = CalculateDirectPhotonPointsAndUpperLimits(histoCombDirGammaNonFitSpectrumErrSum,histoCombDirGammaSpecNonFitStatErr,5,0.5);
    ...
    hist2DDRDummySingle->DrawCopy();
        ...
        TLatex *labelDRSingle = new TLatex(0.95,0.92,collisionSystempp8TeV.Data());
    ...
    hist2DDRDummySingle->DrawCopy();
        ...
        legendDRSingle = GetAndSetLegend2(0.12,0.953-textSizeSinglePad*2,0.5,0.953, textSizeSinglePad, 2, "", 42, 0.3);
        legendDRSingle->SetTextAlign(11);
        DrawGammaLines(doubleRatioXpp[0], doubleRatioXpp[1], 1., 1., 1.2, kGray+2, 7);
        for (Int_t i = 10; i > -1; i--){
            if (graphDRSysErr[i]){
                ...
                legendDRSingle->AddEntry(graphDRSysErr[i],nameMeasGlobalLabel[i],"pf");
            ...
            if (histoDRStatErr[i]){
                ...
                if (!graphDRSysErr[i])legendDRSingle->AddEntry(histoDRStatErr[i],nameMeasGlobalLabel[i],"p");
            }
        }
...
//         legendDRComb->Draw();
    ...
    canvasDoubleRatio->Print(Form("%s/DR_Comb_NonFit_pp8TeV.pdf", outputDir.Data()));
        ...
        TLegend* legendDRTheoryComb2 = GetAndSetLegend2(0.12,0.96-textSizeSinglePad*3,0.5,0.96-textSizeSinglePad*1, textSizeSinglePad, 1, "NLO pQCD:", 42, 0.15);
        ...
        if (graphTheoryNLODRpp8TeV) {
            ...
            legendDRTheoryComb2->AddEntry(graphTheoryNLODRpp8TeV,"PDF: CT10, FF: GRV","f");
        }
        ...
        // if (graphTheoryNLODRpp8TeVPaquettCenter){
        //     DrawGammaNLOTGraph( graphTheoryNLODRpp8TeVPaquettCenter, 2, styleLineMcGill, colorNLOMcGill );
        //     graphTheoryNLODRpp8TeVPaquettCenter->RemovePoint(0);
        //     graphTheoryNLODRpp8TeVPaquettCenter->Draw("lc,same");
        //     legendDRTheoryComb2->AddEntry(graphTheoryNLODRpp8TeVPaquettCenter,"PDF: CTEQ6.1M, FF: BFG2","l");
        // }
        DrawGammaLines(doubleRatioXpp[0], doubleRatioXpp[1], 1., 1., 1.2, kGray+2, 7);
        ...
        DrawGammaLines(0.3, 0.35, 1.492, 1.492, 2, kAzure+2, 7);
    ...
    canvasDoubleRatio->Print(Form("%s/DR_CombAndTheory_pp8TeV.pdf", outputDir.Data()));
        ...
        legendDRTheoryComb->SetTextAlign(11);
        legendDRTheoryComb2 = GetAndSetLegend2(0.12,0.96-textSizeSinglePad*3,0.5,0.96-textSizeSinglePad*1, textSizeSinglePad, 1, "NLO pQCD:", 42, 0.15);
        legendDRTheoryComb2->SetTextAlign(11);

        DrawGammaSetMarkerTGraphAsym(graphCombDRNonFitSys, markerStyleCombpp8TeV, markerSizeCombpp8TeV, colorCombpp8TeV , colorCombpp8TeV,widthLinesBoxes, kTRUE);
        DrawGammaSetMarkerTGraphAsym(graphCombDRNonFitStatPlot, markerStyleCombpp8TeV, markerSizeCombpp8TeV, colorCombpp8TeV , colorCombpp8TeV, widthLinesBoxes);
        legendDRTheoryComb->AddEntry(graphCombDRNonFitSys,"ALICE","pf");
        ...
        // if (graphTheoryNLODRpp8TeVPaquettCenter){
        //     DrawGammaNLOTGraph( graphTheoryNLODRpp8TeVPaquettCenter, 2, styleLineMcGill, colorNLOMcGill );
        //     graphTheoryNLODRpp8TeVPaquettCenter->RemovePoint(0);NonFit
        //     graphTheoryNLODRpp8TeVPaquettCenter->Draw("lc,same");
        //     legendDRTheoryComb2->AddEntry(graphTheoryNLODRpp8TeVPaquettCenter,"PDF: CTEQ6.1M, FF: BFG2","l");
        // }
        DrawGammaLines(doubleRatioXpp[0], doubleRatioXpp[1], 1., 1., 1.2, kGray+2, 7);
...
//     canvasResolCor->SetLogy(1);
    ...
    histo2DYieldGamma->Draw("copy");
        ...
        TLatex *labelEnergyDGInvYieldPaperAll = new TLatex(0.94, 0.965-0.04*1, collisionSystempp8TeV.Data());
    ...
    histo2DYieldGamma->Draw("copy");
        ...
        dummyForLegend->SetPoint(0,6.2,0.02);
    ...
    histo2DYieldGamma->Draw("copy");
        ...
        dummyForLegend    = new TGraphAsymmErrors(1);
        dummyForLegend->SetPoint(0,6.2,0.02);
        dummyForLegend->SetPointError(0,0,0,0.009,0);
        DrawGammaSetMarkerTGraphAsym(dummyForLegend , 1, 3, colorCombpp8TeV, colorCombpp8TeV, 1.8, kTRUE);
        if (graphCombDirGammaNonFitSpectrumSumErrAr){
    ...
    TLegend* legendYieldDirGammaTheo2      = GetAndSetLegend2(0.20, 0.11, 0.5, 0.11+(2*textSizeLabelsRel*0.85),textSizeLabelsPixel,1, "#gamma_{dir} NLO pQCD:", 43, 0.23);
    ...
    graphCombIncGammaStatPlot->Draw("Epsame");
        ...
        // if (graphTheoryNLOpp8TeVPaquettCenter) {
        //     DrawGammaNLOTGraph( graphTheoryNLOpp8TeVPaquettCenter, 2, styleLineMcGill, colorNLOMcGill );
        //     graphTheoryNLOpp8TeVPaquettCenter->RemovePoint(0);
        //     graphTheoryNLOpp8TeVPaquettCenter->Draw("lc,same");
        //     legendYieldDirGammaTheo2->AddEntry(graphTheoryNLOpp8TeVPaquettCenter,"PDF: CTEQ6.1M, FF: BFG2","l");
        // }
    ...
    legendYieldDirGammaTheo2      = GetAndSetLegend2(0.20, 0.11, 0.5, 0.11+(2*textSizeLabelsRel*0.85),textSizeLabelsPixel,1, "#gamma_{dir} NLO pQCD:", 43, 0.23);
    legendYieldDirGammaTheo2->SetTextAlign(12);
    graphCombIncGammaSys->Draw("E2same");
    graphCombIncGammaStatPlot->Draw("Epsame");
