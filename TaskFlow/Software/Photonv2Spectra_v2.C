...
void Photonv2Spectra_v2(
  ...
  if(Trainconfig == 55 || Trainconfig == 58 || Trainconfig == 59 || Trainconfig == 81 || Trainconfig == 82){
    ...
    directoryQaRedo = Form("SPVZEROQa_in_%s%scc_tC%i_v2%sSPv2Qa_%s",CentralityLow.Data(),CentralityHigh.Data(),Trainconfig,AdditionalDirName.Data(),CutNumber.Data());
    directoryQbRedo= Form("SPVZEROQb_in_%s%scc_tC%i_v2%sSPv2Qb_%s",CentralityLow.Data(),CentralityHigh.Data(),Trainconfig,AdditionalDirName.Data(),CutNumber.Data());
  }
