...
void  InclusivePhotonFlowCorrection(  Int_t Trainconfig = 55,
  ...
  TString InputFileNameUncorrected  = Form("/home/mike/0_directphoton/0_analysis/160714_PbPb_systematics/Results_%s/InclusivePhotonv2_uncorrected_%s.root",Cutnumber.Data(),Cutnumber.Data());
  TString InputFileNameBackground   = Form("/home/mike/0_directphoton/0_analysis/160714_PbPb_systematics/Results_%s/v2_background_%s%s_%s.root",Cutnumber.Data(),CentralityLow.Data(),CentralityHigh.Data(),Cutnumber.Data());
