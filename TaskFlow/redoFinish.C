...
// TString mergedFileName = "GammaConvFlow_45.root";
// Final output file name holding correct final results for large statistics sample:
// TString outputFileName = "AnalysisResults45.root";

Bool_t bApplyCorrectionForNUA = kTRUE; // apply correction for non-uniform acceptance
