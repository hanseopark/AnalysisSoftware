...
void BuildHistogramsForGammaQAFlowV1( TString fileName 				= "GammaConvV1_QA_5460001022092970003190000000.root", 
  ...
  if (!fGammaDir) cout << "directory not found" << endl;
	TList* mainList 				= NULL;
	if (fGammaDir){
	...
	TH3F* histonSigdEdxElnSigdEdxPosGammaKind	= NULL; // new sep 15 2015
	TH3F* histonSigdEdxElnSigdEdxPosGammaPKind00		= NULL; // Kind = 0,3,4,5,10
	TH3F* histonSigdEdxElnSigdEdxPosGammaPKind01		= NULL; // Kind = 1
	TH3F* histonSigdEdxElnSigdEdxPosGammaPKind02		= NULL; // Kind = 2
	TH3F* histonSigdEdxElnSigdEdxPosGammaPKind09		= NULL; // Kind = 9
	TH3F* histonSigdEdxElnSigdEdxPosGammaPKind11		= NULL; // Kind = 11
	TH3F* histonSigdEdxElnSigdEdxPosGammaPKind12		= NULL; // Kind = 12
	TH3F* histonSigdEdxElnSigdEdxPosGammaPKind13		= NULL; // Kind = 13
	TH3F* histonSigdEdxElnSigdEdxPosGammaPKind14		= NULL; // Kind = 14
	TH3F* histonSigdEdxElnSigdEdxPosGammaPKind15		= NULL; // Kind = 15
	TH3F* histonSigdEdxElnSigdEdxPosGammaPKind16		= NULL; // Kind = 16
	TH3F* histonSigdEdxElnSigdEdxPosGammaPKind17		= NULL; // Kind = 17
	TH3F* histonSigdEdxElnSigdEdxPosGammaPKind18		= NULL; // Kind = 18
	TH3F* histonSigdEdxElnSigdEdxPosGammaPKindBkg		= NULL; // Kind != 0,3,4,5,10
	TH3F* histonSigdEdxElnSigdEdxPosGammaPKindBkg2		= NULL; // Kind != 0,3,4,5,10,11,13
	//
	TH3F* histoInvMassKappaPKind00    = NULL; // Kind = 0,3,4,5,10
  TH3F* histoInvMassKappaPKind02    = NULL; // Kind = 2
  TH3F* histoInvMassKappaPKind11    = NULL; // Kind = 11
  TH3F* histoInvMassKappaPKind12    = NULL; // Kind = 12
  TH3F* histoInvMassKappaPKind13    = NULL; // Kind = 13
  TH3F* histoInvMassKappaPKind14    = NULL; // Kind = 14
  TH3F* histoInvMassKappaPKind16    = NULL; // Kind = 16
  TH3F* histoInvMassKappaPKind17    = NULL; // Kind = 17
  TH3F* histoInvMassKappaPKind18    = NULL; // Kind = 18
  TH3F* histoInvMassKappaPKindBkg   = NULL; // Kind != 0,3,4,5,10
	TH3F* histoInvMassKappaKind                     = NULL;
  //
	//2D
	TH2F* histonSigdEdxElnSigdEdxPosGammaPReduced			= NULL;
	TH2F* histonSigdEdxElnSigdEdxPosGammaKindReduced		= NULL;
	TH2F* histonSigdEdxElnSigdEdxPosGammaPKind00Reduced		= NULL; // Kind = 0,3,4,5,10
	TH2F* histonSigdEdxElnSigdEdxPosGammaPKind01Reduced		= NULL; // Kind = 1
	TH2F* histonSigdEdxElnSigdEdxPosGammaPKind02Reduced		= NULL; // Kind = 2
	TH2F* histonSigdEdxElnSigdEdxPosGammaPKind09Reduced		= NULL; // Kind = 9
	TH2F* histonSigdEdxElnSigdEdxPosGammaPKind11Reduced		= NULL; // Kind = 11
	TH2F* histonSigdEdxElnSigdEdxPosGammaPKind12Reduced		= NULL; // Kind = 12
	TH2F* histonSigdEdxElnSigdEdxPosGammaPKind13Reduced		= NULL; // Kind = 13
	TH2F* histonSigdEdxElnSigdEdxPosGammaPKind14Reduced		= NULL; // Kind = 14
	TH2F* histonSigdEdxElnSigdEdxPosGammaPKind15Reduced		= NULL; // Kind = 15
	TH2F* histonSigdEdxElnSigdEdxPosGammaPKind16Reduced		= NULL; // Kind = 16
	TH2F* histonSigdEdxElnSigdEdxPosGammaPKind17Reduced		= NULL; // Kind = 17
	TH2F* histonSigdEdxElnSigdEdxPosGammaPKind18Reduced		= NULL; // Kind = 18
	TH2F* histonSigdEdxElnSigdEdxPosGammaPKindBkgReduced		= NULL; // Kind != 0,3,4,5,10
	TH2F* histonSigdEdxElnSigdEdxPosGammaPKindBkg2Reduced		= NULL; // Kind != 0,3,4,5,10,11,13
	TH2F* histoInvMassPKind00Reduced = NULL;
  TH2F* histoInvMassPKind11Reduced = NULL;
  TH2F* histoInvMassPKind13Reduced = NULL;
  TH2F* histoInvMassPKindBkg2Reduced = NULL;
	TH2F* histoInvMassKappa = NULL;
	//
	...
	TH2F* histoGammaInvMassGammaKind				= NULL;
	...
	if (!merge || directoryConv==0) {   
		...
		histonSigdEdxElnSigdEdxPosGammaKind		= new TH3F("histonSigdEdxElnSigdEdxPosGammaKind","", nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, 20, 0, 20); // new sep 15 2015
		histonSigdEdxElnSigdEdxPosGammaPKind00 		= new TH3F("histonSigdEdxElnSigdEdxPosGammaPKind00","", nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
		histonSigdEdxElnSigdEdxPosGammaPKind01 		= new TH3F("histonSigdEdxElnSigdEdxPosGammaPKind01","", nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
		histonSigdEdxElnSigdEdxPosGammaPKind02 		= new TH3F("histonSigdEdxElnSigdEdxPosGammaPKind02","", nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
		histonSigdEdxElnSigdEdxPosGammaPKind09 		= new TH3F("histonSigdEdxElnSigdEdxPosGammaPKind09","", nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
		histonSigdEdxElnSigdEdxPosGammaPKind11 		= new TH3F("histonSigdEdxElnSigdEdxPosGammaPKind11","", nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
		histonSigdEdxElnSigdEdxPosGammaPKind12 		= new TH3F("histonSigdEdxElnSigdEdxPosGammaPKind12","", nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
		histonSigdEdxElnSigdEdxPosGammaPKind13 		= new TH3F("histonSigdEdxElnSigdEdxPosGammaPKind13","", nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
		histonSigdEdxElnSigdEdxPosGammaPKind14 		= new TH3F("histonSigdEdxElnSigdEdxPosGammaPKind14","", nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
		histonSigdEdxElnSigdEdxPosGammaPKind15 		= new TH3F("histonSigdEdxElnSigdEdxPosGammaPKind15","", nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
		histonSigdEdxElnSigdEdxPosGammaPKind16 		= new TH3F("histonSigdEdxElnSigdEdxPosGammaPKind16","", nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
		histonSigdEdxElnSigdEdxPosGammaPKind17 		= new TH3F("histonSigdEdxElnSigdEdxPosGammaPKind17","", nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
		histonSigdEdxElnSigdEdxPosGammaPKind18 		= new TH3F("histonSigdEdxElnSigdEdxPosGammaPKind18","", nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
		histonSigdEdxElnSigdEdxPosGammaPKindBkg		= new TH3F("histonSigdEdxElnSigdEdxPosGammaPKindBkg","", nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
		histonSigdEdxElnSigdEdxPosGammaPKindBkg2	= new TH3F("histonSigdEdxElnSigdEdxPosGammaPKindBkg2","", nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsSigmaTPC, firstBinSigmaTPC, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
//     //
//     histoInvMassKappaPKind00    = new TH3F("histoInvMassKappaPKind00","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
//     histoInvMassKappaPKind02    = new TH3F("histoInvMassKappaPKind02","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
//     histoInvMassKappaPKind11    = new TH3F("histoInvMassKappaPKind11","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
//     histoInvMassKappaPKind12    = new TH3F("histoInvMassKappaPKind12","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
//     histoInvMassKappaPKind13    = new TH3F("histoInvMassKappaPKind13","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
//     histoInvMassKappaPKind14    = new TH3F("histoInvMassKappaPKind14","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
//     histoInvMassKappaPKind16    = new TH3F("histoInvMassKappaPKind16","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
//     histoInvMassKappaPKind17    = new TH3F("histoInvMassKappaPKind17","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
//     histoInvMassKappaPKind18    = new TH3F("histoInvMassKappaPKind18","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
//     histoInvMassKappaPKindBkg   = new TH3F("histoInvMassKappaPKindBkg","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
//     histoInvMassKappaKind       = new TH3F("histoInvMassKappaKind","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, 0, lastBinSigmaTPC, 20, 0, 20);
// 		//2D
// 		histonSigdEdxElnSigdEdxPosGammaPReduced 		= new TH2F("histonSigdEdxElnSigdEdxPosGammaPReduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
// 		histonSigdEdxElnSigdEdxPosGammaKindReduced		= new TH2F("histonSigdEdxElnSigdEdxPosGammaKindReduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, 20, 0, 20); // new okt 12 2015
// 		histonSigdEdxElnSigdEdxPosGammaPKind00Reduced 		= new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind00Reduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
// 		histonSigdEdxElnSigdEdxPosGammaPKind01Reduced 		= new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind01Reduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
// 		histonSigdEdxElnSigdEdxPosGammaPKind02Reduced 		= new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind02Reduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
// 		histonSigdEdxElnSigdEdxPosGammaPKind09Reduced 		= new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind09Reduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
// 		histonSigdEdxElnSigdEdxPosGammaPKind11Reduced 		= new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind11Reduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
// 		histonSigdEdxElnSigdEdxPosGammaPKind12Reduced 		= new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind12Reduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
// 		histonSigdEdxElnSigdEdxPosGammaPKind13Reduced 		= new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind13Reduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
// 		histonSigdEdxElnSigdEdxPosGammaPKind14Reduced 		= new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind14Reduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
// 		histonSigdEdxElnSigdEdxPosGammaPKind15Reduced 		= new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind15Reduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
// 		histonSigdEdxElnSigdEdxPosGammaPKind16Reduced 		= new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind16Reduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
// 		histonSigdEdxElnSigdEdxPosGammaPKind17Reduced 		= new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind17Reduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
// 		histonSigdEdxElnSigdEdxPosGammaPKind18Reduced 		= new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind18Reduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
// 		histonSigdEdxElnSigdEdxPosGammaPKindBkgReduced		= new TH2F("histonSigdEdxElnSigdEdxPosGammaPKindBkgReduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
// 		histonSigdEdxElnSigdEdxPosGammaPKindBkg2Reduced		= new TH2F("histonSigdEdxElnSigdEdxPosGammaPKindBkg2Reduced","", nBinsSigmaTPC, 0, lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    
    //
    
    Double_t TPCFACTOR = 5;
    histoInvMassKappaPKind00    = new TH3F("histoInvMassKappaPKind00","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histoInvMassKappaPKind02    = new TH3F("histoInvMassKappaPKind02","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histoInvMassKappaPKind11    = new TH3F("histoInvMassKappaPKind11","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histoInvMassKappaPKind12    = new TH3F("histoInvMassKappaPKind12","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histoInvMassKappaPKind13    = new TH3F("histoInvMassKappaPKind13","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histoInvMassKappaPKind14    = new TH3F("histoInvMassKappaPKind14","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histoInvMassKappaPKind16    = new TH3F("histoInvMassKappaPKind16","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histoInvMassKappaPKind17    = new TH3F("histoInvMassKappaPKind17","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histoInvMassKappaPKind18    = new TH3F("histoInvMassKappaPKind18","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histoInvMassKappaPKindBkg   = new TH3F("histoInvMassKappaPKindBkg","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histoInvMassKappaKind       = new TH3F("histoInvMassKappaKind","", nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, 20, 0, 20);
    //2D
    histonSigdEdxElnSigdEdxPosGammaPReduced     = new TH2F("histonSigdEdxElnSigdEdxPosGammaPReduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histonSigdEdxElnSigdEdxPosGammaKindReduced    = new TH2F("histonSigdEdxElnSigdEdxPosGammaKindReduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, 20, 0, 20); // new okt 12 2015
    histonSigdEdxElnSigdEdxPosGammaPKind00Reduced     = new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind00Reduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histonSigdEdxElnSigdEdxPosGammaPKind01Reduced     = new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind01Reduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histonSigdEdxElnSigdEdxPosGammaPKind02Reduced     = new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind02Reduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histonSigdEdxElnSigdEdxPosGammaPKind09Reduced     = new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind09Reduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histonSigdEdxElnSigdEdxPosGammaPKind11Reduced     = new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind11Reduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histonSigdEdxElnSigdEdxPosGammaPKind12Reduced     = new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind12Reduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histonSigdEdxElnSigdEdxPosGammaPKind13Reduced     = new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind13Reduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histonSigdEdxElnSigdEdxPosGammaPKind14Reduced     = new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind14Reduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histonSigdEdxElnSigdEdxPosGammaPKind15Reduced     = new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind15Reduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histonSigdEdxElnSigdEdxPosGammaPKind16Reduced     = new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind16Reduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histonSigdEdxElnSigdEdxPosGammaPKind17Reduced     = new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind17Reduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histonSigdEdxElnSigdEdxPosGammaPKind18Reduced     = new TH2F("histonSigdEdxElnSigdEdxPosGammaPKind18Reduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histonSigdEdxElnSigdEdxPosGammaPKindBkgReduced    = new TH2F("histonSigdEdxElnSigdEdxPosGammaPKindBkgReduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    histonSigdEdxElnSigdEdxPosGammaPKindBkg2Reduced   = new TH2F("histonSigdEdxElnSigdEdxPosGammaPKindBkg2Reduced","", nBinsSigmaTPC, -1*TPCFACTOR*lastBinSigmaTPC, TPCFACTOR*lastBinSigmaTPC, nBinsPt, firstBinPt, lastBinPt);
    
    histoInvMassPKind00Reduced   = new TH2F("histoInvMassPKind00Reduced","",nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsPt, firstBinPt, lastBinPt);
    histoInvMassPKind11Reduced   = new TH2F("histoInvMassPKind11Reduced","",nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsPt, firstBinPt, lastBinPt);
    histoInvMassPKind13Reduced   = new TH2F("histoInvMassPKind13Reduced","",nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsPt, firstBinPt, lastBinPt);
    histoInvMassPKindBkg2Reduced = new TH2F("histoInvMassPKindBkg2Reduced","",nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsPt, firstBinPt, lastBinPt);
		
    histoInvMassKappa     = new TH2F("histoInvMassKappa","",nBinsInvMass, firstBinInvMass, lastBinInvMass, nBinsSigmaTPC, 0, lastBinSigmaTPC);
		...
		histoGammaInvMassGammaKind				= new TH2F("histoGammaInvMassGammaKind","",nBinsInvMass, firstBinInvMass, lastBinInvMass,20, 0, 20);
		...
		histoGammaInvMassGammaKind					= (TH2F*)directoryConv->Get("histoGammaInvMassGammaKind");
		...
		histonSigdEdxElnSigdEdxPosGammaKind		= (TH3F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaKind"); // new sep 15 2015
		histonSigdEdxElnSigdEdxPosGammaPKind00		= (TH3F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind00");
		histonSigdEdxElnSigdEdxPosGammaPKind01		= (TH3F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind01");
		histonSigdEdxElnSigdEdxPosGammaPKind02		= (TH3F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind02");
		histonSigdEdxElnSigdEdxPosGammaPKind09		= (TH3F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind09");
		histonSigdEdxElnSigdEdxPosGammaPKind11		= (TH3F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind11");
		histonSigdEdxElnSigdEdxPosGammaPKind12		= (TH3F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind12");
		histonSigdEdxElnSigdEdxPosGammaPKind13		= (TH3F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind13");
		histonSigdEdxElnSigdEdxPosGammaPKind14		= (TH3F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind14");
		histonSigdEdxElnSigdEdxPosGammaPKind15		= (TH3F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind15");
		histonSigdEdxElnSigdEdxPosGammaPKind16		= (TH3F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind16");
		histonSigdEdxElnSigdEdxPosGammaPKind17		= (TH3F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind17");
		histonSigdEdxElnSigdEdxPosGammaPKind18		= (TH3F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind18");
		histonSigdEdxElnSigdEdxPosGammaPKindBkg		= (TH3F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKindBkg");
		histonSigdEdxElnSigdEdxPosGammaPKindBkg2	= (TH3F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKindBkg2");
    //
    histoInvMassKappaPKind00    = (TH3F*)directoryConv->Get("histoInvMassKappaPKind00");
    histoInvMassKappaPKind02    = (TH3F*)directoryConv->Get("histoInvMassKappaPKind02");
    histoInvMassKappaPKind11    = (TH3F*)directoryConv->Get("histoInvMassKappaPKind11");
    histoInvMassKappaPKind12    = (TH3F*)directoryConv->Get("histoInvMassKappaPKind12");
    histoInvMassKappaPKind13    = (TH3F*)directoryConv->Get("histoInvMassKappaPKind13");
    histoInvMassKappaPKind14    = (TH3F*)directoryConv->Get("histoInvMassKappaPKind14");
    histoInvMassKappaPKind16    = (TH3F*)directoryConv->Get("histoInvMassKappaPKind16");
    histoInvMassKappaPKind17    = (TH3F*)directoryConv->Get("histoInvMassKappaPKind17");
    histoInvMassKappaPKind18    = (TH3F*)directoryConv->Get("histoInvMassKappaPKind18");
    histoInvMassKappaPKindBkg   = (TH3F*)directoryConv->Get("histoInvMassKappaPKindBkg");
    histoInvMassKappaKind       = (TH3F*)directoryConv->Get("histoInvMassKappaKind");
		//2D
		histonSigdEdxElnSigdEdxPosGammaPReduced 		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPReduced");
		histonSigdEdxElnSigdEdxPosGammaKindReduced		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaKindReduced");
		histonSigdEdxElnSigdEdxPosGammaPKind00Reduced		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind00Reduced");
		histonSigdEdxElnSigdEdxPosGammaPKind01Reduced		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind01Reduced");
		histonSigdEdxElnSigdEdxPosGammaPKind02Reduced		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind02Reduced");
		histonSigdEdxElnSigdEdxPosGammaPKind09Reduced		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind09Reduced");
		histonSigdEdxElnSigdEdxPosGammaPKind11Reduced		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind11Reduced");
		histonSigdEdxElnSigdEdxPosGammaPKind12Reduced		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind12Reduced");
		histonSigdEdxElnSigdEdxPosGammaPKind13Reduced		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind13Reduced");
		histonSigdEdxElnSigdEdxPosGammaPKind14Reduced		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind14Reduced");
		histonSigdEdxElnSigdEdxPosGammaPKind15Reduced		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind15Reduced");
		histonSigdEdxElnSigdEdxPosGammaPKind16Reduced		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind16Reduced");
		histonSigdEdxElnSigdEdxPosGammaPKind17Reduced		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind17Reduced");
		histonSigdEdxElnSigdEdxPosGammaPKind18Reduced		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKind18Reduced");
		histonSigdEdxElnSigdEdxPosGammaPKindBkgReduced		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKindBkgReduced");
		histonSigdEdxElnSigdEdxPosGammaPKindBkg2Reduced		= (TH2F*)directoryConv->Get("histonSigdEdxElnSigdEdxPosGammaPKindBkg2Reduced");
    histoInvMassPKind00Reduced   = (TH2F*)directoryConv->Get("histoInvMassPKind00Reduced");
    histoInvMassPKind11Reduced   = (TH2F*)directoryConv->Get("histoInvMassPKind11Reduced");
    histoInvMassPKind13Reduced   = (TH2F*)directoryConv->Get("histoInvMassPKind13Reduced");
    histoInvMassPKindBkg2Reduced = (TH2F*)directoryConv->Get("histoInvMassPKindBkg2Reduced");
    histoInvMassKappa                                 = (TH2F*)directoryConv->Get("histoInvMassKappa");
		//
		...
		histoGammaInvMassGammaKind->Sumw2();
		histoGammaZR->Sumw2();
		histoGammaXY->Sumw2();
		//ITS add
		...
		histonSigdEdxElnSigdEdxPosGammaKind->Sumw2(); // new sep 15 2015
		histonSigdEdxElnSigdEdxPosGammaPKind00->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind01->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind02->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind09->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind11->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind12->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind13->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind14->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind15->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind16->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind17->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind18->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKindBkg->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKindBkg2->Sumw2();
    //
    histoInvMassKappaPKind00->Sumw2();
    histoInvMassKappaPKind02->Sumw2();
    histoInvMassKappaPKind11->Sumw2();
    histoInvMassKappaPKind12->Sumw2();
    histoInvMassKappaPKind13->Sumw2();
    histoInvMassKappaPKind14->Sumw2();
    histoInvMassKappaPKind16->Sumw2();
    histoInvMassKappaPKind17->Sumw2();
    histoInvMassKappaPKind18->Sumw2();
    histoInvMassKappaPKindBkg->Sumw2();
    histoInvMassKappaKind->Sumw2();
		//2D
		histonSigdEdxElnSigdEdxPosGammaPReduced->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaKindReduced->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind00Reduced->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind01Reduced->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind02Reduced->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind09Reduced->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind11Reduced->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind12Reduced->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind13Reduced->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind14Reduced->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind15Reduced->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind16Reduced->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind17Reduced->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKind18Reduced->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKindBkgReduced->Sumw2();
		histonSigdEdxElnSigdEdxPosGammaPKindBkg2Reduced->Sumw2();
    histoInvMassPKind00Reduced->Sumw2();
    histoInvMassPKind11Reduced->Sumw2();
    histoInvMassPKind13Reduced->Sumw2();
    histoInvMassPKindBkg2Reduced->Sumw2();
    histoInvMassKappa->Sumw2();
		//
	...
	for (Long64_t i=0; i<nEntriesRecGam;i++) {
		if(i%100000==0) cout << "Processing Gamma " << i << endl;
...
// 		Double_t nSigmaTPC1D = (TMath::Abs(nSigmaTPCElectron) + TMath::Abs(nSigmaTPCPositron))/2;
    Double_t nSigmaTPC1D = (TMath::Abs(nSigmaTPCElectron) + TMath::Abs(nSigmaTPCPositron))/2 + 2*(nSigmaTPCElectron+nSigmaTPCPositron);
		//Double_t nSigmaTPC1D = TMath::Sqrt((nSigmaTPCElectron*nSigmaTPCElectron + nSigmaTPCPositron*nSigmaTPCPositron)/2);
		...
		if ( photonPt > minPtPhotonCut ){ 
			if (TMath::Abs(photonEta) >= etaMinCut && TMath::Abs(photonEta) <= etaMaxCut){ 
				...
				&& kPassedPsiPair && kPassedChi2){
					...
					histonSigdEdxElnSigdEdxPosGammaPReduced->Fill(nSigmaTPC1D,photonPt);
          histoInvMassKappa->Fill(photonInvMass,nSigmaTPC1D);
          
          
					
					if(kMC){
						histonSigdEdxElnSigdEdxPosGammaKind->Fill(nSigmaTPCElectron,nSigmaTPCPositron,kind);
						histonSigdEdxElnSigdEdxPosGammaKindReduced->Fill(nSigmaTPC1D,kind); 
						
            histoInvMassKappaKind->Fill(photonInvMass, nSigmaTPC1D, kind);
						histoGammaInvMassGammaKind->Fill(photonInvMass,kind);    
						
						if(kind == 0 || kind == 3 || kind == 4 || kind == 5 || kind == 10){
						  histonSigdEdxElnSigdEdxPosGammaPKind00->Fill(nSigmaTPCElectron,nSigmaTPCPositron,photonPt);
						  histonSigdEdxElnSigdEdxPosGammaPKind00Reduced->Fill(nSigmaTPC1D,photonPt);
              histoInvMassPKind00Reduced->Fill(photonInvMass,photonPt);
              histoInvMassKappaPKind00->Fill(photonInvMass,nSigmaTPC1D,photonPt);
						}
						if(kind == 1){  
						  histonSigdEdxElnSigdEdxPosGammaPKind01->Fill(nSigmaTPCElectron,nSigmaTPCPositron,photonPt);
						  histonSigdEdxElnSigdEdxPosGammaPKind01Reduced->Fill(nSigmaTPC1D,photonPt);
						}
						if(kind == 2){
						  histonSigdEdxElnSigdEdxPosGammaPKind02->Fill(nSigmaTPCElectron,nSigmaTPCPositron,photonPt);
						  histonSigdEdxElnSigdEdxPosGammaPKind02Reduced->Fill(nSigmaTPC1D,photonPt);
              histoInvMassKappaPKind02->Fill(photonInvMass,nSigmaTPC1D,photonPt);
						}
						if(kind == 9){
						  histonSigdEdxElnSigdEdxPosGammaPKind09->Fill(nSigmaTPCElectron,nSigmaTPCPositron,photonPt);
						  histonSigdEdxElnSigdEdxPosGammaPKind09Reduced->Fill(nSigmaTPC1D,photonPt);
						}
						if(kind == 11){
						  histonSigdEdxElnSigdEdxPosGammaPKind11->Fill(nSigmaTPCElectron,nSigmaTPCPositron,photonPt);
						  histonSigdEdxElnSigdEdxPosGammaPKind11Reduced->Fill(nSigmaTPC1D,photonPt);
              histoInvMassPKind11Reduced->Fill(photonInvMass,photonPt);
              histoInvMassKappaPKind11->Fill(photonInvMass,nSigmaTPC1D,photonPt);
						}
						if(kind == 12){
						  histonSigdEdxElnSigdEdxPosGammaPKind12->Fill(nSigmaTPCElectron,nSigmaTPCPositron,photonPt);
						  histonSigdEdxElnSigdEdxPosGammaPKind12Reduced->Fill(nSigmaTPC1D,photonPt);
              histoInvMassKappaPKind12->Fill(photonInvMass,nSigmaTPC1D,photonPt);
						}
						if(kind == 13){
						  histonSigdEdxElnSigdEdxPosGammaPKind13->Fill(nSigmaTPCElectron,nSigmaTPCPositron,photonPt);
						  histonSigdEdxElnSigdEdxPosGammaPKind13Reduced->Fill(nSigmaTPC1D,photonPt);
              histoInvMassPKind13Reduced->Fill(photonInvMass,photonPt);
              histoInvMassKappaPKind13->Fill(photonInvMass,nSigmaTPC1D,photonPt);
						}
						if(kind == 14){
						  histonSigdEdxElnSigdEdxPosGammaPKind14->Fill(nSigmaTPCElectron,nSigmaTPCPositron,photonPt);
						  histonSigdEdxElnSigdEdxPosGammaPKind14Reduced->Fill(nSigmaTPC1D,photonPt);
              histoInvMassKappaPKind14->Fill(photonInvMass,nSigmaTPC1D,photonPt);
						}
						if(kind == 15){
						  histonSigdEdxElnSigdEdxPosGammaPKind15->Fill(nSigmaTPCElectron,nSigmaTPCPositron,photonPt);
						  histonSigdEdxElnSigdEdxPosGammaPKind15Reduced->Fill(nSigmaTPC1D,photonPt);
						}
						if(kind == 16){
						  histonSigdEdxElnSigdEdxPosGammaPKind16->Fill(nSigmaTPCElectron,nSigmaTPCPositron,photonPt);
						  histonSigdEdxElnSigdEdxPosGammaPKind16Reduced->Fill(nSigmaTPC1D,photonPt);
              histoInvMassKappaPKind16->Fill(photonInvMass,nSigmaTPC1D,photonPt);
						}
						if(kind == 17){
						  histonSigdEdxElnSigdEdxPosGammaPKind17->Fill(nSigmaTPCElectron,nSigmaTPCPositron,photonPt);
						  histonSigdEdxElnSigdEdxPosGammaPKind17Reduced->Fill(nSigmaTPC1D,photonPt);
              histoInvMassKappaPKind17->Fill(photonInvMass,nSigmaTPC1D,photonPt);
						}
						if(kind == 18){
						  histonSigdEdxElnSigdEdxPosGammaPKind18->Fill(nSigmaTPCElectron,nSigmaTPCPositron,photonPt);
						  histonSigdEdxElnSigdEdxPosGammaPKind18Reduced->Fill(nSigmaTPC1D,photonPt);
              histoInvMassKappaPKind18->Fill(photonInvMass,nSigmaTPC1D,photonPt);
						}
						
						//creating background for 10 template case
						if(kind != 0 && kind != 3 && kind != 4 && kind != 5 && kind != 10 && kind != 2 && kind != 11 && kind != 12 && kind != 13 && kind != 14 && kind != 16 && kind != 17 && kind != 18){
						  histonSigdEdxElnSigdEdxPosGammaPKindBkg->Fill(nSigmaTPCElectron,nSigmaTPCPositron,photonPt);
						  histonSigdEdxElnSigdEdxPosGammaPKindBkgReduced->Fill(nSigmaTPC1D,photonPt);
              histoInvMassKappaPKindBkg->Fill(photonInvMass,nSigmaTPC1D,photonPt);
						}
						
						//checking if the gamma is not signal and neither from e+pi ,pi+pi
						if(kind != 0 && kind != 3 && kind != 4 && kind != 5 && kind != 10 && kind != 11 && kind != 13){
						  histonSigdEdxElnSigdEdxPosGammaPKindBkg2->Fill(nSigmaTPCElectron,nSigmaTPCPositron,photonPt);
						  histonSigdEdxElnSigdEdxPosGammaPKindBkg2Reduced->Fill(nSigmaTPC1D,photonPt);
              histoInvMassPKindBkg2Reduced->Fill(photonInvMass,photonPt);
						}
					}
				}
			}
	...
	filePhotoQAWrite->cd(Form("GammaConv_%s",  specificCutSelection.Data()));
		...
		histoGammaInvMassGammaKind->Write("histoGammaInvMassGammaKind",TObject::kWriteDelete);
		...
		histonSigdEdxElnSigdEdxPosGammaKind->Write("histonSigdEdxElnSigdEdxPosGammaKind",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind00->Write("histonSigdEdxElnSigdEdxPosGammaPKind00",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind01->Write("histonSigdEdxElnSigdEdxPosGammaPKind01",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind02->Write("histonSigdEdxElnSigdEdxPosGammaPKind02",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind09->Write("histonSigdEdxElnSigdEdxPosGammaPKind09",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind11->Write("histonSigdEdxElnSigdEdxPosGammaPKind11",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind12->Write("histonSigdEdxElnSigdEdxPosGammaPKind12",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind13->Write("histonSigdEdxElnSigdEdxPosGammaPKind13",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind14->Write("histonSigdEdxElnSigdEdxPosGammaPKind14",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind15->Write("histonSigdEdxElnSigdEdxPosGammaPKind15",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind16->Write("histonSigdEdxElnSigdEdxPosGammaPKind16",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind17->Write("histonSigdEdxElnSigdEdxPosGammaPKind17",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind18->Write("histonSigdEdxElnSigdEdxPosGammaPKind18",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKindBkg->Write("histonSigdEdxElnSigdEdxPosGammaPKindBkg",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKindBkg2->Write("histonSigdEdxElnSigdEdxPosGammaPKindBkg2",TObject::kWriteDelete);
    //
    histoInvMassKappaPKind00->Write("histoInvMassKappaPKind00",TObject::kWriteDelete);
    histoInvMassKappaPKind02->Write("histoInvMassKappaPKind02",TObject::kWriteDelete);
    histoInvMassKappaPKind11->Write("histoInvMassKappaPKind11",TObject::kWriteDelete);
    histoInvMassKappaPKind12->Write("histoInvMassKappaPKind12",TObject::kWriteDelete);
    histoInvMassKappaPKind13->Write("histoInvMassKappaPKind13",TObject::kWriteDelete);
    histoInvMassKappaPKind14->Write("histoInvMassKappaPKind14",TObject::kWriteDelete);
    histoInvMassKappaPKind16->Write("histoInvMassKappaPKind16",TObject::kWriteDelete);
    histoInvMassKappaPKind17->Write("histoInvMassKappaPKind17",TObject::kWriteDelete);
    histoInvMassKappaPKind18->Write("histoInvMassKappaPKind18",TObject::kWriteDelete);
    histoInvMassKappaPKindBkg->Write("histoInvMassKappaPKindBkg",TObject::kWriteDelete);
    histoInvMassKappaKind->Write("histoInvMassKappaKind",TObject::kWriteDelete);
		//2D
		histonSigdEdxElnSigdEdxPosGammaPReduced->Write("histonSigdEdxElnSigdEdxPosGammaPReduced",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaKindReduced->Write("histonSigdEdxElnSigdEdxPosGammaKindReduced",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind00Reduced->Write("histonSigdEdxElnSigdEdxPosGammaPKind00Reduced",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind01Reduced->Write("histonSigdEdxElnSigdEdxPosGammaPKind01Reduced",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind02Reduced->Write("histonSigdEdxElnSigdEdxPosGammaPKind02Reduced",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind09Reduced->Write("histonSigdEdxElnSigdEdxPosGammaPKind09Reduced",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind11Reduced->Write("histonSigdEdxElnSigdEdxPosGammaPKind11Reduced",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind12Reduced->Write("histonSigdEdxElnSigdEdxPosGammaPKind12Reduced",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind13Reduced->Write("histonSigdEdxElnSigdEdxPosGammaPKind13Reduced",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind14Reduced->Write("histonSigdEdxElnSigdEdxPosGammaPKind14Reduced",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind15Reduced->Write("histonSigdEdxElnSigdEdxPosGammaPKind15Reduced",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind16Reduced->Write("histonSigdEdxElnSigdEdxPosGammaPKind16Reduced",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind17Reduced->Write("histonSigdEdxElnSigdEdxPosGammaPKind17Reduced",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKind18Reduced->Write("histonSigdEdxElnSigdEdxPosGammaPKind18Reduced",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKindBkgReduced->Write("histonSigdEdxElnSigdEdxPosGammaPKindBkgReduced",TObject::kWriteDelete);
		histonSigdEdxElnSigdEdxPosGammaPKindBkg2Reduced->Write("histonSigdEdxElnSigdEdxPosGammaPKindBkg2Reduced",TObject::kWriteDelete);
    histoInvMassPKind00Reduced->Write("histoInvMassPKind00Reduced",TObject::kWriteDelete);
    histoInvMassPKind11Reduced->Write("histoInvMassPKind11Reduced",TObject::kWriteDelete);
    histoInvMassPKind13Reduced->Write("histoInvMassPKind13Reduced",TObject::kWriteDelete);
    histoInvMassPKindBkg2Reduced->Write("histoInvMassPKindBkg2Reduced",TObject::kWriteDelete);
    histoInvMassKappa->Write("histoInvMassKappa",TObject::kWriteDelete);
		//
	...
	delete   histoGammaInvMassGammaKind;
	delete   histoGammaZR;
	delete   histoGammaXY;
	...
	delete   histonSigdEdxElnSigdEdxPosGammaKind;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind00;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind01;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind02;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind09;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind11;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind12;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind13;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind14;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind15;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind16;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind17;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind18;
	delete   histonSigdEdxElnSigdEdxPosGammaPKindBkg;
	delete   histonSigdEdxElnSigdEdxPosGammaPKindBkg2;
  //
  delete   histoInvMassKappaPKind00;
  delete   histoInvMassKappaPKind02;
  delete   histoInvMassKappaPKind11;
  delete   histoInvMassKappaPKind12;
  delete   histoInvMassKappaPKind13;
  delete   histoInvMassKappaPKind14;
  delete   histoInvMassKappaPKind16;
  delete   histoInvMassKappaPKind17;
  delete   histoInvMassKappaPKind18;
  delete   histoInvMassKappaPKindBkg;
  delete   histoInvMassKappaKind;
	//2D
	delete   histonSigdEdxElnSigdEdxPosGammaPReduced;
	delete   histonSigdEdxElnSigdEdxPosGammaKindReduced;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind00Reduced;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind01Reduced;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind02Reduced;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind09Reduced;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind11Reduced;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind12Reduced;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind13Reduced;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind14Reduced;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind15Reduced;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind16Reduced;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind17Reduced;
	delete   histonSigdEdxElnSigdEdxPosGammaPKind18Reduced;
	delete   histonSigdEdxElnSigdEdxPosGammaPKindBkgReduced;
	delete   histonSigdEdxElnSigdEdxPosGammaPKindBkg2Reduced;
  delete   histoInvMassPKind00Reduced;
  delete   histoInvMassPKind11Reduced;
  delete   histoInvMassPKind13Reduced;
  delete   histoInvMassPKindBkg2Reduced;
  delete   histoInvMassKappa;
	//
