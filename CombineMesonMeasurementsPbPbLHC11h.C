...
//     SetStyleTLatex( labelFactorEta,FontSize,4,colorCombo2050);
    ...
    DrawGammaSetMarkerTGraphAsym(TheoryBegunEQ_0010ScaledforPlot, 0, 0, kViolet+1,kViolet+1, 5, kTRUE, kViolet+1);
    DrawGammaSetMarkerTGraphAsym(TheoryBegunEQ_0010, 0, 0, kViolet+1,kViolet+1, 5, kTRUE, kViolet+1);
    DrawGammaSetMarkerTGraphAsym(TheoryBegunEQ_2050, 0, 0, kCyan+1,kCyan+1, 5, kTRUE, kCyan+1);
    DrawGammaSetMarkerTGraphAsym(TheoryBegunEQPi0_0010, 0, 0, kViolet+1,kViolet+1, 5, kTRUE, kViolet+1);
    DrawGammaSetMarkerTGraphAsym(TheoryBegunEQPi0_2050, 0, 0, kCyan+1,kCyan+1, 5, kTRUE, kCyan+1);
    DrawGammaSetMarkerTGraphAsym(TheoryBegunEQEta_0010, 0, 0, kPink+10,kPink+10, 5, kTRUE, kPink+10);
    DrawGammaSetMarkerTGraphAsym(TheoryBegunEQEta_2050, 0, 0, kTeal-7,kTeal-7, 5, kTRUE,kTeal-7);
...
//         return;
    ...
    canvasRelSysErrLHC11h->SetLogx();
        ...
        if(thesisPlotting || PaperPi0) histo2DRelSysErrLHC11h->GetXaxis()->SetRangeUser(0.6,30.);
        ...
        TLegend* legendRelSysErrLHC11h = GetAndSetLegend2(0.12, 0.92-(0.04*nMeasSetLHC11h0010*1.35), 0.5, 0.92, 32);
        for (Int_t i = 0; i < nMeasSetLHC11h0010; i++){
...
//     }
    ...
    TCanvas* canvasRelStatErrLHC11h = new TCanvas("canvasRelStatErrLHC11h","",200,10,1350,900);  // gives the page size
        ...
        if(thesisPlotting || PaperPi0) histo2DRelStatErrLHC11h->GetXaxis()->SetRangeUser(0.6,30.);
        ...
        TLegend* legendRelStatErrLHC11h = GetAndSetLegend2(0.12, 0.92-(0.04*nMeasSetLHC11h0010*1.35), 0.5, 0.92, 32);
        for (Int_t i = 0; i < nMeasSetLHC11h0010; i++){
...
//         Double_t heightBox                      = 0.08/2;
    ...
    TCanvas* canvasInvYieldMeasRatios4pads = new TCanvas("canvasInvYieldMeasRatios4pads","",0,0,2500,2000);
        ...
        Double_t rowsLegendMeasRatioAbs[5]   = {0.87,1.98,1.88,1.78,1.9};
...
//                     graphEPOSEtaforPlot_2050->GetXaxis()->SetRangeUser(0.,13.);
                    ...
                    TLegend* legtheoryNEQ = new TLegend(0.57,0.95-(5*0.04),0.93,0.95);
...
//     canvasInvariantYield->SaveAs(Form("%s/%s_YieldCombinedLHC11h_DataOnlyWithPPandNLO.%s",paperPlots.Data(),meson.Data(),suffix.Data()));
    ...
    canvasInvariantYield->cd();
        ...
        TLegend* legtheory = new TLegend(0.2,0.24-(0.04*5),0.52,0.24);
        ...
        legtheory->AddEntry(TheoryBegunEQ_0010ScaledforPlot,"EQ SHM 0-10%", "l");
        legtheory->AddEntry(TheoryBegunEQ_2050,"EQ SHM 20-50%", "l");
        legtheory->Draw("same");
...
//         TLatex *labelEnergyInvYieldSectionPi0LHC11h0010 = new TLatex(0.6,0.88,collisionSystemPbPb0010.Data());
//         SetStyleTLatex( labelEnergyInvYieldSectionPi0LHC11h0010,FontSize,4);
...
//         TLatex *labelEnergyInvYieldSectionPi0LHC11h2050 = new TLatex(0.6,0.88,collisionSystemPbPb2050.Data());
//         SetStyleTLatex( labelEnergyInvYieldSectionPi0LHC11h2050,FontSize,4);
        labelEnergyInvYieldSectionPi0LHC11h->Draw();
        labelDetSysInvYieldSectionPi0LHC11h->Draw();
...
//         graphCombRAAStatPbPbPbPb2760GeV_2050->Draw("p,same");
        ...
        if(thesisPlotting){
            TLatex *thesisLabel = new TLatex(0.12,0.91,thisthesis.Data());
            SetStyleTLatex( thesisLabel,FontSize,4);
            thesisLabel->Draw();
        }
