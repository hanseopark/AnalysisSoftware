...
if [ $HAVELHC11h == 1 ]; then
    ls $OUTPUTDIR_LHC11h/GammaConvCalo_*.root > fileLHC11h.txt
...
if [ $HAVELHC14a1a == 1 ]; then
    ls $OUTPUTDIR_LHC14a1a/GammaConvCalo_*.root > fileLHC14a1a.txt
...
if [ $HAVELHC14a1b == 1 ]; then
    ls $OUTPUTDIR_LHC14a1b/GammaConvCalo_*.root > fileLHC14a1b.txt
...
if [ $HAVELHC14a1c == 1 ]; then
    ls $OUTPUTDIR_LHC14a1c/GammaConvCalo_*.root > fileLHC14a1c.txt
