...
if [ $CLEANUPMAYOR == 0 ]; then
    ...
    echo -e "DPGTrackIncAccAndEMC\nDPGTrack\nDPGTrackIncAcc" > runlistsToMerge.txt
    cd $currentDir
    CopyRunwiseAndMergeAccordingToRunlistData "LHC13b" $HAVELHC13b $OUTPUTDIR_LHC13b $LHC13bData $pathDataR1b $baseLegoData "/alice/data/2013" $NSlashes3 runlistsToMerge.txt "pass4" GammaConvV1
    cd $currentDir
    CopyRunwiseAndMergeAccordingToRunlistData "LHC13c" $HAVELHC13c $OUTPUTDIR_LHC13c $LHC13cData $pathDataR1c $baseLegoData "/alice/data/2013" $NSlashes3 runlistsToMerge.txt "pass4" GammaConvV1
    cd $currentDir
    CopyRunwiseAndMergeAccordingToRunlistData "LHC13d" $HAVELHC13d $OUTPUTDIR_LHC13d $LHC13dData $pathDataR1d $baseLegoData "/alice/data/2013" $NSlashes3 runlistsToMerge.txt "pass4" GammaConvV1
    cd $currentDir
    CopyRunwiseAndMergeAccordingToRunlistData "LHC13e" $HAVELHC13e $OUTPUTDIR_LHC13e $LHC13eData $pathDataR1e $baseLegoData "/alice/data/2013" $NSlashes3 runlistsToMerge.txt "pass4" GammaConvV1
    cd $currentDir
    CopyRunwiseAndMergeAccordingToRunlistData "LHC13f" $HAVELHC13f $OUTPUTDIR_LHC13f $LHC13fData $pathDataR1f $baseLegoData "/alice/data/2013" $NSlashes3 runlistsToMerge.txt "pass4" GammaConvV1

    cd $currentDir
    echo -e "DPGTrackIncAccAndEMC\nDPGTrack\nDPGTrackIncAcc" > runlistsToMerge.txt
    CopyRunwiseAndMergeAccordingToRunlistMC "LHC18j5_1" $HAVELHC18j51 $OUTPUTDIR_LHC18j51 $LHC18j5_1MC $pathMCR1 $baseLegoMC "/alice/sim/2018" $NSlashes3 runlistsToMerge.txt GammaConvV1
    cd $currentDir
    CopyRunwiseAndMergeAccordingToRunlistMC "LHC18j5_2" $HAVELHC18j52 $OUTPUTDIR_LHC18j52 $LHC18j5_2MC $pathMCR1 $baseLegoMC "/alice/sim/2018" $NSlashes3 runlistsToMerge.txt GammaConvV1
    cd $currentDir
    CopyRunwiseAndMergeAccordingToRunlistMC "LHC18j5_3" $HAVELHC18j53 $OUTPUTDIR_LHC18j53 $LHC18j5_3MC $pathMCR1 $baseLegoMC "/alice/sim/2018" $NSlashes3 runlistsToMerge.txt GammaConvV1

    echo -e "DPGTrackIncAccAndEMC\nDPGTrack\nDPGTrackIncAcc" > runlistsToMerge.txt
    CopyRunwiseAndMergeAccordingToRunlistData "LHC16q" $HAVELHC16q $OUTPUTDIR_LHC16q $LHC16qData $pathDataR2WOSDD $baseLegoData "/alice/data/2016" $NSlashes3 runlistsToMerge.txt "pass1$WOSDD" GammaConvV1
    cd $currentDir
    CopyRunwiseAndMergeAccordingToRunlistData "LHC16q" $HAVELHC16qF $OUTPUTDIR_LHC16qF $LHC16qDataFast $pathDataR2FAST $baseLegoData "/alice/data/2016" $NSlashes3 runlistsToMerge.txt "pass1$FAST" GammaConvV1
    cd $currentDir
    CopyRunwiseAndMergeAccordingToRunlistData "LHC16t" $HAVELHC16t $OUTPUTDIR_LHC16t $LHC16tData $pathDataR2WOSDD $baseLegoData "/alice/data/2016" $NSlashes3 runlistsToMerge.txt "pass1$WOSDD" GammaConvV1
    cd $currentDir
    CopyRunwiseAndMergeAccordingToRunlistData "LHC16t" $HAVELHC16tF $OUTPUTDIR_LHC16tF $LHC16tDataFast $pathDataR2FAST $baseLegoData "/alice/data/2016" $NSlashes3 runlistsToMerge.txt "pass1$FAST" GammaConvV1


    CopyRunwiseAndMergeAccordingToRunlistMC "LHC17f2b" $HAVELHC17f2b $OUTPUTDIR_LHC17f2b $LHC17f2bMC $pathMCR2 $baseLegoMC "/alice/sim/2017" $NSlashes3 runlistsToMerge.txt GammaConvV1
    ...
    CopyRunwiseAndMergeAccordingToRunlistMC "LHC17f2b_fast" $HAVELHC17f2bF $OUTPUTDIR_LHC17f2bF $LHC17f2bMCFast $pathMCR2 $baseLegoMC "/alice/sim/2017" $NSlashes3 runlistsToMerge.txt GammaConvV1
    ...
    CopyRunwiseAndMergeAccordingToRunlistMC "LHC17f2a_fix" $HAVELHC17f2afix $OUTPUTDIR_LHC17f2a_fix $LHC17f2a_fixMC $pathMCR2 $baseLegoMC "/alice/sim/2017" $NSlashes3 runlistsToMerge.txt GammaConvV1
    ...
    CopyRunwiseAndMergeAccordingToRunlistMC "LHC17f2a_fix_fast" $HAVELHC17f2afixF $OUTPUTDIR_LHC17f2a_fixF $LHC17f2a_fixMCFast $pathMCR2 $baseLegoMC "/alice/sim/2017" $NSlashes3 runlistsToMerge.txt GammaConvV1
    ...
    CopyRunwiseAndMergeAccordingToRunlistJJMC "LHC17g8a" $HAVELHC17g8a $OUTPUTDIR_LHC17g8a $LHC17g8aMC $pathMCR2 $baseLegoMC "/alice/sim/2017" $NSlashes3 runlistsToMerge.txt GammaConvV1
    ...
    CopyRunwiseAndMergeAccordingToRunlistJJMC "LHC17g8a_fast" $HAVELHC17g8aF $OUTPUTDIR_LHC17g8aF $LHC17g8aMCFast $pathMCR2 $baseLegoMC "/alice/sim/2017" $NSlashes3 runlistsToMerge.txt GammaConvV1
    ...
    for runListName in $listsToMerge; do
        if [ $HAVELHC13b == 1 ]; then
            ls $OUTPUTDIR_LHC13b/GammaConvV1-$runListName\_*.root > fileLHC13b.txt
            fileNumbers=`cat fileLHC13b.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC13b $NSlashes "LHC13b-pass4-$runListName" "-$runListName"
            done;
        fi
        if [ $HAVELHC13c == 1 ]; then
            ls $OUTPUTDIR_LHC13c/GammaConvV1-$runListName\_*.root > fileLHC13c.txt
            fileNumbers=`cat fileLHC13c.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC13c $NSlashes "LHC13c-pass4-$runListName" "-$runListName"
            done;
        fi
        if [ $HAVELHC13d == 1 ]; then
            ls $OUTPUTDIR_LHC13d/GammaConvV1-$runListName\_*.root > fileLHC13d.txt
            fileNumbers=`cat fileLHC13d.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC13d $NSlashes "LHC13d-pass4-$runListName" "-$runListName"
            done;
        fi
        if [ $HAVELHC13e == 1 ]; then
            ls $OUTPUTDIR_LHC13e/GammaConvV1-$runListName\_*.root > fileLHC13e.txt
            fileNumbers=`cat fileLHC13e.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC13e $NSlashes "LHC13e-pass4-$runListName" "-$runListName"
            done;
        fi
        if [ $HAVELHC13f == 1 ]; then
            ls $OUTPUTDIR_LHC13f/GammaConvV1-$runListName\_*.root > fileLHC13f.txt
            fileNumbers=`cat fileLHC13f.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC13f $NSlashes "LHC13f-pass4-$runListName" "-$runListName"
            done;
        fi

        if [ $HAVELHC18j51 == 1 ]; then
            ls $OUTPUTDIR_LHC18j51/GammaConvV1-$runListName\_*.root > fileLHC18j5.txt
            fileNumbers=`cat fileLHC18j5.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC18j51 $NSlashes "MC_LHC18j5_1-$runListName" "-$runListName"
            done;
        fi
        if [ $HAVELHC18j52 == 1 ]; then
            ls $OUTPUTDIR_LHC18j52/GammaConvV1-$runListName\_*.root > fileLHC18j5.txt
            fileNumbers=`cat fileLHC18j5.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC18j52 $NSlashes "MC_LHC18j5_2-$runListName" "-$runListName"
            done;
        fi
        if [ $HAVELHC18j53 == 1 ]; then
            ls $OUTPUTDIR_LHC18j53/GammaConvV1-$runListName\_*.root > fileLHC18j5.txt
            fileNumbers=`cat fileLHC18j5.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC18j53 $NSlashes "MC_LHC18j5_3-$runListName" "-$runListName"
            done;
        fi

        if [ $HAVELHC16q == 1 ]; then
            ls $OUTPUTDIR_LHC16q/GammaConvV1-$runListName\_*.root > fileLHC16q.txt
            fileNumbers=`cat fileLHC16q.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC16q $NSlashes "LHC16q-pass1-$runListName" "-$runListName"
            done;
        fi
        if [ $HAVELHC16qF == 1 ]; then
            ls $OUTPUTDIR_LHC16qF/GammaConvV1-$runListName\_*.root > fileLHC16qF.txt
            fileNumbers=`cat fileLHC16qF.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC16qF $NSlashes "LHC16q_fast-pass1-$runListName" "-$runListName"
            done;
        fi
        if [ $HAVELHC16t == 1 ]; then
            ls $OUTPUTDIR_LHC16t/GammaConvV1-$runListName\_*.root > fileLHC16t.txt
            fileNumbers=`cat fileLHC16t.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC16t $NSlashes "LHC16t-pass1-$runListName" "-$runListName"
            done;
        fi
        if [ $HAVELHC16tF == 1 ]; then
            ls $OUTPUTDIR_LHC16tF/GammaConvV1-$runListName\_*.root > fileLHC16tF.txt
            fileNumbers=`cat fileLHC16tF.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC16tF $NSlashes "LHC16t_fast-pass1-$runListName" "-$runListName"
            done;
        fi

        if [ $HAVELHC17f2b == 1 ]; then
            ls $OUTPUTDIR_LHC17f2b/GammaConvV1-$runListName\_*.root > fileLHC17f2b.txt
            fileNumbers=`cat fileLHC17f2b.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC17f2b $NSlashes "MC_LHC17f2b-$runListName" "-$runListName"
            done;
        fi
        if [ $HAVELHC17f2bF == 1 ]; then
            ls $OUTPUTDIR_LHC17f2bF/GammaConvV1-$runListName\_*.root > fileLHC17f2bF.txt
            fileNumbers=`cat fileLHC17f2bF.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC17f2bF $NSlashes "MC_LHC17f2b_fast-$runListName" "-$runListName"
            done;
        fi
        if [ $HAVELHC17f2afix == 1 ]; then
            ls $OUTPUTDIR_LHC17f2a_fix/GammaConvV1-$runListName\_*.root > fileLHC17f2a_fix.txt
            fileNumbers=`cat fileLHC17f2a_fix.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC17f2a_fix $NSlashes "MC_LHC17f2a_fix-$runListName" "-$runListName"
            done;
        fi
        if [ $HAVELHC17f2afixF == 1 ]; then
            ls $OUTPUTDIR_LHC17f2a_fixF/GammaConvV1-$runListName\_*.root > fileLHC17f2a_fixF.txt
            fileNumbers=`cat fileLHC17f2a_fixF.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC17f2a_fixF $NSlashes "MC_LHC17f2a_fix_fast-$runListName" "-$runListName"
            done;
        fi
        if [ $HAVELHC17g8a == 1 ]; then
            ls $OUTPUTDIR_LHC17g8a/GammaConvV1-$runListName\_*.root > fileLHC17g8a.txt
            fileNumbers=`cat fileLHC17g8a.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC17g8a $NSlashes "MC_LHC17g8a-$runListName" "-$runListName"
            done;
...
#                     cp $OUTPUTDIR_LHC17g8a/$binNumber/GammaConvV1-$runListName\_$number.root  $OUTPUTDIR/JJMCSingleBins/GammaConvV1_MC_LHC17g8a-$binNumber\_$3-$runListName\_$number.root
#                 done
#             done;
        fi
        if [ $HAVELHC17g8aF == 1 ]; then
            ls $OUTPUTDIR_LHC17g8aF/GammaConvV1-$runListName\_*.root > fileLHC17g8a.txt
            fileNumbers=`cat fileLHC17g8a.txt`
            for fileName in $fileNumbers; do
                echo $fileName
                ChangeStructureIfNeededPCM $fileName $OUTPUTDIR_LHC17g8aF $NSlashes "MC_LHC17g8a_fast-$runListName" "-$runListName"
            done;
#             for binNumber in $binNumbersJJ; do
#                 echo $binNumber
#                 ls $OUTPUTDIR_LHC17g8aF/GammaConvV1-$runListName\_*.root > fileLHC17g8a.txt
...
#                     echo $fileName
#                     GetFileNumberMerging $fileName $((NSlashes)) 2
#                     cp $OUTPUTDIR_LHC17g8aF/$binNumber/GammaConvV1-$runListName\_$number.root  $OUTPUTDIR/JJMCSingleBins/GammaConvV1_MC_LHC17g8a_fast-$binNumber\_$3-$runListName\_$number.root
#                 done
#             done;
        fi
    done
    ...
    if [ $MERGEON == 1 ]; then
        ...
        listsToMerge=`cat runlistsToMerge.txt`
        for runListName in $listsToMerge; do
            ls $OUTPUTDIR/GammaConvV1_LHC13f-pass4-$runListName\_*.root > filesForMerging.txt
            ...
            for fileName in $filesForMerging; do
                ...
                for periodID in $periodList; do
                    echo $periodID
                    currFile=$OUTPUTDIR/GammaConvV1_LHC13$periodID-$runListName\_$number.root
                    if [ -f $currFile ]; then
                ...
                MergeAccordingToList listCurrMerge.txt $OUTPUTDIR/GammaConvV1_LHC13$nameOut-pass4-$runListName\_$number.root
            done

            ls $OUTPUTDIR/GammaConvV1_LHC13e-pass4-$runListName\_*.root > filesForMerging.txt
            periodList=`echo -e "b-pass4\nc-pass4\nd-pass4\ne-pass4"`
            for fileName in $filesForMerging; do
                echo $fileName
                GetFileNumberMerging $fileName $((NSlashes-1)) 3 "bla" 1
            ...
            ls $OUTPUTDIR/GammaConvV1_MC_LHC18j5_1-$runListName\_*.root > filesForMerging.txt
            ...
            for fileName in $filesForMerging; do
                ...
                for periodID in $periodList; do
                    echo $periodID
                    currFile=$OUTPUTDIR/GammaConvV1_MC_LHC18$periodID-$runListName\_$number.root
                    if [ -f $currFile ]; then
                        outAdd=`echo $periodID  | cut -d "-" -f 1 `
                        nameOut+=$outAdd
                        echo -e "$currFile\n" >> listCurrMerge.txt
                ...
                MergeAccordingToList listCurrMerge.txt $OUTPUTDIR/GammaConvV1_MC_LHC18j5x-$runListName\_$number.root
            done
        done
