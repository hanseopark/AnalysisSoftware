...
if [ $3 = "AODmc" ]; then
   ...
   for fileName in $fileNumbers; do
      ...
      echo $number
      root -l -b -q -x ChangeStructureToStandardCalo.C\(\"$OUTPUTDIR_LHC13d2_A/GammaConvCalo_$number.root\"\,\"$OUTPUTDIR/GammaConvCalo_GA_PbPb_MC_AOD_LHC13d2_$number.root\"\,\"GammaConvCalo_$number\"\,2\)
   ...
   for fileName in $fileNumbersb; do
      ...
      number=`echo $fileName  | cut -d "/" -f 10 | cut -d "_" -f 2 | cut -d "." -f1`
      echo $number
      root -l -b -q -x ChangeStructureToStandardCalo.C\(\"$OUTPUTDIR_LHC13d2b_A/GammaConvCalo_$number.root\"\,\"$OUTPUTDIR/GammaConvCalo_GA_PbPb_MC_AOD_LHC13d2b_$number.root\"\,\"GammaConvCalo_$number\"\,2\)
   ...
   for fileName in $fileNumbers; do
      ...
      number=`echo $fileName  | cut -d "/" -f 10 | cut -d "_" -f 2 | cut -d "." -f1`
      echo $number
      root -l -b -q -x ChangeStructureToStandardCalo.C\(\"$OUTPUTDIR_LHC13d2_A/GammaConvCalo_$number.root\"\,\"$OUTPUTDIR/GammaConvCalo_GA_PbPb_MC_LHC13d2_$number.root\"\,\"GammaConvCalo_$number\"\,2\)
   ...
   for fileName in $fileNumbersb; do
      ...
      number=`echo $fileName  | cut -d "/" -f 10 | cut -d "_" -f 2 | cut -d "." -f1`
      echo $number
      root -l -b -q -x ChangeStructureToStandardCalo.C\(\"$OUTPUTDIR_LHC13d2b_A/GammaConvCalo_$number.root\"\,\"$OUTPUTDIR/GammaConvCalo_GA_PbPb_MC_LHC13d2b_$number.root\"\,\"GammaConvCalo_$number\"\,2\)
...
if [ $2 = "AODdata" ]; then
   ...
   for fileName in $fileNumbersData; do
      ...
      number=`echo $fileName  | cut -d "/" -f 10 | cut -d "_" -f 2 | cut -d "." -f1`
      echo $number
      root -l -b -q -x ChangeStructureToStandardCalo.C\(\"$OUTPUTDIR_LHC10h_A/GammaConvCalo_$number.root\"\,\"$OUTPUTDIR/GammaConvCalo_GA_PbPb_LHC10h-pass2_$number.root\"\,\"GammaConvCalo_$number\"\,2\)
