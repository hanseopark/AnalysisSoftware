...
if [ $CLEANUPMAYOR == 0 ]; then
    if [ $HAVELHC17n == 1 ]; then
        ...
        if [ $SINGLERUN == 1 ]; then
            ...
            if [ $MERGEONSINGLEData == 1 ] && [ ! -f $OUTPUTDIR_LHC17n/mergedAllConv.txt ]; then
                rm $OUTPUTDIR_LHC17n/GammaConvCalo*.root*
                firstrunNumber=`head -n1 runlists/runNumbersLHC17n_all.txt`
                ls $OUTPUTDIR_LHC17n/$firstrunNumber/GammaConvCalo_*.root > fileLHC17n.txt
                MergeAccordingToSpecificRunlist fileLHC17n.txt $OUTPUTDIR_LHC17n $NSlashes3 GammaConvCalo All$addName runlists/runNumbersLHC17n_all.txt "no"
            fi
        else
    ...
    if [ $HAVELHC17j7a == 1 ]; then
        ...
        if [ $SINGLERUN == 1 ]; then
            ...
            if [ $MERGEONSINGLEMC == 1 ] && [ ! -f $OUTPUTDIR_LHC17j7a/mergedAllConv.txt ]; then
                cd $currentDir
                rm $OUTPUTDIR_LHC17j7a/GammaConvCalo*.root*
                echo runlists/runNumbersLHC17j7_all.txt
                firstrunNumber=`head -n1 runlists/runNumbersLHC17j7_all.txt`
                echo $firstrunNumber
                ls $OUTPUTDIR_LHC17j7a/$firstrunNumber/GammaConvCalo_*.root > fileLHC17j7.txt
                MergeAccordingToSpecificRunlist fileLHC17j7.txt $OUTPUTDIR_LHC17j7a $NSlashes3 GammaConvCalo All$addName runlists/runNumbersLHC17j7_all.txt "no"
            fi
        else
    ...
    if [ $HAVELHC17j7b == 1 ]; then
        ...
        if [ $SINGLERUN == 1 ]; then
            ...
            if [ $MERGEONSINGLEMC == 1 ] && [ ! -f $OUTPUTDIR_LHC17j7b/mergedAllConv.txt ]; then
                cd $currentDir
                rm $OUTPUTDIR_LHC17j7b/GammaConvCalo*.root*
                echo runlists/runNumbersLHC17j7_all.txt
                firstrunNumber=`head -n1 runlists/runNumbersLHC17j7_all.txt`
                echo $firstrunNumber
                ls $OUTPUTDIR_LHC17j7b/$firstrunNumber/GammaConvCalo_*.root > fileLHC17j7.txt
                MergeAccordingToSpecificRunlist fileLHC17j7.txt $OUTPUTDIR_LHC17j7b $NSlashes3 GammaConvCalo All$addName runlists/runNumbersLHC17j7_all.txt "no"
            fi
        else
    ...
    if [ $HAVELHC17j7c == 1 ]; then
        ...
        if [ $SINGLERUN == 1 ]; then
            ...
            if [ $MERGEONSINGLEMC == 1 ] && [ ! -f $OUTPUTDIR_LHC17j7c/mergedAllConv.txt ]; then
                cd $currentDir
                rm $OUTPUTDIR_LHC17j7c/GammaConvCalo*.root*
                echo runlists/runNumbersLHC17j7_all.txt
                firstrunNumber=`head -n1 runlists/runNumbersLHC17j7_all.txt`
                echo $firstrunNumber
                ls $OUTPUTDIR_LHC17j7c/$firstrunNumber/GammaConvCalo_*.root > fileLHC17j7.txt
                MergeAccordingToSpecificRunlist fileLHC17j7.txt $OUTPUTDIR_LHC17j7c $NSlashes3 GammaConvCalo All$addName runlists/runNumbersLHC17j7_all.txt "no"
            fi
        else
    ...
    if [ $HAVELHC17n == 1 ]; then
        ...
        for fileName in $fileNumbers; do
            echo $fileName
            ChangeStructureIfNeededPCMCalo $fileName $OUTPUTDIR_LHC17n $NSlashes "LHC17n-pass$passNr-All$addName" "-All$addName"
        done;
    fi

    if [ $HAVELHC17j7a == 1 ]; then
        ls $OUTPUTDIR_LHC17j7a/GammaConvCalo-All$addName_*.root > fileLHC17j7a.txt
        fileNumbers=`cat fileLHC17j7a.txt`
        for fileName in $fileNumbers; do
            echo $fileName
            ChangeStructureIfNeededPCMCalo $fileName $OUTPUTDIR_LHC17j7a $NSlashes "MC_LHC17j7-All$addName" "-All$addName"
        done;
    fi
    if [ $HAVELHC17j7b == 1 ]; then
        ls $OUTPUTDIR_LHC17j7b/GammaConvCalo-All$addName_*.root > fileLHC17j7b.txt
        fileNumbers=`cat fileLHC17j7b.txt`
        for fileName in $fileNumbers; do
            echo $fileName
            ChangeStructureIfNeededPCMCalo $fileName $OUTPUTDIR_LHC17j7b $NSlashes "MC_LHC17j7ZDCfix-All$addName" "-All$addName"
        done;
    fi
    if [ $HAVELHC17j7c == 1 ]; then
        ls $OUTPUTDIR_LHC17j7c/GammaConvCalo-All$addName_*.root > fileLHC17j7c.txt
        fileNumbers=`cat fileLHC17j7c.txt`
        for fileName in $fileNumbers; do
            echo $fileName
            ChangeStructureIfNeededPCMCalo $fileName $OUTPUTDIR_LHC17j7c $NSlashes "MC_LHC17j7ZDCfixExtra-All$addName" "-All$addName"
        done;
    fi
    ...
    if [ $MERGEON == 1 ]; then
        ...
        for fileName in $filesForMerging; do
            ...
            fileA="$OUTPUTDIR/GammaConvCalo_MC_LHC17j7-All$addName""_$number.root"
            fileB="$OUTPUTDIR/GammaConvCalo_MC_LHC17j7ZDCfix-All$addName""_$number.root"
    ...
    if [ $HAVELHC17j7a == 1 ]; then
        echo "removing all GammaConvCalo files in runFolders for LHC17j7";
        rm $OUTPUTDIR_LHC17j7a/*/GammaConvCalo_*.root
    fi
    if [ $HAVELHC17j7b == 1 ]; then
        echo "removing all GammaConvCalo files in runFolders for LHC17j7ZDCfix";
        rm $OUTPUTDIR_LHC17j7b/*/GammaConvCalo_*.root
    fi
    if [ $HAVELHC17j7c == 1 ]; then
