...
#                 MergeAccordingToSpecificRunlist fileLHC16q.txt $OUTPUTDIR_LHC16q $NSlashes3 GammaCalo All runlists/runNumbersLHC16q_$3_all.txt
    ...
    if [ $HAVELHC16qF == 1 ]; then
        ...
        if [ $SINGLERUN == 1 ]; then
            ...
            echo $runNumbers
            for runNumber in $runNumbers; do
                CopyFileIfNonExisitent $OUTPUTDIR_LHC16qF/$runNumber "/alice/data/2016/LHC16q/000$runNumber/pass$passNr\_FAST/PWGGA/GA_pPb/$LHC16qDataFast" $NSlashes3 "/alice/data/2016/LHC16q/000$runNumber/pass$passNr\_FAST/PWGGA/GA_pPb/$LHC16qDataFast/Stage_1/" kTRUE
            done;
...
#                 MergeAccordingToSpecificRunlist fileLHC16t.txt $OUTPUTDIR_LHC16t $NSlashes3 GammaCalo All runlists/runNumbersLHC16t_$3_all.txt
    ...
    if [ $HAVELHC16tF == 1 ]; then
        ...
        if [ $SINGLERUN == 1 ]; then
            ...
            echo $runNumbers
            for runNumber in $runNumbers; do
                CopyFileIfNonExisitent $OUTPUTDIR_LHC16tF/$runNumber "/alice/data/2016/LHC16t/000$runNumber/pass$passNr\_FAST/PWGGA/GA_pPb/$LHC16tDataFast" $NSlashes3 "/alice/data/2016/LHC16t/000$runNumber/pass$passNr\_FAST/PWGGA/GA_pPb/$LHC16tDataFast/Stage_1/" kTRUE
            done;
