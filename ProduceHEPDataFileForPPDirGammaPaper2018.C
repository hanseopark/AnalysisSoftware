...
void ProduceHEPDataFileForPPDirGammaPaper2018(
  TString nameFilepp2760GeV                       = "CombinedGammaResultPP2760GeV_2018_07_24.root",
  TString nameFilepp8TeV                          = "CombinedGammaResultPP8TeV_2018_11_22.root"
){
   ...
   TString dateForOutput = ReturnDateStringForOutput();
	...
	TString headerPaper = "*author: ACHARYA \n*reference: CERN-PH-EP-2018-045 : 2018\n*status: Encoded 9 Nov 2018 by N. Schmidt\n*experiment: CERN-LHC-ALICE\n*detector: ALICE\n\n*title: Direct photon production at low transverse momentum in proton-proton collisions at $\\sqrt{s}=2.76$ and 8 TeV\n*comment: CERN-LHC. Measurements of inclusive and direct photon production at mid-rapidity in pp collisions at $\\sqrt{s}=2.76$ and 8 TeV are presented by the ALICE experiment at the LHC. The results are reported in transverse momentum ranges of $0.4<p_{\\rm T}<10$ GeV/c and $0.3<p_{\\rm T}<16$ GeV/c, respectively. Photons are detected with the electromagnetic calorimeter (EMCal) and via reconstruction of $e^+e^-$ pairs from conversions in the ALICE detector material using the central tracking system. For the final measurement of the inclusive photon spectra the results are combined in the overlapping $p_{\\rm T}$ interval of both methods. Direct photon spectra, or their upper limits at 90% C.L. are extracted using the direct photon excess ratio $R_\\gamma$, which quantifies the ratio of inclusive photons over decay photons generated with a decay-photon simulation. An additional hybrid method, combining photons reconstructed from conversions with those identified in the EMCal, is used for the combination of the direct photon excess ratio $R_\\gamma$, as well as the extraction of direct photon spectra or their upper limits. While no significant signal of direct photons is seen over the full $p_{\\rm T}$ range, $R_\\gamma$ for $p_{\\rm T}>7$ GeV/c is at least one $\\sigma$ above unity and consistent with expectations from next-to-leading order pQCD calculations.\n";
		...
		cout << endl;
		TString headerRAApp8TeV = "*location: Fig. 4\n*dscomment: Double Ratio RGAMMA in inelastic pp collisions at center-of-mass energy 8 TeV. RGAMMA is the ratio of inclusive GAMMA to decay GAMMA.\n*reackey: P P --> GAMMA X\n*obskey: RGAMMA\n*qual: RE: P P --> GAMMA X\n*qual: YRAP : -0.9 TO 0.9\n*qual: SQRT(S) IN GEV : 8000.0\n*yheader: RGAMMA \n*xheader: PT IN GEV/c\n*data: x : y";
		...
		TString headerIncpp2760GeV = "*location: Fig. 5\n*dscomment: Invariant differential cross section of inclusive GAMMA produced in inelastic pp collisions at center-of-mass energy 2.76 TeV, the uncertainty of $\\sigma_{MB}$ of 2.5% is not included in the systematic error. Values are given in the center of the PT bin.\n*reackey: P P --> GAMMA X\n*obskey: E*D3SIG/D3P\n*qual: RE: P P --> GAMMA X\n*qual: YRAP : -0.9 TO 0.9\n*qual: SQRT(S) IN GEV : 2760.0\n*yheader: E d**3sigma/dp**3 IN (pb GEV**-2 c**3) \n*xheader: PT IN GEV/c\n*data: x : y";
		...
		cout << endl;
		TString headerIncpp8TeV = "*location: Fig. 5\n*dscomment: Invariant differential cross section of inclusive GAMMA produced in inelastic pp collisions at center-of-mass energy 8 TeV, the uncertainty of $\\sigma_{MB}$ of 2.6% is not included in the systematic error. Values are given in the center of the PT bin.\n*reackey: P P --> GAMMA X\n*obskey: E*D3SIG/D3P\n*qual: RE: P P --> GAMMA X\n*qual: YRAP : -0.9 TO 0.9\n*qual: SQRT(S) IN GEV : 8000.0\n*yheader: E d**3sigma/dp**3 IN (pb GEV**-2 c**3) \n*xheader: PT IN GEV/c\n*data: x : y";
    ...
    TString headerpp2760GeV = "*location: Fig. 5\n*dscomment: Invariant differential cross section of direct GAMMA produced in inelastic pp collisions at center-of-mass energy 2.76 TeV, the uncertainty of $\\sigma_{MB}$ of 2.5% is not included in the systematic error. Values are given in the center of the PT bin.\n*reackey: P P --> GAMMA X\n*obskey: E*D3SIG/D3P\n*qual: RE: P P --> GAMMA X\n*qual: YRAP : -0.9 TO 0.9\n*qual: SQRT(S) IN GEV : 2760.0\n*yheader: E d**3sigma/dp**3 IN (pb GEV**-2 c**3) \n*xheader: PT IN GEV/c\n*data: x : y";
		...
		cout << endl;
		TString headerpp8TeV = "*location: Fig. 5\n*dscomment: Invariant differential cross section of direct GAMMA produced in inelastic pp collisions at center-of-mass energy 8 TeV, the uncertainty of $\\sigma_{MB}$ of 2.6% is not included in the systematic error. Values are given in the center of the PT bin.\n*reackey: P P --> GAMMA X\n*obskey: E*D3SIG/D3P\n*qual: RE: P P --> GAMMA X\n*qual: YRAP : -0.9 TO 0.9\n*qual: SQRT(S) IN GEV : 8000.0\n*yheader: E d**3sigma/dp**3 IN (pb GEV**-2 c**3) \n*xheader: PT IN GEV/c\n*data: x : y";
    ...
    // additional data for invariant yield
		TString headerYieldIncpp2760GeV = "*location: not in paper\n*dscomment: Invariant differential yield of inclusive GAMMA produced in inelastic pp collisions at center-of-mass energy 2.76 TeV. Values are given in the center of the PT bin.\n*reackey: P P --> GAMMA X\n*obskey: DN/DPT**2/DYRAP\n*qual: RE: P P --> GAMMA X\n*qual: YRAP : -0.9 TO 0.9\n*qual: SQRT(S) IN GEV : 2760.0\n*yheader: 1/(2*PI*Nevt)*(d**2N)/(PT*dPT*dY) IN (GEV/c)**-2\n*xheader: PT IN GEV/c\n*data: x : y";
		...
		cout << endl;
		TString headerYieldIncpp8TeV = "*location: not in paper\n*dscomment: Invariant differential yield of inclusive GAMMA produced in inelastic pp collisions at center-of-mass energy 8 TeV. Values are given in the center of the PT bin.\n*reackey: P P --> GAMMA X\n*obskey: DN/DPT**2/DYRAP\n*qual: RE: P P --> GAMMA X\n*qual: YRAP : -0.9 TO 0.9\n*qual: SQRT(S) IN GEV : 8000.0\n*yheader: 1/(2*PI*Nevt)*(d**2N)/(PT*dPT*dY) IN (GEV/c)**-2\n*xheader: PT IN GEV/c\n*data: x : y";
		// TString headerYieldIncpp8TeV = "*location: not in paper\n*dscomment: Invariant differential yield of inclusive GAMMA produced in inelastic pp collisions at center-of-mass energy 8 TeV. Values are given in the center of the PT bin.\n*reackey: P P --> GAMMA X\n*obskey: DN/DPT**2/DYRAP\n*qual: RE: P P --> GAMMA X\n*qual: YRAP : -0.9 TO 0.9\n*qual: SQRT(S) IN GEV : 8000.0\n*yheader: 1/(2*PI*Nevt)*(d**2N)/(PT*dPT*dY) IN (GEV/c)**-2\n*xheader: PT IN GEV/c\n*data: x : y";
    ...
    TString headerYieldpp2760GeV = "*location: not in paper\n*dscomment: Invariant differential yield of direct GAMMA produced in inelastic pp collisions at center-of-mass energy 2.76 TeV. Values are given in the center of the PT bin.\n*reackey: P P --> GAMMA X\n*obskey: DN/DPT**2/DYRAP\n*qual: RE: P P --> GAMMA X\n*qual: YRAP : -0.9 TO 0.9\n*qual: SQRT(S) IN GEV : 2760.0\n*yheader: 1/(2*PI*Nevt)*(d**2N)/(PT*dPT*dY) IN (GEV/c)**-2\n*xheader: PT IN GEV/c\n*data: x : y";
		...
		cout << endl;
		TString headerYieldpp8TeV = "*location: not in paper\n*dscomment: Invariant differential yield of direct GAMMA produced in inelastic pp collisions at center-of-mass energy 8 TeV. Values are given in the center of the PT bin.\n*reackey: P P --> GAMMA X\n*obskey: DN/DPT**2/DYRAP\n*qual: RE: P P --> GAMMA X\n*qual: YRAP : -0.9 TO 0.9\n*qual: SQRT(S) IN GEV : 8000.0\n*yheader: 1/(2*PI*Nevt)*(d**2N)/(PT*dPT*dY) IN (GEV/c)**-2\n*xheader: PT IN GEV/c\n*data: x : y";
