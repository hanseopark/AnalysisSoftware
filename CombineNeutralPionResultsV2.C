...
void CombineNeutralPionResultsV2(TString suffix = "pdf", TString nameFilePP = "data_PCMResultsFullCorrection_PP_NoBinShifting.root", TString nameFilePbPb = "data_GammaConversionResultsFullCorrection_PbPb_2.76TeV_.root", Bool_t runDrawReweighted = kTRUE, TString nameFileTPCMult = ""){

   
//    nameFileTPCMult = "data_PCMResults_PbPb_2.76TeV_TPCMultNewMCWeighted2ndIteration.root"; // old file
   gROOT->Reset();   
   gROOT->SetStyle("Plain");
   
   TString nameFileEtaPbPb = "data_PCMResults_PbPb_2.76TeV_NewMCWeighted1stIteration.root";
   ...
   gSystem->Exec(Form("cp %s %s/InputFilePCMPionPbPb.root ",nameFilePbPb.Data(),outputDir.Data() ));
   ...
   TString collisionSystempPb0020 = "0-20% p-Pb #sqrt{s_{_{NN}}} = 5.023 TeV";     
   TString collisionSystempPb2040 = "20-40% p-Pb #sqrt{s_{_{NN}}} = 5.023 TeV";      
   TString collisionSystempPb4060 = "40-60% p-Pb #sqrt{s_{_{NN}}} = 5.023 TeV";    
   TString collisionSystempPb60100 = "60-100% p-Pb #sqrt{s_{_{NN}}} = 5.023 TeV";     
   // TString collisionSystempPb6080 = "60-80% p-Pb #sqrt{s_{_{NN}}} = 5.023 TeV";     
   // TString collisionSystempPb80100 = "80-100% p-Pb #sqrt{s_{_{NN}}} = 5.023 TeV";     
   TString collisionSystempPb = "p-Pb #sqrt{s_{_{NN}}} = 5.023 TeV";     
   ...
   TFile*   filePCMPbPbEta =              new TFile(nameFileEtaPbPb.Data());
   TDirectory* directoryEtaPbPb0010 =           (TDirectory*)filePCMPbPbEta->Get("Eta_PbPb_2.76TeV_0-10%"); 
   ...
   TDirectory* directoryEtaPbPb1020 =           (TDirectory*)filePCMPbPbEta->Get("Eta_PbPb_2.76TeV_10-20%"); 
   ...
   TDirectory* directoryEtaPbPb2040 =           (TDirectory*)filePCMPbPbEta->Get("Eta_PbPb_2.76TeV_20-40%"); 
   ...
   TDirectory* directoryEtaPbPb4060 =           (TDirectory*)filePCMPbPbEta->Get("Eta_PbPb_2.76TeV_40-60%"); 
   ...
   TDirectory* directoryEtaPbPb6080 =           (TDirectory*)filePCMPbPbEta->Get("Eta_PbPb_2.76TeV_60-80%"); 
...
//    histoPCMMassEtaMCpPb->Scale(1000.);
   ...
   TFile* fileNeutralPionpPbEffi = new TFile("800001100208366300020000000_01631031009000/pPb_5.023TeV/Pi0_data_GammaConvV1Correction_800001100208366300020000000_01631031009000.root");
   TH1D* histoEffiPi0pPb= (TH1D*)fileNeutralPionpPbEffi->Get("TrueMesonEffiPt");
   TH1D* histoAcceptPi0pPb= (TH1D*)fileNeutralPionpPbEffi->Get("fMCMesonAccepPt");
   
   TFile* fileEtapPbEffi = new TFile("800001100208366300020000000_01631031009000/pPb_5.023TeV/Eta_data_GammaConvV1Correction_800001100208366300020000000_01631031009000.root");
   TH1D* histoEffiEtapPb= (TH1D*)fileEtapPbEffi->Get("TrueMesonEffiPt");
   
   
   
   TFile*   filePCMPbPbOldMC =              new TFile("PbPbAdditionalInput/data_PCMResults_PbPb_2.76TeV_1stIterationRerun.root");
   cout << "0-5% old MC file" << endl;
   TDirectory* directoryPi0PbPb0005_OldMC =  (TDirectory*)filePCMPbPbOldMC->Get("Pi0_PbPb_2.76TeV_0-5%"); 
   TH1D* histoTrueEffiPt0005_OldMC =        (TH1D*)directoryPi0PbPb0005_OldMC->Get("Pi0_Efficiency");
   TH1D* histoAcceptPt0005_OldMC =          (TH1D*)directoryPi0PbPb0005_OldMC->Get("Pi0_Acceptance");
   TH1D* histoMCYieldPtWOWeights0005_OldMC = (TH1D*)directoryPi0PbPb0005_OldMC->Get("Pi0_HIJING_Input");
   
   cout << "0-10% old MC file" << endl;
   TDirectory* directoryPi0PbPb0010_OldMC =           (TDirectory*)filePCMPbPbOldMC->Get("Pi0_PbPb_2.76TeV_0-10%"); 
   TH1D* histoTrueEffiPt0010_OldMC =        (TH1D*)directoryPi0PbPb0010_OldMC->Get("Pi0_Efficiency");
   TH1D* histoAcceptPt0010_OldMC =          (TH1D*)directoryPi0PbPb0010_OldMC->Get("Pi0_Acceptance");
   TH1D* histoMCYieldPtWOWeights0010_OldMC = (TH1D*)directoryPi0PbPb0010_OldMC->Get("Pi0_HIJING_Input");
   
   cout << "0-20% old MC file" << endl;
   TDirectory* directoryPi0PbPb0020_OldMC =           (TDirectory*)filePCMPbPbOldMC->Get("Pi0_PbPb_2.76TeV_0-20%"); 
   TH1D* histoMCYieldPtWOWeights0020_OldMC = NULL; 
   if (directoryPi0PbPb0020_OldMC){
      histoMCYieldPtWOWeights0020_OldMC = (TH1D*)directoryPi0PbPb0020_OldMC->Get("Pi0_HIJING_Input");
   }
   
   cout << "0-40%  old MC file" << endl;
   TDirectory* directoryPi0PbPb0040_OldMC =           (TDirectory*)filePCMPbPbOldMC->Get("Pi0_PbPb_2.76TeV_0-40%"); 
   TH1D* histoMCYieldPtWOWeights0040_OldMC = NULL; 
   if (directoryPi0PbPb0040_OldMC){
      histoMCYieldPtWOWeights0040_OldMC = (TH1D*)directoryPi0PbPb0040_OldMC->Get("Pi0_HIJING_Input");
   }
   
   cout << "0-80%  old MC file" << endl;
   TDirectory* directoryPi0PbPb0080_OldMC =           (TDirectory*)filePCMPbPbOldMC->Get("Pi0_PbPb_2.76TeV_0-80%"); 
   TH1D* histoMCYieldPtWOWeights0080_OldMC = NULL; 
   if (directoryPi0PbPb0080_OldMC){
      histoMCYieldPtWOWeights0080_OldMC = (TH1D*)directoryPi0PbPb0080_OldMC->Get("Pi0_HIJING_Input");
   }
   
   cout << "40-80% old MC file" << endl;
   TDirectory* directoryPi0PbPb4080_OldMC =           (TDirectory*)filePCMPbPbOldMC->Get("Pi0_PbPb_2.76TeV_40-80%"); 
   TH1D* histoMCYieldPtWOWeights4080_OldMC = NULL; 
   if (directoryPi0PbPb4080_OldMC){
      histoMCYieldPtWOWeights4080_OldMC = (TH1D*)directoryPi0PbPb4080_OldMC->Get("Pi0_HIJING_Input");
   }
   
   cout << "5-10% old MC file" << endl;
   TDirectory* directoryPi0PbPb0510_OldMC =           (TDirectory*)filePCMPbPbOldMC->Get("Pi0_PbPb_2.76TeV_5-10%"); 
   TH1D* histoTrueEffiPt0510_OldMC =        (TH1D*)directoryPi0PbPb0510_OldMC->Get("Pi0_Efficiency");
   TH1D* histoAcceptPt0510_OldMC =          (TH1D*)directoryPi0PbPb0510_OldMC->Get("Pi0_Acceptance");
   TH1D* histoMCYieldPtWOWeights0510_OldMC = (TH1D*)directoryPi0PbPb0510_OldMC->Get("Pi0_HIJING_Input");
   
   cout << "10-20% old MC file" << endl;
   TDirectory* directoryPi0PbPb1020_OldMC =           (TDirectory*)filePCMPbPbOldMC->Get("Pi0_PbPb_2.76TeV_10-20%"); 
   TH1D* histoTrueEffiPt1020_OldMC =        (TH1D*)directoryPi0PbPb1020_OldMC->Get("Pi0_Efficiency");
   TH1D* histoAcceptPt1020_OldMC =          (TH1D*)directoryPi0PbPb1020_OldMC->Get("Pi0_Acceptance");
   TH1D* histoMCYieldPtWOWeights1020_OldMC = (TH1D*)directoryPi0PbPb1020_OldMC->Get("Pi0_HIJING_Input");
   
   cout << "20-40% old MC file" << endl;
   TDirectory* directoryPi0PbPb2040_OldMC =           (TDirectory*)filePCMPbPbOldMC->Get("Pi0_PbPb_2.76TeV_20-40%"); 
   TH1D* histoTrueEffiPt2040_OldMC =        (TH1D*)directoryPi0PbPb2040_OldMC->Get("Pi0_Efficiency");
   TH1D* histoAcceptPt2040_OldMC =          (TH1D*)directoryPi0PbPb2040_OldMC->Get("Pi0_Acceptance");
   TH1D* histoMCYieldPtWOWeights2040_OldMC = (TH1D*)directoryPi0PbPb2040_OldMC->Get("Pi0_HIJING_Input");
   
   cout << "40-60% old MC file" << endl;
   TDirectory* directoryPi0PbPb4060_OldMC =           (TDirectory*)filePCMPbPbOldMC->Get("Pi0_PbPb_2.76TeV_40-60%"); 
   TH1D* histoTrueEffiPt4060_OldMC =        (TH1D*)directoryPi0PbPb4060_OldMC->Get("Pi0_Efficiency");
   TH1D* histoAcceptPt4060_OldMC =          (TH1D*)directoryPi0PbPb4060_OldMC->Get("Pi0_Acceptance");
   TH1D* histoMCYieldPtWOWeights4060_OldMC = (TH1D*)directoryPi0PbPb4060_OldMC->Get("Pi0_HIJING_Input");
   
   cout << "60-80% old MC file" << endl;
   TDirectory* directoryPi0PbPb6080_OldMC =           (TDirectory*)filePCMPbPbOldMC->Get("Pi0_PbPb_2.76TeV_60-80%");
   TH1D* histoTrueEffiPt6080_OldMC =        (TH1D*)directoryPi0PbPb6080_OldMC->Get("Pi0_Efficiency");
   TH1D* histoAcceptPt6080_OldMC =          (TH1D*)directoryPi0PbPb6080_OldMC->Get("Pi0_Acceptance");
   TH1D* histoMCYieldPtWOWeights6080_OldMC = (TH1D*)directoryPi0PbPb6080_OldMC->Get("Pi0_HIJING_Input");
   
   
   TFile* fileNeutralPionPbPbPileup4060 = new TFile("546000103209297002322000000_01523065009000/PbPb_2.76TeV/Pi0_data_GammaConvV1Correction_546000103209297002322000000_01523065009000.root");
   TH1D* histoPileupContaminationPi0PbPb4060= (TH1D*)fileNeutralPionPbPbPileup4060->Get("PileupContamination");
   TFile* fileNeutralPionPbPbPileup6080 = new TFile("568000103209297002322000000_01523065009000/PbPb_2.76TeV/Pi0_data_GammaConvV1Correction_568000103209297002322000000_01523065009000.root");
   TH1D* histoPileupContaminationPi0PbPb6080= (TH1D*)fileNeutralPionPbPbPileup6080->Get("PileupContamination");
   TFile* fileNeutralPionPbPbPileup4050 = new TFile("545000104209297002322000000_01522065009000/PbPb_2.76TeV/Pi0_data_GammaConvV1Correction_545000104209297002322000000_01522065009000.root");
   TH1D* histoPileupContaminationPi0PbPb4050= (TH1D*)fileNeutralPionPbPbPileup4050->Get("PileupContamination");
   TFile* fileNeutralPionPbPbPileup5060 = new TFile("556000104209297002322000000_01522065009000/PbPb_2.76TeV/Pi0_data_GammaConvV1Correction_556000104209297002322000000_01522065009000.root");
   TH1D* histoPileupContaminationPi0PbPb5060= (TH1D*)fileNeutralPionPbPbPileup5060->Get("PileupContamination");
   TFile* fileNeutralPionPbPbPileup6070 = new TFile("567000104209297002322000000_01522065009000/PbPb_2.76TeV/Pi0_data_GammaConvV1Correction_567000104209297002322000000_01522065009000.root");
   TH1D* histoPileupContaminationPi0PbPb6070= (TH1D*)fileNeutralPionPbPbPileup6070->Get("PileupContamination");
   TFile* fileNeutralPionPbPbPileup7080 = new TFile("578000104209297002322000000_01522065009000/PbPb_2.76TeV/Pi0_data_GammaConvV1Correction_578000104209297002322000000_01522065009000.root");
   TH1D* histoPileupContaminationPi0PbPb7080= (TH1D*)fileNeutralPionPbPbPileup7080->Get("PileupContamination");
   TFile* fileNeutralPionPbPbPileup7590 = new TFile("469000104209297002322000000_01522065009000/PbPb_2.76TeV/Pi0_data_GammaConvV1Correction_469000104209297002322000000_01522065009000.root");
   TH1D* histoPileupContaminationPi0PbPb7590= (TH1D*)fileNeutralPionPbPbPileup7590->Get("PileupContamination");
   TFile* fileNeutralPionPbPbPileup8090 = new TFile("589000104209297002322000000_01522065009000/PbPb_2.76TeV/Pi0_data_GammaConvV1Correction_589000104209297002322000000_01522065009000.root");
   TH1D* histoPileupContaminationPi0PbPb8090= (TH1D*)fileNeutralPionPbPbPileup8090->Get("PileupContamination");

   
   TFile* fileNeutralPionPbPbAddSig0005 = new TFile("0thIteration/3010002042092970023220000_01522045009/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_3010002042092970023220000_01522045009.root");
   TH1D* histoMCYieldPi0PbPbAddSig0005= (TH1D*)fileNeutralPionPbPbAddSig0005->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig0005= (TH1D*)fileNeutralPionPbPbAddSig0005->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig0510 = new TFile("0thIteration/3120002042092970023220000_01522045009/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_3120002042092970023220000_01522045009.root");
   TH1D* histoMCYieldPi0PbPbAddSig0510= (TH1D*)fileNeutralPionPbPbAddSig0510->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig0510= (TH1D*)fileNeutralPionPbPbAddSig0510->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig0010 = new TFile("0thIteration/1010002042092970023220000_01522045009/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_1010002042092970023220000_01522045009.root");
   TH1D* histoMCYieldPi0PbPbAddSig0010= (TH1D*)fileNeutralPionPbPbAddSig0010->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig0010= (TH1D*)fileNeutralPionPbPbAddSig0010->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig1020 = new TFile("0thIteration/1120002042092970023220000_01522045009/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_1120002042092970023220000_01522045009.root");
   TH1D* histoMCYieldPi0PbPbAddSig1020= (TH1D*)fileNeutralPionPbPbAddSig1020->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig1020= (TH1D*)fileNeutralPionPbPbAddSig1020->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig2040 = new TFile("0thIteration/1240002042092970023220000_01522045009/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_1240002042092970023220000_01522045009.root");
   TH1D* histoMCYieldPi0PbPbAddSig2040= (TH1D*)fileNeutralPionPbPbAddSig2040->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig2040= (TH1D*)fileNeutralPionPbPbAddSig2040->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig4060 = new TFile("0thIteration/1460002042092970023220000_01522065009/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_1460002042092970023220000_01522065009.root");
   TH1D* histoMCYieldPi0PbPbAddSig4060= (TH1D*)fileNeutralPionPbPbAddSig4060->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig4060= (TH1D*)fileNeutralPionPbPbAddSig4060->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig6080 = new TFile("0thIteration/1680002042092970023220000_01522065009/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_1680002042092970023220000_01522065009.root");
   TH1D* histoMCYieldPi0PbPbAddSig6080= (TH1D*)fileNeutralPionPbPbAddSig6080->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig6080= (TH1D*)fileNeutralPionPbPbAddSig6080->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig0020 = new TFile("0thIteration/102000204209237002370000000_01522045009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_102000204209237002370000000_01522045009000.root");
   TH1D* histoMCYieldPi0PbPbAddSig0020= (TH1D*)fileNeutralPionPbPbAddSig0020->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig0020= (TH1D*)fileNeutralPionPbPbAddSig0020->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig0040 = new TFile("0thIteration/104000204209237002370000000_01522045009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_104000204209237002370000000_01522045009000.root");
   TH1D* histoMCYieldPi0PbPbAddSig0040= (TH1D*)fileNeutralPionPbPbAddSig0040->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig0040= (TH1D*)fileNeutralPionPbPbAddSig0040->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig0080 = new TFile("0thIteration/108000204209237002370000000_01522045009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_108000204209237002370000000_01522045009000.root");
   TH1D* histoMCYieldPi0PbPbAddSig0080= (TH1D*)fileNeutralPionPbPbAddSig0080->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig0080= (TH1D*)fileNeutralPionPbPbAddSig0080->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig4080 = new TFile("0thIteration/148000204209237002370000000_01522065009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_148000204209237002370000000_01522065009000.root");
   TH1D* histoMCYieldPi0PbPbAddSig4080= (TH1D*)fileNeutralPionPbPbAddSig4080->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig4080= (TH1D*)fileNeutralPionPbPbAddSig4080->Get("TrueMesonEffiPt");

   // ************************************************************************************
   // ********************** Added signal TPC mult ***************************************
   // ************************************************************************************
   TFile* fileNeutralPionPbPbAddSig0005TPCMult = new TFile("0thIteration/601000204209297002322000000_01522045009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_601000204209297002322000000_01522045009000.root");
   TH1D* histoMCYieldPi0PbPbAddSig0005TPCMult= (TH1D*)fileNeutralPionPbPbAddSig0005TPCMult->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig0005TPCMult= (TH1D*)fileNeutralPionPbPbAddSig0005TPCMult->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig0510TPCMult = new TFile("0thIteration/612000204209297002322000000_01522045009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_612000204209297002322000000_01522045009000.root");
   TH1D* histoMCYieldPi0PbPbAddSig0510TPCMult= (TH1D*)fileNeutralPionPbPbAddSig0510TPCMult->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig0510TPCMult= (TH1D*)fileNeutralPionPbPbAddSig0510TPCMult->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig0010TPCMult = new TFile("0thIteration/501000204209297002322000000_01522045009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_501000204209297002322000000_01522045009000.root");
   TH1D* histoMCYieldPi0PbPbAddSig0010TPCMult= (TH1D*)fileNeutralPionPbPbAddSig0010TPCMult->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig0010TPCMult= (TH1D*)fileNeutralPionPbPbAddSig0010TPCMult->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig1020TPCMult = new TFile("0thIteration/512000204209297002322000000_01522045009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_512000204209297002322000000_01522045009000.root");
   TH1D* histoMCYieldPi0PbPbAddSig1020TPCMult= (TH1D*)fileNeutralPionPbPbAddSig1020TPCMult->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig1020TPCMult= (TH1D*)fileNeutralPionPbPbAddSig1020TPCMult->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig2040TPCMult = new TFile("0thIteration/524000204209297002322000000_01522045009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_524000204209297002322000000_01522045009000.root");
   TH1D* histoMCYieldPi0PbPbAddSig2040TPCMult= (TH1D*)fileNeutralPionPbPbAddSig2040TPCMult->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig2040TPCMult= (TH1D*)fileNeutralPionPbPbAddSig2040TPCMult->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig4060TPCMult = new TFile("0thIteration/546000204209297002322000000_01522065009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_546000204209297002322000000_01522065009000.root");
   TH1D* histoMCYieldPi0PbPbAddSig4060TPCMult= (TH1D*)fileNeutralPionPbPbAddSig4060TPCMult->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig4060TPCMult= (TH1D*)fileNeutralPionPbPbAddSig4060TPCMult->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig6080TPCMult = new TFile("0thIteration/568000204209297002322000000_01522065009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_568000204209297002322000000_01522065009000.root");
   TH1D* histoMCYieldPi0PbPbAddSig6080TPCMult= (TH1D*)fileNeutralPionPbPbAddSig6080TPCMult->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig6080TPCMult= (TH1D*)fileNeutralPionPbPbAddSig6080TPCMult->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig0020TPCMult = new TFile("0thIteration/502000204209237002370000000_01522045009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_502000204209237002370000000_01522045009000.root");
   TH1D* histoMCYieldPi0PbPbAddSig0020TPCMult= (TH1D*)fileNeutralPionPbPbAddSig0020TPCMult->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig0020TPCMult= (TH1D*)fileNeutralPionPbPbAddSig0020TPCMult->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig0040TPCMult = new TFile("0thIteration/504000204209237002370000000_01522045009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_504000204209237002370000000_01522045009000.root");
   TH1D* histoMCYieldPi0PbPbAddSig0040TPCMult= (TH1D*)fileNeutralPionPbPbAddSig0040TPCMult->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig0040TPCMult= (TH1D*)fileNeutralPionPbPbAddSig0040TPCMult->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig4080TPCMult = new TFile("0thIteration/548000204209237002370000000_01522065009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_548000204209237002370000000_01522065009000.root");
   TH1D* histoMCYieldPi0PbPbAddSig4080TPCMult= (TH1D*)fileNeutralPionPbPbAddSig4080TPCMult->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig4080TPCMult= (TH1D*)fileNeutralPionPbPbAddSig4080TPCMult->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPbAddSig0080TPCMult = new TFile("0thIteration/508000204209237002370000000_01522045009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_508000204209237002370000000_01522045009000.root");
   TH1D* histoMCYieldPi0PbPbAddSig0080TPCMult= (TH1D*)fileNeutralPionPbPbAddSig0080TPCMult->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPbAddSig0080TPCMult= (TH1D*)fileNeutralPionPbPbAddSig0080TPCMult->Get("TrueMesonEffiPt");
   
   // ************************************************************************************
   // ********************** Minbias TPC mult ********************************************
   // ************************************************************************************
   TFile*   filePCMTPCMult = NULL;
   TDirectory* directoryPi0PbPb0005TPCMul = NULL;
   TH1D* histoTrueEffiPt0005TPCMult = NULL;
   TH1D* histoAcceptPt0005TPCMult = NULL;
   TH1D* histoMCYieldPtWOWeights0005TPCMult 
   TDirectory* directoryPi0PbPb0010TPCMult = NULL;
   TH1D* histoTrueEffiPt0010TPCMult = NULL;
   TH1D* histoAcceptPt0010TPCMult = NULL;
   TH1D* histoMCYieldPtWOWeights0010TPCMult = NULL;
   TDirectory* directoryPi0PbPb0510TPCMult = NULL;
   TH1D* histoTrueEffiPt0510TPCMult= NULL;
   TH1D* histoAcceptPt0510TPCMult = NULL;
   TH1D* histoMCYieldPtWOWeights0510TPCMult = NULL;
   TDirectory* directoryPi0PbPb1020TPCMult= NULL;
   TH1D* histoTrueEffiPt1020TPCMult = NULL;
   TH1D* histoAcceptPt1020TPCMult = NULL;
   TH1D* histoMCYieldPtWOWeights1020TPCMult = NULL;
   TDirectory* directoryPi0PbPb2040TPCMult = NULL;
   TH1D* histoTrueEffiPt2040TPCMult = NULL;
   TH1D* histoAcceptPt2040TPCMult = NULL;
   TH1D* histoMCYieldPtWOWeights2040TPCMult = NULL;
   TDirectory* directoryPi0PbPb4060TPCMult = NULL;
   TH1D* histoTrueEffiPt4060TPCMult = NULL;
   TH1D* histoAcceptPt4060TPCMult = NULL;
   TH1D* histoMCYieldPtWOWeights4060TPCMult = NULL;
   TDirectory* directoryPi0PbPb6080TPCMult = NULL;
   TH1D* histoTrueEffiPt6080TPCMult = NULL;
   TH1D* histoAcceptPt6080TPCMult = NULL;
   TH1D* histoMCYieldPtWOWeights6080TPCMult = NULL;
   
   if (nameFileTPCMult.CompareTo("") != 0){
      filePCMTPCMult =              new TFile(nameFileTPCMult.Data());
      cout << "0-5% old MC file" << endl;
      directoryPi0PbPb0005TPCMult =  (TDirectory*)filePCMTPCMult->Get("Pi0_PbPb_2.76TeV_0-5%"); 
      histoTrueEffiPt0005TPCMult =        (TH1D*)directoryPi0PbPb0005TPCMult->Get("Pi0_Efficiency");
      histoAcceptPt0005TPCMult =          (TH1D*)directoryPi0PbPb0005TPCMult->Get("Pi0_Acceptance");
      histoMCYieldPtWOWeights0005TPCMult = (TH1D*)directoryPi0PbPb0005TPCMult->Get("Pi0_HIJING_Input");
   
      cout << "0-10% old MC file" << endl;
      directoryPi0PbPb0010TPCMult =           (TDirectory*)filePCMTPCMult->Get("Pi0_PbPb_2.76TeV_0-10%"); 
      histoTrueEffiPt0010TPCMult =        (TH1D*)directoryPi0PbPb0010TPCMult->Get("Pi0_Efficiency");
      histoAcceptPt0010TPCMult =          (TH1D*)directoryPi0PbPb0010TPCMult->Get("Pi0_Acceptance");
      histoMCYieldPtWOWeights0010TPCMult = (TH1D*)directoryPi0PbPb0010TPCMult->Get("Pi0_HIJING_Input");
   
      cout << "5-10% old MC file" << endl;
      directoryPi0PbPb0510TPCMult =           (TDirectory*)filePCMTPCMult->Get("Pi0_PbPb_2.76TeV_5-10%"); 
      histoTrueEffiPt0510TPCMult =        (TH1D*)directoryPi0PbPb0510TPCMult->Get("Pi0_Efficiency");
      histoAcceptPt0510TPCMult =          (TH1D*)directoryPi0PbPb0510TPCMult->Get("Pi0_Acceptance");
      histoMCYieldPtWOWeights0510TPCMult = (TH1D*)directoryPi0PbPb0510TPCMult->Get("Pi0_HIJING_Input");
   
      cout << "10-20% old MC file" << endl;
      directoryPi0PbPb1020TPCMult =           (TDirectory*)filePCMTPCMult->Get("Pi0_PbPb_2.76TeV_10-20%"); 
      histoTrueEffiPt1020TPCMult =        (TH1D*)directoryPi0PbPb1020TPCMult->Get("Pi0_Efficiency");
      histoAcceptPt1020TPCMult =          (TH1D*)directoryPi0PbPb1020TPCMult->Get("Pi0_Acceptance");
      histoMCYieldPtWOWeights1020TPCMult = (TH1D*)directoryPi0PbPb1020TPCMult->Get("Pi0_HIJING_Input");
   
      cout << "20-40% old MC file" << endl;
      directoryPi0PbPb2040TPCMult =           (TDirectory*)filePCMTPCMult->Get("Pi0_PbPb_2.76TeV_20-40%"); 
      histoTrueEffiPt2040TPCMult =        (TH1D*)directoryPi0PbPb2040TPCMult->Get("Pi0_Efficiency");
      histoAcceptPt2040TPCMult =          (TH1D*)directoryPi0PbPb2040TPCMult->Get("Pi0_Acceptance");
      histoMCYieldPtWOWeights2040TPCMult = (TH1D*)directoryPi0PbPb2040TPCMult->Get("Pi0_HIJING_Input");
   
      cout << "40-60% old MC file" << endl;
      directoryPi0PbPb4060TPCMult =           (TDirectory*)filePCMTPCMult->Get("Pi0_PbPb_2.76TeV_40-60%"); 
      histoTrueEffiPt4060TPCMult =        (TH1D*)directoryPi0PbPb4060TPCMult->Get("Pi0_Efficiency");
      histoAcceptPt4060TPCMult =          (TH1D*)directoryPi0PbPb4060TPCMult->Get("Pi0_Acceptance");
      histoMCYieldPtWOWeights4060TPCMult = (TH1D*)directoryPi0PbPb4060TPCMult->Get("Pi0_HIJING_Input");
   
      cout << "60-80% old MC file" << endl;
      directoryPi0PbPb6080TPCMult =           (TDirectory*)filePCMTPCMult->Get("Pi0_PbPb_2.76TeV_60-80%");
      histoTrueEffiPt6080TPCMult =        (TH1D*)directoryPi0PbPb6080TPCMult->Get("Pi0_Efficiency");
      histoAcceptPt6080TPCMult =          (TH1D*)directoryPi0PbPb6080TPCMult->Get("Pi0_Acceptance");
      histoMCYieldPtWOWeights6080TPCMult = (TH1D*)directoryPi0PbPb6080TPCMult->Get("Pi0_HIJING_Input");
   }

   TFile* fileNeutralPionPbPb0020TPCMult = new TFile("0thIteration/502000104209237002370000000_01522045009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_502000104209237002370000000_01522045009000.root");
   TH1D* histoMCYieldPi0PbPb0020TPCMult= (TH1D*)fileNeutralPionPbPb0020TPCMult->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPb0020TPCMult= (TH1D*)fileNeutralPionPbPb0020TPCMult->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPb0040TPCMult = new TFile("0thIteration/504000104209237002370000000_01522045009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_504000104209237002370000000_01522045009000.root");
   TH1D* histoMCYieldPi0PbPb0040TPCMult= (TH1D*)fileNeutralPionPbPb0040TPCMult->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPb0040TPCMult= (TH1D*)fileNeutralPionPbPb0040TPCMult->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPb4080TPCMult = new TFile("0thIteration/548000104209237002370000000_01522065009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_548000104209237002370000000_01522065009000.root");
   TH1D* histoMCYieldPi0PbPb4080TPCMult= (TH1D*)fileNeutralPionPbPb4080TPCMult->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPb4080TPCMult= (TH1D*)fileNeutralPionPbPb4080TPCMult->Get("TrueMesonEffiPt");
   TFile* fileNeutralPionPbPb0080TPCMult = new TFile("0thIteration/508000104209237002370000000_01522045009000/PbPb_2.76TeV/Pi0_MC_GammaConvV1Correction_108000104209237002370000000_01522045009000.root");
   TH1D* histoMCYieldPi0PbPb0080TPCMult= (TH1D*)fileNeutralPionPbPb0080TPCMult->Get("MCYield_Meson_oldBin");
   TH1D* histoEffiPi0PbPb0080TPCMult= (TH1D*)fileNeutralPionPbPb0080TPCMult->Get("TrueMesonEffiPt");
   ...
   TFile* fileNeutralPionCombDataPP = new TFile("CombinedResultsPaperX_2_Dec_2013.root");
...
//    TH1D* histoCorrectedYieldPi02760GeVOld =           (TH1D*)directoryPi02760GeVOld->Get("CorrectedYieldPi0");
   ...
   TFile* filePi0PbPbRawExtraction0005 = new TFile("LHC11h/601000100209297002322000000_01525045009000/PbPb_2.76TeV/Pi0_data_GammaConvV1WithoutCorrection_601000100209297002322000000_01525045009000.root");
   TH1D* histoPi0RawYieldLHC11h0005= (TH1D*)filePi0PbPbRawExtraction0005->Get("histoYieldMesonPerEvent");
   TH1D* histoPi0SBLHC11h0005= (TH1D*)filePi0PbPbRawExtraction0005->Get("histoSBMeson");
   TH1D* histoPi0SignLHC11h0005= (TH1D*)filePi0PbPbRawExtraction0005->Get("histoSignMeson");
   TFile* filePi0PbPbRawExtraction0510 = new TFile("LHC11h/612000100209297002322000000_01525045009000/PbPb_2.76TeV/Pi0_data_GammaConvV1WithoutCorrection_612000100209297002322000000_01525045009000.root");
   TH1D* histoPi0RawYieldLHC11h0510= (TH1D*)filePi0PbPbRawExtraction0510->Get("histoYieldMesonPerEvent");
   TH1D* histoPi0SBLHC11h0510= (TH1D*)filePi0PbPbRawExtraction0510->Get("histoSBMeson");
   TH1D* histoPi0SignLHC11h0510= (TH1D*)filePi0PbPbRawExtraction0510->Get("histoSignMeson");
   
   TFile* filePi0PbPbRawExtraction0010 = new
   TFile("LHC11h/501000100209297002322000000_01525045009000/PbPb_2.76TeV/Pi0_data_GammaConvV1WithoutCorrection_501000100209297002322000000_01525045009000.root");
   TH1D* histoPi0RawYieldLHC11h0010= (TH1D*)filePi0PbPbRawExtraction0010->Get("histoYieldMesonPerEvent");
   TH1D* histoPi0SBLHC11h0010= (TH1D*)filePi0PbPbRawExtraction0010->Get("histoSBMeson");
   TH1D* histoPi0SignLHC11h0010= (TH1D*)filePi0PbPbRawExtraction0010->Get("histoSignMeson");
   
   TFile* filePi0PbPbRawExtraction1020 = new TFile("LHC11h/512000100209297002322000000_01525045009000/PbPb_2.76TeV/Pi0_data_GammaConvV1WithoutCorrection_512000100209297002322000000_01525045009000.root");
   TH1D* histoPi0RawYieldLHC11h1020= (TH1D*)filePi0PbPbRawExtraction1020->Get("histoYieldMesonPerEvent");
   TH1D* histoPi0SBLHC11h1020= (TH1D*)filePi0PbPbRawExtraction1020->Get("histoSBMeson");
   TH1D* histoPi0SignLHC11h1020= (TH1D*)filePi0PbPbRawExtraction1020->Get("histoSignMeson");
   
   TFile* filePi0PbPbRawExtraction2040 = new TFile("LHC11h/524000100209297002322000000_01525045009000/PbPb_2.76TeV/Pi0_data_GammaConvV1WithoutCorrection_524000100209297002322000000_01525045009000.root");
   TH1D* histoPi0RawYieldLHC11h2040= (TH1D*)filePi0PbPbRawExtraction2040->Get("histoYieldMesonPerEvent");
   TH1D* histoPi0SBLHC11h2040= (TH1D*)filePi0PbPbRawExtraction2040->Get("histoSBMeson");
   TH1D* histoPi0SignLHC11h2040= (TH1D*)filePi0PbPbRawExtraction2040->Get("histoSignMeson");
   
   TFile* filePi0PbPbRawExtraction4060 = new TFile("LHC11h/546000100209297002322000000_01525065009000/PbPb_2.76TeV/Pi0_data_GammaConvV1WithoutCorrection_546000100209297002322000000_01525065009000.root");
   TH1D* histoPi0RawYieldLHC11h4060= (TH1D*)filePi0PbPbRawExtraction4060->Get("histoYieldMesonPerEvent");
   TH1D* histoPi0SBLHC11h4060= (TH1D*)filePi0PbPbRawExtraction4060->Get("histoSBMeson");
   TH1D* histoPi0SignLHC11h4060= (TH1D*)filePi0PbPbRawExtraction4060->Get("histoSignMeson");
   

   TFile* fileEtaPbPbRawExtraction0005 = new TFile("LHC11h/601000100209297002322000000_01525045009000/PbPb_2.76TeV/Eta_data_GammaConvV1WithoutCorrectionLHC11h_601000100209297002322000000_01525045009000.root");
   TH1D* histoEtaRawYieldLHC11h0005= (TH1D*)fileEtaPbPbRawExtraction0005->Get("histoYieldMesonPerEvent");
   TH1D* histoEtaSBLHC11h0005= (TH1D*)fileEtaPbPbRawExtraction0005->Get("histoSBMeson");
   TH1D* histoEtaSignLHC11h0005= (TH1D*)fileEtaPbPbRawExtraction0005->Get("histoSignMeson");
   
   TFile* fileEtaPbPbRawExtraction0510 = new TFile("LHC11h/612000100209297002322000000_01525045009000/PbPb_2.76TeV/Eta_data_GammaConvV1WithoutCorrectionLHC11h_612000100209297002322000000_01525045009000.root");
   TH1D* histoEtaRawYieldLHC11h0510= (TH1D*)fileEtaPbPbRawExtraction0510->Get("histoYieldMesonPerEvent");
   TH1D* histoEtaSBLHC11h0510= (TH1D*)fileEtaPbPbRawExtraction0510->Get("histoSBMeson");
   TH1D* histoEtaSignLHC11h0510= (TH1D*)fileEtaPbPbRawExtraction0510->Get("histoSignMeson");
   
   TFile* fileEtaPbPbRawExtraction0010 = new TFile("LHC11h/501000100209297002322000000_01525045009000/PbPb_2.76TeV/Eta_data_GammaConvV1WithoutCorrectionLHC11h_501000100209297002322000000_01525045009000.root");
   TH1D* histoEtaRawYieldLHC11h0010= (TH1D*)fileEtaPbPbRawExtraction0010->Get("histoYieldMesonPerEvent");
   TH1D* histoEtaSBLHC11h0010= (TH1D*)fileEtaPbPbRawExtraction0010->Get("histoSBMeson");
   TH1D* histoEtaSignLHC11h0010= (TH1D*)fileEtaPbPbRawExtraction0010->Get("histoSignMeson");
   
   TFile* fileEtaPbPbRawExtraction1020 = new TFile("LHC11h/512000100209297002322000000_01525045009000/PbPb_2.76TeV/Eta_data_GammaConvV1WithoutCorrectionLHC11h_512000100209297002322000000_01525045009000.root");
   TH1D* histoEtaRawYieldLHC11h1020= (TH1D*)fileEtaPbPbRawExtraction1020->Get("histoYieldMesonPerEvent");
   TH1D* histoEtaSBLHC11h1020= (TH1D*)fileEtaPbPbRawExtraction1020->Get("histoSBMeson");
   TH1D* histoEtaSignLHC11h1020= (TH1D*)fileEtaPbPbRawExtraction1020->Get("histoSignMeson");
   
   TFile* fileEtaPbPbRawExtraction2040 = new TFile("LHC11h/524000100209297002322000000_01525045009000/PbPb_2.76TeV/Eta_data_GammaConvV1WithoutCorrectionLHC11h_524000100209297002322000000_01525045009000.root");
   TH1D* histoEtaRawYieldLHC11h2040= (TH1D*)fileEtaPbPbRawExtraction2040->Get("histoYieldMesonPerEvent");
   TH1D* histoEtaSBLHC11h2040= (TH1D*)fileEtaPbPbRawExtraction2040->Get("histoSBMeson");
   TH1D* histoEtaSignLHC11h2040= (TH1D*)fileEtaPbPbRawExtraction2040->Get("histoSignMeson");
   
   TFile* fileEtaPbPbRawExtraction4060 = new TFile("LHC11h/546000100209297002322000000_01525065009000/PbPb_2.76TeV/Eta_data_GammaConvV1WithoutCorrectionLHC11h_546000100209297002322000000_01525065009000.root");
   TH1D* histoEtaRawYieldLHC11h4060= (TH1D*)fileEtaPbPbRawExtraction4060->Get("histoYieldMesonPerEvent");
   TH1D* histoEtaSBLHC11h4060= (TH1D*)fileEtaPbPbRawExtraction4060->Get("histoSBMeson");
   TH1D* histoEtaSignLHC11h4060= (TH1D*)fileEtaPbPbRawExtraction4060->Get("histoSignMeson");
...
//       histo2DEffEta->GetXaxis()->SetRangeUser(0.,12.);
      ...
      legendEffiEta->AddEntry(histoEtaTrueEffiPt0010,"0-10% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiEta->AddEntry(histoTrueEffPtEta7TeV,"pp #sqrt{#it{s}} = 7 TeV","p");
      legendEffiEta->AddEntry(histoEtaTrueEffiPt1020,"10-20% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiEta->AddEntry(histoTrueEffPtEta2760GeV,"pp #sqrt{#it{s}} = 2.76 TeV","p");
      legendEffiEta->AddEntry(histoEtaTrueEffiPt2040,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiEta->AddEntry(histoTrueEffPtEta900GeV,"pp #sqrt{#it{s}} = 0.9 TeV","p");
      legendEffiEta->AddEntry(histoEtaTrueEffiPt4060,"40-60% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiEta->AddEntry((TObject*)0, "","");
      legendEffiEta->AddEntry(histoEtaTrueEffiPt6080,"60-80% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
   ...
   canvasEffAllEta->SaveAs(Form("%s/EffCompEta.%s",outputDir.Data(),suffix.Data()));
      ...
      DrawGammaSetMarker(histoEffiEtapPb, 33, markerSizePi0PP7TeV, kViolet+2, kViolet+2);  
      histoEffiEtapPb->DrawCopy("e1,same");
      
      TLegend* legendEffiEtapPb = new TLegend(0.12,0.78,0.83,0.93);
      legendEffiEtapPb->SetFillColor(0);
      legendEffiEtapPb->SetLineColor(0);
      legendEffiEtapPb->SetTextSize(0.027);
      legendEffiEtapPb->SetNColumns(2);
      legendEffiEtapPb->AddEntry(histoEtaTrueEffiPt0010,"0-10% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiEtapPb->AddEntry(histoTrueEffPtEta7TeV,"pp #sqrt{#it{s}} = 7 TeV","p");
      legendEffiEtapPb->AddEntry(histoEtaTrueEffiPt2040,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiEtapPb->AddEntry(histoTrueEffPtEta2760GeV,"pp #sqrt{#it{s}} = 2.76 TeV","p");
      legendEffiEtapPb->AddEntry(histoEtaTrueEffiPt6080,"60-80% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiEtapPb->AddEntry(histoEffiEtapPb,"p-Pb #sqrt{s_{_{NN}}} = 5.023 TeV","p");
      legendEffiEtapPb->Draw();

      
  canvasEffAllEta->SaveAs(Form("%s/EffCompEtaIncpPb.%s",outputDir.Data(),suffix.Data()));    
...
//       canvasRawYieldEta->SetLogx();
      ...
      SetStyleHistoTH2ForGraphs(histo2DRawEta, "#it{p}_{T} (GeV/#it{c})","#frac{d#it{N}_{raw}^{#eta}}{N_{evt} d#it{p}_{T}}",0.035,0.04, 0.035,0.04, 1.,1.3);
...
//       canvasRawYieldPi0->SetLogx();
      ...
      SetStyleHistoTH2ForGraphs(histo2DRawPi0, "#it{p}_{T} (GeV/#it{c})","#frac{d#it{N}_{raw}^{#pi^{0}}}{N_{evt} d#it{p}_{T}}",0.035,0.04, 0.035,0.04, 1.,1.3);
...
//       legendRawYieldPi02760GeV->AddEntry(histoRawYieldPi02760GeVOld,"pp #sqrt{#it{s}} = 2.76 TeV, old","p");      
...
//    
   ...
   TH2F * histo2DPileupBG;
   histo2DPileupBG = new TH2F("histo2DPileupBG","histo2DPileupBG",1000,0.,12.,1000,0,30 );
   SetStyleHistoTH2ForGraphs(histo2DPileupBG, "#it{p}_{T} (GeV/#it{c})","Pileup Contamination", 0.03,0.04, 0.03,0.04, 0.83,1.4);
//    histo2DPileupBG->GetXaxis()->SetRangeUser(0.3,30);
//    histo2DPileupBG->GetXaxis()->SetLabelOffset(-0.01);
   histo2DPileupBG->GetYaxis()->SetLabelOffset(0.01);
   histo2DPileupBG->DrawCopy(); 
   
   if (histoPileupContaminationPi0PbPb4060){
      DrawGammaSetMarker(histoPileupContaminationPi0PbPb4060, markerStylePbPb4060, markerSizePbPb4060, colorCombPbPb4060, colorCombPbPb4060); 
      histoPileupContaminationPi0PbPb4060->DrawCopy("e1,same");   
   }
   if (histoPileupContaminationPi0PbPb4050){
      DrawGammaSetMarker(histoPileupContaminationPi0PbPb4050, markerStylePbPb4050, markerSizePbPb4060, colorCombPbPb4050, colorCombPbPb4050); 
      histoPileupContaminationPi0PbPb4050->DrawCopy("e1,same");   
   }
   if (histoPileupContaminationPi0PbPb5060){
      DrawGammaSetMarker(histoPileupContaminationPi0PbPb5060, markerStylePbPb5060, markerSizePbPb4060, colorCombPbPb5060, colorCombPbPb5060); 
      histoPileupContaminationPi0PbPb5060->DrawCopy("e1,same");   
   }
   if (histoPileupContaminationPi0PbPb6080){
      DrawGammaSetMarker(histoPileupContaminationPi0PbPb6080, markerStylePbPb6080, markerSizePbPb6080, colorCombPbPb6080, colorCombPbPb6080); 
      histoPileupContaminationPi0PbPb6080->DrawCopy("e1,same");   
   }
   if (histoPileupContaminationPi0PbPb6070){
      DrawGammaSetMarker(histoPileupContaminationPi0PbPb6070, markerStylePbPb6070, markerSizePbPb6080, colorCombPbPb6070, colorCombPbPb6070); 
      histoPileupContaminationPi0PbPb6070->DrawCopy("e1,same");   
   }
   if (histoPileupContaminationPi0PbPb7080){
      DrawGammaSetMarker(histoPileupContaminationPi0PbPb7080, markerStylePbPb7080, markerSizePbPb6080, colorCombPbPb7080, colorCombPbPb7080); 
      histoPileupContaminationPi0PbPb7080->DrawCopy("e1,same");   
   }
   if (histoPileupContaminationPi0PbPb8090){
      DrawGammaSetMarker(histoPileupContaminationPi0PbPb8090, markerStylePbPb8090, markerSizePbPb6080, colorCombPbPb8090, colorCombPbPb8090); 
      histoPileupContaminationPi0PbPb8090->DrawCopy("e1,same");   
   }
   if (histoPileupContaminationPi0PbPb7590){
      DrawGammaSetMarker(histoPileupContaminationPi0PbPb7590, markerStylePbPb7590, markerSizePbPb6080, colorCombPbPb7590, colorCombPbPb7590); 
      histoPileupContaminationPi0PbPb7590->DrawCopy("e1,same");   
   }

         
   TLegend* legendPileup = new TLegend(0.5,0.7,0.93,0.93);
   legendPileup->SetFillColor(0);
   legendPileup->SetLineColor(0);
   legendPileup->SetTextSize(0.027);
   if (histoPileupContaminationPi0PbPb4050)legendPileup->AddEntry(histoPileupContaminationPi0PbPb4050,Form("%s, |#eta| < 0.75",collisionSystemPbPb4050.Data()),"p");
   if (histoPileupContaminationPi0PbPb4060)legendPileup->AddEntry(histoPileupContaminationPi0PbPb4060,Form("%s, |#eta| < 0.65",collisionSystemPbPb4060.Data()),"p");
   if (histoPileupContaminationPi0PbPb5060)legendPileup->AddEntry(histoPileupContaminationPi0PbPb5060,Form("%s, |#eta| < 0.75",collisionSystemPbPb5060.Data()),"p");
   if (histoPileupContaminationPi0PbPb6070)legendPileup->AddEntry(histoPileupContaminationPi0PbPb6070,Form("%s, |#eta| < 0.75",collisionSystemPbPb6070.Data()),"p");
   if (histoPileupContaminationPi0PbPb6080)legendPileup->AddEntry(histoPileupContaminationPi0PbPb6080,Form("%s, |#eta| < 0.65",collisionSystemPbPb6080.Data()),"p");
   if (histoPileupContaminationPi0PbPb7080)legendPileup->AddEntry(histoPileupContaminationPi0PbPb7080,Form("%s, |#eta| < 0.75",collisionSystemPbPb7080.Data()),"p");
   if (histoPileupContaminationPi0PbPb8090)legendPileup->AddEntry(histoPileupContaminationPi0PbPb8090,Form("%s, |#eta| < 0.75",collisionSystemPbPb8090.Data()),"p");
   if (histoPileupContaminationPi0PbPb7590)legendPileup->AddEntry(histoPileupContaminationPi0PbPb7590,Form("%s, |#eta| < 0.75",collisionSystemPbPb7590.Data()),"p");

   legendPileup->Draw();

   
   
   canvasFraction2->SaveAs(Form("%s/PileupFractionForDifferentCentralities.%s",outputDir.Data(),suffix.Data()));
...
//                "", "#it{p}_{T} (GeV/#it{c})", "#frac{N^{raw}_{#pi^{0},old}}{N^{raw}_{#pi^{0},new}}, pp @ 2.76TeV",
...
//                "", "#it{p}_{T} (GeV/#it{c})", "#frac{N^{corr}_{#pi^{0},old}}{N^{corr}_{#pi^{0},new}}, pp @ 2.76TeV",
//                kFALSE, 5., 10e-10, kTRUE,
//                kTRUE, 0.5, 1.5,
//                kTRUE, 0., 7.9);
//    canvasFraction2->Update();
...
//       canvasMCYieldPi0->SetLogx();
      ...
      SetStyleHistoTH2ForGraphs(histo2DMCYieldPi0, "#it{p}_{T} (GeV/#it{c})","#frac{1}{2#pi #it{N}_{ev}} #frac{d^{2}#it{N}}{#it{p}_{T}d#it{p}_{T}d#it{y}} (GeV/#it{c})^{-2}",0.035,0.04, 0.035,0.04, 1.,1.3);
...
//       canvasMCYieldEta->SetLogx();
      ...
      SetStyleHistoTH2ForGraphs(histo2DMCYieldEta, "#it{p}_{T} (GeV/#it{c})","#frac{1}{2#pi #it{N}_{ev}} #frac{d^{2}#it{N}}{#it{p}_{T}d#it{p}_{T}d#it{y}} (GeV/#it{c})^{-2}",0.035,0.04, 0.035,0.04, 1.,1.3);
...
//       canvasRawYieldPi0PbPb->SetLogx();
      ...
      histo2DRawPi0PbPb = new TH2F("histo2DRawPi0PbPb","histo2DRawPi0PbPb",1000,0.,25,2000,1.e-8,1e-1 );
      ...
      histo2DRawPi0PbPb->GetXaxis()->SetRangeUser(0.,14.);
      histo2DRawPi0PbPb->GetYaxis()->SetRangeUser(1.e-7,1e-1 );
      ...
      legendRawYieldPi0PbPb->AddEntry(histoRawYield0005,"0-5% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldPi0PbPb->AddEntry(histoRawYield0510,"5-10% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldPi0PbPb->AddEntry(histoRawYield1020,"10-20% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldPi0PbPb->AddEntry(histoRawYield2040,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldPi0PbPb->AddEntry(histoRawYield4060,"40-60% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldPi0PbPb->AddEntry(histoRawYield6080,"60-80% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldPi0PbPb->Draw();
   
   canvasRawYieldPi0PbPb->SaveAs(Form("%s/RawYieldCompPi0PbPb.%s",outputDir.Data(),suffix.Data()));
      histo2DRawPi0PbPb->GetXaxis()->SetRangeUser(0.,25.);
      histo2DRawPi0PbPb->GetYaxis()->SetRangeUser(1.e-8,1e-1 );
      histo2DRawPi0PbPb->Draw("copy");
   
      DrawGammaSetMarker(histoPi0RawYieldLHC11h0005, markerStylePbPb0005, markerSizePbPb0005, colorCombPbPb0005, colorCombPbPb0005);   
      histoPi0RawYieldLHC11h0005->DrawCopy("e1,same");   
      DrawGammaSetMarker(histoPi0RawYieldLHC11h0510, markerStylePbPb0010, markerSizePbPb0010, colorCombPbPb0510, colorCombPbPb0510);   
      histoPi0RawYieldLHC11h0510->DrawCopy("e1,same");   
      DrawGammaSetMarker(histoPi0RawYieldLHC11h1020, markerStylePbPb1020, markerSizePbPb1020, colorCombPbPb1020, colorCombPbPb1020);   
      histoPi0RawYieldLHC11h1020->DrawCopy("e1,same");   
      DrawGammaSetMarker(histoPi0RawYieldLHC11h2040, markerStylePbPb2040, markerSizePbPb2040, colorCombPbPb2040, colorCombPbPb2040);   
      histoPi0RawYieldLHC11h2040->DrawCopy("e1,same");   
      DrawGammaSetMarker(histoPi0RawYieldLHC11h4060, markerStylePbPb4060, markerSizePbPb4060, colorCombPbPb4060, colorCombPbPb4060);   
      histoPi0RawYieldLHC11h4060->DrawCopy("e1,same");   

      labelRawPi0PbPb->Draw();

      
      TLegend* legendRawYieldPi0PbPbLHC11h = new TLegend(0.55,0.63,0.93,0.93);
      legendRawYieldPi0PbPbLHC11h->SetFillColor(0);
      legendRawYieldPi0PbPbLHC11h->SetLineColor(0);
      legendRawYieldPi0PbPbLHC11h->SetTextSize(0.035);
      legendRawYieldPi0PbPbLHC11h->AddEntry(histoPi0RawYieldLHC11h0005,"0-5% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldPi0PbPbLHC11h->AddEntry(histoPi0RawYieldLHC11h0510,"5-10% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldPi0PbPbLHC11h->AddEntry(histoPi0RawYieldLHC11h1020,"10-20% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldPi0PbPbLHC11h->AddEntry(histoPi0RawYieldLHC11h2040,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldPi0PbPbLHC11h->AddEntry(histoPi0RawYieldLHC11h4060,"40-60% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldPi0PbPbLHC11h->Draw();
   
   canvasRawYieldPi0PbPb->SaveAs(Form("%s/RawYieldCompPi0PbPb_LHC11h.%s",outputDir.Data(),suffix.Data()));

      TH2F * histo2DSBPi0PbPb;
      histo2DSBPi0PbPb = new TH2F("histo2DSBPi0PbPb","histo2DSBPi0PbPb",1000,0.,25,2000,0,1000);
      
      SetStyleHistoTH2ForGraphs(histo2DSBPi0PbPb, "#it{p}_{T} (GeV/#it{c})","S/B",0.035,0.04, 0.035,0.04, 1.,1.3);
      histo2DSBPi0PbPb->GetXaxis()->SetRangeUser(0.,14.);
//       histo2DSBPi0PbPb->GetYaxis()->SetRangeUser(1.e-7,1e-1 );
      histo2DSBPi0PbPb->Draw("copy");
        
      DrawGammaSetMarker(histoPi0SBLHC11h0005, markerStylePbPb0005, markerSizePbPb0005, colorCombPbPb0005, colorCombPbPb0005);   
      histoPi0SBLHC11h0005->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoPi0SBLHC11h0510, markerStylePbPb0010, markerSizePbPb0010, colorCombPbPb0510, colorCombPbPb0510);   
      histoPi0SBLHC11h0510->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoPi0SBLHC11h1020, markerStylePbPb1020, markerSizePbPb1020, colorCombPbPb1020, colorCombPbPb1020);   
      histoPi0SBLHC11h1020->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoPi0SBLHC11h2040, markerStylePbPb2040, markerSizePbPb2040, colorCombPbPb2040, colorCombPbPb2040);   
      histoPi0SBLHC11h2040->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoPi0SBLHC11h4060, markerStylePbPb4060, markerSizePbPb4060, colorCombPbPb4060, colorCombPbPb4060);   
      histoPi0SBLHC11h4060->DrawCopy("pe1,same");   

      labelRawPi0PbPb->Draw();

      
      TLegend* legendSBPi0PbPbLHC11h = new TLegend(0.18,0.13,0.63,0.33);
      legendSBPi0PbPbLHC11h->SetFillColor(0);
      legendSBPi0PbPbLHC11h->SetLineColor(0);
      legendSBPi0PbPbLHC11h->SetTextSize(0.035);
      legendSBPi0PbPbLHC11h->AddEntry(histoPi0SBLHC11h0005,"0-5% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSBPi0PbPbLHC11h->AddEntry(histoPi0SBLHC11h0510,"5-10% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSBPi0PbPbLHC11h->AddEntry(histoPi0SBLHC11h1020,"10-20% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSBPi0PbPbLHC11h->AddEntry(histoPi0SBLHC11h2040,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSBPi0PbPbLHC11h->AddEntry(histoPi0SBLHC11h4060,"40-60% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSBPi0PbPbLHC11h->Draw();
   
   canvasRawYieldPi0PbPb->SaveAs(Form("%s/Pi0_SBCombPbPb_LHC11h.%s",outputDir.Data(),suffix.Data()));

      TH2F * histo2DSignPi0PbPb;
      histo2DSignPi0PbPb = new TH2F("histo2DSignPi0PbPb","histo2DSignPi0PbPb",1000,0.,25,2000,0,100);
      
      SetStyleHistoTH2ForGraphs(histo2DSignPi0PbPb, "#it{p}_{T} (GeV/#it{c})","S/#sqrt{S+B}",0.035,0.04, 0.035,0.04, 1.,1.3);
      histo2DSignPi0PbPb->GetXaxis()->SetRangeUser(0.,14.);
      histo2DSignPi0PbPb->GetYaxis()->SetRangeUser(1.e-2,50 );
      histo2DSignPi0PbPb->Draw("copy");
        
      DrawGammaSetMarker(histoPi0SignLHC11h0005, markerStylePbPb0005, markerSizePbPb0005, colorCombPbPb0005, colorCombPbPb0005);   
      histoPi0SignLHC11h0005->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoPi0SignLHC11h0510, markerStylePbPb0010, markerSizePbPb0010, colorCombPbPb0510, colorCombPbPb0510);   
      histoPi0SignLHC11h0510->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoPi0SignLHC11h1020, markerStylePbPb1020, markerSizePbPb1020, colorCombPbPb1020, colorCombPbPb1020);   
      histoPi0SignLHC11h1020->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoPi0SignLHC11h2040, markerStylePbPb2040, markerSizePbPb2040, colorCombPbPb2040, colorCombPbPb2040);   
      histoPi0SignLHC11h2040->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoPi0SignLHC11h4060, markerStylePbPb4060, markerSizePbPb4060, colorCombPbPb4060, colorCombPbPb4060);   
      histoPi0SignLHC11h4060->DrawCopy("pe1,same");   

      labelRawPi0PbPb->Draw();

      
      TLegend* legendSignPi0PbPbLHC11h = new TLegend(0.55,0.63,0.93,0.93);
      legendSignPi0PbPbLHC11h->SetFillColor(0);
      legendSignPi0PbPbLHC11h->SetLineColor(0);
      legendSignPi0PbPbLHC11h->SetTextSize(0.035);
      legendSignPi0PbPbLHC11h->AddEntry(histoPi0SignLHC11h0005,"0-5% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSignPi0PbPbLHC11h->AddEntry(histoPi0SignLHC11h0510,"5-10% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSignPi0PbPbLHC11h->AddEntry(histoPi0SignLHC11h1020,"10-20% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSignPi0PbPbLHC11h->AddEntry(histoPi0SignLHC11h2040,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSignPi0PbPbLHC11h->AddEntry(histoPi0SignLHC11h4060,"40-60% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSignPi0PbPbLHC11h->Draw();
   
   canvasRawYieldPi0PbPb->SaveAs(Form("%s/Pi0_SignCombPbPb_LHC11h.%s",outputDir.Data(),suffix.Data()));
...
//       canvasRawYieldEtaPbPb->SetLogx();
      ...
      legendRawYieldEtaPbPb->AddEntry(histoEtaRawYield0010,"0-10% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldEtaPbPb->AddEntry(histoEtaRawYield1020,"10-20% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldEtaPbPb->AddEntry(histoEtaRawYield2040,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldEtaPbPb->AddEntry(histoEtaRawYield4060,"40-60% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldEtaPbPb->AddEntry(histoEtaRawYield6080,"60-80% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
   ...
   canvasRawYieldEtaPbPb->SaveAs(Form("%s/RawYieldCompEtaPbPb.%s",outputDir.Data(),suffix.Data()));
      ...
      DrawGammaSetMarker(histoEtaRawYieldLHC11h0510, markerStylePbPb0510, markerSizePbPb0510, colorCombPbPb0510, colorCombPbPb0510);   
      histoEtaRawYieldLHC11h0510->DrawCopy("e1,same");   
      DrawGammaSetMarker(histoEtaRawYieldLHC11h0005, markerStylePbPb0005, markerSizePbPb0005, colorCombPbPb0005, colorCombPbPb0005);   
      histoEtaRawYieldLHC11h0005->DrawCopy("e1,same");   
      DrawGammaSetMarker(histoEtaRawYieldLHC11h1020, markerStylePbPb1020, markerSizePbPb1020, colorCombPbPb1020, colorCombPbPb1020);   
      histoEtaRawYieldLHC11h1020->DrawCopy("e1,same");   
      DrawGammaSetMarker(histoEtaRawYieldLHC11h2040, markerStylePbPb2040, markerSizePbPb2040, colorCombPbPb2040, colorCombPbPb2040);   
      histoEtaRawYieldLHC11h2040->DrawCopy("e1,same");   
      DrawGammaSetMarker(histoEtaRawYieldLHC11h4060, markerStylePbPb4060, markerSizePbPb4060, colorCombPbPb4060, colorCombPbPb4060);   
      histoEtaRawYieldLHC11h4060->DrawCopy("e1,same");   

      labelRawEtaPbPb->Draw();

      TLegend* legendRawYieldEtaPbPbLHC11h = new TLegend(0.55,0.63,0.93,0.93);
      legendRawYieldEtaPbPbLHC11h->SetFillColor(0);
      legendRawYieldEtaPbPbLHC11h->SetLineColor(0);
      legendRawYieldEtaPbPbLHC11h->SetTextSize(0.035);
      legendRawYieldEtaPbPbLHC11h->AddEntry(histoEtaRawYieldLHC11h0005,"0-5% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldEtaPbPbLHC11h->AddEntry(histoEtaRawYieldLHC11h0510,"5-10% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldEtaPbPbLHC11h->AddEntry(histoEtaRawYieldLHC11h1020,"10-20% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldEtaPbPbLHC11h->AddEntry(histoEtaRawYieldLHC11h2040,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldEtaPbPbLHC11h->AddEntry(histoEtaRawYieldLHC11h4060,"40-60% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendRawYieldEtaPbPbLHC11h->Draw();
   
   canvasRawYieldEtaPbPb->SaveAs(Form("%s/RawYieldCompEtaPbPbLHC11h.%s",outputDir.Data(),suffix.Data()));

      TH2F * histo2DSBEtaPbPb;
      histo2DSBEtaPbPb = new TH2F("histo2DSBEtaPbPb","histo2DSBEtaPbPb",1000,0.,25,2000,1e-1,1000);
      
      SetStyleHistoTH2ForGraphs(histo2DSBEtaPbPb, "#it{p}_{T} (GeV/#it{c})","S/B",0.035,0.04, 0.035,0.04, 1.,1.3);
      histo2DSBEtaPbPb->GetXaxis()->SetRangeUser(0.,14.);
      histo2DSBEtaPbPb->GetYaxis()->SetRangeUser(1.e-3,1e2);
      histo2DSBEtaPbPb->Draw("copy");
        
      DrawGammaSetMarker(histoEtaSBLHC11h0005, markerStylePbPb0005, markerSizePbPb0005, colorCombPbPb0005, colorCombPbPb0005);   
      histoEtaSBLHC11h0005->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoEtaSBLHC11h0510, markerStylePbPb0010, markerSizePbPb0010, colorCombPbPb0510, colorCombPbPb0510);   
      histoEtaSBLHC11h0510->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoEtaSBLHC11h1020, markerStylePbPb1020, markerSizePbPb1020, colorCombPbPb1020, colorCombPbPb1020);   
      histoEtaSBLHC11h1020->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoEtaSBLHC11h2040, markerStylePbPb2040, markerSizePbPb2040, colorCombPbPb2040, colorCombPbPb2040);   
      histoEtaSBLHC11h2040->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoEtaSBLHC11h4060, markerStylePbPb4060, markerSizePbPb4060, colorCombPbPb4060, colorCombPbPb4060);   
      histoEtaSBLHC11h4060->DrawCopy("pe1,same");   

      labelRawEtaPbPb->Draw();

      
      TLegend* legendSBEtaPbPbLHC11h = new TLegend(0.55,0.13,0.93,0.33);
      legendSBEtaPbPbLHC11h->SetFillColor(0);
      legendSBEtaPbPbLHC11h->SetLineColor(0);
      legendSBEtaPbPbLHC11h->SetTextSize(0.035);
      legendSBEtaPbPbLHC11h->AddEntry(histoEtaSBLHC11h0005,"0-5% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSBEtaPbPbLHC11h->AddEntry(histoEtaSBLHC11h0510,"5-10% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSBEtaPbPbLHC11h->AddEntry(histoEtaSBLHC11h1020,"10-20% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSBEtaPbPbLHC11h->AddEntry(histoEtaSBLHC11h2040,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSBEtaPbPbLHC11h->AddEntry(histoEtaSBLHC11h4060,"40-60% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSBEtaPbPbLHC11h->Draw();
   
   canvasRawYieldEtaPbPb->SaveAs(Form("%s/Eta_SBCombPbPb_LHC11h.%s",outputDir.Data(),suffix.Data()));

      TH2F * histo2DSignEtaPbPb;
      histo2DSignEtaPbPb = new TH2F("histo2DSignEtaPbPb","histo2DSignEtaPbPb",1000,0.,25,2000,0,100);
      
      SetStyleHistoTH2ForGraphs(histo2DSignEtaPbPb, "#it{p}_{T} (GeV/#it{c})","S/#sqrt{S+B}",0.035,0.04, 0.035,0.04, 1.,1.3);
      histo2DSignEtaPbPb->GetXaxis()->SetRangeUser(0.,14.);
      histo2DSignEtaPbPb->GetYaxis()->SetRangeUser(1.e-2,50 );
      histo2DSignEtaPbPb->Draw("copy");
        
      DrawGammaSetMarker(histoEtaSignLHC11h0005, markerStylePbPb0005, markerSizePbPb0005, colorCombPbPb0005, colorCombPbPb0005);   
      histoEtaSignLHC11h0005->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoEtaSignLHC11h0510, markerStylePbPb0010, markerSizePbPb0010, colorCombPbPb0510, colorCombPbPb0510);   
      histoEtaSignLHC11h0510->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoEtaSignLHC11h1020, markerStylePbPb1020, markerSizePbPb1020, colorCombPbPb1020, colorCombPbPb1020);   
      histoEtaSignLHC11h1020->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoEtaSignLHC11h2040, markerStylePbPb2040, markerSizePbPb2040, colorCombPbPb2040, colorCombPbPb2040);   
      histoEtaSignLHC11h2040->DrawCopy("pe1,same");   
      DrawGammaSetMarker(histoEtaSignLHC11h4060, markerStylePbPb4060, markerSizePbPb4060, colorCombPbPb4060, colorCombPbPb4060);   
      histoEtaSignLHC11h4060->DrawCopy("pe1,same");   

      labelRawEtaPbPb->Draw();

      
      TLegend* legendSignEtaPbPbLHC11h = new TLegend(0.55,0.63,0.93,0.93);
      legendSignEtaPbPbLHC11h->SetFillColor(0);
      legendSignEtaPbPbLHC11h->SetLineColor(0);
      legendSignEtaPbPbLHC11h->SetTextSize(0.035);
      legendSignEtaPbPbLHC11h->AddEntry(histoEtaSignLHC11h0005,"0-5% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSignEtaPbPbLHC11h->AddEntry(histoEtaSignLHC11h0510,"5-10% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSignEtaPbPbLHC11h->AddEntry(histoEtaSignLHC11h1020,"10-20% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSignEtaPbPbLHC11h->AddEntry(histoEtaSignLHC11h2040,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSignEtaPbPbLHC11h->AddEntry(histoEtaSignLHC11h4060,"40-60% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendSignEtaPbPbLHC11h->Draw();
   
   canvasRawYieldEtaPbPb->SaveAs(Form("%s/Eta_SignCombPbPb_LHC11h.%s",outputDir.Data(),suffix.Data()));
...
//       histo2DEffAllCent->GetXaxis()->SetRangeUser(0.,12.);
      SetStyleHistoTH2ForGraphs(histo2DEffAllCent, "#it{p}_{T} (GeV/#it{c})","#epsilon_{reco, #pi^{0}}",0.03,0.04, 0.03,0.04, 1.,1.);
      ...
      TLegend* legendEffiCompAllCent = new TLegend(0.5,0.13,0.94,0.32);
      legendEffiCompAllCent->SetFillColor(0);
      legendEffiCompAllCent->SetLineColor(0);
      legendEffiCompAllCent->SetTextSize(0.027);
      legendEffiCompAllCent->AddEntry(histoTrueEffiPt0005,"0-5% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiCompAllCent->AddEntry(histoTrueEffiPt0510,"5-10% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiCompAllCent->AddEntry(histoTrueEffiPt1020,"10-20% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiCompAllCent->AddEntry(histoTrueEffiPt2040,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiCompAllCent->AddEntry(histoTrueEffiPt4060,"40-60% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiCompAllCent->AddEntry(histoTrueEffiPt6080,"60-80% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiCompAllCent->Draw();
   
      TLegend* legendEffiCompAllCent2 = new TLegend(0.14,0.84,0.4,0.94);
      legendEffiCompAllCent2->SetFillColor(0);
      legendEffiCompAllCent2->SetLineColor(0);
      legendEffiCompAllCent2->SetTextSize(0.027);
      legendEffiCompAllCent2->AddEntry(histoTrueEffPtPi07TeV,"pp #sqrt{#it{s}} = 7 TeV","p");
      legendEffiCompAllCent2->AddEntry(histoTrueEffPtPi02760GeV,"pp #sqrt{#it{s}} = 2.76 TeV","p");
      legendEffiCompAllCent2->AddEntry(histoTrueEffPtPi0900GeV,"pp #sqrt{#it{s}} = 0.9 TeV","p");
      legendEffiCompAllCent2->Draw();
   ...
   canvasEffAllCent->SaveAs(Form("%s/EffCompSimplePP.%s",outputDir.Data(),suffix.Data()));
      ...
      histoTrueEffiPt2040->DrawCopy("e1,same");
      histoTrueEffiPt6080->DrawCopy("e1,same");
      DrawGammaSetMarker(histoEffiPi0pPb, 33, markerSizePi0PP7TeV, kViolet+2, kViolet+2);  
      histoEffiPi0pPb->DrawCopy("e1,same");
      
      legendEffiCompAllCent2->Draw();

      TLegend* legendEffiCompAllCentIncpPb = new TLegend(0.5,0.13,0.94,0.32);
      legendEffiCompAllCentIncpPb->SetFillColor(0);
      legendEffiCompAllCentIncpPb->SetLineColor(0);
      legendEffiCompAllCentIncpPb->SetTextSize(0.027);
      legendEffiCompAllCentIncpPb->AddEntry(histoTrueEffiPt0005,"0-5% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiCompAllCentIncpPb->AddEntry(histoTrueEffiPt1020,"10-20% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiCompAllCentIncpPb->AddEntry(histoTrueEffiPt2040,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiCompAllCentIncpPb->AddEntry(histoTrueEffiPt6080,"60-80% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendEffiCompAllCentIncpPb->AddEntry(histoEffiPi0pPb,"p-Pb #sqrt{s_{_{NN}}} = 5.023 TeV","p");
      legendEffiCompAllCentIncpPb->Draw();
      
   canvasEffAllCent->SaveAs(Form("%s/EffCompSimpleAllCentIncpPb.%s",outputDir.Data(),suffix.Data()));  

   if (nameFileTPCMult.CompareTo("") != 0){
      canvasEffAllCent->cd();
         histo2DEffAllCent->GetXaxis()->SetRangeUser(0.,12.);
         histo2DEffAllCent->GetYaxis()->SetRangeUser(0.e-3,2.6e-3 );
         histo2DEffAllCent->Draw("copy");
         ...
         DrawGammaSetMarker(histoTrueEffiPt0005, markerStylePbPb0005, markerSizePbPb0005, colorCombPbPb0005, colorCombPbPb0005); 
         histoTrueEffiPt0005->DrawCopy("e1,same");    
         DrawGammaSetMarker(histoTrueEffiPt0510, markerStylePbPb0510, markerSizePbPb0510, colorCombPbPb0510, colorCombPbPb0510); 
         histoTrueEffiPt0510->DrawCopy("e1,same");    
         DrawGammaSetMarker(histoTrueEffiPt1020, markerStylePbPb1020, markerSizePbPb1020, colorCombPbPb1020, colorCombPbPb1020); 
         histoTrueEffiPt1020->DrawCopy("e1,same");    
         DrawGammaSetMarker(histoTrueEffiPt2040, markerStylePbPb2040, markerSizePbPb2040, colorCombPbPb2040, colorCombPbPb2040); 
         ...
         DrawGammaSetMarker(histoTrueEffiPt6080TPCMult, markerStylePbPb6080MC, markerSizePbPb6080, colorCombPbPb6080, colorCombPbPb6080); 
         histoTrueEffiPt6080TPCMult->DrawCopy("e1,same");    
         DrawGammaSetMarker(histoTrueEffiPt0005TPCMult, markerStylePbPb0005MC, markerSizePbPb0005, colorCombPbPb0005, colorCombPbPb0005); 
         histoTrueEffiPt0005TPCMult->DrawCopy("e1,same");    
         DrawGammaSetMarker(histoTrueEffiPt0510TPCMult, markerStylePbPb0510MC, markerSizePbPb0510, colorCombPbPb0510, colorCombPbPb0510); 
         histoTrueEffiPt0510TPCMult->DrawCopy("e1,same");    
         DrawGammaSetMarker(histoTrueEffiPt1020TPCMult, markerStylePbPb1020MC, markerSizePbPb1020, colorCombPbPb1020, colorCombPbPb1020); 
         histoTrueEffiPt1020TPCMult->DrawCopy("e1,same");    
         DrawGammaSetMarker(histoTrueEffiPt2040TPCMult, markerStylePbPb2040MC, markerSizePbPb2040, colorCombPbPb2040, colorCombPbPb2040); 
         histoTrueEffiPt2040TPCMult->DrawCopy("e1,same");    
         DrawGammaSetMarker(histoTrueEffiPt4060TPCMult, markerStylePbPb4060MC, markerSizePbPb4060, colorCombPbPb4060, colorCombPbPb4060); 
         histoTrueEffiPt4060TPCMult->DrawCopy("e1,same");    
   //       legendEffiCompAllCent->Draw();
         
         TLegend* legendEffiDiffCentSel = new TLegend(0.25,0.13,0.94,0.32);
         legendEffiDiffCentSel->SetFillColor(0);
         legendEffiDiffCentSel->SetLineColor(0);
         legendEffiDiffCentSel->SetTextSize(0.027);
         legendEffiDiffCentSel->SetNColumns(3);
         legendEffiDiffCentSel->AddEntry((TObject*)0,"0-5% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","");
         legendEffiDiffCentSel->AddEntry(histoTrueEffiPt0005,"V0 Mult","p");
         legendEffiDiffCentSel->AddEntry(histoTrueEffiPt0005TPCMult,"TPC Mult","p");
         legendEffiDiffCentSel->AddEntry((TObject*)0,"5-10% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","");
         legendEffiDiffCentSel->AddEntry(histoTrueEffiPt0510,"V0 Mult","p");
         legendEffiDiffCentSel->AddEntry(histoTrueEffiPt0510TPCMult,"TPC Mult","p");
         legendEffiDiffCentSel->AddEntry((TObject*)0,"10-20% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","");
         legendEffiDiffCentSel->AddEntry(histoTrueEffiPt1020,"V0 Mult","p");
         legendEffiDiffCentSel->AddEntry(histoTrueEffiPt1020TPCMult,"TPC Mult","p");
         legendEffiDiffCentSel->AddEntry((TObject*)0,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","");
         legendEffiDiffCentSel->AddEntry(histoTrueEffiPt2040,"V0 Mult","p");
         legendEffiDiffCentSel->AddEntry(histoTrueEffiPt2040TPCMult,"TPC Mult","p");
         legendEffiDiffCentSel->AddEntry((TObject*)0,"40-60% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","");
         legendEffiDiffCentSel->AddEntry(histoTrueEffiPt4060,"V0 Mult","p");
         legendEffiDiffCentSel->AddEntry(histoTrueEffiPt4060TPCMult,"TPC Mult","p");
         legendEffiDiffCentSel->AddEntry((TObject*)0,"60-80% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","");
         legendEffiDiffCentSel->AddEntry(histoTrueEffiPt6080,"V0 Mult","p");
         legendEffiDiffCentSel->AddEntry(histoTrueEffiPt6080TPCMult,"TPC Mult","p");
         legendEffiDiffCentSel->Draw();
      
         
      canvasEffAllCent->SaveAs(Form("%s/EffComparedDiffCentSelections.%s",outputDir.Data(),suffix.Data()));
   
   
   canvasEffAllCent->cd();
      canvasEffAllCent->SetLogy();
      histo2DEffAllCent->GetXaxis()->SetRangeUser(0.,12.);
      histo2DEffAllCent->GetYaxis()->SetRangeUser(1.e-6,5e-3 );
      histo2DEffAllCent->Draw("copy");
   ...
   canvasEffAllCent->SaveAs(Form("%s/EffComparedDiffCentSelectionsLogY.%s",outputDir.Data(),suffix.Data()));
   ...
   DrawGammaCanvasSettings( canvasAccepAllCent, 0.1, 0.02, 0.035, 0.09);
      ...
      SetStyleHistoTH2ForGraphs(histo2DAccepAllEta, "#it{p}_{T} (GeV/#it{c})","A_{#eta}",0.03,0.04, 0.03,0.04, 1.,1.2);
      ...
      legendAcceptAllEta->AddEntry(histoEtaAcceptPt0010,"0-10% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendAcceptAllEta->AddEntry((TObject*)0, " |y| < 0.7","");
      legendAcceptAllEta->AddEntry(histoEtaAcceptPt1020,"10-20% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendAcceptAllEta->AddEntry((TObject*)0, " |y| < 0.7","");
      legendAcceptAllEta->AddEntry(histoEtaAcceptPt2040,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendAcceptAllEta->AddEntry((TObject*)0, " |y| < 0.7","");
      legendAcceptAllEta->AddEntry(histoEtaAcceptPt4060,"40-60% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendAcceptAllEta->AddEntry((TObject*)0, " |y| < 0.7","");
      legendAcceptAllEta->AddEntry(histoEtaAcceptPt6080,"60-80% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendAcceptAllEta->AddEntry((TObject*)0, " |y| < 0.7","");
...
//       histo2DAccepAllCent->GetXaxis()->SetRangeUser(0.,12.);
      ...
      SetStyleHistoTH2ForGraphs(histo2DAccepAllCent, "#it{p}_{T} (GeV/#it{c})","A_{#pi^{0}}",0.03,0.04, 0.03,0.04, 1.,1.2);
      ...
      legendAcceptAllCent->AddEntry(histoAcceptPt0005,"0-5% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendAcceptAllCent->AddEntry((TObject*)0, " |y| < 0.6","");
      legendAcceptAllCent->AddEntry(histoAcceptPt0510,"5-10% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendAcceptAllCent->AddEntry((TObject*)0, " |y| < 0.6","");
      legendAcceptAllCent->AddEntry(histoAcceptPt1020,"10-20% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendAcceptAllCent->AddEntry((TObject*)0, " |y| < 0.6","");
      legendAcceptAllCent->AddEntry(histoAcceptPt2040,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendAcceptAllCent->AddEntry((TObject*)0, " |y| < 0.6","");
      legendAcceptAllCent->AddEntry(histoAcceptPt4060,"40-60% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendAcceptAllCent->AddEntry((TObject*)0, " |y| < 0.6","");
      legendAcceptAllCent->AddEntry(histoAcceptPt6080,"60-80% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendAcceptAllCent->AddEntry((TObject*)0, " |y| < 0.6","");
   ...
   canvasAccepEta->SaveAs(Form("%s/AcceptanceCompAllCent.%s",outputDir.Data(),suffix.Data()));
      ...
      DrawGammaSetMarker(histoAcceptPt2040, markerStylePbPb2040, markerSizePbPb2040, colorCombPbPb2040, colorCombPbPb2040);   
      histoAcceptPt2040->DrawCopy("e1,same");   
      DrawGammaSetMarker(histoAcceptPi0pPb, 33, markerSizePi0PP7TeV, kViolet+2, kViolet+2);  
      histoAcceptPi0pPb->DrawCopy("e1,same");
   
      TLegend* legendAcceptAllCentIncpPb = new TLegend(0.34,0.13,0.93,0.43);
      legendAcceptAllCentIncpPb->SetFillColor(0);
      legendAcceptAllCentIncpPb->SetLineColor(0);
      legendAcceptAllCentIncpPb->SetTextSize(0.03);
      legendAcceptAllCentIncpPb->SetNColumns(2);
      legendAcceptAllCentIncpPb->AddEntry(histoAcceptPt0005,"0-5% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendAcceptAllCentIncpPb->AddEntry((TObject*)0, " |y| < 0.6","");
      legendAcceptAllCentIncpPb->AddEntry(histoAcceptPt1020,"10-20% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendAcceptAllCentIncpPb->AddEntry((TObject*)0, " |y| < 0.6","");
      legendAcceptAllCentIncpPb->AddEntry(histoAcceptPt2040,"20-40% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendAcceptAllCentIncpPb->AddEntry((TObject*)0, " |y| < 0.6","");
      legendAcceptAllCentIncpPb->AddEntry(histoAcceptPt6080,"60-80% Pb-Pb #sqrt{s_{_{NN}}} = 2.76 TeV","p");
      legendAcceptAllCentIncpPb->AddEntry((TObject*)0, " |y| < 0.6","");
      legendAcceptAllCentIncpPb->AddEntry(histoAcceptPi0pPb,"p-Pb #sqrt{s_{_{NN}}} = 5.023 TeV","p");
      legendAcceptAllCentIncpPb->AddEntry((TObject*)0, " |y| < 0.8","");
      legendAcceptAllCentIncpPb->AddEntry(histoAccPi07TeV,"pp #sqrt{#it{s}} = 7 TeV","p");
      legendAcceptAllCentIncpPb->AddEntry((TObject*)0, " |y| < 0.8","");
      legendAcceptAllCentIncpPb->AddEntry(histoAccPi02760GeV,"pp #sqrt{#it{s}} = 2.76 TeV","p");
      legendAcceptAllCentIncpPb->AddEntry((TObject*)0, " |y| < 0.8","");
      legendAcceptAllCentIncpPb->AddEntry(histoAccPi0900GeV,"pp #sqrt{#it{s}} = 0.9 TeV","p");
      legendAcceptAllCentIncpPb->AddEntry((TObject*)0, " |y| < 0.8","");
      legendAcceptAllCentIncpPb->Draw();
   
   canvasAccepEta->SaveAs(Form("%s/AcceptanceCompAllCentIncpPb.%s",outputDir.Data(),suffix.Data()));
   ...
   SetStyleHistoTH2ForGraphs(histo2DEtaFWHM, "#it{p}_{T} (GeV/#it{c})","FWHM/2.36 (MeV/#it{c}^{2})", 0.035,0.05, 0.065,0.08, 1,1, 515, 504); 
   ...
   SetStyleHistoTH2ForGraphs(histo2DEtaMass, "#it{p}_{T} (GeV/#it{c})","m_{#eta} (MeV/#it{c}^{2})", 0.062,0.076, 0.062,0.078, 0.8,1, 515, 504); 
...
//       canvasSecFrac->SetLogy(1); 
      ...
      DrawAutoGammaMesonHistos( histoDefaultTrueSecFracMeson, 
            "", "#it{p}_{T} (GeV/#it{c})", "r_{X} = #frac{X->#pi^{0}}{#pi^{0}}", 
            kTRUE, 1.5, 0, kFALSE,
            kFALSE, 0., 0.7, 
            kFALSE, 0., 10.);
...
//    legendSpectra->AddEntry(fitInvCrossSectionPi0Comb2760GeVPow,"Powerlaw Fit","l");
   ...
   SetStyleHistoTH2ForGraphs(histo2DSpectraMCAll, "#it{p}_{T} (GeV/#it{c})","#frac{1}{2#pi #it{N}_{ev}} #frac{d^{2}#it{N}}{#it{p}_{T}d#it{p}_{T}d#it{y}} (GeV/#it{c})^{-2}", 0.03,0.04, 0.03,0.04, 0.83,1.4);// 512, 505); //#frac{#frac{1}{N_{evt}^{AA}}#frac{d#it{N}^{AA}}{d#it{p}_{T} d#it{y}}}{ #frac{1}{N_{evt}^{pp}}#frac{d#it{N}^{pp}}{d#it{p}_{T} d#it{y}}}
   ...
   DrawGammaSetMarker(histoMCYieldPtWOWeights0005, markerStylePbPb0005,markerSizePbPb0005, colorCombPbPb0005 , colorCombPbPb0005);//, colorCombPbPb0510-5);
   histoMCYieldPtWOWeights0005->Draw("hist,l,same");
   DrawGammaSetMarker(histoMCYieldPtWOWeights0510, markerStylePbPb0510,markerSizePbPb0510, colorCombPbPb0510 , colorCombPbPb0510);//, colorCombPbPb0510-5);
   histoMCYieldPtWOWeights0510->Draw("hist,l,same");   
   DrawGammaSetMarker(histoMCYieldPtWOWeights1020, markerStylePbPb1020,markerSizePbPb1020, colorCombPbPb1020 , colorCombPbPb1020);//, colorCombPbPb1020-5);
   histoMCYieldPtWOWeights1020->Draw("hist,l,same");
   DrawGammaSetMarker(histoMCYieldPtWOWeights2040, markerStylePbPb2040,markerSizePbPb2040, colorCombPbPb2040 , colorCombPbPb2040);//, colorCombPbPb2040-5);
   histoMCYieldPtWOWeights2040->Draw("hist,l,same");
   DrawGammaSetMarker(histoMCYieldPtWOWeights4060, markerStylePbPb4060,markerSizePbPb4060, colorCombPbPb4060 , colorCombPbPb4060);//, colorCombPbPb4060-5);
   histoMCYieldPtWOWeights4060->Draw("hist,l,same");
   DrawGammaSetMarker(histoMCYieldPtWOWeights6080, markerStylePbPb6080,markerSizePbPb6080, colorCombPbPb6080 , colorCombPbPb6080);//, colorCombPbPb6080-5);
   histoMCYieldPtWOWeights6080->Draw("hist,l,same");
   
   DrawGammaSetMarker(histoMCYieldPtWOWeights0005_OldMC, markerStylePbPb0005,markerSizePbPb0005, colorCombPbPb0005 , colorCombPbPb0005);
   histoMCYieldPtWOWeights0005_OldMC->SetLineStyle(2);
   histoMCYieldPtWOWeights0005_OldMC->Draw("hist,l,same");
   DrawGammaSetMarker(histoMCYieldPtWOWeights0510_OldMC, markerStylePbPb0510,markerSizePbPb0510, colorCombPbPb0510 , colorCombPbPb0510);
   histoMCYieldPtWOWeights0510_OldMC->SetLineStyle(2);
   histoMCYieldPtWOWeights0510_OldMC->Draw("hist,l,same");   
   DrawGammaSetMarker(histoMCYieldPtWOWeights1020_OldMC, markerStylePbPb1020,markerSizePbPb1020, colorCombPbPb1020 , colorCombPbPb1020);
   histoMCYieldPtWOWeights1020_OldMC->SetLineStyle(2);
   histoMCYieldPtWOWeights1020_OldMC->Draw("hist,l,same");
   DrawGammaSetMarker(histoMCYieldPtWOWeights2040_OldMC, markerStylePbPb2040,markerSizePbPb2040, colorCombPbPb2040 , colorCombPbPb2040);
   histoMCYieldPtWOWeights2040_OldMC->SetLineStyle(2);
   histoMCYieldPtWOWeights2040_OldMC->Draw("hist,l,same");
   DrawGammaSetMarker(histoMCYieldPtWOWeights4060_OldMC, markerStylePbPb4060,markerSizePbPb4060, colorCombPbPb4060 , colorCombPbPb4060);
   histoMCYieldPtWOWeights4060_OldMC->SetLineStyle(2);
   histoMCYieldPtWOWeights4060_OldMC->Draw("hist,l,same");
   DrawGammaSetMarker(histoMCYieldPtWOWeights6080_OldMC, markerStylePbPb6080,markerSizePbPb6080, colorCombPbPb6080 , colorCombPbPb6080);
   histoMCYieldPtWOWeights6080_OldMC->SetLineStyle(2);
   histoMCYieldPtWOWeights6080_OldMC->Draw("hist,l,same");   
   
   DrawGammaSetMarker(histoMCYieldPi0PbPbAddSig0005, markerStylePbPb0005,markerSizePbPb0005, colorCombMCPbPb0005 , colorCombMCPbPb0005);
   histoMCYieldPi0PbPbAddSig0005->SetLineStyle(8);
   histoMCYieldPi0PbPbAddSig0005->Draw("hist,l,same");
   
   DrawGammaSetMarker(histoMCYieldPi0PbPbAddSig0510, markerStylePbPb0510,markerSizePbPb0510, colorCombMCPbPb0510 , colorCombMCPbPb0510);
   histoMCYieldPi0PbPbAddSig0510->SetLineStyle(8);
   histoMCYieldPi0PbPbAddSig0510->Draw("hist,l,same");

   DrawGammaSetMarker(histoMCYieldPi0PbPbAddSig1020, markerStylePbPb1020,markerSizePbPb1020, colorCombMCPbPb1020 , colorCombMCPbPb1020);
   histoMCYieldPi0PbPbAddSig1020->SetLineStyle(8);
   histoMCYieldPi0PbPbAddSig1020->Draw("hist,l,same");

   DrawGammaSetMarker(histoMCYieldPi0PbPbAddSig2040, markerStylePbPb2040,markerSizePbPb2040, colorCombMCPbPb2040 , colorCombMCPbPb2040);
   histoMCYieldPi0PbPbAddSig2040->SetLineStyle(8);
   histoMCYieldPi0PbPbAddSig2040->Draw("hist,l,same");

   DrawGammaSetMarker(histoMCYieldPi0PbPbAddSig4060, markerStylePbPb4060,markerSizePbPb4060, colorCombMCPbPb4060 , colorCombMCPbPb4060);
   histoMCYieldPi0PbPbAddSig4060->SetLineStyle(8);
   histoMCYieldPi0PbPbAddSig4060->Draw("hist,l,same");

   DrawGammaSetMarker(histoMCYieldPi0PbPbAddSig6080, markerStylePbPb6080,markerSizePbPb6080, colorCombMCPbPb6080 , colorCombMCPbPb6080);
   histoMCYieldPi0PbPbAddSig6080->SetLineStyle(8);
   histoMCYieldPi0PbPbAddSig6080->Draw("hist,l,same");
...
//    SetStyleTLatex( labelSpectraPi0InputPbPb, 0.04  ,4);
   ...
   TLegend* legendSpectraMCOldNew = new TLegend(0.16,0.09,0.7,0.35);
   legendSpectraMCOldNew->SetFillColor(0);
   legendSpectraMCOldNew->SetLineColor(0);
   legendSpectraMCOldNew->SetTextSize(0.025);
   legendSpectraMCOldNew->SetNColumns(4);
   legendSpectraMCOldNew->SetMargin(0.2);
   
   legendSpectraMCOldNew->AddEntry((TObject*)0,"0-5 %","");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPt0005,"LHC13d2x","l");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPtWOWeights0005_OldMC,"LHC11a10x","l");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPi0PbPbAddSig0005,"add Sig","l");
   legendSpectraMCOldNew->AddEntry((TObject*)0,"5-10 %","");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPt0510,"LHC13d2x","l");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPtWOWeights0510_OldMC,"LHC11a10x","l");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPi0PbPbAddSig0510,"add Sig","l");
   legendSpectraMCOldNew->AddEntry((TObject*)0,"10-20 %","");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPt1020,"LHC13d2x","l");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPtWOWeights1020_OldMC,"LHC11a10x","l");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPi0PbPbAddSig1020,"add Sig","l");
   legendSpectraMCOldNew->AddEntry((TObject*)0,"20-40 %","");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPt2040,"LHC13d2x","l");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPtWOWeights2040_OldMC,"LHC11a10x","l");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPi0PbPbAddSig2040,"add Sig","l");
   legendSpectraMCOldNew->AddEntry((TObject*)0,"40-60 %","");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPt4060,"LHC13d2x","l");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPtWOWeights4060_OldMC,"LHC11a10x","l");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPi0PbPbAddSig4060,"add Sig","l");
   legendSpectraMCOldNew->AddEntry((TObject*)0,"60-80 %","");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPt6080,"LHC13d2x","l");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPtWOWeights6080_OldMC,"LHC11a10x","l");
   legendSpectraMCOldNew->AddEntry(histoMCYieldPi0PbPbAddSig6080,"add Sig","l");
   legendSpectraMCOldNew->Draw();
   
   canvasSpectraMCAllTogether->Update();
   canvasSpectraMCAllTogether->Print(Form("%s/Pi0_MCInputSpectraNewAndOldMC_All.%s",outputDir.Data(),suffix.Data()));
   ...
   if (nameFileTPCMult.CompareTo("") != 0){
      ...
      DrawGammaSetMarker(histoMCYieldPtWOWeights0005TPCMult, markerStylePbPb0005,markerSizePbPb0005, colorCombPbPb0005 , colorCombPbPb0005);
      histoMCYieldPtWOWeights0005TPCMult->SetLineStyle(2);
      histoMCYieldPtWOWeights0005TPCMult->Draw("hist,l,same");
      DrawGammaSetMarker(histoMCYieldPtWOWeights0510TPCMult, markerStylePbPb0510,markerSizePbPb0510, colorCombPbPb0510 , colorCombPbPb0510);
      histoMCYieldPtWOWeights0510TPCMult->SetLineStyle(2);
      histoMCYieldPtWOWeights0510TPCMult->Draw("hist,l,same");   
      DrawGammaSetMarker(histoMCYieldPtWOWeights1020TPCMult, markerStylePbPb1020,markerSizePbPb1020, colorCombPbPb1020 , colorCombPbPb1020);
      histoMCYieldPtWOWeights1020TPCMult->SetLineStyle(2);
      histoMCYieldPtWOWeights1020TPCMult->Draw("hist,l,same");
      DrawGammaSetMarker(histoMCYieldPtWOWeights2040TPCMult, markerStylePbPb2040,markerSizePbPb2040, colorCombPbPb2040 , colorCombPbPb2040);
      histoMCYieldPtWOWeights2040TPCMult->SetLineStyle(2);
      histoMCYieldPtWOWeights2040TPCMult->Draw("hist,l,same");
      DrawGammaSetMarker(histoMCYieldPtWOWeights4060TPCMult, markerStylePbPb4060,markerSizePbPb4060, colorCombPbPb4060 , colorCombPbPb4060);
      histoMCYieldPtWOWeights4060TPCMult->SetLineStyle(2);
      histoMCYieldPtWOWeights4060TPCMult->Draw("hist,l,same");
      DrawGammaSetMarker(histoMCYieldPtWOWeights6080TPCMult, markerStylePbPb6080,markerSizePbPb6080, colorCombPbPb6080 , colorCombPbPb6080);
      histoMCYieldPtWOWeights6080TPCMult->SetLineStyle(2);
      histoMCYieldPtWOWeights6080TPCMult->Draw("hist,l,same");   
      
   //    TLatex *labelSpectraPi0InputPbPb = new TLatex(0.5,0.89,"#pi^{0} #rightarrow #gamma #gamma #rightarrow e^{+}e^{-} e^{+}e^{-} MC input");
   //    SetStyleTLatex( labelSpectraPi0InputPbPb, 0.04  ,4);
      labelSpectraPi0InputPbPb->Draw();
      
      TLegend* legendSpectraMCDiffMult = new TLegend(0.16,0.09,0.7,0.35);
      legendSpectraMCDiffMult->SetFillColor(0);
      legendSpectraMCDiffMult->SetLineColor(0);
      legendSpectraMCDiffMult->SetTextSize(0.025);
      legendSpectraMCDiffMult->SetNColumns(3);
      legendSpectraMCDiffMult->SetMargin(0.2);
      
      legendSpectraMCDiffMult->AddEntry((TObject*)0,"0-5 %","");
      legendSpectraMCDiffMult->AddEntry(histoMCYieldPtWOWeights0005,"V0 Mult","l");
      legendSpectraMCDiffMult->AddEntry(histoMCYieldPtWOWeights0005TPCMult,"TPC Mult","l");
      legendSpectraMCDiffMult->AddEntry((TObject*)0,"5-10 %","");
      legendSpectraMCDiffMult->AddEntry(histoMCYieldPtWOWeights0510,"V0 Mult","l");
      legendSpectraMCDiffMult->AddEntry(histoMCYieldPtWOWeights0510TPCMult,"TPC Mult","l");
      legendSpectraMCDiffMult->AddEntry((TObject*)0,"10-20 %","");
      legendSpectraMCDiffMult->AddEntry(histoMCYieldPtWOWeights1020,"V0 Mult","l");
      legendSpectraMCDiffMult->AddEntry(histoMCYieldPtWOWeights1020TPCMult,"TPC Mult","l");
      legendSpectraMCDiffMult->AddEntry((TObject*)0,"20-40 %","");
      legendSpectraMCDiffMult->AddEntry(histoMCYieldPtWOWeights2040,"V0 Mult","l");
      legendSpectraMCDiffMult->AddEntry(histoMCYieldPtWOWeights2040TPCMult,"TPC Mult","l");
      legendSpectraMCDiffMult->AddEntry((TObject*)0,"40-60 %","");
      legendSpectraMCDiffMult->AddEntry(histoMCYieldPtWOWeights4060,"V0 Mult","l");
      legendSpectraMCDiffMult->AddEntry(histoMCYieldPtWOWeights4060TPCMult,"TPC Mult","l");
      legendSpectraMCDiffMult->AddEntry((TObject*)0,"60-80 %","");
      legendSpectraMCDiffMult->AddEntry(histoMCYieldPtWOWeights6080,"V0 Mult","l");
      legendSpectraMCDiffMult->AddEntry(histoMCYieldPtWOWeights6080TPCMult,"TPC Mult","l");
      legendSpectraMCDiffMult->Draw();
      
      canvasSpectraMCAllTogether->Update();
      canvasSpectraMCAllTogether->Print(Form("%s/Pi0_MCInputSpectraDifferentCentSelection.%s",outputDir.Data(),suffix.Data()));
   ...
   SetStyleHistoTH2ForGraphs(histo2DPi0SpectraAllPlusMC, "#it{p}_{T} (GeV/#it{c})","#frac{1}{2#pi #it{N}_{ev}} #frac{d^{2}#it{N}}{#it{p}_{T}d#it{p}_{T}d#it{y}} (GeV/#it{c})^{-2}", 0.03,0.04, 0.03,0.04, 0.83,1.4);// 512, 505); //#frac{#frac{1}{N_{evt}^{AA}}#frac{d#it{N}^{AA}}{d#it{p}_{T} d#it{y}}}{ #frac{1}{N_{evt}^{pp}}#frac{d#it{N}^{pp}}{d#it{p}_{T} d#it{y}}}
...
//    fitYieldDataQCDPi0PbPb0005->SetRange(0.1,20);
   ...
   DrawAutoGammaMesonHistos( histoRatioDatatoFitQCDPbPb0005,
               "", "#it{p}_{T} (GeV/#it{c})", "Spectrum/ fit to Spectrum, PbPb",
               kFALSE, 1.5, 0, kTRUE,
               kTRUE, -0.5, 8.,
               kTRUE, 0., 7.9);
...
//    legendFit1020->SetNColumns(3);
   ...
   legendFit1020->Draw();
   TLatex *labelRatioMCData1020 = new TLatex(0.2,0.92,collisionSystemPbPb1020.Data());
   SetStyleTLatex( labelRatioMCData1020, 0.04,4);
   labelRatioMCData1020->Draw();
...
//    legendFit4060->SetNColumns(3);
   ...
   legendFit4060->Draw();
   TLatex *labelRatioMCData4060 = new TLatex(0.2,0.92,collisionSystemPbPb4060.Data());
   SetStyleTLatex( labelRatioMCData4060, 0.04,4);
   labelRatioMCData4060->Draw();
...
//    legendFit6080->SetNColumns(3);
   ...
   legendFit6080->Draw();
   TLatex *labelRatioMCData6080 = new TLatex(0.2,0.92,collisionSystemPbPb6080.Data());
   SetStyleTLatex( labelRatioMCData6080, 0.04,4);
   labelRatioMCData6080->Draw();
   ...
   //**********************************************************************************
   TF1* fitYieldDataQCDPi0PbPb0020 = NULL;
   if (directoryPi0PbPb0020){
      canvasSpectraMCAllTogether->cd();
      canvasSpectraMCAllTogether->SetLogx(1);
      histo2DSpectraMCAll->GetXaxis()->SetRangeUser(0.01,30);
      ...
      fitYieldDataQCDPi0PbPb0020 = FitObject("qcd","fitYieldDataQCDPi0PbPb0020","Pi0",histoPCMPi0CorrectedSpec0020,0.4,8,NULL,"QNRME+");
   ...
   //    legendFit0020->SetNColumns(3);
      ...
      if (histoRatioMCUnweightedtoDataFitQCDPbPb0020) legendFit0020->AddEntry(histoRatioMCUnweightedtoDataFitQCDPbPb0020,"MC/QCD fit to Data (0.4 <pT<8)","p");
       legendFit0020->Draw();
      TLatex *labelRatioMCData0020 = new TLatex(0.2,0.92,collisionSystemPbPb0020.Data());
      SetStyleTLatex( labelRatioMCData0020, 0.04,4);
      labelRatioMCData0020->Draw();
   ...
   //**********************************************************************************
   TF1* fitYieldDataQCDPi0PbPb0040 = NULL;
   if (directoryPi0PbPb0040){
      canvasSpectraMCAllTogether->cd();
      canvasSpectraMCAllTogether->SetLogx(1);
      histo2DSpectraMCAll->GetXaxis()->SetRangeUser(0.01,30);
      ...
      fitYieldDataQCDPi0PbPb0040 = FitObject("qcd","fitYieldDataQCDPi0PbPb0040","Pi0",histoPCMPi0CorrectedSpec0040,0.4,8,NULL,"QNRME+");
   ...
   //    legendFit0040->SetNColumns(3);
      ...
      legendFit0040->Draw();
      TLatex *labelRatioMCData0040 = new TLatex(0.2,0.92,collisionSystemPbPb0040.Data());
      SetStyleTLatex( labelRatioMCData0040, 0.04,4);
      labelRatioMCData0040->Draw();
   ...
   //**********************************************************************************
   TF1* fitYieldDataQCDPi0PbPb0080 = NULL;
   if (directoryPi0PbPb0080){
      canvasSpectraMCAllTogether->cd();
      canvasSpectraMCAllTogether->SetLogx(1);
      histo2DSpectraMCAll->GetXaxis()->SetRangeUser(0.01,30);
      ...
      fitYieldDataQCDPi0PbPb0080 = FitObject("qcd","fitYieldDataQCDPi0PbPb0080","Pi0",histoPCMPi0CorrectedSpec0080,0.4,8,NULL,"QNRME+");
   ...
   //    legendFit0080->SetNColumns(3);
      ...
      legendFit0080->Draw();
      TLatex *labelRatioMCData0080 = new TLatex(0.2,0.92,collisionSystemPbPb0080.Data());
      SetStyleTLatex( labelRatioMCData0080, 0.04,4);
      labelRatioMCData0080->Draw();
   ...
   //**********************************************************************************
   TF1* fitYieldDataQCDPi0PbPb4080 = NULL;
   if (directoryPi0PbPb4080){
      canvasSpectraMCAllTogether->cd();
      canvasSpectraMCAllTogether->SetLogx(1);
      histo2DSpectraMCAll->GetXaxis()->SetRangeUser(0.01,30);
      ...
      fitYieldDataQCDPi0PbPb4080 = FitObject("qcd","fitYieldDataQCDPi0PbPb4080","Pi0",histoPCMPi0CorrectedSpec4080,0.4,8,NULL,"QNRME+");
   ...
   //    legendFit4080->SetNColumns(3);
      ...
      legendFit4080->Draw();
      TLatex *labelRatioMCData4080 = new TLatex(0.2,0.92,collisionSystemPbPb4080.Data());
      SetStyleTLatex( labelRatioMCData4080, 0.04,4);
      labelRatioMCData4080->Draw();
...
//    SetStyleHistoTH2ForGraphs(histo2DRatioEtaPi0DiffEnergiesSep, "#it{p}_{T} (GeV/#it{c})","#eta/#pi^{0}", 0.03,0.04, 0.03,0.04, 0.83,0.95);
...
//    canvasRatioEtaPi0DiffEnergiesSep->SaveAs(Form("%s/EtaPi0RatioDiffEnergiesSepPCM.%s",outputDir.Data(), suffix.Data()));
   ...
   TFile fMCSpectraInput("MCSpectraInput.root","UPDATE");
      if (fitYieldDataQCDPi0PbPb0005){
         fitYieldDataQCDPi0PbPb0005->SetRange(0,30);
         fitYieldDataQCDPi0PbPb0005->Write("Pi0_Fit_Data_PbPb_2760GeV_0005V0M");
      }
      if (fitYieldDataQCDPi0PbPb0510){
         fitYieldDataQCDPi0PbPb0510->SetRange(0,30);
         fitYieldDataQCDPi0PbPb0510->Write("Pi0_Fit_Data_PbPb_2760GeV_0510V0M");
      }   
      if (fitYieldDataQCDPi0PbPb0010){
         fitYieldDataQCDPi0PbPb0010->SetRange(0,30);
         fitYieldDataQCDPi0PbPb0010->Write("Pi0_Fit_Data_PbPb_2760GeV_0010V0M");
      }
      if (fitYieldDataQCDPi0PbPb1020){
         fitYieldDataQCDPi0PbPb1020->SetRange(0,30);
         fitYieldDataQCDPi0PbPb1020->Write("Pi0_Fit_Data_PbPb_2760GeV_1020V0M");
      }
      if (fitYieldDataQCDPi0PbPb2040){
         fitYieldDataQCDPi0PbPb2040->SetRange(0,30);
         fitYieldDataQCDPi0PbPb2040->Write("Pi0_Fit_Data_PbPb_2760GeV_2040V0M");
      }
      if (fitYieldDataQCDPi0PbPb4060){
         fitYieldDataQCDPi0PbPb4060->SetRange(0,30);
         fitYieldDataQCDPi0PbPb4060->Write("Pi0_Fit_Data_PbPb_2760GeV_4060V0M");
      }
      if (fitYieldDataQCDPi0PbPb6080){
         fitYieldDataQCDPi0PbPb6080->SetRange(0,30);
         fitYieldDataQCDPi0PbPb6080->Write("Pi0_Fit_Data_PbPb_2760GeV_6080V0M");
      }
      if (fitYieldDataQCDPi0PbPb0020){
         fitYieldDataQCDPi0PbPb0020->SetRange(0,30);
         fitYieldDataQCDPi0PbPb0020->Write("Pi0_Fit_Data_PbPb_2760GeV_0020V0M");  
      }
      if (fitYieldDataQCDPi0PbPb0040){
         fitYieldDataQCDPi0PbPb0040->SetRange(0,30);
         fitYieldDataQCDPi0PbPb0040->Write("Pi0_Fit_Data_PbPb_2760GeV_0040V0M");
      }
      if (fitYieldDataQCDPi0PbPb0080){
         fitYieldDataQCDPi0PbPb0080->SetRange(0,30);
         fitYieldDataQCDPi0PbPb0080->Write("Pi0_Fit_Data_PbPb_2760GeV_0080V0M");
      }
      if (fitYieldDataQCDPi0PbPb4080){
         fitYieldDataQCDPi0PbPb4080->SetRange(0,30);
         fitYieldDataQCDPi0PbPb4080->Write("Pi0_Fit_Data_PbPb_2760GeV_4080V0M");
      }   
      histoMCYieldPtWOWeights0005->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_0005V0M");
      histoMCYieldPtWOWeights0510->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_0510V0M");
      histoMCYieldPtWOWeights0010->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_0010V0M");
      histoMCYieldPtWOWeights1020->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_1020V0M");
      histoMCYieldPtWOWeights2040->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_2040V0M");
      histoMCYieldPtWOWeights4060->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_4060V0M");
      histoMCYieldPtWOWeights6080->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_6080V0M");
      if (directoryPi0PbPb0020) histoMCYieldPtWOWeights0020->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_0020V0M");
      if (directoryPi0PbPb0040) histoMCYieldPtWOWeights0040->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_0040V0M");
      if (directoryPi0PbPb0080) histoMCYieldPtWOWeights0080->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_0080V0M");
      if (directoryPi0PbPb4080) histoMCYieldPtWOWeights4080->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_4080V0M");
      histoMCYieldPtWOWeights0005_OldMC->Write("Pi0_Hijing_LHC11a10x_PbPb_2760GeV_0005V0M");
      histoMCYieldPtWOWeights0510_OldMC->Write("Pi0_Hijing_LHC11a10x_PbPb_2760GeV_0510V0M");
      histoMCYieldPtWOWeights0010_OldMC->Write("Pi0_Hijing_LHC11a10x_PbPb_2760GeV_0010V0M");
      histoMCYieldPtWOWeights1020_OldMC->Write("Pi0_Hijing_LHC11a10x_PbPb_2760GeV_1020V0M");
      histoMCYieldPtWOWeights2040_OldMC->Write("Pi0_Hijing_LHC11a10x_PbPb_2760GeV_2040V0M");
      histoMCYieldPtWOWeights4060_OldMC->Write("Pi0_Hijing_LHC11a10x_PbPb_2760GeV_4060V0M");
      histoMCYieldPtWOWeights6080_OldMC->Write("Pi0_Hijing_LHC11a10x_PbPb_2760GeV_6080V0M");
      if (directoryPi0PbPb0020_OldMC) histoMCYieldPtWOWeights0020_OldMC->Write("Pi0_Hijing_LHC11a10x_PbPb_2760GeV_0020V0M");
      if (directoryPi0PbPb0040_OldMC) histoMCYieldPtWOWeights0040_OldMC->Write("Pi0_Hijing_LHC11a10x_PbPb_2760GeV_0040V0M");
      if (directoryPi0PbPb0080_OldMC) histoMCYieldPtWOWeights0080_OldMC->Write("Pi0_Hijing_LHC11a10x_PbPb_2760GeV_0080V0M");
      if (directoryPi0PbPb4080_OldMC) histoMCYieldPtWOWeights4080_OldMC->Write("Pi0_Hijing_LHC11a10x_PbPb_2760GeV_4080V0M");
      histoMCYieldPi0PbPbAddSig0005->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_0005V0M");
      histoMCYieldPi0PbPbAddSig0510->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_0510V0M");
      histoMCYieldPi0PbPbAddSig0010->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_0010V0M");
      histoMCYieldPi0PbPbAddSig1020->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_1020V0M");
      histoMCYieldPi0PbPbAddSig2040->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_2040V0M");
      histoMCYieldPi0PbPbAddSig4060->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_4060V0M");
      histoMCYieldPi0PbPbAddSig6080->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_6080V0M");
      if (histoMCYieldPi0PbPbAddSig0020) histoMCYieldPi0PbPbAddSig0020->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_0020V0M");
      if (histoMCYieldPi0PbPbAddSig0040) histoMCYieldPi0PbPbAddSig0040->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_0040V0M");
      if (histoMCYieldPi0PbPbAddSig0080) histoMCYieldPi0PbPbAddSig0080->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_0080V0M");
      if (histoMCYieldPi0PbPbAddSig4080) histoMCYieldPi0PbPbAddSig4080->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_4080V0M");
      if (histoMCYieldPi0PbPbAddSig0005TPCMult) histoMCYieldPi0PbPbAddSig0005TPCMult->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_0005TPC");
      if (histoMCYieldPi0PbPbAddSig0510TPCMult) histoMCYieldPi0PbPbAddSig0510TPCMult->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_0510TPC");
      if (histoMCYieldPi0PbPbAddSig0010TPCMult) histoMCYieldPi0PbPbAddSig0010TPCMult->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_0010TPC");
      if (histoMCYieldPi0PbPbAddSig1020TPCMult) histoMCYieldPi0PbPbAddSig1020TPCMult->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_1020TPC");
      if (histoMCYieldPi0PbPbAddSig2040TPCMult) histoMCYieldPi0PbPbAddSig2040TPCMult->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_2040TPC");
      if (histoMCYieldPi0PbPbAddSig4060TPCMult) histoMCYieldPi0PbPbAddSig4060TPCMult->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_4060TPC");
      if (histoMCYieldPi0PbPbAddSig6080TPCMult) histoMCYieldPi0PbPbAddSig6080TPCMult->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_6080TPC");
      if (histoMCYieldPi0PbPbAddSig0020TPCMult) histoMCYieldPi0PbPbAddSig0020TPCMult->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_0020TPC");
      if (histoMCYieldPi0PbPbAddSig0040TPCMult) histoMCYieldPi0PbPbAddSig0040TPCMult->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_0040TPC");
      if (histoMCYieldPi0PbPbAddSig0080TPCMult) histoMCYieldPi0PbPbAddSig0080TPCMult->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_0080TPC");
      if (histoMCYieldPi0PbPbAddSig4080TPCMult) histoMCYieldPi0PbPbAddSig4080TPCMult->Write("Pi0_Hijing_LHC13d2_addSig_PbPb_2760GeV_4080TPC");
      if (histoMCYieldPtWOWeights0005TPCMult) histoMCYieldPtWOWeights0005TPCMult->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_0005TPC");
      if (histoMCYieldPtWOWeights0510TPCMult) histoMCYieldPtWOWeights0510TPCMult->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_0510TPC");
      if (histoMCYieldPtWOWeights0010TPCMult) histoMCYieldPtWOWeights0010TPCMult->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_0010TPC");
      if (histoMCYieldPtWOWeights1020TPCMult) histoMCYieldPtWOWeights1020TPCMult->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_1020TPC");
      if (histoMCYieldPtWOWeights2040TPCMult) histoMCYieldPtWOWeights2040TPCMult->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_2040TPC");
      if (histoMCYieldPtWOWeights4060TPCMult) histoMCYieldPtWOWeights4060TPCMult->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_4060TPC");
      if (histoMCYieldPtWOWeights6080TPCMult) histoMCYieldPtWOWeights6080TPCMult->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_6080TPC");
      if (histoMCYieldPi0PbPb0020TPCMult) histoMCYieldPi0PbPb0020TPCMult->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_0020TPC");
      if (histoMCYieldPi0PbPb0040TPCMult) histoMCYieldPi0PbPb0040TPCMult->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_0040TPC");
      if (histoMCYieldPi0PbPb0080TPCMult) histoMCYieldPi0PbPb0080TPCMult->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_0080TPC");
      if (histoMCYieldPi0PbPb4080TPCMult) histoMCYieldPi0PbPb4080TPCMult->Write("Pi0_Hijing_LHC13d2_PbPb_2760GeV_4080TPC");
      
      histoRatioDatatoMCK0s0005->Write("K0s_RatioDataToMC_Hijing_PbPb_2760GeV_0005V0M");
      histoRatioDatatoMCK0s0010->Write("K0s_RatioDataToMC_Hijing_PbPb_2760GeV_0010V0M");
      histoRatioDatatoMCK0s0510->Write("K0s_RatioDataToMC_Hijing_PbPb_2760GeV_0510V0M");
      histoRatioDatatoMCK0s1020->Write("K0s_RatioDataToMC_Hijing_PbPb_2760GeV_1020V0M");
      histoRatioDatatoMCK0s2040->Write("K0s_RatioDataToMC_Hijing_PbPb_2760GeV_2040V0M");
      histoRatioDatatoMCK0s4060->Write("K0s_RatioDataToMC_Hijing_PbPb_2760GeV_4060V0M");
      histoRatioDatatoMCK0s6080->Write("K0s_RatioDataToMC_Hijing_PbPb_2760GeV_6080V0M");
      histoRatioDatatoMCK0s0020->Write("K0s_RatioDataToMC_Hijing_PbPb_2760GeV_0020V0M");
      histoRatioDatatoMCK0s0040->Write("K0s_RatioDataToMC_Hijing_PbPb_2760GeV_0040V0M");
      histoRatioDatatoMCK0s0080->Write("K0s_RatioDataToMC_Hijing_PbPb_2760GeV_0080V0M");
      histoRatioDatatoMCK0s4080->Write("K0s_RatioDataToMC_Hijing_PbPb_2760GeV_4080V0M");
