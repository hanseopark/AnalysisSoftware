...
void ProduceHEPDataFileForPi0EtaPbPbPaper2017( TString nameFilePbPb = "/home/admin1/leardini/Results/FinalMeson25July2017/pdf/2017_09_29/CombineMesonMeasurementsPbPb2760GeVX/CombinedResultsPaperPbPb2760GeV_2017_09_29.root"){
    ...
    TString collisionSystemPbPb = "PbPb #sqrt{#it{s}_{NN}} = 2.76 TeV";

    TString headerPaper = "*author: ACHARYA \n*reference: XXXX \n*reference: ARXIV: XXXXX : \n*reference: CERN-EP-2018-XXX : 2018 \n*status: Encoded 13 Dec 2017 by L. Leardini \n*experiment: CERN-LHC-ALICE \n*detector: ALICE \n*inspireId: \n*cdsId: 000 \n*title: Neutral pion and ETA meson production at central rapidity in Pb-Pb collisions at $\sqrt{s_{\mbox{ NN}}}$\xspace~=~2.76~TeV\n*comment: CERN-LHC.  Neutral pion and ETA meson production in the transverse momentum range 1~$<$~$p_{\mbox{T}}$$<$~20~GeV/$c$ have been measured at midrapidity by the ALICE experiment at the Large Hadron Collider (LHC) in central and semi-central Pb-Pb collisions at $\sqrt{s_{\mbox{NN}}}$. These results extend the $p_{\mbox{T}}$ reach of the previous ALICE PI0 measurements from 12~GeV/$c$ to 20~GeV/$c$ and present the first measurement of the ETA meson in heavy-ion collisions at the LHC. The ETA to PI0 ratio is similar for the two centralities and reaches a plateau value of 0.46~$\pm$~0.01. A suppression of the same magnitude for \pai and ETA meson production is observed in Pb-Pb collisions with respect to their production in pp collisions scaled by the number of binary nucleon-nucleon collisions. For both mesons, the nuclear modification factor \ensuremath{R_{\mbox{AA}}} reaches a minimum at $p_{\mbox{T}}$~$\approx$~7~GeV/$c$ and then increases with transverse momentum. The measurements show a stronger suppression with respect to what was observed at lower center-of-mass energies in the $p_{\mbox{T}}$ range 6~$<$~$p_{\mbox{T}}$$<$~10~GeV/$c$. The results are compared with statistical hadronization models at low-$p_{\mbox{T}}$ and with NLO pQCD jet quenching predictions at high-$p_{\mbox{T}}$.\n\n";
    ...
    cout << endl;
    TString headerPi0RAA_2050 = "*location: Fig. 4, 8 \n *dscomment: Nuclear modification factor RAA of PI0 produced in 0-10%    central inelastic PbPb collisions at center-of-mass energy per nucleon 2.76 TeV, TAA uncertainty of 3.3% and uncertainty of \sigma_{inel} of 3.9% included in systematics\n *reackey: PB PB --> PI0 X\n *obskey: RAA\n *qual: RE: PB PB --> PI0 X\n *qual: YRAP : 0.0\n *qual: CENTRALITY : 20.0 TO 50.0\n *qual: SQRT(S)/NUCLEON IN GEV : 2760.0\n *yheader:  RAA\n *xheader: PT IN GEV/c\n *data: x : y";
    ...
    cout << endl;
    TString headerEtaRAA_2050 = "*location: Fig. 4, 8 \n *dscomment: Nuclear modification factor RAA of ETA produced in 0-10%    central inelastic PbPb collisions at center-of-mass energy per nucleon 2.76 TeV, TAA uncertainty of 3.3% and uncertainty of \sigma_{inel} of 3.9% included in systematics\n *reackey: PB PB --> ETA X\n *obskey: RAA\n *qual: RE: PB PB --> ETA X\n *qual: YRAP : 0.0\n *qual: CENTRALITY : 20.0 TO 50.0\n *qual: SQRT(S)/NUCLEON IN GEV : 2760.0\n *yheader:  RAA\n *xheader: PT IN GEV/c\n *data: x : y";
