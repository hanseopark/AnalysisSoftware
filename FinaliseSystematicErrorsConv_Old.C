...
void FinaliseSystematicErrorsConv_Old(  const char* nameDataFileErrors  = "", 
                                        TString energy                  = "", 
                                        TString meson                   = "", 
                                        Int_t numberOfPtBins            = 1 ,
                                        Int_t numberCutStudies          = 1, 
                                        Double_t decisionBoundary       = 1.,
	...
	TString nameCutVariation7TeV[14] 			= {"Yield extraction", "BG variation", "dE/dx e-line", "dE/dx #pi-line", "TPC cluster", "TOF variation",
												   "Single e^{#pm} p_{t}", "#chi^{2} #gamma", "q_{t,max}", "R", "V0-finder", "#alpha", "#psi_{pair}", "#eta"};  
	TString nameCutForOutputVariation7TeV[14] 	= {"Yield extraction", "BG variation", "dE/dx e-line", "dE/dx #pi-line", "TPC cluster", "TOF variation",
													"Single e^{#pm} p_{t}", "#chi^{2} #gamma", "q_{t,max}", "V0-finder", "R", "#alpha", "#psi_{pair}", "#eta"};  

	TString nameCutVariation900GeV[14] 			= {"Yield extraction", "dE/dx e-line", "dE/dx #pi-line", "TPC cluster", "TOF variation", "Single e^{#pm} p_{t}",
												   "#chi^{2} #gamma", "q_{t,max}", "#alpha","R", "#psi_{pair}", "V0-finder", "#eta", "BG variation"};  
	TString nameCutVariationPbPb2760GeV[15] 	= {"Yield extraction", "dE/dx e-line", "dE/dx #pi-line", "TPC cluster", "TOF variation", "Single e^{#pm} p_{t}", 
													"#chi^{2} #gamma", "q_{t,max}", "#alpha", "#psi_{pair}", "#eta","Pileup Estimate" ,"V0-finder","R", "BG variation"};  
	TString nameCutVariation2760GeV[16] 		= {"Yield extraction", "BG variation", "BG variation N mix", "dE/dx e-line", "dE/dx #pi-line", "TPC cluster",
													"Single e^{#pm} p_{t}", "#chi^{2} #gamma", "q_{t,max}", "#alpha", "Pileup Estimate", "Track Sharing", "V0-finder",
													"R", "#psi_{pair}", "#eta"};  

	TString nameCutVariation[16];
	TString nameCutVariationSC[16];
	
	TString nameCutVariationSCPbPb2760GeV[15] 	= {"YieldExtraction", "dEdxE", "dEdxPi", "Cluster", "TOF", "SinglePt", "Chi2", "Qt", "Alpha", 
													"PsiPair", "Eta","BGEstimate","V0Offline", "R","BG"};
	
	TString nameCutVariationSC2760GeV[16] = {"YieldExtraction","BG", "BGN", "dEdxE","dEdxPi", "Cluster", "SinglePt", "Chi2","Qt", "Alpha","BGEstimate", "TrackShare",  "V0Offline","R" ,"PsiPair", "Eta"};
