...
//*****************************************************************************************************
    ...
    //-----------------------------------
        ...
        TDirectory* TopDir = (TDirectory*) fPhotonQAFile->Get(Form("GammaConvV1_QA_%s_%s",nameCutsPQAmain[i].Data(), cutTreeProjection.Data()));
    ...
    //-----------------------------------
        ...
        if(fHistTruePrimGammaAlphaQt){
            ...
            cout << "INFO: Object |histoTruePrimGammaAlphaQt| could not be found! Skipping Draw..." << endl;
            isMC[i]     = kFALSE;
        }
    //-----------------------------------
