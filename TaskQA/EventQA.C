...
//*****************************************************************************************************
	...
	//-----------------------------------
        ...
        TList* ConvCutsContainer = (TList*) TopContainer->FindObject(Form("ConvCuts_%s",fGammaCutSelection[i].Data()));
            if(isGamma && ConvCutsContainer == NULL) {cout << "ERROR: " << Form("ConvCuts_%s",fGammaCutSelection[i].Data()) << " not found in File" << endl; return;}
    ...
    //-----------------------------------
        ...
        }else cout << "INFO: Object |ESD_MotherPi0_Pt_Y| could not be found! Skipping Draw..." << endl;
    //-----------------------------------
        ...
        }else cout << "INFO: Object |ESD_MotherPi0_Pt_Alpha| could not be found! Skipping Draw..." << endl;
    //-----------------------------------
        ...
        }else cout << "INFO: Object |ESD_MotherPi0_Pt_OpenAngle| could not be found! Skipping Draw..." << endl;
    //-----------------------------------
	...
	//-----------------------------------
		...
		if(isCalo && fHistAcceptance && fHistCutIndex){
